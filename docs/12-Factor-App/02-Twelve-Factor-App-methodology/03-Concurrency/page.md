...
> **lightbulb** Scaling strategies come in two flavors: vertical and horizontal. Vertical scaling adds more resources to a single server, but this approach can lead to downtime and has inherent resource limits.
...
> **lightbulb** * Avoids the single point of failure inherent in vertical scaling.
