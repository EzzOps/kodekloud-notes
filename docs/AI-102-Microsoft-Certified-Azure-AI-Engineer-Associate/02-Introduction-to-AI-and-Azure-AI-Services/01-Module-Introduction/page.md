...
> **lightbulb** Tip: As you progress, focus on the role each area (AI, ML, data science) plays in a solution — from data collection and model training to deployment and monitoring — so you can choose the right Azure services for each stage.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/ai-102-microsoft-certified-azure-ai-engineer-associate/module/608629a7-1574-4eb2-95a4-f026fc8888b2/lesson/dff16f0f-873d-44f9-aa90-aac6b3ec4a73)
