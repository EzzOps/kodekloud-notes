...
> **lightbulb** When working with healthcare or sensitive data, ensure compliance with regulations such as HIPAA and GDPR. Use Azure security features—private networks (VNet), role-based access control (RBAC), encryption at rest and in transit, and audit logging—to protect patient information.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/ai-102-microsoft-certified-azure-ai-engineer-associate/module/608629a7-1574-4eb2-95a4-f026fc8888b2/lesson/f7afa4e1-62c3-4d0a-8347-04f3732d76ab)
