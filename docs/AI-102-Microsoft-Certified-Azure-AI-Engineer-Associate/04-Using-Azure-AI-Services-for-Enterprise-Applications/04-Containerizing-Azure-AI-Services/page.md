...
> **lightbulb** If you're using Apple Silicon (ARM) and the container image targets x86\_64 (AMD64), the image may pull successfully but fail to run. Either use an x86\_64 host, an emulator layer (e.g., Docker Desktop Rosetta/QEMU), or check the container docs for a supported ARM build.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/ai-102-microsoft-certified-azure-ai-engineer-associate/module/981568f6-848e-45c2-ae00-083b3975ecb5/lesson/ce30cd19-4f0d-4161-9e2e-d4f999a5474a)
