...
> **lightbulb** Question answering (QA) is optimized for retrieving factual answers from documents. It's ideal for scenarios like knowledge bases, product documentation, and support FAQs where users expect direct, concise responses.
...
> **warning** When publishing and exposing a knowledge base, ensure sensitive or personally identifiable information (PII) is removed or handled according to your organization’s data policies. Review access controls and rotate keys as needed.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/ai-102-microsoft-certified-azure-ai-engineer-associate/module/f55ce98d-afd9-45b6-8f51-9668bad8705d/lesson/2a903f24-5bfc-4770-9401-a65b0cd6dedd)
