...
> **lightbulb** To enable semantic retrieval and ranking, you typically need an [Azure Cognitive Search](https://learn.microsoft.com/en-us/azure/search/search-what-is-azure-search) (Azure AI Search) index. The search service indexes documents and returns ranked results and embeddings that are passed into the model as prompt context.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/ai-102-microsoft-certified-azure-ai-engineer-associate/module/a4cc50fb-4b34-41eb-845e-d527ee8eb362/lesson/35c72bdb-42ad-4f68-a951-063a5649a109)
