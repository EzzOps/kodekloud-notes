...
<Callout icon="lightbulb">
  You can find full Python and JavaScript examples in the studio's code snippets and the [official SDK documentation](https://learn.microsoft.com/azure/applied-ai-services/document-intelligence/client-libraries) to integrate trained models into your applications.
</Callout>

<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/ai-102-microsoft-certified-azure-ai-engineer-associate/module/85c9f500-329b-4e86-b15c-f2e499d8bee6/lesson/d5494e2e-898f-4862-ae4f-f873811c9044" />
</CardGroup>
