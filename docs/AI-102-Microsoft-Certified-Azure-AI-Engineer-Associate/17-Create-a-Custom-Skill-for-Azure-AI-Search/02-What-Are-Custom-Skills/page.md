...
> **lightbulb** Custom skills follow a simple JSON contract: send a "values" array of input records and return a "values" array with matching recordIds and enriched outputs. Ensuring this schema is implemented correctly lets the enrichment pipeline map inputs to outputs reliably.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/ai-102-microsoft-certified-azure-ai-engineer-associate/module/1413da7e-948c-4865-8347-5710a35851a4/lesson/8ddaffd4-49a0-4ddf-9a96-c9f7bcd66037)
