...
> **lightbulb** Treat the top-level values key as mandatory. The data object is a flexible property bag: fields may be primitive values or nested structures depending on your use case (text extraction, language detection, OCR, etc.).

> **warning** Your custom API must accept and parse this exact schema. If recordId or the values array are missing or misnamed, the enrichment pipeline will fail to correlate responses to inputs.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/ai-102-microsoft-certified-azure-ai-engineer-associate/module/1413da7e-948c-4865-8347-5710a35851a4/lesson/c78f3a35-3e60-408d-a449-c812f579f0e0)
