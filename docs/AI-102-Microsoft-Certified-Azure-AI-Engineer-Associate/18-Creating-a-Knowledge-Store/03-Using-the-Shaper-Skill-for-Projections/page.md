...
> **lightbulb** Use "sourceContext" with a wildcard when you want the shaper skill to iterate a collection and construct an array of structured items. Setting "source" to null indicates that the field's values come from the "sourceContext".
...
> **warning** Make sure wildcard paths in sourceContext are correct and that the Shaper's nested inputs match the actual structure of the extracted data. Incorrect paths or mismatched names can result in empty arrays or missing fields in the final projection.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/ai-102-microsoft-certified-azure-ai-engineer-associate/module/e7fb804b-f0e4-48cb-9a9f-756ea9bf2386/lesson/cf47d9d5-e61b-496b-9509-6bbfad7598a8)
