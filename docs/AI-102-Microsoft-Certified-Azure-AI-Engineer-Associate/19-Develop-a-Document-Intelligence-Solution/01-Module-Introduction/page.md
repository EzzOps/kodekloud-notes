...
> **lightbulb** Tip: Choose the right model type before labeling data. Prebuilt models are quick for common document types (invoices, receipts), layout models are ideal for extracting structure (tables, text blocks), and custom models are best when you need domain-specific fields or document formats.
...
> **warning** Warning: When training and testing models, ensure you comply with data privacy regulations. Redact or anonymize personally identifiable information (PII) as required by your organization and legal guidelines before uploading documents to cloud services.

So let's get started with an introduction to Document Intelligence and how to choose the right model for your use case.

- [Watch Video](https://learn.kodekloud.com/user/courses/ai-102-microsoft-certified-azure-ai-engineer-associate/module/85c9f500-329b-4e86-b15c-f2e499d8bee6/lesson/3880411e-3a00-4557-8a6b-28a6c318dc4b)
