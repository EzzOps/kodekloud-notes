...
<Callout icon="lightbulb">
  The custom Web API must accept and return the [Azure Cognitive Search](https://learn.microsoft.com/azure/search) document array format (a `values` array with `recordId` and `data` for each item). The response must include `recordId` and `data` with the output field(s) (for example, `employeeIds`).
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/ai-102-microsoft-certified-azure-ai-engineer-associate/module/1413da7e-948c-4865-8347-5710a35851a4/lesson/8bc619a3-c28e-4aa3-bbba-48e5a8719ab8" />
</CardGroup>
