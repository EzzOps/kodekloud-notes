...
> **lightbulb** For additional details on deploying and configuring Azure Bot Service, please refer to the [Azure Bot Service Documentation](https://learn.microsoft.com/en-us/azure/bot-service/).
