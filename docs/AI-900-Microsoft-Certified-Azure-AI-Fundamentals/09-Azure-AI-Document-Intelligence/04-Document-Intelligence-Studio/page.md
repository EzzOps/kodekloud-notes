...
Source: https://notes.kodekloud.com/docs/AI-900-Microsoft-Certified-Azure-AI-Fundamentals/Azure-AI-Document-Intelligence/Document-Intelligence-Studio/page

Document Intelligence Studio simplifies document processing with a no-code approach, enabling users to extract structured data from various document types efficiently.
...
[https://documentintelligence.azure.com](https://documentintelligence.azure.com)
...
> **lightbulb** Stay tuned for our upcoming articles where we will delve into other Azure AI capabilities, such as Azure AI Search, and how they can further enhance your document processing and data extraction processes.
