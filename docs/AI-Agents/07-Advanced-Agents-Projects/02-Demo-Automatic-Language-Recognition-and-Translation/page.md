...
> **lightbulb** Store your [OpenAI API key](https://platform.openai.com/account/api-keys) in a `.env` file (for example `OPENAI_API_KEY=<your_key>`). This lesson will load environment variables via [python-dotenv](https://pypi.org/project/python-dotenv/).
