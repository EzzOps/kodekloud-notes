...
> **warning** Make sure your VM has network access to GitHub and that you are signed in. Copilot requires connectivity to GitHub’s services and a Copilot-enabled account or subscription—without these, suggestions and chat will not work.
