...
Source: https://notes.kodekloud.com/docs/AWS-Certified-AI-Practitioner/Guidelines-for-Responsible-AI/Legal-Risks-in-Generative-AI/page

This article explores the legal risks of generative AI, including challenges like copyright issues, bias, and data privacy concerns, along with mitigation strategies.
...
![The image is an agenda slide with two points: "Overview of Generative AI risks" and "Mitigation strategies for each risk."](../../../../images/kodekloud.com/kk-media/image/upload/v1752857592/notes-assets/images/AWS-Certified-AI-Practitioner-Legal-Risks-in-Generative-AI/generative-ai-risks-agenda-slide.jpg)
...
![The image shows a conversation between a user and an AI about the Great Wall of China, with the AI providing information on its length and purpose. The title "Hallucination in Generative AI" suggests a focus on AI inaccuracies.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857594/notes-assets/images/AWS-Certified-AI-Practitioner-Legal-Risks-in-Generative-AI/hallucination-generative-ai-conversation.jpg)
...
![The image highlights the risk of bias in AI hiring tools, showing that women over 55 and men over 60 are rejected.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857598/notes-assets/images/AWS-Certified-AI-Practitioner-Legal-Risks-in-Generative-AI/ai-hiring-bias-women-men-rejected.jpg)
...
![The image is a flowchart illustrating how AI models trained on inappropriate data can generate offensive content, leading to issues like mental health problems and violence against specific groups.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857601/notes-assets/images/AWS-Certified-AI-Practitioner-Legal-Risks-in-Generative-AI/ai-models-offensive-content-flowchart.jpg)

![The image illustrates a process where user-generated content is filtered through content guardrails to remove hate speech, insults, and violence, resulting in appropriate content being displayed to users.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857603/notes-assets/images/AWS-Certified-AI-Practitioner-Legal-Risks-in-Generative-AI/user-generated-content-filtering-process.jpg)

> **triangle-alert** Ensure that content filtering and sanitization pipelines are continuously updated to cope with evolving language and emergent forms of harmful content.
...
![The image outlines data privacy and security risks, highlighting issues like unintentional exposure of sensitive information, difficulty in removing knowledge from models, long-term security risks from retained data, and inadequate data governance. It includes an icon of a warning symbol on a webpage.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857604/notes-assets/images/AWS-Certified-AI-Practitioner-Legal-Risks-in-Generative-AI/data-privacy-security-risks-diagram.jpg)

> **lightbulb** Adopt rigorous data cleansing and governance practices to ensure that no sensitive data is used during the training process.
