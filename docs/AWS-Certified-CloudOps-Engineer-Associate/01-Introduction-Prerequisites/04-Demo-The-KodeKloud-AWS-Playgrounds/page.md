...
Source: https://notes.kodekloud.com/docs/AWS-Certified-CloudOps-Engineer-Associate/Introduction-Prerequisites/Demo-The-KodeKloud-AWS-Playgrounds/page

This tutorial helps you explore and gain hands-on experience with AWS services in a safe, sandboxed environment on KodeKloud.com.
...
![The image is a webpage from KodeKloud featuring the "AWS Sandbox Playground," which offers access to cloud computing services. It includes a brief explanation of AWS and cloud computing, with a "Launch now" button.](../../../../images/kodekloud.com/kk-media/image/upload/v1752861257/notes-assets/images/AWS-Certified-SysOps-Administrator-Associate-Demo-The-KodeKloud-AWS-Playgrounds/aws-sandbox-playground-webpage.jpg)
...
> **lightbulb** After signing into the AWS console, use AWS Cloud Shell for an instant command line interface. This tool is great for running AWS CLI commands to interact with your AWS resources.
...
> **triangle-alert** Keep in mind that the lab user's region is set to Virginia. This reflects the playground's limitations and ensures consistency throughout your session.

![The image shows the AWS Management Console home page, featuring sections for recently visited services, applications, and widgets for AWS Health and cost usage.](../../../../images/kodekloud.com/kk-media/image/upload/v1752861263/notes-assets/images/AWS-Certified-SysOps-Administrator-Associate-Demo-The-KodeKloud-AWS-Playgrounds/aws-management-console-home-page.jpg)
...
![The image shows an Amazon EC2 Dashboard from AWS, displaying resources, service health, and options to launch instances in the US East (N. Virginia) region.](../../../../images/kodekloud.com/kk-media/image/upload/v1752861265/notes-assets/images/AWS-Certified-SysOps-Administrator-Associate-Demo-The-KodeKloud-AWS-Playgrounds/amazon-ec2-dashboard-us-east.jpg)
