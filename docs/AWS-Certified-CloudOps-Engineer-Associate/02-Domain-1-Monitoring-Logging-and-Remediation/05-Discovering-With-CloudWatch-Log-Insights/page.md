...
> **lightbulb** You can save your queries using the "Save" option in the upper-right area of the CloudWatch Logs Insights console. This makes it easier to reuse and organize your frequently used queries.
