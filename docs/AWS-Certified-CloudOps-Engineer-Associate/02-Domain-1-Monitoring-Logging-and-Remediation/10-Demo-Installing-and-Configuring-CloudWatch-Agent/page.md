...
> **lightbulb** By streaming these logs to CloudWatch, you can monitor system activity and quickly detect security-related events.
...
> **lightbulb** Ensure the log file `/var/log/audit/audit.log` exists before starting the agent.
