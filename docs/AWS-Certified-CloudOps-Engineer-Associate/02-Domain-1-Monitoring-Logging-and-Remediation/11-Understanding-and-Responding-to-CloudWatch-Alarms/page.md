...
> **lightbulb** AWS documentation may sometimes refer to the "alarm" state without distinguishing between these nuances. Here, we explicitly define each state for enhanced clarity in your monitoring setup.
