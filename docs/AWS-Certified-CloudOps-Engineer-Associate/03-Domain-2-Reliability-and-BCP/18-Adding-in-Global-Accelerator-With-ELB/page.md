...
> **lightbulb** Be aware that caching behavior can complicate timely failover, as different caching layers may honor different TTL (time-to-live) values. This could lead to outdated DNS records persisting for minutes, or even hours, and potentially route traffic to unhealthy endpoints.
