...
> **lightbulb** In single-instance deployments that use multi-AZ, the secondary instance is inaccessible for direct reads because there is no dedicated URL provided.
