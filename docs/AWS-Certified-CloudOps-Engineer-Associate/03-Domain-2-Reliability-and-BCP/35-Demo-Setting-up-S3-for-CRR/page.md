...
> **lightbulb** If an existing IAM role is not available, a permission error may occur. In such cases, you must create a new IAM role with the required permissions.
