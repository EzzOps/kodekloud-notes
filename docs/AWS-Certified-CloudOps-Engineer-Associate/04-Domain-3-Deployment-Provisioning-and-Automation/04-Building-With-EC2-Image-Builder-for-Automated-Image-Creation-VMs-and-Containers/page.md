...
Source: https://notes.kodekloud.com/docs/AWS-Certified-CloudOps-Engineer-Associate/Domain-3-Deployment-Provisioning-and-Automation/Building-With-EC2-Image-Builder-for-Automated-Image-Creation-VMs-and-Containers/page

This article discusses using EC2 Image Builder for automating the creation of Amazon Machine Images, virtual machines, and container images, highlighting its benefits and workflow.
...
> **lightbulb** Container image pipelines follow a process similar to AMI pipelines. The main difference lies in the distribution target—with containers typically using a Dockerfile-based configuration and being deployed to container registries.
