...
Source: https://notes.kodekloud.com/docs/AWS-Certified-CloudOps-Engineer-Associate/Domain-3-Deployment-Provisioning-and-Automation/CloudFormation-Overview/page

This article explores CloudFormation, an AWS service for managing infrastructure as code, emphasizing its role in automated deployments and consistency in resource management.
...
> **lightbulb** CloudFormation templates are written in JSON or YAML. When you submit a template, CloudFormation creates a stack—a collection of AWS resources defined by the template. Although CloudFormation itself is free, you are charged for the AWS resources it provisions.
