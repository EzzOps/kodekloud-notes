...
Source: https://notes.kodekloud.com/docs/AWS-Certified-CloudOps-Engineer-Associate/Domain-3-Deployment-Provisioning-and-Automation/Creating-and-Managing-Services-With-CloudFormation-Templates/page

This article covers creating and managing AWS services using CloudFormation templates as part of the Infrastructure as Code approach.
...
> **lightbulb** For example, a template might ask whether the environment is production or development and configure resources based on that input. Parameters and conditions play a vital role in making these decision-based adjustments.
