...
> **lightbulb** IAM's primary functions include:
...
> **triangle-alert** The root user has full administrative control with no restrictions (unless limited by AWS Organizations). It is best practice to use the root user only to create your first IAM user and not for daily administrative tasks.
