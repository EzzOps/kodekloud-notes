...
Source: https://notes.kodekloud.com/docs/AWS-Certified-CloudOps-Engineer-Associate/Domain-4-Security-and-Compliance/Demo-Setting-up-Secrets-Manager-with-RDS/page

This lesson covers integrating AWS Secrets Manager with RDS for secure database credential management.
...
![The image shows an AWS management console screen for configuring a PostgreSQL database cluster, including options for credentials management and encryption key selection.](../../../../images/kodekloud.com/kk-media/image/upload/v1752860459/notes-assets/images/AWS-Certified-SysOps-Administrator-Associate-Demo-Setting-up-Secrets-Manager-with-RDS/aws-postgresql-database-configuration.jpg)
...
![The image shows an AWS interface for modifying a database cluster, with options to manage master credentials and apply changes immediately.](../../../../images/kodekloud.com/kk-media/image/upload/v1752860461/notes-assets/images/AWS-Certified-SysOps-Administrator-Associate-Demo-Setting-up-Secrets-Manager-with-RDS/aws-database-cluster-modification.jpg)
...
> **lightbulb** For further confirmation, navigate directly to Secrets Manager. You should see a secret associated with your RDS cluster, clearly identifiable by the cluster name.

![The image shows the AWS Secrets Manager interface with a list of secrets, including a secret associated with an RDS DB cluster. The secret's name, description, and other details are displayed.](../../../../images/kodekloud.com/kk-media/image/upload/v1752860462/notes-assets/images/AWS-Certified-SysOps-Administrator-Associate-Demo-Setting-up-Secrets-Manager-with-RDS/aws-secrets-manager-rds-secret.jpg)
...
![The image shows an AWS RDS interface for modifying a database instance named "rds-pg-taz-reader1," with options to manage master credentials and schedule modifications. The user is selecting to apply changes immediately.](../../../../images/kodekloud.com/kk-media/image/upload/v1752860463/notes-assets/images/AWS-Certified-SysOps-Administrator-Associate-Demo-Setting-up-Secrets-Manager-with-RDS/aws-rds-modify-database-instance.jpg)
...
![The image shows an Amazon RDS dashboard displaying details of a database instance, including its configuration, storage, and availability settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752860465/notes-assets/images/AWS-Certified-SysOps-Administrator-Associate-Demo-Setting-up-Secrets-Manager-with-RDS/amazon-rds-dashboard-database-instance.jpg)
...
![The image shows an AWS Secrets Manager interface displaying details of a secret related to an Amazon RDS database cluster, including the encryption key, secret name, and secret ARN.](../../../../images/kodekloud.com/kk-media/image/upload/v1752860466/notes-assets/images/AWS-Certified-SysOps-Administrator-Associate-Demo-Setting-up-Secrets-Manager-with-RDS/aws-secrets-manager-rds-secret-details.jpg)

> **lightbulb** By reviewing the **Configuration** section in the RDS console, you can confirm that your instance or cluster is actively using Secrets Manager. Options for immediate rotation and further secret management should now be readily available.
