...
Source: https://notes.kodekloud.com/docs/AWS-Certified-CloudOps-Engineer-Associate/Domain-6-Cost-and-Performance-Optimization/Configuring-Billing-Alarms-to-Send-Notifications-for-Cost-Monitoring/page

This article explains how to configure billing alarms in AWS CloudWatch for effective cost monitoring and notifications.
...
> **lightbulb** Before you begin, ensure that your billing alerts are enabled in your AWS account. This demonstration uses a demo account that may incur some costs.
...
> **lightbulb** Remember to regularly review your billing metrics and adjust alarm thresholds as needed to ensure they match your spending habits.
