...
Source: https://notes.kodekloud.com/docs/AWS-Certified-CloudOps-Engineer-Associate/Domain-4-Security-and-Compliance/Key-Management-Service-KMS/page

This article provides a comprehensive overview of AWS Key Management Service (KMS), covering its features, types of keys, and integration with AWS services.
...
* **Customer Managed Keys (CMKs):**\
  ...
  * *Symmetric keys:* Use a single key for both encryption and decryption.
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-certified-sysops-administrator-associate/module/0c9bb9a3-5201-434e-8085-a9f1e9f23f22/lesson/16c8253b-afe3-4e1c-8235-e9dbeb432407" />
</CardGroup>
