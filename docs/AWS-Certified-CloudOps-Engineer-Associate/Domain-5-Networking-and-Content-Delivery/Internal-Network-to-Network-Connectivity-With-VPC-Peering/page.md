...
Source: https://notes.kodekloud.com/docs/AWS-Certified-CloudOps-Engineer-Associate/Domain-5-Networking-and-Content-Delivery/Internal-Network-to-Network-Connectivity-With-VPC-Peering/page

This article explores establishing internal network connectivity using VPC peering to connect separate Virtual Private Clouds securely across different AWS accounts or regions.
...
<Callout icon="lightbulb">
  ...
  * Using distinct CIDR blocks (such as 10.10.0.0/24 and 10.10.1.0/24) avoids conflicts.
    For IPv6, overlapping is typically not an issue since every address is unique.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-certified-sysops-administrator-associate/module/fd99c412-5efc-46e2-99ce-bb9c581fec27/lesson/33119f66-a57f-4733-bbb6-c3ae9afe941e" />
</CardGroup>
