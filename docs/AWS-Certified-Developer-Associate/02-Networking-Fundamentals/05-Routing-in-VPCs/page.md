...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Networking-Fundamentals/Routing-in-VPCs/page

This article explores routing functions within a Virtual Private Cloud, focusing on internal routers, route tables, and subnet associations in AWS environments.
...
> **lightbulb** Remember that this behavior applies to both IPv4 and IPv6 traffic.
...
> **lightbulb** For more detailed information on AWS networking and VPC configuration, explore the [AWS Networking Documentation](https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html).
