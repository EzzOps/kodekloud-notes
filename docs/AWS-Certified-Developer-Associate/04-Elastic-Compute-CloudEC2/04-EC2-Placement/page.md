...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Elastic-Compute-CloudEC2/EC2-Placement/page

This article explores options for strategically placing EC2 instances to optimize performance and redundancy.
...
> **lightbulb** Using a Cluster Placement Group can significantly improve communication speeds between instances when they are tightly coupled.
...
> **lightbulb** The separation provided by partitions ensures that a failure in one partition does not cascade to affect the entire application.
