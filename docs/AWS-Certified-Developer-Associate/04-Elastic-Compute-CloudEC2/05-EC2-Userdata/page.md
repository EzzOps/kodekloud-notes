...
> **lightbulb** Ensure that your user data script is correctly configured to run during your instance's startup. Proper scripting helps maintain consistency and saves time during instance provisioning.
