...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Storage/Instance-Store-Demo/page

Learn to work with EC2 instance store volumes and understand their limitations regarding data persistence during instance movements.
...
> **lightbulb** Remember that a reboot keeps the EC2 instance on the same physical host, preserving the instance store. However, a stop/start operation changes the host, causing the loss of any data on the instance store.
