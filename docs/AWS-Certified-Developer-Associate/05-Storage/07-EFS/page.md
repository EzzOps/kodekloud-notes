...
> **lightbulb** To persist mounts across reboots, add an appropriate entry in /etc/fstab (or configure boot scripts). See the official AWS EFS mounting instructions for recommended options and examples: [https://docs.aws.amazon.com/efs/latest/ug/mounting-fs.html](https://docs.aws.amazon.com/efs/latest/ug/mounting-fs.html)
...
> **lightbulb** Amazon EFS supports mounting the same file system on multiple EC2 instances concurrently, making it ideal for sharing data across various instances.
