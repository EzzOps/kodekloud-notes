...
> **lightbulb** After uploading, verify that the file's storage class is set to **"One Zone-Infrequent Access"** by checking the file details in the S3 console.
...
> **lightbulb** Remember that each S3 storage class is optimized for different use cases. Choose the class that best meets your performance, durability, and cost requirements.
