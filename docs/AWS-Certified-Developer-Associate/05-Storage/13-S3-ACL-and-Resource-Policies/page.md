...
> **triangle-alert** Be cautious when configuring bucket policies. An incorrect configuration, such as using `"Principal": "*"` with broad permissions like `"s3:*"`, can inadvertently expose your bucket to the public.
