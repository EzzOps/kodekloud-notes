...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Storage/S3-Access-Points-Demo/page
...
> **lightbulb** Ensure that permissions granted in an access point policy are also allowed by the underlying bucket. You can either delegate control from the bucket or include the access point policy in the bucket policy.
