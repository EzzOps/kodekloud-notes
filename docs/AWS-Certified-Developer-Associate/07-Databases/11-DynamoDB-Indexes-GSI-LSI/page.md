...
> **triangle-alert** Efficient querying in DynamoDB depends on leveraging the partition key and, optionally, the sort key. Avoid client-side filtering when possible to improve performance.
