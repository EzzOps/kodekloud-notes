...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Elastic-Beanstalk/Deployment-Options/page

This article explores various deployment strategies for updating EC2 instances while minimizing service disruptions.
...
> **lightbulb** Although this method may incur additional costs due to the temporary increase in instances, it maintains overall processing capacity during the upgrade.
...
> **triangle-alert** It is essential to thoroughly test your chosen deployment strategy in a staging environment before applying it to production to avoid unforeseen issues.
