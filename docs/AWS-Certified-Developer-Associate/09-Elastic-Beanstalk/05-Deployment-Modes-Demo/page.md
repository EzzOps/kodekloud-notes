...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Elastic-Beanstalk/Deployment-Modes-Demo/page

Learn to update and deploy application versions using AWS Elastic Beanstalk, including environment switching, deployment configurations, and rollback features.
...
> **lightbulb** This feature allows you to deploy a new version in a separate environment and then swap the domain. For example, after deploying a new version (e.g., "prod v3") in a secondary environment, you can swap the domain with the current production environment, ensuring a seamless transition for users.
