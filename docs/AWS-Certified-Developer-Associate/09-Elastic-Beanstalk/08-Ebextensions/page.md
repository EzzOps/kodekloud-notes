...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Elastic-Beanstalk/Ebextensions/page

Elastic Beanstalk extensions manage environment configuration in source code, ensuring consistent, version-controlled deployments across different stages.
...
> **lightbulb** EB extensions are particularly useful for automating environment setups while keeping your configurations in sync with your application code.
...
> **triangle-alert** Make sure to test your EB extension configurations in a non-production environment before applying them to critical deployments.
