...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Storage/EBS-Demo-1/page

This lesson covers working with Amazon Elastic Block Store by moving data between Availability Zones and regions using preconfigured EC2 instances.
...
2. Confirm the mount by checking the disk usage:
   ...
   tmpfs            191596    2844     191596    2% /run
   /dev/xvda1     8310764 1561336  6749428   19% /
   tmpfs            486096       0     486096    0% /tmp
   tmpfs             97216       0      97216    0% /run/user/1000
   /dev/xvdf     10420224  105704 10314520    2% /ebsdemo
   ------------------------------------------------------
...
1. Retrieve the unique UUID of the volume:
   ...
   ## /dev/xvdf: UUID="04fddc8e-3441-4518-986c-a32254c0e925" BLOCK\_SIZE="512" TYPE="xfs"
...
3. Append a new line (do not modify existing entries) similar to the following:
   ...
   UUID=78de5e87-1c4f-4c4a-abba-d469bbc45143 /                       xfs     defaults,noatime      1 1
   UUID=2594-F04B                           /boot/efi                vfat    defaults,noatime,uid=0,gid=0,umask=0077,shortname=winnt,x-systemd.automount 0 2
   UUID=04fddc8e-3441-4518-986c-a32254c0e925 /ebsdemo                xfs     defaults,nofail
   -----------------------------------------------------------------------------------------
...
1. Change to the mounted directory and create a test file:
   ...
   cd /ebsdemo
   sudo bash -c 'echo "I made this file on server one" > demo.txt'
   ---------------------------------------------------------------
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-certified-developer-associate/module/e8ae2293-e16b-42d3-b32b-5c260a1f1e5d/lesson/29905cc0-1285-4deb-a4f5-67f71ebcb859" />
</CardGroup>
