...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/API-Gateway/Stages-Deployments-Demo/page
...
<Frame>
  ![The image shows the AWS Management Console home page, displaying recently visited services, application management, AWS health, and cost and usage information.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857891/notes-assets/images/AWS-Certified-Developer-Associate-Stages-Deployments-Demo/aws-management-console-home-page.jpg)
</Frame>
...
<Frame>
  ![The image shows the AWS Lambda console where a user is creating a new function. The function is named "getPr" with Node.js 20.x selected as the runtime.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857892/notes-assets/images/AWS-Certified-Developer-Associate-Stages-Deployments-Demo/aws-lambda-create-function-getpr-nodejs.jpg)
</Frame>
...
<Frame>
  ![The image shows an AWS Lambda console with a function named "getProducts" at version 3. It includes options for exporting, downloading, and adding destinations, along with a function ARN displayed.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857893/notes-assets/images/AWS-Certified-Developer-Associate-Stages-Deployments-Demo/aws-lambda-getproducts-console-2.jpg)
</Frame>
...
<Frame>
  ![The image shows an AWS Lambda console screen with details of a function alias named "prod" for the function "getProducts." It includes options to add triggers and destinations, and displays the function's ARN and version information.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857894/notes-assets/images/AWS-Certified-Developer-Associate-Stages-Deployments-Demo/aws-lambda-console-getproducts-prod.jpg)
</Frame>
...
<Frame>
  ![The image shows an AWS Lambda console interface for a function named "getProducts," displaying its overview, configuration options, and aliases.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857896/notes-assets/images/AWS-Certified-Developer-Associate-Stages-Deployments-Demo/aws-lambda-getproducts-console-3.jpg)
</Frame>
...
<Frame>
  ![The image shows an AWS API Gateway interface with options to build WebSocket API, REST API, and REST API Private, each with corresponding "Build" buttons.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857898/notes-assets/images/AWS-Certified-Developer-Associate-Stages-Deployments-Demo/aws-api-gateway-interface-options.jpg)
</Frame>

<Frame>
  ![The image shows the AWS API Gateway interface for creating a REST API. The "New API" option is selected, and the API name is set to "ecommerce."](../../../../images/kodekloud.com/kk-media/image/upload/v1752857899/notes-assets/images/AWS-Certified-Developer-Associate-Stages-Deployments-Demo/aws-api-gateway-ecommerce-rest-api.jpg)
</Frame>

3. Create a resource named **products**.

<Frame>
  ![The image shows an AWS API Gateway interface where a user is creating a new resource named "product" with options for proxy resource and CORS.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857900/notes-assets/images/AWS-Certified-Developer-Associate-Stages-Deployments-Demo/aws-api-gateway-create-product-resource.jpg)
</Frame>
...
<Frame>
  ![The image shows an AWS API Gateway interface where a user is configuring a method to integrate with a Lambda function. Various integration options like HTTP, AWS service, and VPC link are visible.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857902/notes-assets/images/AWS-Certified-Developer-Associate-Stages-Deployments-Demo/aws-api-gateway-lambda-integration.jpg)
</Frame>
...
<Frame>
  ![The image shows an AWS API Gateway interface where a Lambda function is being integrated. Various integration options like HTTP, AWS service, and VPC link are visible.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857903/notes-assets/images/AWS-Certified-Developer-Associate-Stages-Deployments-Demo/aws-api-gateway-lambda-integration-2.jpg)
</Frame>
...
<Frame>
  ![The image shows an AWS API Gateway console with details of the "staging" stage for an API named "ecommerce." It includes stage details like the invoke URL and deployment information.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857906/notes-assets/images/AWS-Certified-Developer-Associate-Stages-Deployments-Demo/aws-api-gateway-ecommerce-staging.jpg)
</Frame>
...
<Frame>
  ![The image shows an AWS API Gateway console with stages for an "ecommerce" API, highlighting the "prod" stage and a GET method for the "/products" endpoint.](../../../../images/kodekloud.com/kk-media/image/upload/v1752857907/notes-assets/images/AWS-Certified-Developer-Associate-Stages-Deployments-Demo/aws-api-gateway-ecommerce-prod-get.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-certified-developer-associate/module/628f3688-9475-4368-90bb-89dc572f86d0/lesson/8a4e4794-205e-47b0-acc9-003c3f97610a" />
</CardGroup>
