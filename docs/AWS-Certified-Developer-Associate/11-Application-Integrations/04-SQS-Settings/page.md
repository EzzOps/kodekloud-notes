...
> **triangle-alert** Always verify that your API usage conforms to AWS best practices to avoid issues such as duplicate message processing or unnecessary costs.
