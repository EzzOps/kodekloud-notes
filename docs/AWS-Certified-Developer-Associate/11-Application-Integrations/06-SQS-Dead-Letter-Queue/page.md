...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Application-Integrations/SQS-Dead-Letter-Queue/page

This article explores the SQS dead letter queues role in message processing workflows and its importance for troubleshooting and system reliability.
...
![The image is a flowchart illustrating a dead letter queue process, showing a message retry mechanism with a maximum receive threshold and eventual sending to a dead queue if retries fail.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858422/notes-assets/images/AWS-Certified-Developer-Associate-SQS-Dead-Letter-Queue/dead-letter-queue-flowchart.jpg)

> **lightbulb** Administrators or developers can later examine the messages in the dead letter queue to diagnose and resolve issues. Once the problem is fixed, the original message can be reintroduced into the main queue for reprocessing, leading to a higher likelihood of successful execution.
...
![The image provides information about SQS Dead Letter Queues, explaining that they must be the same type as the main queue, need provisioning like any other queue, and have a retention period of up to 14 days.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858423/notes-assets/images/AWS-Certified-Developer-Associate-SQS-Dead-Letter-Queue/sqs-dead-letter-queues-info.jpg)
