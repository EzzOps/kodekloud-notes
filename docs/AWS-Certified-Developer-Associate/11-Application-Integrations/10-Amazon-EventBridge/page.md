...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Application-Integrations/Amazon-EventBridge/page

This article explores AWS EventBridge, a serverless event bus for capturing, routing, and delivering events from various sources to multiple targets.
...
> **lightbulb** EventBridge makes it easy to build loosely coupled and scalable architectures by abstracting the event routing logic. This separation of concerns allows your application components to evolve independently.
