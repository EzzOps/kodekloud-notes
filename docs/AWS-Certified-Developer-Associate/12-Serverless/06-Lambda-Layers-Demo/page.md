...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Serverless/Lambda-Layers-Demo/page

This article demonstrates using AWS Lambda layers to manage third-party libraries in Lambda functions for password hashing.
...
> **lightbulb** This error occurs because the Lambda function does not have access to the `node_modules` folder that contains bcrypt.js.
...
> **lightbulb** Before attaching the layer, your Lambda function may display errors due to the missing bcrypt.js package.
