...
> **lightbulb** Lambda Destinations is applicable only for functions invoked asynchronously. Ensure your Lambda function's invocation type aligns with this capability.
