...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Serverless/Execution-Context-and-tmp-Demo/page
...
> **triangle-alert** Avoid repetitive initialization of external resources in your Lambda functions. It increases latency and resource consumption.
...
> **lightbulb** By moving the initialization of external resources outside the handler, your Lambda function will benefit from reduced execution times during subsequent invocations. This is particularly useful for high-traffic applications where performance gains are critical.
