...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Application-Integrations/Exam-TIps/page

This guide covers essential AWS services and best practices for the AWS Developer Associate exam, including SQS, SNS, EventBridge, and Step Functions.
...
<Frame>
  <img alt="The image provides exam tips for SQS, highlighting its features such as message size, retention period, and queue types (Standard and FIFO) with their characteristics." />
</Frame>
...
<Frame>
  <img alt="The image provides exam tips for SQS, mentioning the use of the SQS Extended Client Library for larger messages via S3 and configuring SQS with KMS for message encryption." />
</Frame>
...
<Frame>
  <img alt="The image provides exam tips for SQS, focusing on visibility timeout and message processing. It includes details about default timeout settings and the ChangeMessageVisibility API." />
</Frame>

<Frame>
  <img alt="The image provides exam tips for SQS, highlighting long polling benefits and message retry configurations." />
</Frame>

<Frame>
  <img alt="The image provides exam tips for SQS, focusing on the requirements for dead letter queues (DLQ) to match the type of the main queue and the need for DLQs to be provisioned like any other queue." />
</Frame>
...
<Frame>
  <img alt="The image provides exam tips about SNS, describing it as a message delivery service for publishers and subscribers, emphasizing its use for forwarding information to multiple parties, and explaining SNS topics as communication channels." />
</Frame>
...
<Frame>
  <img alt="The image provides exam tips about AWS EventBridge, explaining its functions such as connecting application components, routing events, performing scheduled tasks, and using an event bus." />
</Frame>
...
<Frame>
  <img alt="The image provides exam tips for AWS Step Functions, describing various states such as Pass, Choice, Fail, Succeed, Parallel, and Map, with brief explanations of each." />
</Frame>

<Frame>
  <img alt="The image provides exam tips for step functions, explaining how to handle task failures and use callback tasks to pause workflows." />
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-certified-developer-associate/module/60c267ab-da8b-4408-97f4-b53aad3f4479/lesson/b3b86b23-d3fa-4975-9e98-7b44ce328a49" />
</CardGroup>
