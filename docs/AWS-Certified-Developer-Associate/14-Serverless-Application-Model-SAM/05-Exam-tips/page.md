...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Serverless-Application-Model-SAM/Exam-tips/page

This guide provides essential tips for the AWS Certified Developer - Associate exam focusing on AWS SAM and its key commands for building serverless applications.
...
<Frame>
  <img alt="The image provides exam tips for AWS SAM, highlighting its use for building serverless applications, utilizing CloudFormation, and key CLI commands like SAM Init, SAM Build, SAM Deploy, and SAM Sync." />
</Frame>
...
> **lightbulb** For a complete list of available SAM policy templates and additional details, refer to the [AWS SAM documentation](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/what-is-sam.html).

<Frame>
  <img alt="The image provides exam tips for AWS SAM, explaining the use of the &#x22;Transform&#x22; keyword, SAM policy templates, and where to find a list of templates." />
</Frame>
