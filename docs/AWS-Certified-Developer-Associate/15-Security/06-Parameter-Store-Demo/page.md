...
> **lightbulb** The **username** is returned as plain text, while the **password** remains encrypted.
...
> **lightbulb** Always ensure that you enforce the principle of least privilege when configuring IAM policies for Parameter Store access.
