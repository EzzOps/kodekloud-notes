...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Data-Analytics/Kinesis-Data-analytics/page

This article explores Amazon Kinesis Data Analytics, a service for processing and analyzing streaming data in real time using SQL.
...
> **lightbulb** This service utilizes SQL for data processing, making it accessible for teams already familiar with SQL query techniques.
...
> **triangle-alert** Ensure that your data sources and sinks are correctly configured—only Kinesis Data Streams and Kinesis Data Firehose are supported. Incorrect configuration may lead to processing interruptions.
