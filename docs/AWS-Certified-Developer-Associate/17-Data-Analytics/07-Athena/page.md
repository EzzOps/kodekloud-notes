...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Data-Analytics/Athena/page

AWS Athena is a serverless query service for analyzing data in Amazon S3 using standard SQL without managing infrastructure.
...
> **lightbulb** Leverage AWS Athena to perform quick, cost-effective analytics on your S3 data. With its serverless nature, you only pay for the bytes scanned, making it an ideal solution for scalable data analysis.
