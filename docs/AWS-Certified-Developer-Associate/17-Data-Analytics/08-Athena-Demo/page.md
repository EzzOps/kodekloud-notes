...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Data-Analytics/Athena-Demo/page

This article demonstrates how to use Amazon Athena with a sample CSV file containing user records.
...
> **lightbulb** Ensure that your CSV file is correctly formatted and stored in an S3 bucket before proceeding.
...
2. Provide a table name (for instance, "users") and choose to create a new database (e.g., "athena\_demo").
...
> **lightbulb** Adjust the column types as necessary—for example, converting the ID to an integer and the date joined to a date type.
