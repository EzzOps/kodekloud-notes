...
> **lightbulb** Before you begin, ensure Git is installed on your machine. You can download it from the [official Git website](https://git-scm.com/downloads). After installation, confirm by running:
