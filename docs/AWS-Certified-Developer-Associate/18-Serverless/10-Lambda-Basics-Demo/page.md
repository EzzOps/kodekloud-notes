...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Serverless/Lambda-Basics-Demo/page
...
For this demonstration, we will **author the function from scratch**. Enter a name for your function (for example, "demoFunction") and choose a runtime. AWS supports recent versions of various languages such as Python 3.12, Ruby 3.3, and Node.js 20.x. You may also select your preferred code architecture (the default is x86\_64).
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-certified-developer-associate/module/3c842ffc-5841-456d-9fad-7bb3af5fdbfc/lesson/37f598f2-4e1c-4861-98e6-299a0c13ef40" />
</CardGroup>
