...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Serverless/Lambda-EventBridge-Integration/page

Learn to integrate AWS Lambda with Amazon EventBridge for automating workflows and responding to various events in your AWS environment and applications.
...
<Frame>
  ![The image illustrates a flowchart showing how an Amazon EventBridge Rule matches an event pattern to trigger an Amazon EventBridge Event, which then invokes an AWS Lambda function.](../../../../images/kodekloud.com/kk-media/image/upload/v1752859532/notes-assets/images/AWS-Certified-Developer-Associate-Lambda-EventBridge-Integration/amazon-eventbridge-flowchart-lambda.jpg)
</Frame>
...
<Frame>
  ![The image displays five types of events: AWS Service Events, Scheduled Events, Custom Application Events, SaaS Partner Events, and Cross-Account Events, each represented with an icon and a number.](../../../../images/kodekloud.com/kk-media/image/upload/v1752859534/notes-assets/images/AWS-Certified-Developer-Associate-Lambda-EventBridge-Integration/event-types-icons-numbers.jpg)
</Frame>

<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-certified-developer-associate/module/3c842ffc-5841-456d-9fad-7bb3af5fdbfc/lesson/380c9971-1cd1-40ad-8c69-94a36faae218" />
</CardGroup>
