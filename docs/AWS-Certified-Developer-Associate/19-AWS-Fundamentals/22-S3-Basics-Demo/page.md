...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/AWS-Fundamentals/S3-Basics-Demo/page

Learn to create and manage an Amazon S3 bucket using the AWS Management Console, including uploading files and organizing objects.
...
<Frame>
  ![The image shows the AWS Management Console with a search for "S3," displaying various related services and features like S3, S3 Glacier, AWS Snow Family, and AWS Transfer Family.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858230/notes-assets/images/AWS-Certified-Developer-Associate-S3-Basics-Demo/aws-management-console-s3-search.jpg)
</Frame>

<Frame>
  ![The image shows the Amazon S3 console interface, highlighting features like creating a bucket, pricing, and resources, with a video introduction to Amazon S3.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858232/notes-assets/images/AWS-Certified-Developer-Associate-S3-Basics-Demo/amazon-s3-console-interface-features.jpg)
</Frame>
...
<Frame>
  ![The image shows an Amazon S3 console interface with an account snapshot and a list of AWS regions. There are no buckets created, and a "Create bucket" button is visible.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858233/notes-assets/images/AWS-Certified-Developer-Associate-S3-Basics-Demo/amazon-s3-console-account-snapshot.jpg)
</Frame>
...
<Frame>
  ![The image shows a screenshot of the AWS S3 "Create bucket" configuration page, including fields for bucket name, AWS region, and object ownership settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858235/notes-assets/images/AWS-Certified-Developer-Associate-S3-Basics-Demo/aws-s3-create-bucket-screenshot.jpg)
</Frame>
...
<Frame>
  ![The image shows an AWS S3 bucket creation interface with options for bucket versioning, tags, default encryption, and advanced settings. The "Create bucket" button is visible at the bottom.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858236/notes-assets/images/AWS-Certified-Developer-Associate-S3-Basics-Demo/aws-s3-bucket-creation-interface.jpg)
</Frame>
...
<Frame>
  ![The image shows an Amazon S3 dashboard with details of a bucket named "kk-demo-123" in the US East (N. Virginia) region. The account snapshot indicates total storage of 390.6 KB with 41 objects.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858237/notes-assets/images/AWS-Certified-Developer-Associate-S3-Basics-Demo/amazon-s3-dashboard-kk-demo-123.jpg)
</Frame>
...
<Frame>
  ![The image shows an AWS S3 bucket overview with details about bucket versioning, multi-factor authentication, tags, and default encryption settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858239/notes-assets/images/AWS-Certified-Developer-Associate-S3-Basics-Demo/aws-s3-bucket-overview-details.jpg)
</Frame>
...
<Frame>
  ![The image shows an Amazon S3 bucket permissions settings page, indicating that the bucket and objects are not public, with public access blocked.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858241/notes-assets/images/AWS-Certified-Developer-Associate-S3-Basics-Demo/amazon-s3-bucket-permissions-settings.jpg)
</Frame>
...
<Frame>
  ![The image shows an AWS S3 upload interface with a file named "pexels-julio-nery-1687147.jpg" ready to be uploaded to the "kk-demo-123" bucket. The file is 2.7 MB in size.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858242/notes-assets/images/AWS-Certified-Developer-Associate-S3-Basics-Demo/aws-s3-upload-interface-pexels-file.jpg)
</Frame>
...
<Frame>
  ![The image shows an Amazon S3 console screen displaying storage class options and their properties, such as availability zones and minimum storage duration.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858243/notes-assets/images/AWS-Certified-Developer-Associate-S3-Basics-Demo/amazon-s3-storage-class-options.jpg)
</Frame>
...
<Frame>
  ![The image shows an Amazon S3 console interface displaying details about an object, including sections for additional checksums, tags, metadata, and object lock settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858245/notes-assets/images/AWS-Certified-Developer-Associate-S3-Basics-Demo/amazon-s3-console-object-details.jpg)
</Frame>
...
<Frame>
  ![The image shows an Amazon S3 interface where a user is creating a folder named "food" with options for server-side encryption.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858246/notes-assets/images/AWS-Certified-Developer-Associate-S3-Basics-Demo/amazon-s3-folder-creation-food.jpg)
</Frame>
...
<Frame>
  ![The image shows an Amazon S3 console with a bucket named "kk-demo-123" containing four image files: burger.jpg, pizza.jpg, sandwich.jpg, and steak.jpg.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858247/notes-assets/images/AWS-Certified-Developer-Associate-S3-Basics-Demo/amazon-s3-bucket-kk-demo-123-2.jpg)
</Frame>
...
<Frame>
  ![The image shows an Amazon S3 console interface for moving objects, with instructions and a destination input field for specifying the S3 bucket path.](../../../../images/kodekloud.com/kk-media/image/upload/v1752858250/notes-assets/images/AWS-Certified-Developer-Associate-S3-Basics-Demo/amazon-s3-console-move-objects.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-certified-developer-associate/module/6d3acaeb-020a-4e1e-9bd0-5fc6c50eb164/lesson/9caba271-dfb9-4143-96b7-9391edcb9791" />
</CardGroup>
