...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/AWS-Fundamentals/What-is-AWS/page

This article explores AWS, its benefits, challenges it addresses, and compares traditional IT infrastructure with cloud computing.
...
<Frame>
  <img alt="The image depicts a traditional IT setup with servers, a cloud icon, and people working on computers. An exclamation mark indicates an alert or issue with the servers." />
</Frame>
...
<Frame>
  <img alt="The image illustrates a traditional IT setup with servers and people working on laptops, highlighting issues like paying for idle servers and unused compute power." />
</Frame>
...
<Frame>
  <img alt="The image illustrates the cons of traditional IT, highlighting increased costs, long provisioning times, more personnel, limited geographic presence, and a non-dynamic environment, alongside a graphic of people working with servers." />
</Frame>
...
<Frame>
  <img alt="The image illustrates a user requesting a server with 1 CPU and 2GB RAM from AWS Cloud using a console, CLI, or SDK." />
</Frame>
...
<Frame>
  <img alt="The image illustrates a cloud computing process on AWS, showing a user requesting a server with specific specifications (1 CPU, 2GB RAM) via console, CLI, or SDK, and receiving server details from the AWS cloud." />
</Frame>

<Frame>
  <img alt="The image illustrates a process in cloud computing with AWS, showing a user sending a request to delete a server and receiving confirmation that the server was successfully deleted." />
</Frame>
...
<Frame>
  <img alt="The image explains why Amazon Web Services (AWS) is named as such, highlighting that Amazon offers computing power as a paid service, represented by a server icon within the AWS Cloud." />
</Frame>
...
<Frame>
  <img alt="The image is an infographic explaining why it's called Amazon Web Services, highlighting components like hardware, software, and backups, and features such as availability, security, and scalability. It centers around managing a database." />
</Frame>

<Frame>
  <img alt="The image is a diagram explaining how a user requests a MySQL database via AWS Cloud, highlighting the management, operation, and maintenance of the database." />
</Frame>
...
<Frame>
  <img alt="The image is a summary slide about cloud computing, highlighting its on-demand delivery of IT resources, client-server model, and pay-as-you-go access to AWS services." />
</Frame>

<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-certified-developer-associate/module/6d3acaeb-020a-4e1e-9bd0-5fc6c50eb164/lesson/86d1d31f-d13a-40ce-b132-55dd817b4a38" />
</CardGroup>
