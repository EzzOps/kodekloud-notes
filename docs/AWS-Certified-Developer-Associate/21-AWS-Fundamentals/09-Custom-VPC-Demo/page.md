...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/AWS-Fundamentals/Custom-VPC-Demo/page

This guide explains how to create and delete a Virtual Private Cloud in AWS, covering basic setup and advanced networking options.
...
> **lightbulb** Before starting, ensure that you are logged into your AWS Management Console and have selected the appropriate region for your deployment. For this demo, we are using the US East 1 (Northern Virginia) region.
