...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/AWS-Fundamentals/AWS-CloudShell/page

AWS CloudShell is an integrated terminal in the AWS Console for executing commands in a preconfigured AWS CLI environment without local setup.
...
> **lightbulb** AWS CloudShell automatically uses the credentials of the AWS Console user you are logged in as, streamlining your workflow by eliminating manual authentication steps.
...
> **lightbulb** Consider using AWS CloudShell when working on machines that aren’t preconfigured with AWS tools or when you need a fast, reliable environment for AWS CLI operations.
