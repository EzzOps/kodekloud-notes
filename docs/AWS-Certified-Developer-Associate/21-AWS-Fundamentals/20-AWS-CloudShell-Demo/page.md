...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/AWS-Fundamentals/AWS-CloudShell-Demo/page
...
> **lightbulb** Using AWS CloudShell simplifies the process of working with the AWS CLI by eliminating setup overhead and manual configuration. This makes it an excellent tool for quick command-line tasks directly within your AWS environment.
