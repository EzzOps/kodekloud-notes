...
> **lightbulb** Remember that bucket names must be globally unique. The CDK will append extra characters to ensure uniqueness.
...
> **triangle-alert** It is best practice to create a dedicated IAM user with limited permissions for CDK deployments in production. Avoid using full administrative privileges.
