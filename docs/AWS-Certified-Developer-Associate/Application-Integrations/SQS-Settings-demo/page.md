...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Application-Integrations/SQS-Settings-demo/page

This lesson explores Amazon SQS queue configuration options and their impact on queue behavior, including message retention, visibility timeout, delivery delay, and receive message wait time.
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-certified-developer-associate/module/60c267ab-da8b-4408-97f4-b53aad3f4479/lesson/df9610d3-68a3-4c01-9606-1ee264cf1e38" />
</CardGroup>
