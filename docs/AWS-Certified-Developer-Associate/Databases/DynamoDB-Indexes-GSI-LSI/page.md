...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Databases/DynamoDB-Indexes-GSI-LSI/page

This article explains DynamoDBs Global and Local Secondary Indexes to optimize queries and improve data retrieval efficiency.
...
* **Created\_at:** The timestamp indicating when the review was created.
...
2. Filter the results where the user equals [sam@gmail.com](mailto:sam@gmail.com).
...
* Partition key: product\_id equals 9999
...
* Partition key: user (allowing direct queries for user equals [sam@gmail.com](mailto:sam@gmail.com))
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-certified-developer-associate/module/a1267c00-fc48-4a9b-8d41-fd642fa743ea/lesson/9cf8267c-f700-4ca1-af47-d1130d2d8293" />
</CardGroup>
