...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Security/ACM-Demo/page

This article demonstrates how to use AWS Certificate Manager to generate an SSL certificate for secure HTTPS traffic on a load balancer and CloudFront distribution.
...
3. Click **Next** and add the domain names to be covered (for example, "kodeklouddemo123.com"). You may also add additional names such as "[www.kodeklouddemo123.com](http://www.kodeklouddemo123.com)" if required.
...
1. Open your browser and navigate to [https://kodeklouddemo123.com](https://kodeklouddemo123.com).
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-certified-developer-associate/module/294fdab3-80dd-4183-aa7e-e5e3ffc9edd8/lesson/da3e3122-a128-4638-a439-032916a782a6" />
</CardGroup>
