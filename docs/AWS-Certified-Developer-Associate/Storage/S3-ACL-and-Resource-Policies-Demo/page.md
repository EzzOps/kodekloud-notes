...
Source: https://notes.kodekloud.com/docs/AWS-Certified-Developer-Associate/Storage/S3-ACL-and-Resource-Policies-Demo/page

Learn to define S3 resource policies for user access, combine with IAM policies, and test permissions across multiple AWS users.
...
2. Create a new bucket (e.g., `demo-bucket`) using default settings.
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-certified-developer-associate/module/e8ae2293-e16b-42d3-b32b-5c260a1f1e5d/lesson/c437f327-4f2b-4d74-809b-11677b97b9f0" />
</CardGroup>
