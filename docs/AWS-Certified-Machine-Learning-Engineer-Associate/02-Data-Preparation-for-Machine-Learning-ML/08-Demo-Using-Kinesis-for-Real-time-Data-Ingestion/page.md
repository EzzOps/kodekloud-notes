...
> **lightbulb** Imputation replaces missing numeric values using a chosen strategy (mean, median, mode, constant, etc.). The `median` is robust to outliers and is often a safe default when numeric distributions are skewed.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-machine-learning-associates/module/f6c821d2-a5b8-4946-9a75-624ec2ba0e75/lesson/9ddd44b0-7c9c-41a5-a515-cbb48405b70b)

  - [Practice Lab](https://learn.kodekloud.com/user/courses/aws-machine-learning-associates/module/f6c821d2-a5b8-4946-9a75-624ec2ba0e75/lesson/bdbe13ed-d6d2-400b-9562-b6e958004dc0)
