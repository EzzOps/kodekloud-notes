...
> **lightbulb** Choose the loss function that matches your task (regression vs classification) and the scale/sensitivity you want for errors (e.g., `MAE` vs `MSE`). Consider robustness to outliers and the effect on gradient magnitudes when selecting a loss.
...
> **warning** Don't confuse iterations and epochs: an iteration performs one parameter update on a batch, while an epoch processes the entire dataset once (many iterations per epoch).
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-machine-learning-associates/module/f3f28bdc-5ae5-43bb-85b6-01f7b1bfb71b/lesson/d05c8e28-4593-48a9-8e19-62d881d54373)
