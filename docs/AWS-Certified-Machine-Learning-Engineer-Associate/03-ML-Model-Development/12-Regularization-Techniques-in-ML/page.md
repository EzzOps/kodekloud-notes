...
> **lightbulb** When evaluating compressed models, always benchmark real-world inference latency and accuracy on the target device. Simulator or desktop measurements can differ from on-device behavior.

> **warning** Beware: aggressive compression (very low rank, extreme pruning, or INT8 quantization without calibration) can cause unacceptable accuracy degradation. Validate thoroughly and keep rollback plans for production deployments.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-machine-learning-associates/module/f3f28bdc-5ae5-43bb-85b6-01f7b1bfb71b/lesson/d6ab35d9-7f01-4c9a-928c-bcb8a7eb97f7)
