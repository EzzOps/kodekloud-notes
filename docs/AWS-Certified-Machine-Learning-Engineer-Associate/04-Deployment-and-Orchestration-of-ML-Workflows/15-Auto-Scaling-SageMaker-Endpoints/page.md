...
> **lightbulb** Use latency percentiles like `p95` or `p99` for SLA-driven targets. Set conservative thresholds and reasonable cooldown/stabilization windows to reduce scaling oscillation.
...
> **warning** Avoid very short cooldown windows; they can cause rapid scale-in/scale-out oscillations. Tune cooldowns and aggregation periods for the metric you rely on.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-machine-learning-associates/module/c3d1a3a2-07f8-4702-8653-061263bb5db2/lesson/0c3a9951-696d-40f8-88a8-e3dccbf381b1)
