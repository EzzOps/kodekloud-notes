...
> **lightbulb** Tip: Always configure sensible stopping conditions and use S3 checkpointing for long-running or costly jobs. Start with smaller instance types like `m5.large` for development and monitor costs as you scale.

> **warning** Warning: Instance pricing varies by region and changes over time. Review current pricing before launching large or long-running jobs and include budgeting/alerting in your monitoring strategy.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-machine-learning-associates/module/c3d1a3a2-07f8-4702-8653-061263bb5db2/lesson/b582a610-4393-428c-8674-5cfdee941244)
