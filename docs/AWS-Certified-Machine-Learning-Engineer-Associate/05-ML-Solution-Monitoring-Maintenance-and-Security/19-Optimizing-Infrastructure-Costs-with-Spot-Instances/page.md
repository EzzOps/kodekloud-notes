...
> **lightbulb** Always enable checkpointing and point `S3Uri` to a durable S3 location. This allows training jobs to resume from the last saved state after a Spot interruption.
...
> **warning** Avoid using Spot Instances for latency-sensitive, real-time inference or critical workloads that cannot tolerate interruptions. For such cases, prefer On-Demand or Reserved Instances to guarantee availability.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-machine-learning-associates/module/e07ceb86-4976-4c8e-a6f8-3518534ec115/lesson/eff49e68-3624-4fd1-9f77-04a1aa590fda)
