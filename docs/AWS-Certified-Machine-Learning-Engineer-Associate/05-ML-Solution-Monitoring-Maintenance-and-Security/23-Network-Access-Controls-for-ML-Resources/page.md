...
> **lightbulb** This lesson explains how VPCs, security groups, VPC endpoints, IAM roles/policies, and AWS Config combine to create defense-in-depth for ML resources such as SageMaker, S3, and EC2.
...
> **warning** Anti-patterns to avoid: wide-open security groups (0.0.0.0/0 on sensitive ports), sending ML traffic over the public internet instead of using VPC endpoints, and assigning overly broad IAM admin permissions where scoped roles would suffice.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-machine-learning-associates/module/e07ceb86-4976-4c8e-a6f8-3518534ec115/lesson/92024dcb-e77f-41fe-a56b-127664992822)
