...
Source: https://notes.kodekloud.com/docs/AWS-Cloud-Practitioner-CLF-C02/Security-and-Compliance/AWS-Shared-Responsibility-Model-for-Security/page

This article explores the AWS Shared Responsibility Model, defining security roles between AWS and customers for cloud infrastructure and applications.
...
> **lightbulb** For optimal security, always follow industry best practices and AWS security guidelines when managing your resources.
...
> **lightbulb** Adopting the AWS Shared Responsibility Model is essential for any organization moving to the cloud, as it ensures that both infrastructure and applications are safeguarded against threats.
