...
> **triangle-alert** Minimize usage of the root user. Any leaked root credentials would grant complete control of your account. Always use an IAM user for day-to-day tasks.
