...
![The image shows the AWS Management Console webpage, featuring options for AWS training, certification, and services like EC2 and Lambda, with a "Log back in" button.](../../../../images/kodekloud.com/kk-media/image/upload/v1752861794/notes-assets/images/AWS-Cloud-Practitioner-CLF-C02-AWS-Console-Demo/frame_20.jpg)
...
![The image shows the AWS sign-in page with options for root and IAM user login, and a SageMaker Fridays promotional banner.](../../../../images/kodekloud.com/kk-media/image/upload/v1752861795/notes-assets/images/AWS-Cloud-Practitioner-CLF-C02-AWS-Console-Demo/frame_30.jpg)
...
![The image shows the AWS Management Console home screen, displaying recently visited services, AWS Health, cost and usage, and welcome resources.](../../../../images/kodekloud.com/kk-media/image/upload/v1752861797/notes-assets/images/AWS-Cloud-Practitioner-CLF-C02-AWS-Console-Demo/frame_50.jpg)
...
![The image shows an AWS Billing Management Console screen displaying account details, payment currency preference, alternate contacts, and security challenge questions configuration.](../../../../images/kodekloud.com/kk-media/image/upload/v1752861798/notes-assets/images/AWS-Cloud-Practitioner-CLF-C02-AWS-Console-Demo/frame_140.jpg)
...
> **lightbulb** Always verify the selected region before launching resources to ensure they are deployed in the correct location.
...
![The image shows the AWS S3 Management Console with a bucket named "kk-access-point" in the US East (N. Virginia) region, not publicly accessible.](../../../../images/kodekloud.com/kk-media/image/upload/v1752861800/notes-assets/images/AWS-Cloud-Practitioner-CLF-C02-AWS-Console-Demo/frame_320.jpg)
...
![The image shows an AWS EC2 console interface for launching a new instance, with options for selecting an Amazon Machine Image and instance details.](../../../../images/kodekloud.com/kk-media/image/upload/v1752861801/notes-assets/images/AWS-Cloud-Practitioner-CLF-C02-AWS-Console-Demo/frame_380.jpg)
...
> **lightbulb** For an in-depth overview of cloud services and their management, check out our related guides and articles on AWS resource management.
