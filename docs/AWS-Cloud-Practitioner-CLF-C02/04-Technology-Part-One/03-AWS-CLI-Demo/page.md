...
> **lightbulb** For installation instructions, visit the [AWS CLI Installation Guide](https://aws.amazon.com/cli/). Once installed, you can begin using it with just a few terminal commands.
