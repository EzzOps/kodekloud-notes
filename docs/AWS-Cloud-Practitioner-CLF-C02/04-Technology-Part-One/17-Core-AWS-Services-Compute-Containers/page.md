...
Source: https://notes.kodekloud.com/docs/AWS-Cloud-Practitioner-CLF-C02/Technology-Part-One/Core-AWS-Services-Compute-Containers/page

This article explores AWS services for deploying and managing containerized applications, focusing on Elastic Container Service and Elastic Kubernetes Service.
...
> **lightbulb** Containers managed by ECS run on either EC2 instances or using the serverless Fargate option. However, ECS itself does not run containers directly—it manages container orchestration within the AWS ecosystem.
