...
> **lightbulb** The public SSH key is safe to share with servers and is essential for establishing a secure connection.
...
> **triangle-alert** If you attempt connecting before the server status is online, the connection may fail. Please refresh the server details and wait for a status update.
