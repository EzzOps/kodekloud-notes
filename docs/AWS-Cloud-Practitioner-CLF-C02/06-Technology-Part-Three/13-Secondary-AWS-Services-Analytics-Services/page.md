...
Source: https://notes.kodekloud.com/docs/AWS-Cloud-Practitioner-CLF-C02/Technology-Part-Three/Secondary-AWS-Services-Analytics-Services/page

This article explores AWS Analytics Services, detailing their unique capabilities and how they empower data-driven decision-making.
...
![The image outlines objectives, including an overview, tasks it accomplishes, and use cases, with a blue gradient background and icons.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862119/notes-assets/images/AWS-Cloud-Practitioner-CLF-C02-Secondary-AWS-Services-Analytics-Services/frame_20.jpg)
...
![The image features a title "The Universe of AWS Analytics Services" and an icon representing AWS Analytics Services, with a graph on a laptop screen.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862120/notes-assets/images/AWS-Cloud-Practitioner-CLF-C02-Secondary-AWS-Services-Analytics-Services/frame_30.jpg)
...
![The image illustrates Amazon Athena as a "Query Telescope," featuring icons for Amazon S3 and SQL, highlighting data querying capabilities.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862121/notes-assets/images/AWS-Cloud-Practitioner-CLF-C02-Secondary-AWS-Services-Analytics-Services/frame_140.jpg)

> **lightbulb** Consider using Amazon Athena for quick insights into voluminous datasets stored in S3 without the overhead of setting up complex ETL processes.
...
![The image illustrates AWS Data Exchange as a data marketplace, featuring icons of a store, rocket, and a head with a dollar sign.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862122/notes-assets/images/AWS-Cloud-Practitioner-CLF-C02-Secondary-AWS-Services-Analytics-Services/frame_210.jpg)
...
> **lightbulb** Optimize your cost and performance by leveraging Amazon EMR when processing extensive datasets and performing heavy computational analytics.
...
![The image illustrates AWS Glue as a data catalog, featuring various colorful icons and a central AWS Glue logo.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862123/notes-assets/images/AWS-Cloud-Practitioner-CLF-C02-Secondary-AWS-Services-Analytics-Services/frame_270.jpg)
...
![The image illustrates Amazon Kinesis as "The Streaming Telescope," highlighting three stages: Collecting, Processing, and Analyzing, with corresponding icons.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862124/notes-assets/images/AWS-Cloud-Practitioner-CLF-C02-Secondary-AWS-Services-Analytics-Services/frame_350.jpg)

> **lightbulb** Use Amazon Kinesis to build responsive, real-time applications that require immediate data feedback for business intelligence.
...
![The image illustrates Amazon MSK's features: real-time analytics, Apache Kafka, and data ingestion, with corresponding icons.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862125/notes-assets/images/AWS-Cloud-Practitioner-CLF-C02-Secondary-AWS-Services-Analytics-Services/frame_400.jpg)
...
> **lightbulb** Integrate Amazon QuickSight with existing AWS Analytics services to deliver a unified, interactive data visualization experience.
...
![The image features the text "Amazon Redshift – The Data Warehouse Telescope" with an icon of a database and an SQL document, indicating data warehousing and SQL usage.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862126/notes-assets/images/AWS-Cloud-Practitioner-CLF-C02-Secondary-AWS-Services-Analytics-Services/frame_530.jpg)
