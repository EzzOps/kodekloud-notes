...
Source: https://notes.kodekloud.com/docs/AWS-Cloud-Practitioner-CLF-C02/Security-and-Compliance/AWS-Identity-Access-Management/page

This lesson provides an overview of AWS Identity and Access Management for securely managing access to AWS resources.
...
1. **Unique Email Address:** For example, if you register an account with [kodekloud@gmail.com](mailto:kodekloud@gmail.com), that email cannot be used to create another account.
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-cloud-practitioner-clf-c02/module/4528372a-a177-43ff-b4b6-236c0eee4029/lesson/3bff0d08-29fe-480b-a4a7-22c7a541145f" />
</CardGroup>
