...
> **warning** If the bucket has versioning enabled, simply emptying the bucket may not remove prior object versions. You must remove all versions (or suspend versioning and delete versions) before CloudFormation can delete the bucket. Attempting to delete a stack with a versioned, non-empty bucket will fail.
...
> **lightbulb** Tip: You can delete an empty bucket directly from the S3 console, but preferring CloudFormation-driven deletion for stack-managed resources keeps the stack status accurate and reduces manual cleanup steps.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-cloud-formation/module/563043d1-772f-4d1f-a812-f0a96dafa94f/lesson/a30d3939-5f6d-4ece-a7cd-39c418aeb4a5)
