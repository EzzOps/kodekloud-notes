...
> **lightbulb** Top-level Metadata is for humans and documentation. CloudFormation itself does not directly use top-level Metadata to change provisioning behavior, although resource-level Metadata can be consumed by helper tools (for example, cfn-init) to influence instance configuration.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-cloud-formation/module/e8be47ac-5e51-4463-8b8c-dc5552940b10/lesson/1bff1f95-d148-4eb5-a988-f56c37f5efaa)
