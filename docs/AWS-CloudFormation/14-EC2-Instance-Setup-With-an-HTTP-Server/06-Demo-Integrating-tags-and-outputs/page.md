...
> **lightbulb** Use `!Ref` to return the logical resource reference (for EC2 this gives the instance ID). Use `!GetAtt` to fetch resource attributes such as the public IP (`.PublicIp`).
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-cloud-formation/module/e8be47ac-5e51-4463-8b8c-dc5552940b10/lesson/dbadbb7b-d604-420b-a5e4-0105b7db4a27)
