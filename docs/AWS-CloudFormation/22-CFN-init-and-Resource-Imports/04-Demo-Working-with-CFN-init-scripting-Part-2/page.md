...
> **lightbulb** Ensure the `--resource` argument passed to `cfn-init` matches the logical
...
> **warning** Always delete demo stacks (or confirm resources are torn down) to avoid
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-cloud-formation/module/026ceaf9-07b6-4964-b49d-7190c136ea2b/lesson/8564edeb-1cfe-4964-8ddc-6465997dcbcf)
