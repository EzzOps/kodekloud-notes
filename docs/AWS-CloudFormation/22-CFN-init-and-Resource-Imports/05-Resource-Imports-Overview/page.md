...
> **lightbulb** When preparing your template, ensure each resource's logical ID and resource type match what you intend to manage, and include all properties CloudFormation requires to track the resource after import (for example, a bucket’s name or an RDS instance identifier).
...
> **warning** Test imports in a non-production environment before importing production resources. Incorrect templates, missing required properties, or mismatched identifiers can cause import failures that require manual remediation.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-cloud-formation/module/026ceaf9-07b6-4964-b49d-7190c136ea2b/lesson/9f30e4ee-6ece-4c48-9846-bcd6d451e481)
