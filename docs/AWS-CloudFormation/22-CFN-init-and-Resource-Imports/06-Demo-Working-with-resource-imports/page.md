...
> **lightbulb** When importing existing resources, CloudFormation requires you to protect them from accidental deletion. Use `DeletionPolicy: Retain` (and optionally `UpdateReplacePolicy: Retain`) to ensure the resource is retained if the stack is deleted or replaced.

> **warning** Before starting the import, verify:
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-cloud-formation/module/026ceaf9-07b6-4964-b49d-7190c136ea2b/lesson/cb055d17-5efa-43c7-a608-92cf84400d5c)
