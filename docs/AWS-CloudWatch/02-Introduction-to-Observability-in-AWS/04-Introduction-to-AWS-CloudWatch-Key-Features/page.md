...
Source: https://notes.kodekloud.com/docs/AWS-CloudWatch/Introduction-to-Observability-in-AWS/Introduction-to-AWS-CloudWatch-Key-Features/page

Learn to build a centralized observability system in AWS using CloudWatch for alarms, notifications, logging, and maintaining application health.
...
> **lightbulb** CloudWatch integrates seamlessly with [AWS services](https://aws.amazon.com/products/management-and-governance/cloudwatch/) like EC2, RDS, Lambda, and EventBridge to give you holistic insight.
...
> **triangle-alert** Monitor RUM data ingestion and retention settings to control costs—especially for high-traffic applications.
