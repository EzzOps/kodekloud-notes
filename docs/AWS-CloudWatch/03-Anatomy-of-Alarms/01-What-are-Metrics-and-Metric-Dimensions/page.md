...
Source: https://notes.kodekloud.com/docs/AWS-CloudWatch/Anatomy-of-Alarms/What-are-Metrics-and-Metric-Dimensions/page

This article explains AWS CloudWatch metrics and dimensions, focusing on monitoring and troubleshooting Amazon RDS database performance.
...
> **lightbulb** Metrics answer **what** is happening. To pinpoint **where** or **which** resource is affected, use metric dimensions.
...
> **triangle-alert** Using too many high-cardinality dimensions (many unique values) can increase CloudWatch costs. Select dimensions judiciously.
