...
Source: https://notes.kodekloud.com/docs/AWS-CloudWatch/Anatomy-of-Alarms/Metric-Granularity-and-Aggregation/page

This guide explains AWS CloudWatch metric granularity and aggregation for effective monitoring, alerting, and capacity planning.
...
> **lightbulb** For mission-critical workloads, enabling detailed monitoring provides the visibility needed to detect spikes and performance bottlenecks.
...
> **triangle-alert** Aggregation over coarse time intervals can mask short-lived spikes. Always align your aggregation period with your alerting requirements.
