...
> **triangle-alert** Avoid setting low thresholds with short evaluation periods—this can generate noise from transient spikes. Tune `EvaluationPeriods` and `DatapointsToAlarm` for stability.
