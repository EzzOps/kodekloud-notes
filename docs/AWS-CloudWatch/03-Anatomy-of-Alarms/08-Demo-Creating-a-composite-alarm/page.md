...
> **lightbulb** Ensure you define the `LatestAmiId` parameter before deploying the stack. For example:
...
> **lightbulb** Although the ASG can scale up to 20 instances, our threshold is set at >10 for demonstration.
...
> **triangle-alert** Deleting the composite alarm must be done manually—it is not removed by the CloudFormation stack.
