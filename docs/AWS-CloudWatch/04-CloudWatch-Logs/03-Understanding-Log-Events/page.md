...
Source: https://notes.kodekloud.com/docs/AWS-CloudWatch/CloudWatch-Logs/Understanding-Log-Events/page
...
> **lightbulb** Structured logs simplify querying with [CloudWatch Logs Insights](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/AnalyzingLogData.html) and help maintain consistent event schemas.
...
> **lightbulb** Use the AWS SDK or [CloudWatch Logs Agent](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/QuickStartEC2Instance.html) to configure filters before data is sent.
