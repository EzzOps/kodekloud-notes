...
> **lightbulb** EventBridge offers both a default event bus and the ability to create custom buses. You can also subscribe to partner SaaS event sources directly.
...
> **triangle-alert** Be sure to clean up unused rules, buses, and schemas to avoid incurring unexpected charges. See [EventBridge pricing](https://aws.amazon.com/eventbridge/pricing/).
