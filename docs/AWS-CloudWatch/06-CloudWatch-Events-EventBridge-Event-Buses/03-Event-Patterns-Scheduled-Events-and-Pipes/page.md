...
> **triangle-alert** Ensure your event rule IAM role has permission to invoke the target service (`lambda:InvokeFunction`, `sns:Publish`, etc.).
...
Source: https://notes.kodekloud.com/docs/AWS-CloudWatch/CloudWatch-Events-EventBridge-Event-Buses/Event-Patterns-Scheduled-Events-and-Pipes/page

This guide explores core components of event-driven architectures in AWS EventBridge, including Event Patterns, Scheduled Events, and Pipes for efficient event response.
...
> **triangle-alert** Overly broad patterns can flood your pipeline with unwanted events. Too narrow patterns risk missing important alerts.
...
> **lightbulb** Pipes simplify data flow and reduce the need for custom glue code by handling filtering, mapping, and retry logic automatically.
