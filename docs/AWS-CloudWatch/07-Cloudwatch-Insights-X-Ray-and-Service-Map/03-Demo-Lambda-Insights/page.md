...
> **lightbulb** Ensure that an IAM role named `HelloWorldFunctionRole` exists with permissions for Lambda execution and CloudWatch logging. You can define it in this template or create it beforehand.
...
> **triangle-alert** Enabling Lambda Insights produces extra logs and metrics, which may incur additional charges.
