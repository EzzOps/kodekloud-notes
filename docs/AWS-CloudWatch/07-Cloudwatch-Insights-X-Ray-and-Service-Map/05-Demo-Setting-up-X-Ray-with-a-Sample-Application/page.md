...
> **lightbulb** Make sure your IAM user or role has the required permissions for deploying CloudFormation stacks and viewing X-Ray service maps.
...
> **lightbulb** Regularly review your service map to detect anomalies and optimize the performance of microservices.
