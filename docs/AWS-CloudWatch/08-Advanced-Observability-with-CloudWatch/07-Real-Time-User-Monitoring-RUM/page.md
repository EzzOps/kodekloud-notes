...
Source: https://notes.kodekloud.com/docs/AWS-CloudWatch/Advanced-Observability-with-CloudWatch/Real-Time-User-Monitoring-RUM/page
...
> **lightbulb** Before deploying to production, verify user consent and compliance with data-privacy regulations when collecting client-side telemetry.
...
> **triangle-alert** Exporting large volumes of RUM data to S3 can incur storage costs. Review your retention policies to control expenses.
