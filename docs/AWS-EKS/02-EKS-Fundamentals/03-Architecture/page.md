...
Source: https://notes.kodekloud.com/docs/AWS-EKS/EKS-Fundamentals/Architecture/page
...
> **lightbulb** Amazon EKS automatically manages patching, scaling, and failover for these control plane components so you can focus on deploying applications.
...
> **triangle-alert** When deploying your own Kubernetes cluster, you’d need to configure multiple data centers, replicate etcd manually, and set up API servers, controllers, and schedulers across zones. EKS eliminates this operational overhead.
