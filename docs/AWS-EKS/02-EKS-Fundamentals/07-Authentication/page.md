...
Source: https://notes.kodekloud.com/docs/AWS-EKS/EKS-Fundamentals/Authentication/page
...
> **lightbulb** EKS clusters must have an OIDC provider associated before you can grant pods AWS permissions. You can set this up via `eksctl` or the AWS CLI.
...
> **triangle-alert** A malformed `aws-auth` ConfigMap can lock you out of the cluster. Always back up the existing ConfigMap before applying changes.
