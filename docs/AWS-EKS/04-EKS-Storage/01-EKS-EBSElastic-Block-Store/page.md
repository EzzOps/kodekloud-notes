...
Source: https://notes.kodekloud.com/docs/AWS-EKS/EKS-Storage/EKS-EBSElastic-Block-Store/page
...
> **lightbulb** `WaitForFirstConsumer` delays volume provisioning until a Pod is scheduled, ensuring the volume is created in the correct AZ.
