...
Source: https://notes.kodekloud.com/docs/AWS-EKS/EKS-Storage/EKS-Other-Storage/page
...
![The image shows icons for different Amazon storage options: FSX, Amazon FSX for Lustre, and Amazon S3.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862839/notes-assets/images/AWS-EKS-EKS-Other-Storage/amazon-storage-options-fsx-s3-icons.jpg)
...
![The image is about "Other Storage Options" and highlights "High-Performance Throughputs" and the "Lustre File System" with an icon representing FSx.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862840/notes-assets/images/AWS-EKS-EKS-Other-Storage/other-storage-options-high-performance-lustre.jpg)
...
> **lightbulb** FSx for Lustre is POSIX-compliant, so standard UNIX file operations work as expected.
...
![The image shows three icons of S3 buckets labeled "S3 Buckets" under the heading "Other Storage Options," with a "Mount Point for S3" label above them.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862842/notes-assets/images/AWS-EKS-EKS-Other-Storage/s3-buckets-other-storage-options-icons.jpg)
...
![The image states "S3 Does Not Support Renames" and shows two buttons labeled "Update a Name" and "Delete and Object."](../../../../images/kodekloud.com/kk-media/image/upload/v1752862842/notes-assets/images/AWS-EKS-EKS-Other-Storage/s3-does-not-support-renames-buttons.jpg)

* “Directories” are key prefixes; empty folders don’t exist unless objects are present.

> **triangle-alert** Some file operations (e.g., hard links, permissions) may not behave as expected on S3. Review the CSI driver documentation for feature support and caveats.
...
![The image illustrates a Kubernetes cluster with two nodes, each containing a local volume.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862843/notes-assets/images/AWS-EKS-EKS-Other-Storage/kubernetes-cluster-two-nodes-local-volume.jpg)

![The image illustrates a Kubernetes cluster with two nodes, each containing NVMe drives.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862845/notes-assets/images/AWS-EKS-EKS-Other-Storage/kubernetes-cluster-two-nodes-nvme.jpg)
...
![The image illustrates a concept of "Storage and Nodes" with labeled elements for "Snapshot," "Backup," and "EBS Volume," accompanied by gear icons.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862846/notes-assets/images/AWS-EKS-EKS-Other-Storage/storage-and-nodes-snapshot-backup-ebs.jpg)

### Lifecycle Management

![The image shows icons and text for "Local Volumes" and "Container Storage Interface (CSI) Driver."](../../../../images/kodekloud.com/kk-media/image/upload/v1752862847/notes-assets/images/AWS-EKS-EKS-Other-Storage/local-volumes-csi-driver-icons.jpg)
...
![The image shows icons representing different storage solutions: FSX, Amazon FSX for Lustre, Amazon S3, and Local Storage, under the heading "Conclusion."](../../../../images/kodekloud.com/kk-media/image/upload/v1752862849/notes-assets/images/AWS-EKS-EKS-Other-Storage/storage-solutions-icons-conclusion.jpg)
