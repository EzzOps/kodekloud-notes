...
Source: https://notes.kodekloud.com/docs/AWS-EKS/Compute-Scaling/Fargate/page
...
![The image shows a diagram labeled "Fargate Scheduler Backend" with icons representing "Fargate Scheduler" and "Fargate Node."](../../../../images/kodekloud.com/kk-media/image/upload/v1752862760/notes-assets/images/AWS-EKS-Fargate/fargate-scheduler-backend-diagram.jpg)
...
![The image is a diagram illustrating how the Fargate Scheduler works, showing the interaction between components like the API Server, etcd, Scheduler, Webhook, Kubelets, Sidecars, and Fargate Node.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862761/notes-assets/images/AWS-EKS-Fargate/fargate-scheduler-components-interaction-diagram.jpg)

> **lightbulb** Fargate profiles support label- and namespace-based selection. Use them to target only specific workloads for serverless deployment.
...
![The image highlights limitations of Fargate nodes, stating that dynamic EFS volumes and EBS volumes do not work in Fargate.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862762/notes-assets/images/AWS-EKS-Fargate/fargate-limitation-dynamic-efs-ebs.jpg)
...
![The image illustrates the limitations of Fargate nodes, comparing "Daemon Sets" and "Fargate" with icons and labels, and showing a sequence of 100 Pods, 100 Nodes, and 100 Daemon Sets.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862763/notes-assets/images/AWS-EKS-Fargate/fargate-nodes-daemon-sets-comparison.jpg)

> **triangle-alert** DaemonSets will not schedule on Fargate. Convert critical agents (e.g., log collectors) into sidecars, which increases per-Pod overhead.
...
![The image explains two reasons for using Fargate: isolation for security and isolation for compute resources.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862764/notes-assets/images/AWS-EKS-Fargate/fargate-isolation-security-compute-reasons.jpg)
...
![The image illustrates Kubernetes services related to availability, featuring icons for Metric Server and Karpenter.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862765/notes-assets/images/AWS-EKS-Fargate/kubernetes-services-availability-metric-karpenter.jpg)
