...
Source: https://notes.kodekloud.com/docs/AWS-EKS/Compute-Scaling/EKS-Node-Groups/page
...
![The image shows a diagram labeled "Node Groups" with an "EKS Cluster" containing an "EC2 Instance" icon.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862749/notes-assets/images/AWS-EKS-EKS-Node-Groups/node-groups-eks-cluster-ec2-diagram.jpg)
...
![The image illustrates unmanaged node groups with a speech bubble requesting a specific type of EC2 instance, alongside a scale indicating the ability to scale up or down.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862750/notes-assets/images/AWS-EKS-EKS-Node-Groups/unmanaged-node-groups-ec2-instance-scale.jpg)
...
![The image is a diagram titled "Unmanaged Node Groups," showing four components: Autoscaling Group, Node Placement, Kubelet Clustering, and IAM Credentials, all associated with a customer.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862751/notes-assets/images/AWS-EKS-EKS-Node-Groups/unmanaged-node-groups-diagram.jpg)
...
![The image shows a comparison between unmanaged and managed node groups, each represented by three hexagons with gear icons inside.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862752/notes-assets/images/AWS-EKS-EKS-Node-Groups/unmanaged-managed-node-groups-comparison.jpg)
...
![The image illustrates how a node group works, showing nodes organized into groups connected to an API server, with components like Fargate and Cluster Autoscaler.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862754/notes-assets/images/AWS-EKS-EKS-Node-Groups/node-group-api-server-architecture.jpg)

> **lightbulb** Use [taints and tolerations](https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/) to isolate workloads to specific Node Groups and prevent scheduling conflicts.
...
![The image outlines the benefits of Managed Node Groups, highlighting "Custom Amazon Managed Image (AMI)" and "Managed upgrades."](../../../../images/kodekloud.com/kk-media/image/upload/v1752862755/notes-assets/images/AWS-EKS-EKS-Node-Groups/managed-node-groups-benefits-ami-upgrades.jpg)
...
![The image illustrates a diagram of a cloud computing architecture involving Fargate, a cluster autoscaler, and a node group with multiple nodes. It shows the relationship between these components in managing churning workloads.](../../../../images/kodekloud.com/kk-media/image/upload/v1752862757/notes-assets/images/AWS-EKS-EKS-Node-Groups/cloud-computing-architecture-fargate-diagram.jpg)

> **triangle-alert** Pod disruptions are expected during Node Group upgrades. Plan for `kubectl drain` windows and monitor the Cluster Autoscaler to avoid unexpected scale events.
