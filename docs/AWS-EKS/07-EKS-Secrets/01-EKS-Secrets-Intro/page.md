...
Source: https://notes.kodekloud.com/docs/AWS-EKS/EKS-Secrets/EKS-Secrets-Intro/page
...
> **lightbulb** Storing configuration separately lets you update settings dynamically without rebuilding or redeploying your app.
...
> **triangle-alert** Relying solely on base64 encoding leaves your secrets exposed. Always implement encryption-at-rest and secure access controls.
