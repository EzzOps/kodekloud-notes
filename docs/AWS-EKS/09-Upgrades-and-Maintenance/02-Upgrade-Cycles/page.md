...
Source: https://notes.kodekloud.com/docs/AWS-EKS/Upgrades-and-Maintenance/Upgrade-Cycles/page
...
> **lightbulb** Use [Amazon EKS version lifecycle](https://docs.aws.amazon.com/eks/latest/userguide/kubernetes-versions.html) documentation to track end-of-support dates for each minor release.
