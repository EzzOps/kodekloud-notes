...
Source: https://notes.kodekloud.com/docs/AWS-IAM/Introduction-to-AWS-Identity-and-Access-Management/Demo-Creating-AWS-Account/page
...
> **triangle-alert** Your root user has full account access. Avoid using these credentials for everyday tasks. After setup, create an [IAM admin user](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html) and assign least-privilege permissions.
