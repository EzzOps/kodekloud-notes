...
Source: https://notes.kodekloud.com/docs/AWS-IAM/Introduction-to-AWS-Identity-and-Access-Management/IAM-Users/page
...
> **lightbulb** By default, a newly created IAM user has **no permissions**. You must attach policies to grant access.
...
> **triangle-alert** Store your Access Key ID and Secret Access Key securely. Treat them like password credentials.
