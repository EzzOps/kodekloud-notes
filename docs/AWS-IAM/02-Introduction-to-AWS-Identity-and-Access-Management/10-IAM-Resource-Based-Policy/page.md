...
Source: https://notes.kodekloud.com/docs/AWS-IAM/Introduction-to-AWS-Identity-and-Access-Management/IAM-Resource-Based-Policy/page
...
> **triangle-alert** Explicit denies always override any allows. Ensure you review all policies for unintended deny statements.
...
> **lightbulb** Make sure you have the necessary IAM permissions to create and attach policies. Failure to do so will result in authorization errors.
