...
Source: https://notes.kodekloud.com/docs/AWS-IAM/Introduction-to-AWS-Identity-and-Access-Management/Demo-Creating-IAM-Role/page
...
> **lightbulb** You’ve successfully created an IAM role that EC2 instances can assume to access S3 resources securely.
...
> **triangle-alert** If your EC2 instance already has an IAM role attached, updating it will replace the existing role and associated permissions. Ensure this change aligns with your security policies.
