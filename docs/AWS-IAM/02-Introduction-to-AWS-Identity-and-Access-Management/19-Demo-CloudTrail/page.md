...
Source: https://notes.kodekloud.com/docs/AWS-IAM/Introduction-to-AWS-Identity-and-Access-Management/Demo-CloudTrail/page
...
> **lightbulb** The console shows the last 90 days of event history by default. For long-term retention, create a CloudTrail trail to deliver logs to an S3 bucket.
...
> **triangle-alert** Make sure your IAM policy includes the `cloudtrail:LookupEvents` permission to view this data.
