...
> **lightbulb** AWS managed policies simplify administration, but they may not cover every custom scenario. Use customer managed policies for greater control, and reserve inline policies for exceptional cases.
...
> **triangle-alert** Replace `123456789012` with your actual AWS account ID before running these commands.
