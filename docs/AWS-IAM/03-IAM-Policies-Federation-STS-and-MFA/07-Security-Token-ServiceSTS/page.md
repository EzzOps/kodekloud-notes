...
Source: https://notes.kodekloud.com/docs/AWS-IAM/IAM-Policies-Federation-STS-and-MFA/Security-Token-ServiceSTS/page
...
> **lightbulb** SAML federation lets you use existing corporate credentials for AWS access, reducing password sprawl and improving security posture.
...
> **triangle-alert** Temporary credentials automatically expire after the duration specified in the role trust policy (maximum 12 hours). Always handle session renewal and error retries in your application.
