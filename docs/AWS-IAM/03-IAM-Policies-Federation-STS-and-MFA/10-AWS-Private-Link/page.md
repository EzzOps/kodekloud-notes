...
Source: https://notes.kodekloud.com/docs/AWS-IAM/IAM-Policies-Federation-STS-and-MFA/AWS-Private-Link/page
...
> **lightbulb** Gateway endpoints are free of data processing charges, whereas interface endpoints incur hourly and per-GB data processing fees.
...
> **triangle-alert** Gateway endpoints support **only** Amazon S3 and DynamoDB. For other services, use interface endpoints.
