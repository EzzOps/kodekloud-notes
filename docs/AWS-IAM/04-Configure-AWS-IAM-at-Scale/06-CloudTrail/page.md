...
> **lightbulb** Enable CloudTrail Insights to detect unusual API activities, such as spikes in resource provisioning or configurations changes.
...
> **triangle-alert** AWS Config is enabled per region. Be sure to deploy your recorder and delivery channel in each region where you have resources.
...
> **lightbulb** Make sure you have at least one active trail in the region where your EC2 instances run.\
...
> **triangle-alert** If your trail isn’t configured to deliver logs to CloudWatch Logs, you won’t get real-time alerts.\
