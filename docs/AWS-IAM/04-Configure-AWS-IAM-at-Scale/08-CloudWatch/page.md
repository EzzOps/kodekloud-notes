...
Source: https://notes.kodekloud.com/docs/AWS-IAM/Configure-AWS-IAM-at-Scale/CloudWatch/page
...
> **lightbulb** Be aware that custom metrics and detailed monitoring (1-minute resolution) may incur additional charges.
...
> **triangle-alert** Ensure your SNS subscription is confirmed; otherwise, you won’t receive alarm notifications.
