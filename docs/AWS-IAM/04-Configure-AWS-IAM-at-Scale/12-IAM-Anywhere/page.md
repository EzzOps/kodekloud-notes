...
Source: https://notes.kodekloud.com/docs/AWS-IAM/Configure-AWS-IAM-at-Scale/IAM-Anywhere/page
...
> **lightbulb** * An [ACM Private CA](https://docs.aws.amazon.com/acm-pca/latest/userguide/PcaCreateCa.html) or an existing on-premises CA
...
> **triangle-alert** Always store private keys in a secure hardware module or key management system. Do not embed certificates or keys directly in application code.
