...
Source: https://notes.kodekloud.com/docs/AWS-IAM/Configure-AWS-IAM-at-Scale/Demo-IAM-Identity-Center/page
...
> **lightbulb** IAM Identity Center can only be enabled from your organization’s management account. Member accounts cannot enable or configure it.
...
> **triangle-alert** Reserve IAM users for programmatic or service-specific credentials. For scalable, centralized console access across multiple accounts, adopt IAM Identity Center.
