...
> **lightbulb** Memory allocation scales CPU and network throughput. Allocating more memory can improve performance for CPU-intensive workloads.

> **triangle-alert** Ephemeral storage is **not** persistent. Data in `/tmp` is lost after the function completes.

> **lightbulb** To raise your concurrency limit permanently, open a [quota increase request](https://console.aws.amazon.com/servicequotas/home) in the AWS Service Quotas console. Approval depends on your use case.
