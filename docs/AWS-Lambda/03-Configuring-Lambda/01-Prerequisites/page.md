...
Source: https://notes.kodekloud.com/docs/AWS-Lambda/Configuring-Lambda/Prerequisites/page

This article outlines prerequisites and methods for configuring AWS Lambda functions, including using the Management Console, CLI, SDKs, CloudFormation, and SAM.
...
1. Open your browser and navigate to the AWS Console: [https://aws.amazon.com/console](https://aws.amazon.com/console)
2. Sign in with your AWS account or create a free tier account if needed.

> **lightbulb** Many AWS services—including Lambda—offer a monthly free tier. Track your usage and delete any test resources to avoid unexpected charges.
...
1. Download and install the AWS CLI: [https://aws.amazon.com/cli/](https://aws.amazon.com/cli/)
...
> **triangle-alert** Avoid using the root account for routine tasks. Instead, create an IAM user with only the permissions required for Lambda operations.
