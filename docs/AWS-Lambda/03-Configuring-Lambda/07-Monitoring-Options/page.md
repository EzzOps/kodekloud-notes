...
> **lightbulb** To collect additional metrics, enable enhanced monitoring in your function’s configuration or use [AWS CLI](https://aws.amazon.com/cli/) / [AWS SDKs](https://aws.amazon.com/developer/tools/) to customize metric filters.
...
> **lightbulb** Ensure your Lambda execution role has permissions for both VPC configuration and flow log creation (`ec2:CreateFlowLogs`, `logs:CreateLogGroup`, `logs:PutLogEvents`).
