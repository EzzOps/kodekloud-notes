...
Source: https://notes.kodekloud.com/docs/AWS-Lambda/Advanced-Topics/Lambda-Networking-Demonstration-Option-2/page

This walkthrough explains how to connect a private VPC to AWS Lambda using an Interface Endpoint for secure resource access.
...
> **lightbulb** Select at least two subnets in different Availability Zones to ensure that ENIs remain reachable even if one AZ experiences issues.
...
> **triangle-alert** Avoid using wildcard (`*`) permissions in production. Restrict the `Resource` field to specific Lambda functions or ARNs.
