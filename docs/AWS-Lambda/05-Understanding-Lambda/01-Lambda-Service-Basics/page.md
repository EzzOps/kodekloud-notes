...
Source: https://notes.kodekloud.com/docs/AWS-Lambda/Understanding-Lambda/Lambda-Service-Basics/page

This article provides an overview of AWS Lambda, its benefits, supported languages, and guides users on getting started with serverless computing.
...
![The image shows a cartoon caveman and a modern man facing each other with an orange square featuring a lambda symbol between them.](../../../../images/kodekloud.com/kk-media/image/upload/v1752863178/notes-assets/images/AWS-Lambda-Lambda-Service-Basics/caveman-modern-man-lambda-symbol.jpg)
...
![The image illustrates a process flow from a code file to a computer, with an AWS Lambda icon in the center, under the title "Bring your own Code."](../../../../images/kodekloud.com/kk-media/image/upload/v1752863179/notes-assets/images/AWS-Lambda-Lambda-Service-Basics/bring-your-own-code-process-flow-aws-lambda.jpg)
...
> **lightbulb** Use the Runtime API to package and invoke functions in unsupported languages. AWS provides [runtime examples](https://github.com/aws/aws-lambda-runtime-interface-emulator) to help you get started.

![The image shows a flowchart with COBOL leading to an API icon, which then leads to an AWS Lambda icon, under the title "Supported Languages."](../../../../images/kodekloud.com/kk-media/image/upload/v1752863181/notes-assets/images/AWS-Lambda-Lambda-Service-Basics/cobol-api-aws-lambda-flowchart.jpg)
