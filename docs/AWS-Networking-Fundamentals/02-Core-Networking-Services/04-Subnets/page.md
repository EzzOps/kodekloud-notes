...
Source: https://notes.kodekloud.com/docs/AWS-Networking-Fundamentals/Core-Networking-Services/Subnets/page
...
> **lightbulb** Configure route tables to associate subnets with the IGW or NAT Gateway as needed.
...
> **triangle-alert** Defining overlapping CIDR blocks in the same VPC causes route conflicts and deployment failures.
