...
> **lightbulb** Each subnet’s CIDR block must reside within the VPC’s `10.0.0.0/16` range. Entering an out-of-range block (e.g., `192.168.1.0/24`) will produce an error.
...
> **triangle-alert** If you receive an error about existing resources (e.g., network interfaces), ensure the instance is fully terminated and retry deletion.
