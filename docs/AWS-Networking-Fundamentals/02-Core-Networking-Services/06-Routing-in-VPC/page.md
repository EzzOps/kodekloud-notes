...
Source: https://notes.kodekloud.com/docs/AWS-Networking-Fundamentals/Core-Networking-Services/Routing-in-VPC/page
...
> **lightbulb** The router always applies the longest-prefix match if multiple routes overlap.
...
> **triangle-alert** A subnet can only be associated with **one** route table at a time, although a route table may serve **multiple** subnets.
