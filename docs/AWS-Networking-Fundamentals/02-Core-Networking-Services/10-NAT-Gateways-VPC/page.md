...
Source: https://notes.kodekloud.com/docs/AWS-Networking-Fundamentals/Core-Networking-Services/NAT-Gateways-VPC/page
...
> **triangle-alert** Avoid routing private instance traffic directly through an Internet Gateway, as this exposes them to inbound connections.
...
> **lightbulb** Each NAT Gateway requires an Elastic IP. Ensure you have available Elastic IPs or allocate new ones before deployment.
...
> **triangle-alert** NAT Gateways incur hourly charges per gateway and data processing fees. Monitor usage in AWS Cost Explorer to avoid unexpected costs.
