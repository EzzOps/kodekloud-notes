...
Source: https://notes.kodekloud.com/docs/AWS-Networking-Fundamentals/Core-Networking-Services/Elastic-IP-Demo/page
...
> **lightbulb** Elastic IPs are free when associated with a running instance. AWS charges apply if you reserve an Elastic IP without attaching it.
...
> **triangle-alert** Releasing an Elastic IP makes it available to other AWS customers. You cannot reclaim the same address once released.
