...
Source: https://notes.kodekloud.com/docs/AWS-Networking-Fundamentals/Edge-Networks/CloudFront/page
...
> **triangle-alert** Serving stale content is possible if TTL is too long. Tune your Cache-Control headers carefully to balance freshness and performance.
