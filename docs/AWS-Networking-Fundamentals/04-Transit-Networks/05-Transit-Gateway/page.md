...
Source: https://notes.kodekloud.com/docs/AWS-Networking-Fundamentals/Transit-Networks/Transit-Gateway/page
...
> **lightbulb** Each Transit Gateway attachment requires at least one subnet per AZ. Plan your AZ strategy accordingly to avoid single points of failure.
...
> **triangle-alert** Ensure your AWS account limits and route table entries align with the number of Transit Gateway attachments to avoid resource exhaustion.
