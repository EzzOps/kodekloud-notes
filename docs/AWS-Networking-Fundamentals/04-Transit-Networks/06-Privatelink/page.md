...
Source: https://notes.kodekloud.com/docs/AWS-Networking-Fundamentals/Transit-Networks/Privatelink/page
...
> **triangle-alert** Using NAT gateways or Internet Gateways for service access can increase your AWS costs and expand your security attack surface.
...
> **lightbulb** AWS PrivateLink endpoints incur per-hour and per-GB data processing charges. Review the [VPC pricing page](https://aws.amazon.com/vpc/pricing/) for details.
