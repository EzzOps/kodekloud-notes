...
> **lightbulb** To follow the labs you will need an [AWS account](https://aws.amazon.com/) with sufficient permissions to create and manage RDS instances (or use a provided sandbox). Basic familiarity with AWS Console navigation and core database concepts will help you move faster.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-rds/module/87f5dd22-d5af-450f-ad8d-f41d9c5f205e/lesson/fefba510-b3b1-4606-b7d9-f53d31d67a3f)
