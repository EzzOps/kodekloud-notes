...
> **lightbulb** Always clean up resources you create during practice (stop/delete instances, snapshots, clusters, etc.). Unused resources can still incur charges.
...
> **lightbulb** Tip: Use tags and service filters when creating budgets to monitor specific projects or resources (for example, only RDS or only a particular project tag).
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-rds/module/bfb32eae-f423-4a2e-9ca1-60adc0ac3ff0/lesson/dfeb170f-7f77-434d-8155-e5a291198e9d)
