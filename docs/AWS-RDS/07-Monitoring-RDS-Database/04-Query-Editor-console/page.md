...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-rds/module/91b2b41b-ba10-4ab3-b483-1ee050a4556c/lesson/02f8439b-6f68-499c-9d44-000ca43a5748)
...
> **lightbulb** Enable the Data API if you plan to use the RDS console Query Editor with Aurora Serverless. Without the Data API enabled, the Query Editor will be unable to connect to the cluster.
...
> **lightbulb** Note: The Query Editor requires valid database credentials (or an appropriate authentication method) and the necessary IAM permissions to use the editor in the console. For Aurora Serverless clusters, the Data API must be enabled so the editor can connect.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-rds/module/91b2b41b-ba10-4ab3-b483-1ee050a4556c/lesson/3a13af8e-07ca-4130-b9aa-13ec6c4648c8)

  - [Practice Lab](https://learn.kodekloud.com/user/courses/aws-rds/module/91b2b41b-ba10-4ab3-b483-1ee050a4556c/lesson/e37fd3b7-759d-490a-95eb-6ca212f2e628)
