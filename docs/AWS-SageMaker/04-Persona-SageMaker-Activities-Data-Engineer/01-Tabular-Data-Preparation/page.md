...
> **warning** When using ScriptProcessor with a custom ECR image, ensure the execution role has permission to pull from ECR and that the image is compatible with SageMaker's processing lifecycle. Also review instance costs for large or GPU-powered instances.
...
> **lightbulb** You can stream processing job logs via [CloudWatch Logs](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/WhatIsCloudWatchLogs.html). Open the Processing job details in the console to find the CloudWatch log group and observe real-time output for troubleshooting.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-sagemaker/module/dc8df298-eaee-4f8a-b1d0-0ec66f9c6d20/lesson/c629a8d9-604f-4eea-b024-281ae8531a63)

  - [Practice Lab](https://learn.kodekloud.com/user/courses/aws-sagemaker/module/dc8df298-eaee-4f8a-b1d0-0ec66f9c6d20/lesson/c76f4f3c-7c00-4f80-8679-73c7c44e3fc9)
