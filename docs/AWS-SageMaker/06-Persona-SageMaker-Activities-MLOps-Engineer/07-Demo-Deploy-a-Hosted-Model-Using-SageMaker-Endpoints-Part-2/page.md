...
> **lightbulb** Data capture delivery to S3 is not real-time. Expect a short delay (often a few minutes) before captured data appears in the S3 destination.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/aws-sagemaker/module/772ec99e-54ee-4f4f-8b2a-08b5bc4d4a32/lesson/7784f252-7990-4988-ade1-46089473be7f)
...
> **lightbulb** When invoking a real-time endpoint from code, always use the SageMaker Runtime client (`'sagemaker-runtime'`). Calling `invoke_endpoint` on the SageMaker service client will not work for real-time inference requests.
