...
<Callout icon="lightbulb">
  Replace placeholders like model\_name and S3 paths with your own values. Ensure the model container supports the specified content\_type / accept values and can process batched input if you enable mini-batching. See the SageMaker Batch Transform docs for available parameters.\
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-sagemaker/module/772ec99e-54ee-4f4f-8b2a-08b5bc4d4a32/lesson/f4644015-b6ff-48f0-9172-a90dc41b230f" />
</CardGroup>
