...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Introduction/Where-are-you-now-Take-an-Assessment-to-know-what-you-dont-know/page

This article explains the purpose and value of an assessment to identify knowledge gaps in AWS proficiency for learners.
...
1. **New to AWS**\
   If you are new to AWS—for example, you have recently completed the [AWS Cloud Practitioner (CLF-C02)](https://learn.kodekloud.com/user/courses/aws-cloud-practitioner-clf-c02) certification but do not yet have extensive hands-on experience—the assessment is optional. It serves as a checkpoint to gauge your current understanding while you continue building your foundational AWS knowledge.
