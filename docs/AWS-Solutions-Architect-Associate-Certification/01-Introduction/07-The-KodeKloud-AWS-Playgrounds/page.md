...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Introduction/The-KodeKloud-AWS-Playgrounds/page

This article explores the KodeKloud AWS Playground features for refining cloud skills and preparing for the AWS Solutions Architect exam.
...
![The image shows a webpage from KodeKloud about the AWS Sandbox Playground, explaining Amazon Web Services and offering a launch button. There's also a small video call window with a person in the bottom right corner.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864631/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-The-KodeKloud-AWS-Playgrounds/aws-sandbox-playground-webpage.jpg)
...
> **lightbulb** AWS services related to code management (e.g., CodeStar, CodePipeline, and CodeDeploy) are generally aligned with operations exams rather than the AWS Solutions Architecture exam.

This organized service list eliminates permission errors, letting you experiment freely with every feature.

![The image shows a webpage listing various AWS services and features, with a "Launch now" button and a small video overlay of a person gesturing.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864632/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-The-KodeKloud-AWS-Playgrounds/aws-services-features-webpage.jpg)
...
![The image shows a KodeKloud AWS playground screen with a console link, username, and password for accessing AWS, along with a timer indicating expiration. A person is visible in a small video overlay at the bottom right corner.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864633/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-The-KodeKloud-AWS-Playgrounds/kodekloud-aws-playground-console.jpg)
...
![The image shows an AWS IAM user sign-in page with fields for account ID, IAM username, and password, alongside an advertisement for AWS data services. There's also a small circular video feed of a person in the bottom right corner.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864634/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-The-KodeKloud-AWS-Playgrounds/aws-iam-user-signin-page.jpg)
...
![The image shows an AWS EC2 dashboard with a dropdown menu displaying various AWS regions. A person is visible in a small overlay at the bottom right corner.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864636/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-The-KodeKloud-AWS-Playgrounds/aws-ec2-dashboard-regions-dropdown.jpg)
...
![The image shows an AWS console screen for launching an EC2 instance, with options for selecting an Amazon Machine Image (AMI) and instance type. A person is visible in a small video overlay at the bottom right corner.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864637/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-The-KodeKloud-AWS-Playgrounds/aws-ec2-launch-console-ami-instance.jpg)
...
![The image shows an AWS console screen for creating a key pair, with options for key pair name, type, and file format. There's also a small video overlay of a person speaking in the bottom right corner.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864638/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-The-KodeKloud-AWS-Playgrounds/aws-console-key-pair-creation.jpg)
...
> **lightbulb** If any service is missing or if you need additional practice, revisit the playground and experiment until you feel confident with the platform’s capabilities.
