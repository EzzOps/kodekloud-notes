...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Introduction/Why-AWS-Solutions-Architecture-Certification-and-what-is-a-solutions-architect/page

This article explores the benefits of the AWS Solutions Architect Associate certification and clarifies the role of a Solutions Architect.
...
We will cover:
• The rationale for the SAA certification\
...
• Attaching a secondary Elastic Network Interface (ENI) with the private IP address to the primary instance and transferring the ENI to the standby instance upon failure.
• Associating an Elastic IP address with the primary instance’s network interface and re-associating it with the standby when necessary.
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-solutions-architect-associate-certification/module/1a87a522-2fb5-41e9-a36f-0157341c75d9/lesson/ad678e69-fbe7-4fab-8bee-b2f5df4f0ef2" />
</CardGroup>
