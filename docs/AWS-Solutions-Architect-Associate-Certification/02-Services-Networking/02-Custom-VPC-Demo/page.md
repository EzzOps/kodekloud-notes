...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Networking/Custom-VPC-Demo/page

Learn to create and delete a Virtual Private Cloud (VPC) in AWS through a step-by-step demonstration.
...
> **lightbulb** Remember that VPCs are region-specific. Ensure you select the appropriate AWS region before proceeding.
...
![The image shows an AWS Management Console with a dropdown menu displaying various AWS regions, including US East, US West, Asia Pacific, Canada, and Europe. The console also features sections for AWS Billing Conductor, getting started guides, and cost usage information.](../../../../images/kodekloud.com/kk-media/image/upload/v1752865501/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Custom-VPC-Demo/aws-management-console-regions-dropdown.jpg)
...
![The image shows the AWS Management Console, specifically the VPC (Virtual Private Cloud) dashboard, displaying various resources and settings related to network management.](../../../../images/kodekloud.com/kk-media/image/upload/v1752865502/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Custom-VPC-Demo/aws-vpc-dashboard-network-management.jpg)
...
![The image shows a screenshot of an AWS VPC (Virtual Private Cloud) dashboard, displaying details such as VPC ID, state, DNS settings, and resource map information.](../../../../images/kodekloud.com/kk-media/image/upload/v1752865505/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Custom-VPC-Demo/aws-vpc-dashboard-screenshot.jpg)
...
![The image shows an AWS VPC management console with details of a newly created VPC named "demo-vpc," including its VPC ID, state, and CIDR information.](../../../../images/kodekloud.com/kk-media/image/upload/v1752865506/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Custom-VPC-Demo/aws-vpc-management-console-demo-vpc.jpg)

> **lightbulb** Deleting a VPC is permanent. Ensure that you have backed up any necessary configurations or data before proceeding.
