...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Networking/Subnets-Demo/page

This lesson teaches how to create subnets in a VPC and deploy an EC2 instance within a specific subnet.
...
* *(Optional)* Enable the Amazon provided IPv6 CIDR block.
...
5. **CIDR Block:** It is crucial that the subnet's CIDR block falls within the VPC's CIDR block. Therefore, set the CIDR block for "subnet one" to 10.0.1.0/24.
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-solutions-architect-associate-certification/module/e03ffb87-3345-4fbb-9576-cb53d21d7a6a/lesson/57c43489-d10a-44eb-98e9-344bb9abde1b" />
</CardGroup>
