...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Networking/Direct-Connect/page

This article explores Direct Connect, a service providing a dedicated connection to AWS for high-speed, reliable network access.
...
> **lightbulb** If you need to connect to private VPC resources, configure a VPN Gateway and establish a connection between the cross connect and the VPN Gateway. For public services, traffic is routed directly through the AWS router, leveraging the AWS backbone network for improved performance.
