...
> **lightbulb** The error occurs because the S3 bucket policy restricts public access by default.
...
> **lightbulb** The cached content persists until the TTL expires. If immediate updates are required, you must invalidate the cache.
