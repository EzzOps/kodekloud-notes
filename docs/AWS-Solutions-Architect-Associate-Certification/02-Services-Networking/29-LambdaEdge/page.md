...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Networking/LambdaEdge/page

This article explores AWS CloudFront functions and Lambda@Edge, enabling code execution at edge locations to optimize request processing and response modification.
...
![The image illustrates the flow of data through Amazon CloudFront, showing connections between various AWS services and edge locations, ultimately reaching the end user.](../../../../images/kodekloud.com/kk-media/image/upload/v1752865573/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-LambdaEdge/amazon-cloudfront-data-flow-diagram.jpg)
...
![The image is a comparison chart showing when functions run in CloudFront and Lambda@Edge, detailing specific request and response events.](../../../../images/kodekloud.com/kk-media/image/upload/v1752865574/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-LambdaEdge/cloudfront-lambdaedge-comparison-chart.jpg)
...
![The image lists four CloudFront Functions use cases: cache key normalization, header manipulation, URL redirects or rewrites, and request authorization. Each use case is represented with an icon and a brief description.](../../../../images/kodekloud.com/kk-media/image/upload/v1752865576/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-LambdaEdge/cloudfront-functions-use-cases.jpg)

> **lightbulb** For extremely short execution times (sub-millisecond), choose CloudFront functions to take full advantage of their speed and efficiency.
...
![The image is a comparison table between CloudFront Functions and Lambda@Edge, detailing aspects like programming languages, event sources, scale, function duration, and more. It highlights differences in capabilities such as network access, file system access, and pricing.](../../../../images/kodekloud.com/kk-media/image/upload/v1752865577/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-LambdaEdge/cloudfront-functions-vs-lambda-edge.jpg)

> **lightbulb** For logic that requires network access, integration with external systems, or longer running times, Lambda\@Edge is the recommended service.
...
![The image is a summary slide highlighting key points about running code at edge locations, manipulating requests/responses through CloudFront, and the use of CloudFront functions and Lambda@Edge.](../../../../images/kodekloud.com/kk-media/image/upload/v1752865579/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-LambdaEdge/edge-code-cloudfront-summary-slide.jpg)
