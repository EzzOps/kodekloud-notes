...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Application-Integration/Autoscaling/page

This lesson explores auto-scaling, which dynamically adjusts compute resources to meet demand, ensuring applications have the right resources without manual intervention.
...
> **lightbulb** This guide has covered scaling policies, dynamic and scheduled scaling, launch templates, and AWS service integrations, empowering you to design robust auto-scaling groups that automatically adjust compute resources based on demand.
