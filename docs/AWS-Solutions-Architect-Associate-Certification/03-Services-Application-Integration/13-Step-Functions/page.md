...
> **lightbulb** For more information, check out the [AWS Step Functions documentation](https://docs.aws.amazon.com/step-functions/latest/dg/welcome.html) and our [serverless application guides](https://aws.amazon.com/serverless/).
