...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Storage/EFS/page

This lesson covers Amazon Elastic File System (EFS) focusing on its features, setup, and performance modes for file system storage in AWS.
...
> **lightbulb** One of the major advantages of EFS is its ability to be mounted on multiple EC2 instances simultaneously. This feature allows efficient data sharing across instances.
...
> **lightbulb** Ensure that you have appropriate permissions for installing packages on your EC2 instance.
