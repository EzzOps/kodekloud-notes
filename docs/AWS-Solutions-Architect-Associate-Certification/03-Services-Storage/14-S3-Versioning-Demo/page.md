...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Storage/S3-Versioning-Demo/page

This tutorial explores Amazon S3 versioning, demonstrating bucket creation, file uploads, version management, and deletion processes.
...
![The image shows the AWS S3 interface for creating a new bucket, with fields for bucket name, AWS region, and object ownership settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866099/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-S3-Versioning-Demo/aws-s3-create-bucket-interface.jpg)

![The image shows an AWS S3 console screen with options for blocking public access and bucket versioning settings. It includes a notification about upcoming permission changes for enabling block public access settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866101/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-S3-Versioning-Demo/aws-s3-console-block-public-access.jpg)
...
![The image shows an Amazon S3 upload interface where a file named "file1.txt" is being prepared for upload to a bucket named "kk-versioning-demo." The file is 17 bytes in size and the "Upload" button is visible.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866102/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-S3-Versioning-Demo/amazon-s3-upload-file1-kk-demo.jpg)
...
![The image shows an Amazon S3 interface for deleting objects, specifically a file named "file1.txt" with details like type, last modified date, and size. There's a prompt to confirm permanent deletion by typing "permanently delete."](../../../../images/kodekloud.com/kk-media/image/upload/v1752866104/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-S3-Versioning-Demo/amazon-s3-delete-file-interface.jpg)

> **triangle-alert** When versioning is disabled, deleting a file permanently removes it from your bucket with no recovery option.
...
![The image shows an Amazon S3 bucket interface with two versions of a file named "file1.txt" listed, displaying details like version ID, last modified date, size, and storage class.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866109/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-S3-Versioning-Demo/amazon-s3-bucket-file-versions.jpg)
...
![The image shows an Amazon S3 upload interface with a file named "file1.txt" ready to be uploaded to a bucket named "kk-versioning-demo." The file is 17.0 bytes in size and is of type "text/plain."](../../../../images/kodekloud.com/kk-media/image/upload/v1752866110/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-S3-Versioning-Demo/amazon-s3-upload-file1-kk-versioning-demo.jpg)
...
![The image shows an Amazon S3 interface for deleting objects, specifically a file named "file1.txt" with a prompt to confirm deletion by typing "delete."](../../../../images/kodekloud.com/kk-media/image/upload/v1752866111/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-S3-Versioning-Demo/amazon-s3-delete-file-interface-2.jpg)
...
![The image shows an Amazon S3 bucket interface with a list of objects, including multiple versions of "file1.txt" with details like version ID, last modified date, size, and storage class.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866112/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-S3-Versioning-Demo/amazon-s3-bucket-objects-list.jpg)

To restore the file, simply delete the delete marker:

![The image shows an Amazon S3 interface for deleting objects, specifically a file named "file1.txt" with a prompt to confirm permanent deletion.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866114/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-S3-Versioning-Demo/amazon-s3-delete-file1txt.jpg)
...
![The image shows the "Edit Bucket Versioning" page in Amazon S3, where options to suspend or enable bucket versioning are displayed, along with a warning about the impact of changes.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866115/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-S3-Versioning-Demo/edit-bucket-versioning-amazon-s3.jpg)
...
![The image shows an Amazon S3 console with a bucket named "kk-versioning-demo" displaying versioned text files, alongside a Windows File Explorer window showing local text files.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866117/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-S3-Versioning-Demo/amazon-s3-versioning-demo-files.jpg)
...
> **lightbulb** MFA delete adds an additional layer of security by ensuring that changes to your versioning configuration require multi-factor authentication.
...
![The image shows an Amazon S3 interface for deleting objects, listing several text files with details like version ID, type, last modified date, and size. There's a prompt to confirm permanent deletion by typing "permanently delete."](../../../../images/kodekloud.com/kk-media/image/upload/v1752866118/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-S3-Versioning-Demo/amazon-s3-delete-objects-interface.jpg)
