...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Compute/Serverless-Application-Model/page

This article explores the Serverless Application Model and its role in simplifying the deployment and management of serverless applications on AWS.
...
> **lightbulb** The SAM CLI workflow begins with a configuration file similar to an AWS CloudFormation template. Once your template is defined, it is packaged along with your application code and uploaded to an S3 bucket. AWS CloudFormation then utilizes this template to swiftly deploy the defined resources.
