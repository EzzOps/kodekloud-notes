...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Compute/ECSEKS-Anywhere/page

This article explores ECS and EKS Anywhere, solutions for deploying and managing containerized applications across AWS and on-premises data centers.
...
> **lightbulb** ECS Anywhere uses the ECS agent to register external instances, providing a centralized dashboard for oversight of containerized applications regardless of their deployment location.
