...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Data-and-ML/Athena/page

This article provides an overview of AWS Athena, a tool for querying datasets stored in Amazon S3 without managing database infrastructure.
...
> **lightbulb** Athena allows you to execute complex, ad hoc queries without managing any underlying infrastructure, making it both simple and cost-effective.
...
> **lightbulb** For more details on how to optimize your queries and integrate Athena with other AWS services, visit the [AWS Athena Documentation](https://docs.aws.amazon.com/athena/latest/ug/what-is.html).
