...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Data-and-ML/Lex/page

This article introduces AWS Lex, a chatbot service that uses machine learning to create intuitive conversational applications.
...
> **lightbulb** * Fully managed service that scales automatically with demand.
...
> **lightbulb** Consider a scenario where a hospitality business uses Lex to automate hotel bookings. Integrated with Lambda and DocumentDB, the chatbot can quickly verify room availability, process reservations, and provide recommendations—all while delivering a seamless conversational experience.
