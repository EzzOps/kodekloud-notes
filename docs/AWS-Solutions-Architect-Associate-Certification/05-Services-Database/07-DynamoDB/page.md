...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Database/DynamoDB/page

This article provides an in-depth overview of DynamoDB's architecture, core components, and practical applications for building scalable and responsive systems.
...
<Frame>
  <img alt="The image explains the benefits of using Amazon DynamoDB, highlighting features like managing and scaling, serverless architecture, handling high traffic, automatic sharding, and operations." />
</Frame>
...
<Frame>
  <img alt="The image illustrates the components of Amazon DynamoDB, highlighting tables, items, and attributes with corresponding icons." />
</Frame>
...
<Frame>
  <img alt="The image illustrates the concept of secondary indexes in Amazon DynamoDB, showing the flow from a table to an index, with details on global and local secondary indexes." />
</Frame>
...
<Frame>
  <img alt="The image illustrates two table classes for Amazon DynamoDB: &#x22;Standard Access Table Class&#x22; and &#x22;Standard Infrequent Access Table Class,&#x22; each represented by icons of a database with arrows and a lightning bolt." />
</Frame>
...
> **lightbulb** One of DynamoDB's most impressive features is its serverless nature. With no servers to provision, patch, or manage, DynamoDB offers on-demand pricing with auto-scaling and maintains high availability even during unexpected traffic surges.
...
<Frame>
  <img alt="The image lists features of DynamoDB, including key-value document data models, serverless architecture, global tables, secondary indexes, global secondary indexes, on-demand backup and restore, and read/write capacity modes." />
</Frame>

<Frame>
  <img alt="The image illustrates Amazon DynamoDB integrations, highlighting key features like NoSQL workbench and encryption, and shows connections to services such as Amazon S3, AWS Glue, and Amazon Kinesis Data Streams." />
</Frame>
...
> **lightbulb** DynamoDB's ability to handle unpredictable workloads and scale seamlessly makes it an excellent choice for applications with rapidly changing data access patterns and extensive read/write demands.
...
<Frame>
  <img alt="The image is a summary of DynamoDB, highlighting its features as a fully managed NoSQL database by AWS, its components like tables, items, and attributes, and details about primary keys." />
</Frame>
