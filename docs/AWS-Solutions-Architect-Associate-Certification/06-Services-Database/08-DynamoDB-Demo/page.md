...
> **lightbulb** Always ensure you have a backup or have exported your data if you need to retain it before deleting any items.
...
> **triangle-alert** Deleting the table will permanently remove all stored data. Ensure you have backed up any necessary information before proceeding with the deletion.
