...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Storage/Instance-Store-Demo/page

This article demonstrates how to work with instance store volumes on AWS EC2, highlighting their temporary nature and usage for non-persistent data.
...
> **lightbulb** Keep in mind that the instance store is optimized for fast, temporary storage. It is ideal for cache, buffers, or temporary files, but not for data that requires persistence.
...
> **triangle-alert** Do not use instance stores for storing critical data. Always rely on persistent storage solutions like Amazon EBS for data that must be retained.
