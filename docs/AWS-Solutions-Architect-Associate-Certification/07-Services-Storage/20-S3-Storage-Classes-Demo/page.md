...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Storage/S3-Storage-Classes-Demo/page

This guide demonstrates how to set and modify the storage class for files in Amazon S3 for cost-effective data storage.
...
4. Change the storage class from *Standard* to **One Zone Infrequent Access**, then upload the file.
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-solutions-architect-associate-certification/module/23e00d1f-6422-4fef-a9bf-e8f007be5514/lesson/55b5dc35-0154-4eed-89d1-751b50e7a101" />
</CardGroup>
