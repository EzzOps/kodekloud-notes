...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Designing-for-Security/Design-Principles-of-the-Security/page

This article covers core security design principles recommended by AWS for creating secure solutions and preparing for related examinations.
...
![The image features a question about ideas or concepts to consider when exploring services, alongside a shield icon on a turquoise background.](../../../../images/kodekloud.com/kk-media/image/upload/v1752863953/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Design-Principles-of-the-Security/services-exploration-ideas-shield.jpg)

For example, when evaluating a service's security posture, identify the elements that bolster its protection.

![The image features the question "What are the aspects of security?" alongside a shield icon on a turquoise background.](../../../../images/kodekloud.com/kk-media/image/upload/v1752863954/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Design-Principles-of-the-Security/security-aspects-shield-icon.jpg)
...
![The image features the question "What principles increase security?" alongside a shield icon on a turquoise background.](../../../../images/kodekloud.com/kk-media/image/upload/v1752863955/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Design-Principles-of-the-Security/security-principles-shield-icon.jpg)

![The image features a question, "What is the end goal of our security?" on a white background with a teal geometric shape containing a shield icon.](../../../../images/kodekloud.com/kk-media/image/upload/v1752863956/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Design-Principles-of-the-Security/security-end-goal-question-teal-shield.jpg)
...
> **lightbulb** Storing data in raw format without encryption exposes it to unauthorized reading by anyone with access. Encrypting data not only ties into robust access controls but is a fundamental security measure in itself.
...
![The image illustrates a concept of strong identity management, showing a central entity connected to IAM User, Role, Groups, and Entity.](../../../../images/kodekloud.com/kk-media/image/upload/v1752863957/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Design-Principles-of-the-Security/strong-identity-management-iam-diagram.jpg)
...
![The image illustrates a layered security model with four levels, each labeled with a different type of firewall or defense: Public Firewall, Network Defense, Private Firewall, and Host Firewall. It emphasizes applying security at all layers.](../../../../images/kodekloud.com/kk-media/image/upload/v1752863959/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Design-Principles-of-the-Security/layered-security-model-firewalls.jpg)
...
![The image illustrates a concept of preparing for security events, featuring a layered pyramid labeled 01 to 04, a wall, a person on horseback, and a group of people with flags.](../../../../images/kodekloud.com/kk-media/image/upload/v1752863960/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Design-Principles-of-the-Security/security-events-preparation-pyramid.jpg)
...
![The image shows a four-layered, multicolored pyramid labeled 01 to 04, alongside a section titled "Central Location" with four icons representing information files. It emphasizes tracking relevant logs, information, state, and configuration.](../../../../images/kodekloud.com/kk-media/image/upload/v1752863961/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Design-Principles-of-the-Security/multicolored-pyramid-central-location-logs.jpg)
...
![The image illustrates the concept of automating best practices, featuring a laptop and gears labeled with terms like "Code," "Scaling," "Security," and "Infra." It emphasizes the importance of automated checks for issues and prevention.](../../../../images/kodekloud.com/kk-media/image/upload/v1752863964/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Design-Principles-of-the-Security/automating-best-practices-laptop-gears.jpg)
...
![The image illustrates the concept of protecting data in all states, featuring icons of a laptop, a shield, and a device. It emphasizes data protection during transit, at rest, and in all intermediate states.](../../../../images/kodekloud.com/kk-media/image/upload/v1752863965/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Design-Principles-of-the-Security/data-protection-laptop-shield-device.jpg)
...
![The image illustrates the "SAPTRAP" design principles, highlighting six key security concepts: Strong Identity Management, Prepare for Security Events, Reduce Direct Contact, Protect Data in All States, Apply Security at All Layers, Track Everything Relevant, and Automate Best Practices. Each principle is represented by a hexagon with an initial letter.](../../../../images/kodekloud.com/kk-media/image/upload/v1752863966/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Design-Principles-of-the-Security/saptrap-security-principles-hexagons.jpg)
...
![The image illustrates the application of security design principles to Amazon S3, showing requirements, corresponding design principles, and service features like encryption, access logs, and identity management.](../../../../images/kodekloud.com/kk-media/image/upload/v1752863968/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Design-Principles-of-the-Security/security-design-amazon-s3-principles.jpg)
...
> **lightbulb** While these principles may not appear exactly as-is on the exam, applying concepts like defense in depth and stringent identity management is critical for your security strategy.
