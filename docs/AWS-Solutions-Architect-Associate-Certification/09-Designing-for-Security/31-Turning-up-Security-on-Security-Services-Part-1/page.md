...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Designing-for-Security/Turning-up-Security-on-Security-Services-Part-1/page

This guide highlights secure design principles and enhancing security within AWS services using tools for access control, auditing, threat detection, and encryption.
...
![The image is a diagram about AWS Identity and Access Management (IAM), highlighting its importance for security, who can access it, the permissions involved, and the resources within an AWS organization.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864495/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/aws-iam-security-access-diagram.jpg)
...
![The image is a diagram illustrating the process of designing for security using AWS Identity and Access Management (IAM) and CloudFormation. It shows how a customer account interacts with a company's account using AWS services, emphasizing the use of MFA with IAM.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864497/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/aws-iam-cloudformation-security-diagram.jpg)
...
![The image is a guide on using AWS IAM to manage cloud infrastructure securely, focusing on defining specific IAM roles for each resource type to ensure minimal necessary permissions. It presents four options for adhering to security policies regarding IAM access.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864498/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/aws-iam-roles-security-guide.jpg)

> **lightbulb** Avoid embedding sensitive credentials like secret keys directly in CloudFormation templates or in Git repositories. Use AWS Secrets Manager or AWS Systems Manager Parameter Store to securely manage and store sensitive data.

![The image is a diagram illustrating AWS IAM security practices, emphasizing not to add sensitive credentials to CloudFormation templates, with components like AWS Secrets Manager and security credentials.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864499/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/aws-iam-security-practices-diagram.jpg)
...
![The image presents a scenario where a software company needs to manage database credentials securely using AWS IAM, offering four approaches: hardcoding in the IAM template, using AWS Secrets Manager, encrypting with AWS KMS, and storing in an S3 bucket.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864500/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/aws-iam-database-credentials-management.jpg)
...
![The image shows a screenshot of an AWS CloudFormation console with a list of stack events, statuses, and timestamps. It also includes a note about IAM reporting events to CloudTrail and the CloudFormation console.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864502/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/aws-cloudformation-stack-events-screenshot.jpg)
...
![The image is a diagram illustrating the design for security using an IAM Identity Center (SSO) setup, showing the integration of on-premises Active Directory with AWS IAM Identity Center for managing user access and roles.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864503/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/iam-identity-center-security-diagram.jpg)
...
![The image is a slide discussing approaches to improve authentication reliability using Amazon Cognito for a mobile app, with four options listed for consideration.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864504/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/amazon-cognito-authentication-approaches.jpg)
...
![The image is a diagram illustrating the integration of AWS Microsoft AD with various services and applications, highlighting its use for AD integration and security. It shows connections between AWS services, EC2 instances, AD-aware workloads, cloud applications, and on-premises AD.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864506/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/aws-microsoft-ad-integration-diagram.jpg)
...
![The image is a diagram explaining "Designing for Security – Verified Permissions," focusing on creating policy validation and access management using Amazon Verified Permissions and Cognito. It outlines steps like creating schemas, managing policies, and authorizing access, with integration into services like Amazon API Gateway and AWS Lambda.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864507/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/designing-for-security-verified-permissions-diagram.jpg)
...
![The image shows a screenshot of the AWS CloudTrail interface displaying event history, with a note stating that CloudTrail mainly holds API calls which are not sensitive per se.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864508/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/aws-cloudtrail-event-history-screenshot.jpg)
...
![The image shows a configuration interface for AWS Config, detailing options for recording strategies, resource categories, data retention periods, and AWS Config roles. It highlights that AWS Config captures all changes.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864509/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/aws-config-configuration-interface.jpg)
...
![The image is a slide titled "Designing for Security – Artifact," showing a list of AWS compliance and agreement documents. It notes that Artifact has no security implications because it shares these documents.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864510/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/designing-for-security-artifact-documents.jpg)
...
![The image is a diagram explaining AWS GuardDuty, a security service that uses machine learning and AI to detect anomalies in network traffic. It outlines data sources, security analytics, security findings, and integration options.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864511/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/aws-guardduty-security-diagram.jpg)
...
![The image describes how AWS GuardDuty can help a financial services company improve its security by identifying potential security risks, offering insights into network traffic, and checking for security gaps and best practices.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864512/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/aws-guardduty-security-improvement.jpg)
...
![The image is a screenshot of the AWS Inspector dashboard, showing environment coverage and critical findings for security scanning, with a focus on Lambda functions.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864513/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/aws-inspector-dashboard-lambda-security.jpg)
...
![The image is a flowchart illustrating how Amazon Macie scans S3 buckets for sensitive data, using AWS services like EventBridge, Lambda, and Glacier to manage data based on sensitivity.](../../../../images/kodekloud.com/kk-media/image/upload/v1752864514/notes-assets/images/AWS-Solutions-Architect-Associate-Certification-Turning-up-Security-on-Security-Services-Part-1/amazon-macie-s3-bucket-flowchart.jpg)
