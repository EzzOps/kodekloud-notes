...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Management-and-Governance/CloudFormation-Demo/page

Learn to use AWS CloudFormation with a YAML template to deploy an EC2 instance, including defining resources, parameters, and outputs.
...
> **lightbulb** Refer to the [AWS CloudFormation User Guide](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/) for a full list of configurable properties.
...
> **lightbulb** If you intend to allow access over a range of ports, modify `FromPort` and `ToPort` accordingly. For a single port, both values remain the same.
