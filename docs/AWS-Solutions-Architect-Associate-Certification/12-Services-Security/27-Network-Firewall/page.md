...
> **lightbulb** When deploying AWS Network Firewall, always configure dedicated Firewall Endpoints within exclusive subnets. Avoid sharing these subnets with other resources to ensure comprehensive protection.
...
> **triangle-alert** Improper routing configuration can lead to traffic bypassing the firewall inspection, potentially exposing your network to security risks.
