...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Designing-for-Cost-Optimization/Design-Principles-for-Costs/page

This article explores strategic design principles for optimizing costs in cloud environments to maximize business value from every dollar spent.
...
> **lightbulb** Utilize infrastructure as code to easily scale resources up or down based on real-time needs, ensuring you only pay for what you use.
...
> **lightbulb** Tagging resources correctly is crucial. It helps in correlating costs with business outcomes, enabling more accurate and efficient decision-making.
