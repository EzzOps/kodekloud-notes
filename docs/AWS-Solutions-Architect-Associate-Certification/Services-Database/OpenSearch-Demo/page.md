...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Database/OpenSearch-Demo/page

This lesson guides you through creating and configuring an Amazon OpenSearch domain for data management and analysis.
...
For bulk uploads, prepare a file (e.g., bulk\_movies.json) with the following content:
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-solutions-architect-associate-certification/module/9fb73cb5-caf2-4dc2-ad5c-fe5fe69507e3/lesson/d1107238-c65e-4af2-83f1-242cee243ced" />
</CardGroup>
