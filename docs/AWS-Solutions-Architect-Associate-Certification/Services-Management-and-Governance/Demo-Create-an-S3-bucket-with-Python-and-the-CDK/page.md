...
Source: https://notes.kodekloud.com/docs/AWS-Solutions-Architect-Associate-Certification/Services-Management-and-Governance/Demo-Create-an-S3-bucket-with-Python-and-the-CDK/page

Learn to use the AWS CDK with Python to create and manage an S3 bucket, covering installation, configuration, deployment, and cleanup processes.
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/aws-solutions-architect-associate-certification/module/3c1ec40a-853a-4bf0-a4de-d53993e309f0/lesson/fa4eb86e-6b23-4646-9201-53e9274a87e0" />
</CardGroup>
