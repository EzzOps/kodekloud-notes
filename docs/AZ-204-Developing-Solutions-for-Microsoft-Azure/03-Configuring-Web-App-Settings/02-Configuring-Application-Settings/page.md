...
Source: https://notes.kodekloud.com/docs/AZ-204-Developing-Solutions-for-Microsoft-Azure/Configuring-Web-App-Settings/Configuring-Application-Settings/page

Learn to configure application settings and connection strings for your web app using the Azure portal, including updates and management of environment variables.
...
> **lightbulb** Using the Advanced Edit option, you can manage your settings in JSON format. This enables you to copy, paste, and make bulk edits efficiently.
...
> **lightbulb** Always store sensitive configuration data such as API keys and passwords using environment variables or connection strings instead of hard coding them into your codebase.
