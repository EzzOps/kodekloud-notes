...
Source: https://notes.kodekloud.com/docs/AZ-204-Developing-Solutions-for-Microsoft-Azure/Working-With-Azure-Cosmos-DB/Creating-Triggers-and-User-Defined-Functions/page

This guide demonstrates creating and utilizing triggers and user-defined functions in Azure Cosmos DB, highlighting their differences from stored procedures.
...
> **lightbulb** Ensure that your pre-trigger logic correctly handles all edge cases to prevent data inconsistencies.
...
> **lightbulb** For further optimization, consider exploring the change feed in Azure Cosmos DB to enhance your data processing strategies.
