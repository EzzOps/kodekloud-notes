...
Source: https://notes.kodekloud.com/docs/AZ-204-Developing-Solutions-for-Microsoft-Azure/Implementing-Azure-Container-Apps/Managing-Revisions-and-Secrets-in-Azure-Container-Apps/page
...
> **lightbulb** When planning updates, always consider the impact of generating new revisions on your operational workflow.
...
> **lightbulb** Detailed inspection may reveal configuration differences, such as a target port set to 80 and a service mesh link port set to 8080.
