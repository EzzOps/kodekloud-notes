...
Source: https://notes.kodekloud.com/docs/AZ-204-Developing-Solutions-for-Microsoft-Azure/Exploring-the-Microsoft-Identity-Platform/Microsoft-Identity-Platform/page

The Microsoft Identity Platform is an authentication and authorization solution that streamlines user access across various applications securely.
...
> **lightbulb** Consider leveraging MSAL in your applications to simplify authentication and enhance security without deep-diving into intricate protocol details.
...
> **lightbulb** Now that you have a clear understanding of the Microsoft Identity Platform, the next step is to explore app registrations (also known as service principals) in greater detail.
