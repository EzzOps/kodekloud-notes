...
Source: https://notes.kodekloud.com/docs/AZ-204-Developing-Solutions-for-Microsoft-Azure/Implementing-Authentication-Using-MSAL/Microsoft-Authentication-Library-MSAL/page

The Microsoft Authentication Library (MSAL) provides secure access to Microsoft services and supports various application architectures and authentication flows.
...
> **lightbulb** Keep in mind that using certificates instead of client secrets can enhance security for production environments.
...
> **triangle-alert** Avoid using the Username/Password flow in production environments due to its inherent security vulnerabilities.
