...
> **lightbulb** Keep in mind that although your Function App will be deployed, it may initially return an unauthorized error if the system-assigned identity has not yet been granted permission to access the Key Vault.
