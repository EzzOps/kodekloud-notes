...
> **lightbulb** Event Hubs Capture begins as soon as the first event is sent, eliminating the need for any manual intervention.
...
> **lightbulb** A sample event captured in Python format:
