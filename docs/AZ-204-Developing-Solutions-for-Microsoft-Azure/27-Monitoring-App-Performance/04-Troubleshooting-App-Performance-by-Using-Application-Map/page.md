...
> **lightbulb** After exploring the Application Map, we will now demonstrate how to capture exceptions and monitor performance issues using Application Insights directly in the Azure Portal.
