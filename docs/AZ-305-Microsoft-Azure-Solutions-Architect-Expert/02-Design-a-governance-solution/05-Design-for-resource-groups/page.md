...
Source: https://notes.kodekloud.com/docs/AZ-305-Microsoft-Azure-Solutions-Architect-Expert/Design-a-governance-solution/Design-for-resource-groups/page

This article discusses strategies for organizing Azure resources into groups to simplify management, access control, and policy application.
...
> **lightbulb** Grouping by application is ideal for solutions where the components have a tightly coupled lifecycle.
...
> **triangle-alert** When configuring RBAC and policies, ensure that the inheritance of permissions aligns with your organizational security practices.
