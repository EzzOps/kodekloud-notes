...
> **lightbulb** Azure Functions is best suited for scenarios with event-driven and short-duration processes. Consider other services if your workload requires long-running operations.
