...
Source: https://notes.kodekloud.com/docs/AZ-305-Microsoft-Azure-Solutions-Architect-Expert/Design-a-nonrelational-data-storage-solution/Design-for-Azure-Storage-Accounts/page

This guide explores design considerations for Azure storage accounts, including types, key factors for deployment, and best practices for performance and compliance.
...
> **lightbulb** Ensure that your storage solution adheres to any legal or regulatory requirements related to data residency, encryption, and auditing.
...
> **triangle-alert** Always evaluate your security configuration and verify that access control policies are rigorously enforced to protect sensitive data.
