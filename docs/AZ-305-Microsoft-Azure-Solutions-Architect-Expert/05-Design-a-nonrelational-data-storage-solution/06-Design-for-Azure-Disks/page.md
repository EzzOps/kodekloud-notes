...
Source: https://notes.kodekloud.com/docs/AZ-305-Microsoft-Azure-Solutions-Architect-Expert/Design-a-nonrelational-data-storage-solution/Design-for-Azure-Disks/page

This article outlines design considerations for Azure Disks, including disk types, caching strategies, and security through encryption.
...
> **lightbulb** Ultra SSD can only be used as a data disk and is supported on select VM SKUs only.
...
> **triangle-alert** Choosing CMK may restrict the use of ADE or host-level encryption, so ensure compatibility based on your security requirements.
