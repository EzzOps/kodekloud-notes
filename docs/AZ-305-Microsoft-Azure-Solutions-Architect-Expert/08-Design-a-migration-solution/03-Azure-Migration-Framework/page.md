...
Source: https://notes.kodekloud.com/docs/AZ-305-Microsoft-Azure-Solutions-Architect-Expert/Design-a-migration-solution/Azure-Migration-Framework/page

The article provides a comprehensive guide on the Azure Migration Framework for moving workloads from on-premises to Azure.
...
> **lightbulb** Before migration, use assessment tools to ensure workloads meet Azure's requirements. Incompatible components, such as 32-bit operating systems or unsupported boot partitions, can disrupt the migration process.
