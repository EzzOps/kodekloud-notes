...
Source: https://notes.kodekloud.com/docs/AZ-305-Microsoft-Azure-Solutions-Architect-Expert/Design-a-migration-solution/Assessing-workloads/page

This guide explores assessing various workloads for seamless migration to Azure using Microsoft’s assessment tools.
...
> **lightbulb** If you experience issues during project creation, such as policies blocking the deployment, consider selecting another region (e.g., Asia Pacific) for project setup.
...
> **lightbulb** Assessment reports provide critical insights that help present data-driven findings to business stakeholders.
