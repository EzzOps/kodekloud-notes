...
> **lightbulb** Although this demonstration uses an Azure-based SQL server to simulate an on-premises environment, the migration process remains identical to that of a true on-premises setup.
