...
Source: https://notes.kodekloud.com/docs/AZ-305-Microsoft-Azure-Solutions-Architect-Expert/Design-a-business-continuity-solution/Design-for-Azure-Backup/page

This article explores the architecture of Azure Backup, discussing design considerations, supported workloads, storage strategies, and best practices for configuring Recovery Services Vaults.
...
> **lightbulb** Using dedicated vaults to store various types of backup data enhances data management and improves overall service reliability.
...
> **triangle-alert** Changing redundancy settings on a vault with onboarded resources requires deleting and recreating the vault. This process can lead to service interruptions, so plan accordingly.
