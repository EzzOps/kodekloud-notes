...
Source: https://notes.kodekloud.com/docs/AZ-305-Microsoft-Azure-Solutions-Architect-Expert/Design-a-business-continuity-solution/Design-for-Azure-VM-Backup-and-Recovery/page
...
![The image shows a Microsoft Azure portal page displaying a list of Recovery Services vaults, with one entry named "fileshare-rsv" located in the "event-analytics" resource group in East US.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866834/notes-assets/images/AZ-305-Microsoft-Azure-Solutions-Architect-Expert-Design-for-Azure-VM-Backup-and-Recovery/azure-portal-recovery-services-vaults.jpg)

Click on **"Create New Vault"** to begin.

![The image shows a Microsoft Azure portal interface for creating a Recovery Services vault. It includes fields for selecting a subscription, resource group, vault name, and region.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866835/notes-assets/images/AZ-305-Microsoft-Azure-Solutions-Architect-Expert-Design-for-Azure-VM-Backup-and-Recovery/azure-portal-recovery-services-vault.jpg)

> **lightbulb** During vault creation, the default storage redundancy is set to geo-redundant (GRS). Adjust this option before onboarding any VMs if you prefer a different redundancy model.

![The image shows a Microsoft Azure portal page for creating a Recovery Services vault, displaying details like subscription, resource group, vault name, and region. There is also a note about storage replication types and a "Create" button at the bottom.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866836/notes-assets/images/AZ-305-Microsoft-Azure-Solutions-Architect-Expert-Design-for-Azure-VM-Backup-and-Recovery/azure-recovery-services-vault-portal.jpg)
...
![The image shows a Microsoft Azure portal interface for configuring backup settings in a recovery services vault named "sample-vault." It includes options for storage replication type and cross-region restore settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866838/notes-assets/images/AZ-305-Microsoft-Azure-Solutions-Architect-Expert-Design-for-Azure-VM-Backup-and-Recovery/azure-portal-backup-settings-sample-vault.jpg)

After updating your settings as necessary, save the changes and return to the vault's overview.

![The image shows a Microsoft Azure portal interface for a Recovery Services vault named "sample-vault," displaying options for backup and site recovery, along with a list of new features and settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866839/notes-assets/images/AZ-305-Microsoft-Azure-Solutions-Architect-Expert-Design-for-Azure-VM-Backup-and-Recovery/azure-portal-recovery-services-vault-2.jpg)
...
![The image shows a Microsoft Azure interface for configuring a backup policy for a virtual machine. It includes options for setting the backup schedule, instant restore, and retention range.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866840/notes-assets/images/AZ-305-Microsoft-Azure-Solutions-Architect-Expert-Design-for-Azure-VM-Backup-and-Recovery/azure-backup-policy-configuration.jpg)
...
![The image shows a Microsoft Azure interface for configuring backup settings, including selecting virtual machines for backup and setting backup policies.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866842/notes-assets/images/AZ-305-Microsoft-Azure-Solutions-Architect-Expert-Design-for-Azure-VM-Backup-and-Recovery/azure-backup-settings-interface.jpg)
...
![The image shows a Microsoft Azure portal page where a deployment named "ConfigureProtection" is in progress for the resource group "db-rg." The page includes deployment details and options for managing the deployment.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866842/notes-assets/images/AZ-305-Microsoft-Azure-Solutions-Architect-Expert-Design-for-Azure-VM-Backup-and-Recovery/azure-portal-configureprotection-deployment.jpg)
...
![The image shows a Microsoft Azure portal page for a virtual machine backup item, displaying backup options, status, and recovery points. The backup pre-check is passed, but there is a warning for the last backup status indicating an initial backup is pending.](../../../../images/kodekloud.com/kk-media/image/upload/v1752866843/notes-assets/images/AZ-305-Microsoft-Azure-Solutions-Architect-Expert-Design-for-Azure-VM-Backup-and-Recovery/azure-portal-virtual-machine-backup.jpg)
...
> **lightbulb** Backup and recovery strategies for Azure SQL build on these concepts. Ensure that you tailor policies and settings to align with specific workload requirements.
