...
> **lightbulb** Managed identities are only available for resources deployed in Azure. They cannot be used with on-premises applications.
...
> **lightbulb** Vendata Corp plans to leverage Azure AD for their identity and access management needs. Their solution requirements are as follows:
