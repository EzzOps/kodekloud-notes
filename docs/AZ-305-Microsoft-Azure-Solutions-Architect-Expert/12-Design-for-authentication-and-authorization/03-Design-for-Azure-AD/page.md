...
Source: https://notes.kodekloud.com/docs/AZ-305-Microsoft-Azure-Solutions-Architect-Expert/Design-for-authentication-and-authorization/Design-for-Azure-AD/page

This article explores designing robust solutions with Azure Active Directory, focusing on its features and best practices for identity and access management.
...
> **triangle-alert** Do not synchronize AD-privileged accounts. Privileged accounts such as enterprise or domain administrators should be excluded from synchronization to safeguard both on-premises and cloud environments. Even though these accounts are filtered out by default, custom roles may inadvertently sync them.
