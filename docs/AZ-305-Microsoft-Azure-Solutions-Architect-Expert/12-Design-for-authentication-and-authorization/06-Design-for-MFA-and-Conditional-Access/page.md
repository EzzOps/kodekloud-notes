...
Source: https://notes.kodekloud.com/docs/AZ-305-Microsoft-Azure-Solutions-Architect-Expert/Design-for-authentication-and-authorization/Design-for-MFA-and-Conditional-Access/page

This guide covers designing conditional access policies that use multiple signals to manage user authentication and application access securely.
...
> **lightbulb** These signals are applicable when using Azure AD authentication, where properties like location, device compliance, and client application are evaluated to dictate access levels.
...
> **lightbulb** Testing your policies in report-only mode before full enforcement is critical. It helps identify any potential issues without impacting user productivity.
