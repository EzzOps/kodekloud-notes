...
Source: https://notes.kodekloud.com/docs/AZ-305-Microsoft-Azure-Solutions-Architect-Expert/Design-for-authentication-and-authorization/Design-for-Identity-Protection/page

This article explains designing for identity protection using Azure Identity Protection to detect, remediate, and export identity-based risks.
...
> **lightbulb** Azure Identity Protection is a premium service that requires a P2 license.
...
> **triangle-alert** Exclude emergency or break-glass accounts from identity protection policies. Ensure these accounts have strong, securely stored passwords so they remain accessible if primary global administrator accounts face issues.
