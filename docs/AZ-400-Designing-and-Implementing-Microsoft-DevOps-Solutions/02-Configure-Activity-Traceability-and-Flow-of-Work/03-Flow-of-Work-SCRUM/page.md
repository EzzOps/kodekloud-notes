...
> **lightbulb** Track PBIs and bugs on the **Kanban board** for visibility, then split them into **Sprint tasks** on the taskboard to manage day-to-day work and remaining effort.
