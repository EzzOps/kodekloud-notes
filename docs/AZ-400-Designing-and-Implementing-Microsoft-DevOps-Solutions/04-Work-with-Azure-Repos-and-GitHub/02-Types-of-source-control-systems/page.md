...
> **lightbulb** Start with a non-critical branch (e.g., development) to verify the process before importing protected or release branches.

![The image illustrates the process of transitioning from TFVC to Git, highlighting branch-level migration and showing an interface for importing a repository from TFVC.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868155/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Transitioning-from-TFVC-to-Git/tfvc-to-git-migration-process-diagram.jpg)
...
> **triangle-alert** A **full-history migration** can take significantly longer and may require careful mapping of authors and commit dates. Plan for additional time and storage.
...
![The image illustrates a concept of centralized source control with a server repository depicted as a cylinder.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868158/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Types-of-source-control-systems/centralized-source-control-server-repository.jpg)

### Examples of Centralized Systems

![The image lists examples of centralized source control systems: Team Foundation Version Control (TFVC), Concurrent Versions System (CVS), Apache Subversion (SVN), and Perforce Helix Core.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868160/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Types-of-source-control-systems/centralized-source-control-systems-examples.jpg)
...
![The image outlines the advantages of centralized source control, highlighting scalability, access management, and usage oversight.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868160/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Types-of-source-control-systems/centralized-source-control-advantages-outline.jpg)
...
![The image illustrates a distributed source control system, showing interactions between a central server repository and two systems (A and B) with pull, push, commit, and replace actions.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868162/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Types-of-source-control-systems/distributed-source-control-system-diagram.jpg)

The most popular distributed systems are Git and Mercurial:

![The image lists examples of distributed source control systems: Git and Mercurial.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868162/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Types-of-source-control-systems/distributed-source-control-systems-git-mercurial.jpg)

> **lightbulb** You get full history access even when offline, making code reviews and commits possible without an internet connection.
...
![The image lists the key strengths of distributed source control, including flexibility, community-centric development, offline functionality, history tracking, and growing popularity. Each strength is highlighted in a colorful box with an icon.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868164/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Types-of-source-control-systems/distributed-source-control-strengths-list.jpg)
...
![The image outlines ideal applications for distributed source control, highlighting its efficiency for compact codebases, open-source projects, remote collaboration, and cross-platform development.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868165/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Types-of-source-control-systems/distributed-source-control-applications-outline.jpg)
...
![The image compares Git and Team Foundation Version Control, highlighting Git as a decentralized system and Team Foundation as a centralized framework.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868166/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Types-of-source-control-systems/git-vs-tfvc-comparison-decentralized-centralized.jpg)
...
> **triangle-alert** Improper use of `git reset` or `git rebase` can rewrite shared history—coordinate closely with your team.

![The image lists three objections to using Git: history management, handling of voluminous files, and educational investment.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868174/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Types-of-source-control-systems/git-objections-history-management-voluminous-files.jpg)
