...
> **lightbulb** If this is your first time using the GitHub CLI, run `gh auth login` to authenticate.
...
> **triangle-alert** Once a tag is published as a public Release, avoid rewriting or deleting it—immutable tags preserve release integrity.
...
> **lightbulb** Refer to the [SemVer specification](https://semver.org/) for detailed guidelines on version numbering.
