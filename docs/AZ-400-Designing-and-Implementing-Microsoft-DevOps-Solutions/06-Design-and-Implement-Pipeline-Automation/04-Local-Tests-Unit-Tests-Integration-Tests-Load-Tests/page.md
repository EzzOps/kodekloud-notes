...
Source: https://notes.kodekloud.com/docs/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions/Design-and-Implement-Pipeline-Automation/Local-Tests-Unit-Tests-Integration-Tests-Load-Tests/page
...
> **lightbulb** Run local tests before every commit to minimize broken builds in your shared branches. Automate unit, integration, and load tests in separate pipeline stages for clear feedback and faster troubleshooting.
