...
Source: https://notes.kodekloud.com/docs/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions/Design-and-Implement-Pipelines/Pipeline-triggers/page

Azure Pipeline Triggers automate build and deployment workflows based on specific events, enhancing code validation, testing, and delivery in CI/CD processes.
...
> **lightbulb** Wildcards (`*`) help you include entire branch families. To exclude specific branches, use `exclude:` under `branches`.
...
> **lightbulb** Cron schedules in Azure Pipelines are evaluated in UTC. Adjust your `cron` expression if your team operates in other time zones.
...
> **triangle-alert** Manual deployments bypass automated gates. Ensure you have approvals or checks in place for sensitive environments.
