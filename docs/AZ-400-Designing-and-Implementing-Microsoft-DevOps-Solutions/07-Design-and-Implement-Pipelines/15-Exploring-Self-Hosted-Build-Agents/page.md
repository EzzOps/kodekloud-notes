...
Source: https://notes.kodekloud.com/docs/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions/Design-and-Implement-Pipelines/Exploring-Self-Hosted-Build-Agents/page

This article covers the setup and best practices for self-hosted Azure DevOps build agents.
...
> **lightbulb** If you choose to run the agent as a service (`Y`), it will automatically start on machine reboot.
...
> **lightbulb** Consider using containerized agents if you need rapid scaling and tighter isolation between builds.
