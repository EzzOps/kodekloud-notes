...
> **lightbulb** Store sensitive values like `SqlPassword` and service connections in Azure Key Vault or secure pipeline variables.
...
> **triangle-alert** Never apply untested schema changes directly to production. Always verify deployments in a safe environment first.
