...
Source: https://notes.kodekloud.com/docs/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions/Design-and-Implement-Deployments/Plan-for-minimizing-downtime-during-deployments/page

This guide covers strategies to achieve near-zero downtime during Azure deployments, ensuring service availability and user satisfaction.
...
> **lightbulb** Ensure health probes are configured correctly so the load balancer only sends traffic to fully initialized instances.
...
> **triangle-alert** Applications with stateful in-memory sessions may require session persistence or sticky sessions to avoid user disruption during rolling updates.
