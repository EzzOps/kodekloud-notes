...
> **lightbulb** If you have a recent Azure CLI installation, the az bicep commands are available without a separate binary. Run az bicep version to confirm availability.
...
> **warning** Never commit secrets or credentials to source control. Use Key Vault references, Azure AD-backed service principals, or secure parameter files for sensitive values.
