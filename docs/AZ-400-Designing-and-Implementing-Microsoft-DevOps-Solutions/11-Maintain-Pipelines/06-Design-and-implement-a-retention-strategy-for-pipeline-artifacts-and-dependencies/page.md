...
Source: https://notes.kodekloud.com/docs/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions/Maintain-Pipelines/Design-and-implement-a-retention-strategy-for-pipeline-artifacts-and-dependencies/page
...
> **lightbulb** You can scope retention settings to specific branches, tags, or pipeline triggers.

![The image shows a Visual Studio Code editor with a markdown file open, listing reasons for a task: reducing storage costs, ensuring compliance with data retention regulations, and maintaining a clean, efficient pipeline environment.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868116/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Design-and-implement-a-retention-strategy-for-pipeline-artifacts-and-dependencies/vscode-markdown-task-reasons-list.jpg)
...
> **triangle-alert** If **Days to keep runs** is shorter than any artifact-level setting, the pipeline-level setting takes precedence.
...
> **lightbulb** Centralize retention variables in a template to keep your pipelines DRY and maintainable.
