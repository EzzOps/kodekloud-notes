...
Source: https://notes.kodekloud.com/docs/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions/Maintain-Pipelines/Summary-Maintaining-Pipelines/page

This article reviews pipeline health, optimization, and migration in Azure DevOps for the AZ-400 exam and practical DevOps applications.
...
> **lightbulb** Use Azure Test Plans to tag and quarantine flaky tests. Consistent test results improve confidence in your releases.
...
> **lightbulb** Limiting `maxParallel` helps avoid agent contention and unexpected billing spikes.
...
> **triangle-alert** Watch for YAML indentation and syntax errors. A single space can break your pipeline!
