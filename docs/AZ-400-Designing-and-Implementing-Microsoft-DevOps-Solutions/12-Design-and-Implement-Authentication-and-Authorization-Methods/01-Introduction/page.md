...
Source: https://notes.kodekloud.com/docs/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions/Design-and-Implement-Authentication-and-Authorization-Methods/Introduction/page

This lesson explores designing and implementing authentication and authorization strategies in Azure DevOps and GitHub for secure workflows.
...
> **lightbulb** Use managed identities wherever possible to eliminate secret management. Reserve service principals for scenarios requiring cross-tenant or custom-role access.
...
> **triangle-alert** Personal Access Tokens expire by default. Always set reminders to renew or automate rotation via the [GitHub REST API](https://docs.github.com/rest/overview/resources-in-the-rest-api#authentication).
...
> **lightbulb** Rotate Azure DevOps PATs at least every 90 days and restrict scope to only what’s necessary.
...
> **lightbulb** Align sprints and iterations with your team’s delivery cadence. Use capacity planning to avoid overcommitment.
