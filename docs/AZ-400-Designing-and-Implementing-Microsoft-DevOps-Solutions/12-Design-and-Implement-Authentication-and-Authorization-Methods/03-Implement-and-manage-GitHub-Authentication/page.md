...
Source: https://notes.kodekloud.com/docs/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions/Design-and-Implement-Authentication-and-Authorization-Methods/Implement-and-manage-GitHub-Authentication/page
...
> **lightbulb** After updating permissions, you must regenerate the installation access token for changes to take effect.
...
> **triangle-alert** Do not expose `GITHUB_TOKEN` to external URLs or untrusted actions—limit usage to internal steps only.
...
> **lightbulb** Store PATs in a secure vault or GitHub Secrets, rotate them regularly, and avoid embedding them in code.
