...
Source: https://notes.kodekloud.com/docs/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions/Design-and-Implement-Authentication-and-Authorization-Methods/Summary/page

This guide covers essential pillars for securing and automating DevOps workflows including identity management, GitHub authentication, Azure DevOps authentication, and project configuration.
...
> **lightbulb** Always assign the minimal Azure RBAC roles required and rotate credentials according to your security policy.
...
* **GITHUB\_TOKEN** (GitHub Actions): Automatically generated per workflow run.
...
> **triangle-alert** Never commit a PAT in source code. Store secrets in GitHub Secrets or a Vault solution.
...
> **lightbulb** Enable diagnostic logging in Azure DevOps to track service connection usage and detect unauthorized access.
...
> **lightbulb** Link commits and pull requests to work items to maintain end-to-end traceability.
