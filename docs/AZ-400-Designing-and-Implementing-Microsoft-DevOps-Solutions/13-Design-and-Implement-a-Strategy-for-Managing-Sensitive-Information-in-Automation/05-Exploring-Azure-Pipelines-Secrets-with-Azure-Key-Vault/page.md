...
> **lightbulb** The setting `always: true` ensures the pipeline runs regardless of code changes.
...
> **triangle-alert** Make sure this service principal has **Get** and **List** permissions on your Key Vault. Otherwise, Azure Pipelines won’t be able to fetch secrets.
