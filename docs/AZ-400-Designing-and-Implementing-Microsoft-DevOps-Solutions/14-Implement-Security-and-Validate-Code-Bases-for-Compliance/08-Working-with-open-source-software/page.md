...
Source: https://notes.kodekloud.com/docs/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions/Implement-Security-and-Validate-Code-Bases-for-Compliance/Working-with-open-source-software/page

This guide covers best practices for evaluating, adopting, and managing open source components in your projects.
...
![The image illustrates the issue of "Lack of Ongoing Maintenance" in open-source software, leading to code failure. It shows a flow from open-source software to lack of maintenance and then to code failure.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868043/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Working-with-open-source-software/lack-of-maintenance-open-source-failure.jpg)

> **lightbulb** Select components with a vibrant community, frequent releases, and clear contribution guidelines. Monitor release cadence on repositories like [GitHub](https://github.com/) or [GitLab](https://about.gitlab.com/).
...
![The image illustrates the risk of malicious code in open-source software, showing its incorporation into IT systems potentially leading to system failure.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868044/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Working-with-open-source-software/malicious-code-open-source-risk-illustration.jpg)

> **triangle-alert** Always run automated security scans (e.g., [Snyk](https://snyk.io/), [Dependabot](https://github.com/dependabot)) and perform manual code reviews on new dependencies.
...
![The image is a slide titled "Essentials of Open-Source Licensing," highlighting "Access to Source Code" with a magnifying glass icon, indicating that the source code is fully available for examination.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868045/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Working-with-open-source-software/essentials-open-source-licensing-access-code.jpg)

3. **Freedom to Modify**\
   Ability to adapt the code and create derivatives.

![The image is a slide titled "Essentials of Open-Source Licensing," highlighting the "Freedom to Modify," which allows users to modify and create derivatives of the original source code.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868046/notes-assets/images/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions-Working-with-open-source-software/open-source-licensing-freedom-modify.jpg)
