...
Source: https://notes.kodekloud.com/docs/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions/Implement-Security-and-Validate-Code-Bases-for-Compliance/Navigating-CodeQL-on-GitHub/page

This guide explains how to use CodeQL for vulnerability detection and quality checks in your GitHub workflow.
...
> **lightbulb** For an in-depth overview of CodeQL’s query language, visit the [CodeQL QL Reference](https://codeql.github.com/docs/codeql-querying/ql-reference/).
...
> **triangle-alert** Be cautious when excluding query packs or paths—omitting critical scans can leave gaps in your security posture.
