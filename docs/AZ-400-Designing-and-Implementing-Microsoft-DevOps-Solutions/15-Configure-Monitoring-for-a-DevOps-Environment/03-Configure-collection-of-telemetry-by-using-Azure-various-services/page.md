...
Source: https://notes.kodekloud.com/docs/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions/Configure-Monitoring-for-a-DevOps-Environment/Configure-collection-of-telemetry-by-using-Azure-various-services/page

This guide covers setting up telemetry collection using various Azure services for monitoring and diagnostics.
...
> **triangle-alert** Enabling advanced telemetry features may increase data ingestion costs. Review [Azure Monitor pricing](https://azure.microsoft.com/pricing/details/monitor/) and set up budget alerts to control expenses.
