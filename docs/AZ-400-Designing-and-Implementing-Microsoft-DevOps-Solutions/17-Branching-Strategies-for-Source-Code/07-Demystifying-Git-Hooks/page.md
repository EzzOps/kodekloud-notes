...
Source: https://notes.kodekloud.com/docs/AZ-400-Designing-and-Implementing-Microsoft-DevOps-Solutions/Branching-Strategies-for-Source-Code/Demystifying-Git-Hooks/page

Git Hooks are scripts that automate tasks in your Git workflow, enhancing code quality and streamlining development processes.
...
> **lightbulb** Hooks reside in the `.git/hooks/` directory. Rename or link your custom scripts (e.g., `pre-commit`) to enable them.
...
> **triangle-alert** Server-side hooks require administrative access to the bare repository. Ensure you understand the impact before enabling these hooks.
