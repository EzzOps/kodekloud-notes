...
> **lightbulb** You can use [Microsoft Learn](https://learn.microsoft.com/) during the exam to look up documentation, service limits, and configuration examples. Practice quick searches and bookmarking relevant pages so you can retrieve information efficiently during the test.
...
> **warning** Do not pop out the documentation window during the exam — some candidates report this can interrupt or break the exam session. Use the integrated split view provided by the exam platform.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/az-700-designing-and-implementing-microsoft-azure-networking-solutions/module/59314846-5982-4096-a4a3-16d34d72f38a/lesson/abac71a7-720f-4f41-a062-1ca1c4eff813)
