...
> **lightbulb** For most new deployments, choose Standard SKU + Static assignment + Regional tier, and set routing preference to `Microsoft network` for best performance and reliability.

> **warning** Exposing a VM to the internet requires careful Network Security Group (NSG) rules. Only open necessary ports (e.g., SSH, HTTP) and consider using Jump Boxes, Bastion, or Just-In-Time access for management.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/az-700-designing-and-implementing-microsoft-azure-networking-solutions/module/d1f14b43-f5eb-48e5-a79d-22d1469571be/lesson/b00032cd-438b-4160-bbe2-bc61d0061bf6)
