...
> **warning** Do not publish internal DNS servers directly to the internet. Restrict access using NSGs, firewalls, or private connectivity and use Azure platform DNS (`168.63.129.16`) where appropriate.
