...
> **warning** Avoid applying restrictive Network Security Group (NSG) rules directly to `GatewaySubnet`. Doing so can block required VPN and management traffic and prevent gateway deployment or tunnel establishment.
