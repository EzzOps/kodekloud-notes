...
> **lightbulb** Recommended prerequisites: familiarity with Azure networking concepts (VNet, subnet, Network Security Groups), Site-to-Site and Point-to-Site VPN basics, and an Azure subscription with contributor access to networking resources.
...
> **warning** Before choosing a SKU, verify throughput and feature requirements for your expected traffic patterns (VPN tunnels, ExpressRoute, and Point-to-Site connections) and confirm SKU availability in your regions.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/az-700-designing-and-implementing-microsoft-azure-networking-solutions/module/26572db6-1783-4efc-a13f-e3185c8ac54d/lesson/f3d9c058-0464-424f-8ae1-4c4bf376cd24)
