...
> **lightbulb** Before making changes, record the current peering settings (VLAN, ASN, IP pairs). You can use the Azure CLI or PowerShell to export these settings for auditing or troubleshooting.
