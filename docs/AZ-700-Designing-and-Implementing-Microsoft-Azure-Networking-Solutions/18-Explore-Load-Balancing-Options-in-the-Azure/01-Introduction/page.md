...
> **lightbulb** Tip: When evaluating which Azure load balancing service to use, first identify your traffic type (TCP/UDP vs. HTTP/HTTPS), whether you need global vs. regional routing, and whether you require application-layer features like WAF or URL-based routing.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/az-700-designing-and-implementing-microsoft-azure-networking-solutions/module/a231ef6d-9e0c-4c9d-81dd-d3ea9de8d42f/lesson/8b4580a6-a941-4dd8-acf0-2e1f6187c203)
