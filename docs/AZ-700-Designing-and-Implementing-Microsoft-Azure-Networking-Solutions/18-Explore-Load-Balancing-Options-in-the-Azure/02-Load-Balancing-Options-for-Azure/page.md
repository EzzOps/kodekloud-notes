...
> **lightbulb** Key decision criteria: protocol (HTTP/HTTPS vs TCP/UDP), scope (regional vs global), required features (WAF, TLS offload, URL-based routing, caching), availability and failover model (zone redundancy, regional failover, instant failover), and cost. Use these factors to map your application to the appropriate Azure service.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/az-700-designing-and-implementing-microsoft-azure-networking-solutions/module/a231ef6d-9e0c-4c9d-81dd-d3ea9de8d42f/lesson/55dad53f-abeb-4c84-a865-91c50f24a0ea)
