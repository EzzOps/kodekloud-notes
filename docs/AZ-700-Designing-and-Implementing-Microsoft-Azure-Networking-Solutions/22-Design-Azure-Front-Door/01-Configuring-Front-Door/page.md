...
4. Select the SKU: Standard or Premium.
   > **lightbulb** Choose Standard unless you need Premium-only features like advanced WAF, geofiltering, or Private Link integration.
...
> **warning** For production workloads, prefer `HTTPS only` or `Match incoming request` with end-to-end TLS enabled to maintain encryption between the edge and your origin.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/az-700-designing-and-implementing-microsoft-azure-networking-solutions/module/705deb1d-f387-4bab-9642-e9838d1a0c4c/lesson/05d584ba-5e60-41bb-91d7-92af806b542a)
