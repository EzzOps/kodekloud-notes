...
> **lightbulb** Application Security Groups simplify NSG management by letting you add or remove VMs from logical groups instead of repeatedly editing IP-based rules. Reuse ASGs across multiple NSGs to enforce consistent, layered network security policies.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/az-700-designing-and-implementing-microsoft-azure-networking-solutions/module/f311416f-4844-43ee-bc18-4ad6b6f0b71a/lesson/8a3904d2-0c99-4395-baea-7ffddaa6aae4)
...
> **lightbulb** Lower numeric priority means higher precedence — the rule with the smallest numeric priority is evaluated first.
