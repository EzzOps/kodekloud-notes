...
> **lightbulb** Azure Bastion must be deployed into a dedicated subnet named exactly `AzureBastionSubnet`. If the subnet name differs, Bastion cannot be deployed there—this name is mandatory.
...
> **warning** The Developer SKU supports only one active Bastion session at a time. For multiple concurrent sessions or advanced features (IP-based connections, Kerberos authentication, etc.), upgrade to the Standard or Premium SKU.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/az-700-designing-and-implementing-microsoft-azure-networking-solutions/module/fbd7bcc4-5539-49f4-abcb-c72fd0f106ee/lesson/9afe9f85-3310-4d7c-ac1e-8d38758d290f)
