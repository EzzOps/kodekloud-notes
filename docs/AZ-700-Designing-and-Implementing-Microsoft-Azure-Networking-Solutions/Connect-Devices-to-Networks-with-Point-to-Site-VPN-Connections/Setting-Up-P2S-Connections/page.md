...
<Callout icon="lightbulb">
  You can use certificate-based authentication, [Azure Active Directory (Entra ID)](https://learn.microsoft.com/en-us/azure/active-directory/), or RADIUS for P2S. Choose the method that fits your security requirements. Make sure the client address pool is large enough and does not overlap your on-prem or hub/spoke address spaces.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/az-700-designing-and-implementing-microsoft-azure-networking-solutions/module/c5df2cec-e98a-4e4f-ad3a-e20fe745164e/lesson/dba5363c-6d0d-4532-a060-927ca12a0ade" />
</CardGroup>
