...
<Callout icon="lightbulb">
  Azure reserves the first four and the last IP address in every subnet (5 addresses total). A `/24` subnet leaves 251 usable IPs. The smallest supported subnet is `/29` (8 addresses), which provides 3 usable IPs after reservations.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/az-700-designing-and-implementing-microsoft-azure-networking-solutions/module/9b16a37d-b022-4ded-93f2-4f43507d73f8/lesson/63c24137-745d-4644-a9a1-d741454b14e2" />
</CardGroup>
