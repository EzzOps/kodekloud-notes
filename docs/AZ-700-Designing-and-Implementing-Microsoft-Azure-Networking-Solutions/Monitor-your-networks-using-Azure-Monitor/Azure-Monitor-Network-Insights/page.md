...
<Callout icon="lightbulb">
  To use Traffic Analytics and many Network Watcher features you may need to enable `Network Watcher` in the target region and enable diagnostic settings (for example, NSG Flow Logs). Ensure you have the required permissions and that diagnostic settings are configured for the resources you wish to monitor.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/az-700-designing-and-implementing-microsoft-azure-networking-solutions/module/9dfef54c-25b7-419f-a3f9-35b473feccf9/lesson/de739e38-a197-4584-b3a2-0a573e383027" />
</CardGroup>
