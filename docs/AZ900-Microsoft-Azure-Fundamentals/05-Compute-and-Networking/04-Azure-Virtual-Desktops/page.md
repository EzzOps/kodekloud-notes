...
![The image lists key features of Azure Virtual Desktops: Remote Access, Multi-Session Windows 10, and Security and Compliance.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868288/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Azure-Virtual-Desktops/azure-virtual-desktops-features.jpg)
...
![The image highlights the benefits of Azure Virtual Desktops, featuring three key points: flexibility, cost-effectiveness, and scalability.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868289/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Azure-Virtual-Desktops/azure-virtual-desktops-benefits.jpg)
...
![The image illustrates common use cases for Azure Virtual Desktops, including remote work, BYOD (Bring Your Own Device), and regulated access to company data, with a diagram showing virtual machines (VM01, VM02, VM03).](../../../../images/kodekloud.com/kk-media/image/upload/v1752868290/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Azure-Virtual-Desktops/azure-virtual-desktops-use-cases.jpg)
...
![The image shows the Azure Virtual Desktop interface, specifically the "Host pools" section, displaying a list of host pools with details like name, resource group, location, and subscription.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868292/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Azure-Virtual-Desktops/azure-virtual-desktop-host-pools.jpg)
...
> **lightbulb** When connecting through a browser, a session prompt will request permission to access local resources such as clipboard, printers, and file transfers to ensure a smooth remote experience.

![The image shows a browser window with the Azure Virtual Desktop interface, displaying a prompt to allow access to local resources such as clipboard, printer, and file transfer.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868293/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Azure-Virtual-Desktops/azure-virtual-desktop-browser-window.jpg)
...
![The image shows a Windows 10 desktop with the Start menu open, displaying various applications and a blue background with the Windows logo.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868293/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Azure-Virtual-Desktops/windows-10-desktop-start-menu.jpg)
...
![The image shows a Windows 10 desktop with a network discovery prompt on the right side, asking if the PC should be discoverable on the network.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868294/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Azure-Virtual-Desktops/windows-10-network-discovery-prompt.jpg)
