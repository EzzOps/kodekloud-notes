...
> **lightbulb** If you prefer PowerShell, here is an example of an HTTP-triggered function. It checks for a "name" parameter in the URL query string or the request body and returns a personalized greeting if provided:
