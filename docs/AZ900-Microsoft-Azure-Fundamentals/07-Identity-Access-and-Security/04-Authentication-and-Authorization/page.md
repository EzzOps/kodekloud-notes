...
Source: https://notes.kodekloud.com/docs/AZ900-Microsoft-Azure-Fundamentals/Identity-Access-and-Security/Authentication-and-Authorization/page
...
> **lightbulb** Authentication is like a security guard checking your ID. Methods such as passwords, tokens, and biometrics confirm that you are who you claim to be.
...
![The image compares authentication and authorization, highlighting that authentication confirms identity using methods like passwords, while authorization determines access and permissions.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868396/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Authentication-and-Authorization/auth-vs-authorization-comparison.jpg)
...
![The image outlines Azure's approach to authentication and authorization, highlighting the use of Microsoft Entra ID for authentication and RBAC, policies, and rules for authorization.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868398/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Authentication-and-Authorization/azure-authentication-authorization-diagram.jpg)
...
![The image outlines the benefits of authentication and authorization, highlighting enhanced security, fine-grained access control, and compliance and governance.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868399/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Authentication-and-Authorization/authentication-authorization-benefits-diagram.jpg)
...
![The image shows two use cases for authentication and authorization: "User login authentication" and "Access control for Azure resources for authorization."](../../../../images/kodekloud.com/kk-media/image/upload/v1752868400/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Authentication-and-Authorization/authentication-authorization-use-cases.jpg)

> **lightbulb** Understanding these security concepts is fundamental to designing a secure Azure environment. Employ both robust authentication methods and granular authorization techniques to safeguard your data and optimize resource management.
