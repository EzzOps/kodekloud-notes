...
Source: https://notes.kodekloud.com/docs/AZ900-Microsoft-Azure-Fundamentals/Identity-Access-and-Security/Microsoft-Defender-for-Cloud/page

Microsoft Defender for Cloud is a security solution that protects cloud and on-premises environments by detecting and responding to threats while ensuring compliance.
...
![The image is a diagram showing "Microsoft Defender for Cloud" connected to Amazon Web Services, Google Cloud, Azure, and an on-premises data center.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868420/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Microsoft-Defender-for-Cloud/microsoft-defender-cloud-diagram.jpg)
...
![The image shows a graphic titled "Microsoft Defender for Cloud" with four colored panels representing GitHub, Azure, DevOps, and GitLab.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868421/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Microsoft-Defender-for-Cloud/microsoft-defender-cloud-graphic.jpg)
...
![The image lists the key features of Microsoft Defender for Cloud: Continuous Assessment, Threat Protection, Secure Score, and Regulatory Compliance Dashboards.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868422/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Microsoft-Defender-for-Cloud/microsoft-defender-cloud-features.jpg)
...
![The image lists the benefits of Microsoft Defender for Cloud, highlighting comprehensive security, centralized management, and automated recommendations.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868424/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Microsoft-Defender-for-Cloud/microsoft-defender-cloud-benefits.jpg)

> **lightbulb** Integrating Microsoft Defender for Cloud into your security strategy not only enhances protection but also streamlines compliance with various regulatory standards.
...
![The image shows three use cases for Microsoft Defender for Cloud: cloud workload security, compliance management, and strengthening cloud security, each represented by a colored card with icons.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868425/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Microsoft-Defender-for-Cloud/microsoft-defender-cloud-use-cases.jpg)
...
![The image shows a Microsoft Azure interface displaying security recommendations from Microsoft Defender for Cloud, with various recommendations listed by severity and status.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868426/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Microsoft-Defender-for-Cloud/azure-security-recommendations-defender.jpg)
...
![The image shows a Microsoft Azure portal screen with a recommendation to install the Guest Configuration extension on machines. It includes remediation steps and a list of affected resources.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868428/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Microsoft-Defender-for-Cloud/azure-portal-guest-configuration.jpg)
...
![The image shows the Microsoft Defender for Cloud overview dashboard on Azure, displaying security posture, regulatory compliance, and workload protections. It includes various metrics and recommendations for improving cloud security.](../../../../images/kodekloud.com/kk-media/image/upload/v1752868429/notes-assets/images/AZ900-Microsoft-Azure-Fundamentals-Microsoft-Defender-for-Cloud/microsoft-defender-cloud-overview-dashboard.jpg)
...
> **triangle-alert** Ensure that you allow up to 24 hours for the secure score data to populate following the activation of Microsoft Defender for Cloud in a new environment.
