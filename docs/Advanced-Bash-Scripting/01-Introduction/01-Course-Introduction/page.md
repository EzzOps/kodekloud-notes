...
> **triangle-alert** Don’t confuse `:` with the external `true` command—`:` is built into the shell and more efficient.
...
> **lightbulb** “Practice is the hardest part of learning, and training is the essence of transformation.”\
  – Ann Boscum
...
> **triangle-alert** Always test your scripts in a safe environment before deploying them in production!
...
- [Watch Video](https://learn.kodekloud.com/user/courses/advanced-bash-scripting/module/62d639a9-3779-4ae6-b8b2-1cc49f117f64/lesson/7638aa37-bddb-447d-8e1a-f843f2af5acd)
