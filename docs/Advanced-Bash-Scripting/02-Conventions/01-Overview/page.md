...
> **triangle-alert** Shell interpreters enforce certain rules (like no spaces around `=` in assignments). Always validate your scripts with [ShellCheck](https://www.shellcheck.net/) before deployment.
