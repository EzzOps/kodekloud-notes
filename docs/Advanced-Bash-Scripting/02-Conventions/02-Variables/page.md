...
> **lightbulb** Avoid uppercase names for regular variables—uppercase is conventionally reserved for constants (see [Defining Constants](#2-defining-constants)).
...
> **triangle-alert** Attempting to modify a `readonly` variable will produce an error:
