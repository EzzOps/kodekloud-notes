...
> **lightbulb** When you omit the FD before `>`, Bash assumes `1` (standard output).
...
> **triangle-alert** Order matters when combining redirections. Always redirect stdout first, then redirect stderr into it.
