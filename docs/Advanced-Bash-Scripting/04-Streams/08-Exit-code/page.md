...
> **triangle-alert** Exit codes are constrained to the range 0–255. Any value above 255 wraps around modulo 256.
...
> **lightbulb** Use clear, documented exit codes in your scripts. This makes it easier for users and other scripts to handle errors automatically.
