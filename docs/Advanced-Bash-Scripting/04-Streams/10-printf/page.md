...
> **triangle-alert** Avoid relying on `echo -e` for escape handling across scripts. Use `printf` for consistent results in Bash, Dash, Zsh, and other POSIX-compliant shells.
