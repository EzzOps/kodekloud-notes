...
Source: https://notes.kodekloud.com/docs/Advanced-Bash-Scripting/Globs/Mixed/page

This article teaches advanced techniques for using glob patterns in Bash to match complex filename patterns efficiently.
...
> **lightbulb** For an in-depth reference on Bash filename expansion, see [Bash Pattern Matching](https://www.gnu.org/software/bash/manual/html_node/Pattern-Matching.html).
...
> **triangle-alert** Be sure to quote or escape the pattern in your shell to prevent expansion before `ls` sees it.
