...
> **lightbulb** When mixing ranges, list them in the order you want matched: here `a-e` before `A-E`.
...
> **triangle-alert** Globbing won’t create files—only match them. If you expect new files, use brace expansion or a loop.
