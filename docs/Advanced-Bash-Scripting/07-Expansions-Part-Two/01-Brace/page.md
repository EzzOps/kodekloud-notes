...
> **lightbulb** Use `${var:-default}` to safely reference a variable that may not exist.
...
> **triangle-alert** Always quote expansions containing spaces unless you explicitly need word splitting.
...
> **lightbulb** Brace expansions are always processed **before** globs and parameter expansions. This lets you quickly generate lists of filenames, parameters, or other strings in a single command.
