...
> **lightbulb** Always validate positional parameters to avoid silent errors and improve script maintainability.
...
> **triangle-alert** Scripts that continue after errors can hide critical failures. Always combine guard clauses with strict error handling.
