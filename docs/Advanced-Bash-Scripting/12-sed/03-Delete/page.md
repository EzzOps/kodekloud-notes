...
> **lightbulb** Wrap your script in single quotes (e.g., `'d'`) so the shell interprets it literally.
...
> **triangle-alert** Address ranges must ascend (e.g., `3,5d`). Specifying `5,3d` is invalid and will have no effect.
