...
Source: https://notes.kodekloud.com/docs/Advanced-Bash-Scripting/Conventions/Overview/page

This guide covers shell scripting conventions to enhance readability, maintainability, and collaboration through consistent coding styles.
...
* Use lowercase, snake\_case for variable names (e.g., `user_home`)
* Prefix boolean flags with `is_` or `has_` (e.g., `is_enabled`)
* Name functions with verbs and snake\_case (e.g., `backup_database`)
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/advanced-bash-scripting/module/06219b3e-dc63-404c-a9df-3ea035628308/lesson/06ce12d2-8a88-4ce3-b13d-08f3116b2f41" />
</CardGroup>
