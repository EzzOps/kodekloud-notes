...
Source: https://notes.kodekloud.com/docs/Advanced-Bash-Scripting/Streams/printf/page

This article explains the `printf` command in Unix-like systems, highlighting its formatting capabilities and differences from `echo`.
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/advanced-bash-scripting/module/d972cdb8-d83f-4d2a-bf89-4d4b38161cf2/lesson/30efe781-54b5-483d-8d6b-0603d8840018" />

  <Card title="Practice Lab" icon="installation" href="https://learn.kodekloud.com/user/courses/advanced-bash-scripting/module/d972cdb8-d83f-4d2a-bf89-4d4b38161cf2/lesson/7fbf07e3-7844-4c27-a2b1-bc6f02cad7a6" />
</CardGroup>
