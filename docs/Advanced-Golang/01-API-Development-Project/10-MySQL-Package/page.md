...
Source: https://notes.kodekloud.com/docs/Advanced-Golang/API-Development-Project/MySQL-Package/page

Learn to integrate a MySQL database into your Go project using the SQL package for common database operations.
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/advanced-golang/module/483ddd82-96d2-43d5-a9a8-e27e8cdb064d/lesson/b97bd475-d619-407c-877d-fc7582120ca8" />
</CardGroup>
