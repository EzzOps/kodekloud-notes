...
Source: https://notes.kodekloud.com/docs/Advanced-Golang/Modules-Packages-and-Imports/Creating-and-accessing-a-package/page

Learn to create a Go module with packages for encryption and decryption, implementing a simple ASCII shifting encryption function.
...
> **lightbulb** The `go.mod` file defines your module’s dependencies and version. Ensure that the module path is aligned with your repository.
...
> **lightbulb** Remember, functions that need to be accessible from other packages must start with an uppercase letter.
