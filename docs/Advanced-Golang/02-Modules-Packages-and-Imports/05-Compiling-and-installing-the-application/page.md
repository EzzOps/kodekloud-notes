...
Source: https://notes.kodekloud.com/docs/Advanced-Golang/Modules-Packages-and-Imports/Compiling-and-installing-the-application/page
...
> **lightbulb** If your current shell prompt is not within the directory that contains the executable, you will need to provide the full path to run it. For instance, running `./cryptit` from your home directory might result in an error like:
