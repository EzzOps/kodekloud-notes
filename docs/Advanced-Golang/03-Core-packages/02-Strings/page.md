...
Source: https://notes.kodekloud.com/docs/Advanced-Golang/Core-packages/Strings/page
...
> **lightbulb** Remember that the check is case sensitive. Ensure that both the string and the substring have matching cases for accurate results.
...
> **lightbulb** The Contains method checks for an exact match. Adjust your substring accordingly to ensure accurate results.
