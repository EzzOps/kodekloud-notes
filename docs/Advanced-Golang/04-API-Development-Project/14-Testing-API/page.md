...
Source: https://notes.kodekloud.com/docs/Advanced-Golang/API-Development-Project/Testing-API/page
...
> **lightbulb** Using dynamic credentials improves flexibility by letting you create separate configurations for production and testing environments.
...
> **lightbulb** Using a dedicated test database ensures that your testing operations do not affect live production data. Always isolate your testing environment from production.
