...
Source: https://notes.kodekloud.com/docs/Advanced-Golang/CICD-pipeline/CICD-pipeline-for-Go-app-with-Github-actions-and-docker/page

This guide demonstrates publishing an API module and establishing a CI/CD pipeline for a Go application using GitHub Actions and Docker.
...
You'll see your untracked Go and test files, such as app.go, app\_test.go, constants.go, go.mod, go.sum, main.go, and model.go. Add and commit these files using:
...
> **lightbulb** If you experience issues with the MySQL setup step in your workflow, it may be due to improper quote usage in the command that alters the user password. Ensure you are using matching quotes.
