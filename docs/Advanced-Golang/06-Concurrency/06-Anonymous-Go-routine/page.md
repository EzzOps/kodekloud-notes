...
Source: https://notes.kodekloud.com/docs/Advanced-Golang/Concurrency/Anonymous-Go-routine/page
...
> **lightbulb** Ensure that the main Goroutine sleeps long enough to allow the anonymous Goroutine to complete its execution. Otherwise, the program may terminate before the concurrent task finishes.
