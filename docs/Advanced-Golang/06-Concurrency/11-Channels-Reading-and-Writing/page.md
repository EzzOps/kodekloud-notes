...
Source: https://notes.kodekloud.com/docs/Advanced-Golang/Concurrency/Channels-Reading-and-Writing/page

Learn to use channels in Go for communication between goroutines, including creation, data transmission, and blocking behavior. Ideal for concurrent programming.
...
> **lightbulb** A channel in Go is passed by reference, similar to slices or maps. Therefore, you do not need to use the ampersand (`&`) or asterisk (`*`) operators.
...
> **triangle-alert** Remember that because goroutines run concurrently, the ordering of the printed messages after unblocking may vary with each execution.
