...
Source: https://notes.kodekloud.com/docs/Advanced-Golang/Concurrency/Channels-Closing-a-channel/page

Learn how to properly close a channel in Go and understand the behavior of channels upon closure.
...
> **lightbulb** In Go, closing a channel does not clear its buffered values; any remaining buffered data can still be received after closing.
...
> **triangle-alert** Attempting to send data to a closed channel will cause a runtime panic. Always ensure you close a channel only when you're certain no further data will be transmitted.
