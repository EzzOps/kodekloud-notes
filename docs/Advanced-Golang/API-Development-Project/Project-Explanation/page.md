...
Source: https://notes.kodekloud.com/docs/Advanced-Golang/API-Development-Project/Project-Explanation/page

This article explains developing an API server to manage product information using a database with five RESTful API endpoints.
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/advanced-golang/module/483ddd82-96d2-43d5-a9a8-e27e8cdb064d/lesson/f6cdd803-248b-48b3-9219-39b736b475f1" />
</CardGroup>
