...
> **lightbulb** `libraryResource` loads the resource as a string. To execute a shell script you must write it to the workspace (e.g., using `writeFile`) and set executable permissions before running it.
