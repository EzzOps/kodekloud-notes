...
<Callout icon="warning">
  Back up `secrets/` and encryption keys securely. Backups that expose `master.key`, `hudson.util.Secret`, or SSH keys must be encrypted at rest and access-controlled. Leaked backups can expose credentials and lead to compromise.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/advanced-jenkins/module/6f55f1ac-064a-4aec-a91a-450caaf82d63/lesson/77cca9ec-482c-47bf-9502-2f92b8d3e025" />
</CardGroup>
