...
> **lightbulb** Network ACLs are **stateless**: you must explicitly configure both inbound and outbound rules to allow return traffic. In contrast, Security Groups are stateful and automatically permit responses.
