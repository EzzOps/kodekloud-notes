...
> **lightbulb** Make sure you have the [AWS CLI](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) installed and configured with valid credentials. Set your default region with `aws configure` or by exporting the `AWS_DEFAULT_REGION` environment variable.
...
> **triangle-alert** Running EC2 instances incurs AWS charges. Always terminate resources you no longer need:
