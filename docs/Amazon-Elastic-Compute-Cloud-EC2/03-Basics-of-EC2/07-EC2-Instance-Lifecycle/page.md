...
> **triangle-alert** Sending a terminate command is **irreversible**. Ensure you’ve backed up any critical data on instance-store volumes or unencrypted EBS volumes before terminating.
