...
> **lightbulb** Instances with IAM roles receive short-lived credentials from the metadata service. This eliminates the need to store access keys on disk.
...
> **triangle-alert** Enable and enforce IMDSv2 on your instances to protect against SSRF attacks. See [AWS IMDSv2 documentation](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/configuring-instance-metadata-service.html).
