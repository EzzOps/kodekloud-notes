...
Source: https://notes.kodekloud.com/docs/Amazon-Elastic-Compute-Cloud-EC2/EC2-Advanced/Launch-template/page

This article explores AWS EC2 launch templates for standardizing and streamlining instance provisioning through reusable configuration blocks.
...
> **lightbulb** Each version is immutable—once created, you cannot modify it. Instead, create a new version to apply updates.
...
> **triangle-alert** Launching too many template versions can lead to clutter. Regularly clean up unused versions to stay organized.
