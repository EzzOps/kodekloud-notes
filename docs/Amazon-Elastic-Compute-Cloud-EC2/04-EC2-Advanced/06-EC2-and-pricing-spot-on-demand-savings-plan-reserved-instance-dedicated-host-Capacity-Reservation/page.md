...
Source: https://notes.kodekloud.com/docs/Amazon-Elastic-Compute-Cloud-EC2/EC2-Advanced/EC2-and-pricing-spot-on-demand-savings-plan-reserved-instance-dedicated-host-Capacity-Reservation/page

This article explores AWS EC2 pricing models to optimize cloud spending and align infrastructure costs with application growth and usage patterns.
...
> **lightbulb** Spot Instances are ideal for workloads that can gracefully handle interruptions. Consider integrating checkpointing or auto-scaling to reduce impact.
...
> **lightbulb** Savings Plans automatically apply your commitment to the lowest-cost usage across eligible instance types.
...
> **triangle-alert** You are billed for your reserved capacity whether or not you run instances. Apply RIs or Savings Plans to offset reservation costs.
