...
> **lightbulb** Tag each AMI with metadata (version, build date, environment) and use [AWS Launch Templates](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-launch-templates.html) to ensure consistent instance provisioning.
