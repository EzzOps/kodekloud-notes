...
Source: https://notes.kodekloud.com/docs/Amazon-Elastic-Compute-Cloud-EC2/EC2-Real-Life-Problems-and-Solutions/Mandatory-best-practice-Part-2/page

This article discusses best practices for designing stateless applications on Amazon EC2 to ensure availability, scalability, and seamless user experiences.
...
> **lightbulb** Offloading session data to a centralized store (like Redis or DynamoDB) is a key pillar of stateless design. This setup allows any instance to handle any user request at any time.
...
> **triangle-alert** Storing sensitive data in Redis without encryption can expose user information. Always enable **encryption in transit** and **at rest**, and restrict access via **Security Groups** and **ACLs**.
