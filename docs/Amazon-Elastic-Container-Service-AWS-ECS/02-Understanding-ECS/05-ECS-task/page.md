...
Source: https://notes.kodekloud.com/docs/Amazon-Elastic-Container-Service-AWS-ECS/Understanding-ECS/ECS-task/page

This article explores the essential components required to configure an ECS task, starting with the ECS task definition file.
...
> **lightbulb** Before diving into the task definition, ensure your application is dockerized successfully using a Dockerfile. Once you build your Docker image, you can upload it to Docker Hub or your preferred container repository.
...
> **lightbulb** Think of a Docker image as the blueprint for a container. In a similar manner, the ECS task definition provides the blueprint for how your container should operate. The running container, or ECS task, is the instantiated version of that blueprint.
