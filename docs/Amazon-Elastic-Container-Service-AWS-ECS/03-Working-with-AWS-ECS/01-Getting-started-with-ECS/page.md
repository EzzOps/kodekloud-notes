...
> **warning** Public container images are convenient for demos, but avoid using unvetted public images in production. Always validate or build your own images, scan for vulnerabilities, and control image sources via private registries or IAM-based access.
