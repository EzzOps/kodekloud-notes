...
Source: https://notes.kodekloud.com/docs/Amazon-Elastic-Container-Service-AWS-ECS/Deploying-a-new-application-from-scratch/Demo-Deploying-task-revisions/page

This guide explains how to update an application, rebuild a Docker image, and deploy it using Amazon ECS.
...
> **lightbulb** Forcing new deployment instructs ECS to pull the latest image and replace the old tasks with new ones.
...
> **lightbulb** A load balancer addresses the potential issue of changing IP addresses by providing a consistent endpoint. It automatically routes traffic to the updated task IP addresses after each deployment, ensuring uninterrupted client connectivity.
