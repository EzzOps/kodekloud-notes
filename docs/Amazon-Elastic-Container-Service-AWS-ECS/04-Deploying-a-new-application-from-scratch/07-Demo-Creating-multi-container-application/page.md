...
> **lightbulb** You can add an optional health check for MongoDB. For example:
...
> **lightbulb** Using "password" for MongoDB credentials is not secure and is used here solely for demonstration purposes.
