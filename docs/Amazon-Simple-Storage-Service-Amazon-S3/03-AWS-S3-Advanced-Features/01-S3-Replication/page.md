...
> **triangle-alert** AWS does not store your customer-provided key. If you lose the key, your data cannot be decrypted.
...
> **lightbulb** Replication Time Control (RTC) guarantees that new objects are copied within 15 minutes of creation. This feature incurs additional costs—see the [Amazon S3 Pricing](https://aws.amazon.com/s3/pricing/) page for details.
