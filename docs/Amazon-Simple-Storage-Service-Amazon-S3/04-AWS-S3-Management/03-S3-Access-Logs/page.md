...
Source: https://notes.kodekloud.com/docs/Amazon-Simple-Storage-Service-Amazon-S3/AWS-S3-Management/S3-Access-Logs/page

Amazon S3 server access logging captures detailed records for every request to a bucket, enabling auditing, debugging, and storage optimization.
...
> **triangle-alert** Storing and analyzing access logs may incur additional storage and request charges. Review your AWS billing dashboard to estimate costs.
...
* [Monitoring Amazon S3 server access logging][aws-logs]
