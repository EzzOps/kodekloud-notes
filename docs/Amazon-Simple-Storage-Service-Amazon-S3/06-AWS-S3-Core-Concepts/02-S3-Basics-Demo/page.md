...
> **lightbulb** By default, both buckets and objects are private. Use the **Open** button in the console (with your AWS credentials) to view private files, or adjust permissions for public access.
