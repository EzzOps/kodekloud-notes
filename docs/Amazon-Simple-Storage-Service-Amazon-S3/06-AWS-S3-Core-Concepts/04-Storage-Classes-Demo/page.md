...
> **lightbulb** Choosing the right storage class balances cost, durability, and retrieval time. Review [S3 pricing](https://aws.amazon.com/s3/pricing/) before proceeding.
...
> **triangle-alert** Archival classes (Glacier) incur retrieval fees and can take from minutes to hours.
