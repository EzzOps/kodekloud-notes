...
> **lightbulb** Before creating a bucket, verify the name’s availability. Bucket names must be globally unique and compliant with DNS naming conventions.
...
> **triangle-alert** Using `--force` is irreversible. All objects in the bucket will be permanently deleted.
