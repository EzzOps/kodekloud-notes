...
> **lightbulb** If you haven’t installed the AWS CLI, follow the [official AWS CLI installation guide](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html).
...
> **triangle-alert** Deleting objects is irreversible. Double-check the object key before running `aws s3 rm`.
