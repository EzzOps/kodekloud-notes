...
> **lightbulb** For further details on variable precedence and advanced usage, consult the [Ansible Documentation](https://docs.ansible.com/ansible/latest/user_guide/playbooks_variables.html).
