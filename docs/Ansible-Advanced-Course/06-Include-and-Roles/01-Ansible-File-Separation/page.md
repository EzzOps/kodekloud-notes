...
> **lightbulb** If your variable file is not located in one of Ansible’s default directories, you can still load external variables by using the `include_vars` module within your playbook.
