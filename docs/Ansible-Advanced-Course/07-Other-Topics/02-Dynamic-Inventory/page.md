...
Source: https://notes.kodekloud.com/docs/Ansible-Advanced-Course/Other-Topics/Dynamic-Inventory/page
...
> **lightbulb** Dynamic inventory allows Ansible to programmatically retrieve host and group data at runtime by querying external sources, such as CMDBs or cloud provider APIs. This eliminates the need for manual updates, ensuring that your inventory stays current.
...
> **lightbulb** In certification exams, you are not typically required to write such inventory scripts. However, you should understand how these scripts function and supply inventory data to Ansible.
...
> **lightbulb** Using the `ansible-inventory` command is an excellent way to troubleshoot issues with inventory variables and to ensure that your dynamic inventory is working as expected.
