...
> **lightbulb** You can combine conditions using logical operators. Use the `or` operator to execute a task if any condition is true, and `and` if all conditions must be met.
