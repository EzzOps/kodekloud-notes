...
> **lightbulb** In single-server scenarios, immediate task failure can be beneficial to prevent further misconfigurations or cascading errors.
...
> **lightbulb** Use `any_errors_fatal` when uniformity in deployment is critical, ensuring that any failure results in an immediate stop.
