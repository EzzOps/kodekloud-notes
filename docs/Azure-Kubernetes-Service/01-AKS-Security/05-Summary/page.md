...
<Frame>
  ![The image shows a webpage titled "Bookbuyer" displaying the total number of books bought (567), with 520 from bookstore V1 and 47 from bookstore V2. The current time is also shown at the bottom.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869447/notes-assets/images/Azure-Kubernetes-Service-Open-Service-Mesh/bookbuyer-total-books-bought-webpage.jpg)
</Frame>
