...
> **lightbulb** Hands-on practice is essential. We recommend using your own [Azure free account](https://azure.microsoft.com/free/) to follow along with the labs.
...
> **triangle-alert** Always restrict API server access and enable network policies to prevent unauthorized lateral movement within your cluster.
