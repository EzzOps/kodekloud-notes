...
<Frame>
  ![The image shows a web page titled "KodeKloudApp" with a welcome message and a highlighted text saying "Message: Hello World from VIM !!!". The page includes links to "Home" and "Privacy".](../../../../images/kodekloud.com/kk-media/image/upload/v1752869451/notes-assets/images/Azure-Kubernetes-Service-Containerizing-the-application/kodekloudapp-welcome-message-hello-world.jpg)
</Frame>
