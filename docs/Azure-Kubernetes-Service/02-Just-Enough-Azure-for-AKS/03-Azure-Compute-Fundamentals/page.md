...
> **lightbulb** For detailed specifications and regional availability, visit [Azure VM Sizes](https://aka.ms/azure-vm-sizes).
...
> **triangle-alert** Selecting an unsupported VM size for your AKS cluster can lead to scheduling failures. Always verify compatibility in the [AKS VM compatibility guide](https://docs.microsoft.com/azure/aks/quotas-skus-regions).
