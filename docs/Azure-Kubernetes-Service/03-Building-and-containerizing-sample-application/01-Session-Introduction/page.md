...
Source: https://notes.kodekloud.com/docs/Azure-Kubernetes-Service/Building-and-containerizing-sample-application/Session-Introduction/page

This module teaches how to scaffold, containerize, and deploy an ASP.NET Core Razor Pages application using Docker and Azure Kubernetes Service.
...
> **lightbulb** Ensure Docker Desktop is running before you build or pull any images.
...
> **lightbulb** You can browse [Docker Hub](https://hub.docker.com) and search for `yourrepo/kodekloudapp` to verify the image and get the exact pull command.
