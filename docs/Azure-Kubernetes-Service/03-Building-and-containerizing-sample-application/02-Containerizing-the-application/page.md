...
> **lightbulb** Containers are ephemeral. Any file changes made inside will be lost if the container is removed.
...
> **triangle-alert** Editing configuration inside a running container is ideal for demos and debugging—but **not** for production. Prefer mounting configuration files or injecting environment variables instead.
