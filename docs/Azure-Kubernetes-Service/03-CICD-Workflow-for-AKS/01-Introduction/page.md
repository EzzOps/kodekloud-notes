...
<Frame>
  ![The image compares imperative and declarative approaches to Kubernetes deployment, highlighting specific commands and defined steps for imperative, and YAML/JSON manifests for declarative.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869453/notes-assets/images/Azure-Kubernetes-Service-Introduction/kubernetes-deployment-imperative-declarative-comparison.jpg)
</Frame>
...
<Frame>
  ![The image is a comparison of the pros and cons of imperative Kubernetes deployment. Pros include fine-grained control and flexibility, while cons highlight being more error-prone and lacking idempotency.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869454/notes-assets/images/Azure-Kubernetes-Service-Introduction/kubernetes-imperative-deployment-pros-cons.jpg)
</Frame>
