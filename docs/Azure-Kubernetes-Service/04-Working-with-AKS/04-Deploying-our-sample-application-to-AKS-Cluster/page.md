...
Source: https://notes.kodekloud.com/docs/Azure-Kubernetes-Service/Working-with-AKS/Deploying-our-sample-application-to-AKS-Cluster/page
...
> **lightbulb** All Azure CLI commands shown here work in [Azure Cloud Shell](https://shell.azure.com), Windows PowerShell, macOS, and Linux terminals. Replace any Windows-specific paths or syntax as needed on other platforms.
...
> **triangle-alert** Replace `20.50.123.456` with your actual `EXTERNAL-IP`. It can take a minute for Azure to provision the public IP.
