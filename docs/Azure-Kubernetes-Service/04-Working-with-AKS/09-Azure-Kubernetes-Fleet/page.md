...
> **lightbulb** Multicluster setups introduce operational overhead. Evaluate your tenancy, compliance, and scale requirements before proceeding.
...
> **triangle-alert** KubeFed v2 is no longer actively developed. Consider alternative projects for production use.
...
> **lightbulb** You need an Azure subscription with required permissions to create and manage fleet resources.
