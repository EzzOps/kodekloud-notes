...
> **lightbulb** You can enable the Defender plan only for container workloads while keeping other services on the free CSPM tier.
...
> **triangle-alert** Ensure your network security groups and firewalls allow outbound port 443 from AKS nodes for Defender data upload.
