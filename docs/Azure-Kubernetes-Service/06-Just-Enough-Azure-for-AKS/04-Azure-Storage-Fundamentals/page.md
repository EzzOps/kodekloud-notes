...
Source: https://notes.kodekloud.com/docs/Azure-Kubernetes-Service/Just-Enough-Azure-for-AKS/Azure-Storage-Fundamentals/page

This article explains Azure Storage services including Block, File, and Object Storage for various storage needs.
...
<Frame>
  ![The image illustrates three Azure storage categories: Block Storage (Azure Disk Storage), Object Storage (Azure Blob and Data Lake Storage), and File Storage (Azure Files and Azure NetApp Files).](../../../../images/kodekloud.com/kk-media/image/upload/v1752869477/notes-assets/images/Azure-Kubernetes-Service-Azure-Storage-Fundamentals/azure-storage-categories-diagram.jpg)
</Frame>
...
<Frame>
  ![The image compares different types of block storage (HDD, Standard SSD, Premium SSD, Premium SSD V2, Ultra Disk) based on IOPS and throughput in MB/s.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869478/notes-assets/images/Azure-Kubernetes-Service-Azure-Storage-Fundamentals/block-storage-comparison-iops-throughput.jpg)
</Frame>
...
<Frame>
  ![The image compares two file storage options: "Standard" with 300 MBps and "Premium" with 10 GBps, highlighting differences in latency and pricing. It also shows a storage capacity indicator from 100 GB to 1 TB.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869479/notes-assets/images/Azure-Kubernetes-Service-Azure-Storage-Fundamentals/file-storage-comparison-standard-premium.jpg)
</Frame>
...
<Frame>
  ![The image illustrates a concept of "Geo-zone Redundant" object storage durability, showing a region with multiple availability zones represented by cylindrical icons.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869480/notes-assets/images/Azure-Kubernetes-Service-Azure-Storage-Fundamentals/geo-zone-redundant-storage-durability.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/azure-kubernetes-service/module/4a7168ba-8262-47d0-a9de-7a4342b0b0f6/lesson/22b9ff96-ad61-48ba-800e-0a710e9ab168" />
</CardGroup>
