...
Source: https://notes.kodekloud.com/docs/Azure-Kubernetes-Service/Just-Enough-Azure-for-AKS/Session-Introduction/page

This module introduces Microsoft Azures core services and architecture best practices for building, deploying, and managing applications and infrastructure.
...
| Module                      | Overview                                                                           |
| --------------------------- | ---------------------------------------------------------------------------------- |
| Azure Landing Zone          | Framework for governance, networking, identity, and security                       |
...
<Frame>
  ![The image shows an agenda with five topics related to Azure services, including Landing Zone, Compute, Storage, Network & Security, and Database offering. Each topic is accompanied by an icon, and the background is a gradient of blue.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869487/notes-assets/images/Azure-Kubernetes-Service-Session-Introduction/azure-services-agenda-topics-icons.jpg)
</Frame>

## Links and References

* [Azure Landing Zones Documentation](https://docs.microsoft.com/azure/cloud-adoption-framework/ready/landing-zone/)
* [Azure Compute Services Overview](https://docs.microsoft.com/azure/architecture/)
* [Azure Storage Documentation](https://docs.microsoft.com/azure/storage/)
* [Azure Networking Fundamentals](https://docs.microsoft.com/azure/networking/)
* [Azure Database Services](https://docs.microsoft.com/azure/azure-sql/)

<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/azure-kubernetes-service/module/4a7168ba-8262-47d0-a9de-7a4342b0b0f6/lesson/b333c7a4-b157-4d6b-ad88-72745588467e" />
</CardGroup>
