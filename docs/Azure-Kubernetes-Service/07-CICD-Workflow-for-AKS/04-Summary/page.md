...
> **lightbulb** Make sure your current context points to the correct AKS cluster. Use `kubectl config current-context` to check.
...
> **triangle-alert** If you switch to `type: NodePort`, ensure `nodePort` values are in the 30000–32767 range.
