...
Source: https://notes.kodekloud.com/docs/Azure-Kubernetes-Service/Close-out/Conclusion/page
...
> **triangle-alert** Don’t forget to delete your AKS cluster and associated resources using the Azure Portal or CLI (`az group delete`) to avoid unexpected charges.

> **lightbulb** Advance your skills by exploring:
...
- [Watch Video](https://learn.kodekloud.com/user/courses/azure-kubernetes-service/module/ee946e5f-161f-4c37-acff-b9a805538288/lesson/2dcab6de-46d3-4094-ba45-36e45677248a)
