...
<Callout icon="lightbulb">
  Grant only the permissions your Lambda function needs. Start with the managed policy `service-role/AWSLambdaBasicExecutionRole` for CloudWatch Logs, then narrow permissions with a custom inline or managed policy to follow the principle of least privilege.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/cdk-for-terraform-with-typescript/module/4625ff69-dbd8-42ac-9542-d0e60a85e2ae/lesson/6099b48a-109c-4a8c-88b7-3c38e290379a" />
</CardGroup>
