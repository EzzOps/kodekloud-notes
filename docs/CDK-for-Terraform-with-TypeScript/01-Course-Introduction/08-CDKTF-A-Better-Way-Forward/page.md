...
> **lightbulb** CDKTF bridges the gap between application developers and infrastructure operators: you gain the expressiveness and tooling available in general-purpose languages while retaining Terraform’s robust provider ecosystem and execution model.
