...
> **lightbulb** If you're new to TypeScript, prefer the `tsconfig.json` that comes with your framework or starter project. It will usually have sensible defaults.
