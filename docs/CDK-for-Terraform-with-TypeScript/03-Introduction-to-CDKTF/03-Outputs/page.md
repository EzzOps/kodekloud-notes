...
> **lightbulb** Define outputs after creating the resources they reference. Keep a reference to the resource (for example `readmeFile`) so you can access attributes like `readmeFile.content` when constructing `TerraformOutput`.
