...
<Callout icon="warning">
  Deploying cloud resources can incur AWS charges. Use the provided lab accounts or the free tier when possible and remember to destroy resources after use (`cdktf destroy` or the AWS console).
</Callout>
