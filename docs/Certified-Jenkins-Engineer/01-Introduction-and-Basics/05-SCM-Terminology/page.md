...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/2e8ea9bb-e5bb-428e-85d9-89f2eb816adb/lesson/ed0284be-2a62-429b-acb0-3d2ffbd53e23)
...
> **lightbulb** Use clear, descriptive branch names (e.g., `feature/payment-api`) to make pull request reviews and CI/CD tracking easier.
...
> **triangle-alert** Never push directly to the protected `main` branch. Always open a pull request to enforce code reviews, automated testing, and compliance checks.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/2e8ea9bb-e5bb-428e-85d9-89f2eb816adb/lesson/c0cd6177-dafd-4daf-9144-72c719c2d275)
