...
<Frame>
  ![The image shows a webpage from the AWS CLI Command Reference, specifically detailing the "update-function-configuration" command for AWS Lambda. It includes sections like description, synopsis, options, and examples.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870277/notes-assets/images/Certified-Jenkins-Engineer-Demo-Update-Lambda-Configuration/aws-cli-update-function-configuration.jpg)
</Frame>
