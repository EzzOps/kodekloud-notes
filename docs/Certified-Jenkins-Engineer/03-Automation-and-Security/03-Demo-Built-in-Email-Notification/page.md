...
<Frame>
  ![The image shows a Jenkins configuration screen for a project named "npm-version-test," focusing on the "Post-build Actions" section where email notifications are set up for build status updates.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870335/notes-assets/images/Certified-Jenkins-Engineer-Demo-Built-in-Email-Notification/jenkins-npm-version-test-email-notifications.jpg)
</Frame>
...
<Frame>
  ![The image shows the email notification configuration settings in Jenkins, with fields for SMTP server, default user email suffix, and options for SMTP authentication, SSL, and TLS.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870337/notes-assets/images/Certified-Jenkins-Engineer-Demo-Built-in-Email-Notification/jenkins-email-notification-settings.jpg)
</Frame>

3. Click **Test Configuration**:

<Frame>
  ![The image shows a configuration screen in Jenkins for setting up SMTP email settings, including fields for username, password, SSL, and SMTP port.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870338/notes-assets/images/Certified-Jenkins-Engineer-Demo-Built-in-Email-Notification/jenkins-smtp-email-configuration.jpg)
</Frame>
...
<Frame>
  ![The image shows a Google Account page for managing app passwords, with existing passwords listed and an option to create a new app-specific password named "jenkins-email."](../../../../images/kodekloud.com/kk-media/image/upload/v1752870340/notes-assets/images/Certified-Jenkins-Engineer-Demo-Built-in-Email-Notification/google-account-app-passwords-management.jpg)
</Frame>

4. Copy the 16-character app password.

<Frame>
  ![The image shows a Google Account page with a pop-up displaying a generated app password and instructions on how to use it.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870342/notes-assets/images/Certified-Jenkins-Engineer-Demo-Built-in-Email-Notification/google-account-app-password-popup.jpg)
</Frame>
...
<Frame>
  ![The image shows a Jenkins configuration page where the user is setting the Jenkins URL and the system admin email address. There is a warning to set a valid host name instead of "localhost."](../../../../images/kodekloud.com/kk-media/image/upload/v1752870344/notes-assets/images/Certified-Jenkins-Engineer-Demo-Built-in-Email-Notification/jenkins-configuration-url-email-warning.jpg)
</Frame>

You’ll receive another test email showing the updated **From** address:

<Frame>
  ![The image shows a Gmail interface with an open email labeled "Test email #3" from "sid demos." A contact card is displayed, showing options to send mail and view details.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870344/notes-assets/images/Certified-Jenkins-Engineer-Demo-Built-in-Email-Notification/gmail-interface-test-email-sid-demos.jpg)
</Frame>
...
<Frame>
  ![The image shows a Jenkins dashboard for a project named "npm-version-test," displaying build history and permalinks for recent builds. The sidebar includes options like "Build Now," "Configure," and "Delete Project."](../../../../images/kodekloud.com/kk-media/image/upload/v1752870346/notes-assets/images/Certified-Jenkins-Engineer-Demo-Built-in-Email-Notification/jenkins-dashboard-npm-version-test-2.jpg)
</Frame>
...
<Frame>
  ![The image shows an email notification in Gmail about a Jenkins build failure for "npm-version-test #10," including details of the build process and error message.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870347/notes-assets/images/Certified-Jenkins-Engineer-Demo-Built-in-Email-Notification/gmail-jenkins-build-failure-notification.jpg)
</Frame>
