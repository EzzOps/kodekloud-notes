...
> **lightbulb** Use `script` sparingly. Most tasks can be handled with declarative steps or existing plugins.
...
> **triangle-alert** Never print credentials or secrets to the console. Always use the Jenkins credentials store and the appropriate binding methods.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/054c2c42-f54a-42a4-ab39-4b432a36aaa1/lesson/c93ac078-4d03-4191-bb8f-7deae5a5e163)
