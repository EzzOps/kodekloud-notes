...
> **triangle-alert** If Jenkins enforces CSRF protection, you will receive a `403 No valid crumb` error unless you include a valid crumb header.
...
> **lightbulb** Always authenticate using an API token and set `Content-Type: text/xml` when sending XML payloads.

Once the request completes, navigate to **Manage Jenkins → Manage Plugins → Advanced** to monitor download progress:

![The image shows a Jenkins interface displaying the download progress of various plugins, all marked as successful. The left sidebar includes options like Updates, Available plugins, Installed plugins, and Advanced settings.](https://kodekloud.com/kk-media/image/upload/v1752870400/notes-assets/images/Certified-Jenkins-Engineer-Demo-Jenkins-REST-API-install-a-plugin/jenkins-plugin-download-progress-interface.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/4d6d1f39-307c-4fdb-8d2b-834c1650e792/lesson/cac5f86b-dc77-47d4-9f55-f0c0f54823bd)
