...
> **lightbulb** By default, the SSH server is disabled in Jenkins, so you won’t see the `X-SSH-Endpoint` header until it’s enabled.
...
> **triangle-alert** If you choose a fixed port, make sure it’s open in your firewall and not in use by another service.
