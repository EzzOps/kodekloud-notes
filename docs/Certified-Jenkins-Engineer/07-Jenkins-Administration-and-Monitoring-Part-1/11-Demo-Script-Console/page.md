...
<Frame>
  ![The image shows a Jenkins dashboard with a dropdown menu open, displaying various options like "New Item," "Build History," and "Script Console." The background lists different Jenkins jobs with their statuses and execution times.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870651/notes-assets/images/Certified-Jenkins-Engineer-Demo-Script-Console/jenkins-dashboard-dropdown-menu.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub repository page for "jenkinsci/jenkins-scripts" with a list of Groovy script files and their last commit messages.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870653/notes-assets/images/Certified-Jenkins-Engineer-Demo-Script-Console/github-repo-jenkins-scripts-groovy.jpg)
</Frame>
...
<Frame>
  ![This image shows a GitHub repository page for "jenkins-script-console-scripts" by "samrocketman," featuring a list of files and directories related to Jenkins script console scripts. The repository is public and includes details like the number of stars, forks, and commits.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870654/notes-assets/images/Certified-Jenkins-Engineer-Demo-Script-Console/jenkins-script-console-repo-samrocketman.jpg)
</Frame>
