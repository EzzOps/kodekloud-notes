...
> **lightbulb** NPM Audit supports four severity levels: `low`, `moderate`, `high`, and `critical`.\
...
> **triangle-alert** Builds will now fail if `critical` vulnerabilities exceed your defined threshold.\
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/73d0066f-a01f-4d13-a00c-c9baf9aae603/lesson/f3ae0d17-31fb-40be-ad10-0a3056474a61)
...
> **triangle-alert** Storing sensitive connection strings directly in the `Jenkinsfile` exposes them in plaintext. Use [Jenkins Credentials](#managing-jenkins-credentials) for usernames and passwords.
...
> **lightbulb** The `junit` step will fail the build if no XML files are found unless you set `allowEmptyResults: true`.\
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/73d0066f-a01f-4d13-a00c-c9baf9aae603/lesson/d6aa8774-59d8-44fb-bcbb-97911b4b0c3d)
