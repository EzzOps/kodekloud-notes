...
> **lightbulb** Refer to the [Pipeline Syntax documentation](https://www.jenkins.io/doc/book/pipeline/syntax/) for an up-to-date list of directives you can use.

![The image shows a webpage from the Jenkins documentation, specifically detailing pipeline syntax options. It includes a navigation menu on the left and descriptions of various pipeline options on the right.](https://kodekloud.com/kk-media/image/upload/v1752871090/notes-assets/images/Certified-Jenkins-Engineer-Demo-Using-Options-Directive/jenkins-pipeline-syntax-documentation.jpg)
...
![The image shows a Jenkins build pipeline for "Build #14" with various stages, including "Checkout SCM," "Tool Install," and "Unit Testing," where the build has failed at the "Unit Testing" stage.](https://kodekloud.com/kk-media/image/upload/v1752871091/notes-assets/images/Certified-Jenkins-Engineer-Demo-Using-Options-Directive/jenkins-build-pipeline-failed-unit-testing.jpg)
...
![The image shows a Jenkins pipeline interface for a project named "solar-system," displaying the progress of a build process with steps like "Installing Dependencies" and "Dependency Scanning." The current step is "Installing Dependencies," with several completed tasks and one ongoing task labeled "sleep 100s."](https://kodekloud.com/kk-media/image/upload/v1752871093/notes-assets/images/Certified-Jenkins-Engineer-Demo-Using-Options-Directive/jenkins-pipeline-solar-system-build.jpg)
...
> **triangle-alert** Using `disableResume()` will remove the ability to resume pipeline execution after a Jenkins restart. Use it only if you have idempotent stages or external state management.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/73d0066f-a01f-4d13-a00c-c9baf9aae603/lesson/ba134466-caa5-4ca2-b72e-dd1c2f0d1393)
