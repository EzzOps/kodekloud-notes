...
> **lightbulb** Quality Gates enforce your code quality standards automatically. Failing criteria (e.g., coverage, duplications, maintainability) will mark the gate as failed.
...
> **triangle-alert** Avoid using tokens without expiration in production. Rotate your tokens regularly.
...
> **lightbulb** Since SonarQube doesn’t return the Quality Gate status to Jenkins by default, your pipeline may remain green. In the next tutorial, we’ll configure the [SonarQube Quality Gate plugin](https://docs.sonarqube.org/latest/analysis/scan/sonarscanner-for-jenkins/) to fail builds when the gate fails.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/7214771c-8a65-4b34-94a9-43665202a4e4/lesson/a2542195-f04e-405c-b493-e2730afb6127)
