...
> **lightbulb** Using `when` conditions can help you skip unnecessary stages, save build time, and reduce resource consumption.
...
> **triangle-alert** Avoid placing expensive computations or external calls in `expression` blocks—they run during pipeline evaluation and can slow down the build.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/e16e4b93-31c4-479b-96b8-f0d26cde31cd/lesson/6ee17ad3-2eb9-40a7-8b39-7abd44917da3)
