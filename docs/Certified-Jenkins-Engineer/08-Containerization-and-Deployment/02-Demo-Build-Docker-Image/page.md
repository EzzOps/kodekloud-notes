...
> **lightbulb** `GIT_COMMIT` is a built-in Jenkins variable provided when you use the `checkout` step. It resolves to the current commit SHA, ensuring each Docker image is uniquely tagged.
