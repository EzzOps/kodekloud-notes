...
<Frame>
  ![The image shows a Jenkins setup wizard screen with options to "Install suggested plugins" or "Select plugins to install."](../../../../images/kodekloud.com/kk-media/image/upload/v1752870848/notes-assets/images/Certified-Jenkins-Engineer-Demo-Running-the-Jenkins-WAR-as-a-standalone-application/jenkins-setup-wizard-plugins.jpg)
</Frame>
...
<Frame>
  ![The image shows a Jenkins system configuration page in a web browser, with options for setting the number of executors, usage preferences, and other settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870849/notes-assets/images/Certified-Jenkins-Engineer-Demo-System-Settings/jenkins-system-configuration-page.jpg)
</Frame>
