...
<Frame>
  ![The image shows a Jenkins system configuration page with settings for job config history and timestamp formatting. It includes options for system clock time format and elapsed time format.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870852/notes-assets/images/Certified-Jenkins-Engineer-Demo-Timestamp/jenkins-system-configuration-settings.jpg)
</Frame>
