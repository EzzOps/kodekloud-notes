...
> **triangle-alert** Do not hard-code AWS keys in your `Jenkinsfile`. Always use Jenkins Credentials and the `withAWS` wrapper.
...
> **lightbulb** Use double quotes for Groovy string interpolation (`"reports-$BUILD_ID"`).\
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/01d04ab3-0694-4c67-bd1a-c3eaaa8d64d3/lesson/3b9254df-756e-4605-9508-e064e897ec5d)
...
> **lightbulb** GitOps operators typically reconcile every few seconds. If you manually change resources in your cluster, the operator will revert them to match the Git state.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/01d04ab3-0694-4c67-bd1a-c3eaaa8d64d3/lesson/584239f7-4360-4a86-b401-6a649d9f9cb7)
