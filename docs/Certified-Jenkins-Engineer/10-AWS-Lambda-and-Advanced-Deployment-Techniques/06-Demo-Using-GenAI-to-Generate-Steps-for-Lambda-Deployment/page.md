...
> **triangle-alert** Setting `stopBuild: false` allows the pipeline to proceed despite critical vulnerabilities. Be sure to review the detailed report and address issues in your next sprint.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/7e65cc00-b745-498e-8351-c294cbe958ec/lesson/3758be02-627a-49c4-9b16-b470ccfff42b)
...
> **triangle-alert** Ensure that your Jenkins `aws-creds` credential has the necessary IAM permissions to create and update Lambda functions.
