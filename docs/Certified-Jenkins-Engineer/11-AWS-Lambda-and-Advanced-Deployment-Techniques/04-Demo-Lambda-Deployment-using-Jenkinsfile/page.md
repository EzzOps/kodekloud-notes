...
> **lightbulb** Removing environment variables here ensures that Jenkins controls all runtime settings securely.
...
> **lightbulb** Ensure the AWS credentials you reference (`aws-s3-ec2-lambda-creds`) have `s3:PutObject` and `lambda:UpdateFunctionCode` permissions.
...
> **triangle-alert** Without proper environment variables, your Lambda function will fail to connect to MongoDB.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/7e65cc00-b745-498e-8351-c294cbe958ec/lesson/cb882b28-99c4-43f0-9edb-5db9eff82bed)
