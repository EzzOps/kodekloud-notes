...
> **lightbulb** Ensure you have administrative access to your Jenkins controller. Install the [Build Monitor View Plugin](https://plugins.jenkins.io/build-monitor-plugin) via **Manage Plugins** and restart Jenkins if prompted.
...
![The image shows a Jenkins interface where a new view is being created, with options for different view types like "Build Monitor View" and "Dashboard." The view is named "Dasher CI Build Monitor View."](https://kodekloud.com/kk-media/image/upload/v1752870603/notes-assets/images/Certified-Jenkins-Engineer-Demo-Build-Monitor-View/jenkins-dasher-ci-build-monitor-view.jpg)
...
![The image shows a Jenkins configuration page for editing a view named "Dasher CI Build Monitor View," with options for filtering build queues and executors.](https://kodekloud.com/kk-media/image/upload/v1752870604/notes-assets/images/Certified-Jenkins-Engineer-Demo-Build-Monitor-View/jenkins-dasher-ci-build-monitor-view-2.jpg)
...
![The image shows a Jenkins build monitor view with various jobs displayed in different colors indicating their status: green for successful, red for failed, and orange for unstable. There is a settings panel on the right side for adjusting display options.](https://kodekloud.com/kk-media/image/upload/v1752870606/notes-assets/images/Certified-Jenkins-Engineer-Demo-Build-Monitor-View/jenkins-build-monitor-status-display.jpg)
...
![The image shows a Jenkins configuration page with job filters and a list of jobs, including "Generate ASCII Artwork" and various "Gitea-Organization" jobs. The build executor status indicates one job is sleeping.](https://kodekloud.com/kk-media/image/upload/v1752870607/notes-assets/images/Certified-Jenkins-Engineer-Demo-Build-Monitor-View/jenkins-configuration-job-filters.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/bf3ddc28-a03d-4738-9f98-2779d81482f5/lesson/95f4d38b-2c6b-461c-b202-d511d091c204)
