...
<Frame>
  ![The image shows a Jenkins dashboard for a project named "npm-version-test," displaying build status and history with options for configuration and project management.](../../../../images/kodekloud.com/kk-media/image/upload/v1752871060/notes-assets/images/Certified-Jenkins-Engineer-Demo-InstallSetup-NodeJS-Build-Tool/jenkins-dashboard-npm-version-test.jpg)
</Frame>
...
<Frame>
  ![The image shows a Jenkins interface with a search for "NodeJS" in the available plugins section, displaying the NodeJS plugin version 1.6.2.](../../../../images/kodekloud.com/kk-media/image/upload/v1752871062/notes-assets/images/Certified-Jenkins-Engineer-Demo-InstallSetup-NodeJS-Build-Tool/jenkins-nodejs-plugin-search-1-6-2.jpg)
</Frame>

Wait for the installation to complete:

<Frame>
  ![The image shows a Jenkins dashboard displaying the download progress of plugins, with all tasks marked as successful. The interface includes options for managing plugins and settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752871063/notes-assets/images/Certified-Jenkins-Engineer-Demo-InstallSetup-NodeJS-Build-Tool/jenkins-dashboard-plugin-download-progress.jpg)
</Frame>
...
<Frame>
  ![The image shows a Jenkins configuration screen for adding NodeJS, with options to install a specific version and configure global npm packages.](../../../../images/kodekloud.com/kk-media/image/upload/v1752871064/notes-assets/images/Certified-Jenkins-Engineer-Demo-InstallSetup-NodeJS-Build-Tool/jenkins-nodejs-configuration-screen.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/73d0066f-a01f-4d13-a00c-c9baf9aae603/lesson/adb86404-e404-46e0-9a10-42601b3a5a33" />
</CardGroup>
