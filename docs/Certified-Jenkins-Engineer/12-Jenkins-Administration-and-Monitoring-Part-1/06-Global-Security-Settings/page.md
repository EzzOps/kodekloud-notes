...
![The image is an infographic about markup formatting, highlighting security concerns like XSS attacks and suggesting security measures such as using plain text, safe HTML, and custom formatters in Jenkins.](https://kodekloud.com/kk-media/image/upload/v1752870673/notes-assets/images/Certified-Jenkins-Engineer-Global-Security-Settings/markup-formatting-security-infographic.jpg)
...
> **lightbulb** Plain text is ideal for high-security environments where formatting isn’t required.
...
> **triangle-alert** Even with Safe HTML, avoid embedding untrusted content. Review any custom tags allowed by your HTML sanitizer.
...
![The image is about CSRF protection in Jenkins, showing a configuration panel for a "Crumb Issuer" and explaining its use in form submissions and API calls. It includes an illustration of the Jenkins mascot and a special token labeled "crumb."](https://kodekloud.com/kk-media/image/upload/v1752870675/notes-assets/images/Certified-Jenkins-Engineer-Global-Security-Settings/csrf-protection-jenkins-crumb-issuer.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/bf3ddc28-a03d-4738-9f98-2779d81482f5/lesson/10ce6813-2dd0-4609-aa79-42939d610a7a)
