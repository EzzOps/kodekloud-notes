...
> **triangle-alert** Keeping every configuration change can consume significant disk space over time. Monitor the storage and adjust limits in the plugin settings section.
