...
> **lightbulb** Defining a `call` method lets you invoke `slackNotification()` directly in your pipeline like a built-in step.
...
> **triangle-alert** Ensure the Slack Notification plugin is installed and a valid Slack workspace credential is configured under **Manage Jenkins** > **Configure System**.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/b0fefde6-7fea-44da-9509-27007d27869f/lesson/2f33b720-48ca-43f7-a412-f9c769d8d056)
