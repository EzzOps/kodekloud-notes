...
<Frame>
  ![The image shows a Jenkins configuration screen for managing global trusted pipeline libraries, with options to set the library name, default version, and other settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752871101/notes-assets/images/Certified-Jenkins-Engineer-Demo-Load-TrivyScan-Library-in-Jenkins-Pipeline/jenkins-global-pipeline-libraries-config.jpg)
</Frame>
...
<Frame>
  ![The image shows a Jenkins interface displaying artifacts from a build pipeline, including a pipeline log and Trivy vulnerability reports.](../../../../images/kodekloud.com/kk-media/image/upload/v1752871102/notes-assets/images/Certified-Jenkins-Engineer-Demo-Load-TrivyScan-Library-in-Jenkins-Pipeline/jenkins-build-pipeline-artifacts.jpg)
</Frame>
