...
![The image is an overview of a "Shared Library," highlighting its benefits: encapsulating common tasks and making pipelines more concise and readable.](https://kodekloud.com/kk-media/image/upload/v1752871114/notes-assets/images/Certified-Jenkins-Engineer-Introduction-to-Shared-Libraries/shared-library-overview-benefits.jpg)
...
![The image is a slide titled "Why use Shared Library" with icons and labels for "Duplication," "Inconsistency," and "Complexity."](https://kodekloud.com/kk-media/image/upload/v1752871115/notes-assets/images/Certified-Jenkins-Engineer-Introduction-to-Shared-Libraries/why-use-shared-library-icons.jpg)

> **lightbulb** Following the **DRY (Don’t Repeat Yourself)** principle helps you write pipeline logic once and use it everywhere.
...
![The image outlines the steps to create a shared library in Jenkins, including repository setup, Jenkins configuration, writing custom steps, and integrating into pipelines.](https://kodekloud.com/kk-media/image/upload/v1752871117/notes-assets/images/Certified-Jenkins-Engineer-Introduction-to-Shared-Libraries/jenkins-shared-library-steps.jpg)
...
![The image shows a shared library repository structure with directories for source files, variables, and resources, including Groovy and JSON files.](https://kodekloud.com/kk-media/image/upload/v1752871118/notes-assets/images/Certified-Jenkins-Engineer-Introduction-to-Shared-Libraries/shared-library-repository-structure.jpg)
...
![The image shows a configuration screen for "Global Pipeline Libraries" with options for setting a library name, default version, and retrieval method. It includes checkboxes for various settings and a URL for a GitHub repository.](https://kodekloud.com/kk-media/image/upload/v1752871120/notes-assets/images/Certified-Jenkins-Engineer-Introduction-to-Shared-Libraries/global-pipeline-libraries-config.jpg)

> **triangle-alert** Ensure Jenkins has appropriate read permissions for your Shared Library repository.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/b0fefde6-7fea-44da-9509-27007d27869f/lesson/8a6eb6c9-043f-4db3-ab3c-dce38e2f3f1e)
