...
> **triangle-alert** Untrusted libraries run in the Groovy sandbox. If your code calls methods not whitelisted, you’ll see errors like:
...
> **lightbulb** `@Grab` works only in a trusted library (no sandbox). Attempting it in an untrusted library triggers sandbox violations and requires admin approval for each new method.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/b0fefde6-7fea-44da-9509-27007d27869f/lesson/277ada61-68b5-4f60-9403-09985a3e22bd)
