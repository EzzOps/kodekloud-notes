...
> **triangle-alert** Keep the `secret-file` secure. Exposing the JNLP secret allows unauthorized agents to connect.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/2175ebff-1a0f-4c0f-90ea-04e5fa96956f/lesson/34e5d199-7df1-4413-a04c-e9407edaee06)
...
> **lightbulb** Running Freestyle jobs on labeled agents is an easy way to direct platform-specific or dependency-heavy builds to machines prepared with the required environment.
...
> **lightbulb** Defining an `agent` inside a `stage` overrides the pipeline-level agent for that stage — useful for running platform-specific builds or tests on dedicated machines.
...
> **warning** Avoid running long-running or resource-intensive builds on the controller (master). Use labels to route those builds to dedicated agents to keep the controller responsive.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/2175ebff-1a0f-4c0f-90ea-04e5fa96956f/lesson/b51764ee-79f9-4a2f-ada8-f386a22ffe8a)
