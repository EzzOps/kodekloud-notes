...
<Frame>
  ![The image shows a webpage from the Jenkins plugins site, specifically detailing the "Audit Trail" plugin. It includes information on logger configuration, file logger, and syslog logger settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870696/notes-assets/images/Certified-Jenkins-Engineer-Demo-Install-and-Configure-Audit-Trail/jenkins-audit-trail-plugin-settings.jpg)
</Frame>
...
<Frame>
  ![The image shows a Jenkins system configuration page focused on setting up an audit trail, including log file rotation settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870699/notes-assets/images/Certified-Jenkins-Engineer-Demo-Install-and-Configure-Audit-Trail/jenkins-audit-trail-configuration.jpg)
</Frame>
