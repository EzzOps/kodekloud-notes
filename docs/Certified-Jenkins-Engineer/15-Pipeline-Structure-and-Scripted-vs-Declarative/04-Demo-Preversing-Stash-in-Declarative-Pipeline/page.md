...
![The image shows a Jenkins interface where a user is creating a new item named "stash-pipeline-demo" and selecting the item type, with options like Freestyle project, Pipeline, Multi-configuration project, and Folder.](https://kodekloud.com/kk-media/image/upload/v1752870995/notes-assets/images/Certified-Jenkins-Engineer-Demo-Preversing-Stash-in-Declarative-Pipeline/jenkins-new-item-stash-pipeline.jpg)
...
![The image shows a Jenkins dashboard for an agent named "ubuntu-agent," indicating that the agent is connected and displaying related labels and options.](https://kodekloud.com/kk-media/image/upload/v1752870996/notes-assets/images/Certified-Jenkins-Engineer-Demo-Preversing-Stash-in-Declarative-Pipeline/jenkins-dashboard-ubuntu-agent.jpg)
...
![The image shows a Jenkins dashboard displaying the status of a pipeline named "stash-pipeline-demo," with several build stages and their completion statuses.](https://kodekloud.com/kk-media/image/upload/v1752870997/notes-assets/images/Certified-Jenkins-Engineer-Demo-Preversing-Stash-in-Declarative-Pipeline/jenkins-dashboard-stash-pipeline-demo.jpg)
...
![The image shows a Jenkins interface with the "Declarative Directive Generator" section open, allowing users to generate pipeline code for a declarative pipeline directive. It includes options to preserve stashes from completed builds, with a setting to keep the most recent five builds' stashes.](https://kodekloud.com/kk-media/image/upload/v1752870998/notes-assets/images/Certified-Jenkins-Engineer-Demo-Preversing-Stash-in-Declarative-Pipeline/jenkins-declarative-directive-generator.jpg)
...
> **lightbulb** `preserveStashes(buildCount: 5)` retains stashes from the last 5 builds. Adjust `buildCount` according to your retention policy.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/956fce34-baa6-4655-a3cf-7b12d2364544/lesson/d9165081-d2ff-4b5d-829b-41ad497ec2a7)
