...
> **lightbulb** Jenkins may require a restart for these permission changes to take effect.
...
> **triangle-alert** Hiding the checkbox only affects the Jenkins UI. Users with sufficient permissions can still enable or disable the sandbox by:
...
![Jenkins security configuration with sandbox settings and hide checkbox option.](https://kodekloud.com/kk-media/image/upload/v1752870685/notes-assets/images/Certified-Jenkins-Engineer-Demo-Groovy-Sandbox-and-In-process-Script-Approval-Part-2/jenkins-security-configuration-sandbox.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/90da5b24-e8f2-455a-9756-9d69f4a7ce8e/lesson/4b1e2581-6238-4a37-a069-16b5cebcef99)
