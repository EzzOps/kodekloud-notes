...
> **lightbulb** Ensure the Jenkins service account has write permissions to `/var/log/jenkins`.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/90da5b24-e8f2-455a-9756-9d69f4a7ce8e/lesson/280126a6-f48e-4c12-a090-07081f216ec9)
...
> **triangle-alert** Increasing verbosity generates more log output and can impact controller performance due to higher disk and I/O usage. Only raise logging levels during active troubleshooting, and revert to defaults afterward.
...
![The image is a screenshot of a webpage providing instructions on adding a logger from the UI in Jenkins, with a step-by-step guide and a partial view of the Jenkins interface.](https://kodekloud.com/kk-media/image/upload/v1752870701/notes-assets/images/Certified-Jenkins-Engineer-Demo-Log-Recorder/jenkins-ui-logger-instructions.jpg)

> **lightbulb** Using the UI allows you to switch log levels at runtime without restarting Jenkins.
...
> **lightbulb** A 403 Forbidden often indicates missing RBAC permissions for the Jenkins service account.
...
![The image shows a Jenkins configuration interface with a dropdown menu open, displaying various options like "Credentials" and "System Log." There is also an error message related to Kubernetes client execution visible in red text.](https://kodekloud.com/kk-media/image/upload/v1752870703/notes-assets/images/Certified-Jenkins-Engineer-Demo-Log-Recorder/jenkins-configuration-dropdown-error.jpg)

![The image shows a Jenkins configuration screen for setting up a log recorder named "k8s-logs," with a dropdown menu for selecting log levels. A warning advises against setting the Root logger to "FINE" or below due to performance issues.](https://kodekloud.com/kk-media/image/upload/v1752870704/notes-assets/images/Certified-Jenkins-Engineer-Demo-Log-Recorder/jenkins-log-recorder-k8s-logs.jpg)

![The image shows a Jenkins configuration screen for setting up a log recorder, with a dropdown menu displaying Kubernetes-related logger options.](https://kodekloud.com/kk-media/image/upload/v1752870705/notes-assets/images/Certified-Jenkins-Engineer-Demo-Log-Recorder/jenkins-log-recorder-kubernetes-options.jpg)
...
![The image shows a configuration screen for Jenkins, specifically for setting up a Kubernetes cloud. It includes options for Kubernetes Namespace, Agent Docker Registry, and connection settings.](https://kodekloud.com/kk-media/image/upload/v1752870706/notes-assets/images/Certified-Jenkins-Engineer-Demo-Log-Recorder/jenkins-kubernetes-cloud-configuration.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/90da5b24-e8f2-455a-9756-9d69f4a7ce8e/lesson/12c47068-5340-4a07-bbbe-df121479166a)
