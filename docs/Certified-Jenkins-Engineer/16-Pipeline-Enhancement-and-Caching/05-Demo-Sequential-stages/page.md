...
<Callout icon="lightbulb">
  You’ll need Jenkins 2.x with Pipeline plugin 2.5 or later to use nested `stages` in a declarative pipeline.
</Callout>
...
<Frame>
  ![The image shows a Jenkins pipeline interface for a project named "solar-system" under "Gitea-Organization," displaying various stages like installing dependencies, unit testing, and building a Docker image. The pipeline is currently queued, waiting to start.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870977/notes-assets/images/Certified-Jenkins-Engineer-Demo-Sequential-stages/jenkins-pipeline-solar-system-gitea.jpg)
</Frame>
...
<Frame>
  ![The image shows a Visual Studio Code editor with a Jenkinsfile open, displaying stages for NodeJS, installing dependencies, and testing. The terminal at the bottom indicates an SSH connection to a Jenkins controller.](../../../../images/kodekloud.com/kk-media/image/upload/v1752870978/notes-assets/images/Certified-Jenkins-Engineer-Demo-Sequential-stages/visual-studio-code-jenkinsfile-nodejs.jpg)
</Frame>
...
<Callout icon="triangle-alert">
  This error originates from Node.js/npm and is not caused by Jenkins. Because `Install Dependencies` failed, the `Testing` stage was skipped—demonstrating how nested stages enforce correct execution order.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/49e48191-1afc-42bf-9ce5-b98f35b6a2fb/lesson/24796476-0204-42ba-ac20-63e9db857dad" />
</CardGroup>
