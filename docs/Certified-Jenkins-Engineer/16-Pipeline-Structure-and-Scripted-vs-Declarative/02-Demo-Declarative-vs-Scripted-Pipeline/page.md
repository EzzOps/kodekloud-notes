...
> **triangle-alert** Scripted Pipelines require you to explicitly call `checkout scm` if you need source files. They do *not* include automatic SCM checkout.
...
![The image shows a Jenkins interface for creating a new item, with options to select different project types such as Freestyle project, Pipeline, Multi-configuration project, and Folder. The user has entered "d-v-s-pipeline" as the item name.](https://kodekloud.com/kk-media/image/upload/v1752870990/notes-assets/images/Certified-Jenkins-Engineer-Demo-Declarative-vs-Scripted-Pipeline/jenkins-new-item-interface.jpg)
...
![The image shows a Jenkins configuration screen for setting up a pipeline, with options for specifying the SCM, repository URL, credentials, and branch to build.](https://kodekloud.com/kk-media/image/upload/v1752870991/notes-assets/images/Certified-Jenkins-Engineer-Demo-Declarative-vs-Scripted-Pipeline/jenkins-pipeline-configuration-screen.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/956fce34-baa6-4655-a3cf-7b12d2364544/lesson/3454a17d-b4d0-4b5c-ac4b-0c8c9080aacb)
