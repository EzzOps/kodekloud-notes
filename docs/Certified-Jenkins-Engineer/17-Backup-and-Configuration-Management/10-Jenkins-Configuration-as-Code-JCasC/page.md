...
> **lightbulb** Workflow files must reside under `.github/workflows/` with a `.yml` or `.yaml` extension.
...
> **triangle-alert** GitHub-hosted runners have usage quotas based on your plan. Monitor minutes and storage under [Billing settings](https://github.com/settings/billing).
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/77043650-89c2-4ad3-bbd1-e06eabe35581/lesson/9ec91e18-757e-464f-88b6-91c52c580116)
...
> **lightbulb** By defining jobs in code, you get full audit trails, PR-driven changes, and reproducible pipelines.
...
> **triangle-alert** Groovy init scripts can break after Jenkins upgrades. Prefer JCasC for long-term maintainability.
...
> **lightbulb** Always commit your exported YAML to your SCM. Even without immediate customization, it provides a historical configuration record.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/77043650-89c2-4ad3-bbd1-e06eabe35581/lesson/09048dab-99bb-4c08-8e0a-525499fb3b6c)
