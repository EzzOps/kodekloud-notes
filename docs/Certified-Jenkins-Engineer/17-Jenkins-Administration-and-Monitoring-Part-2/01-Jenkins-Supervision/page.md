...
![The image is an infographic titled "Jenkins Supervision," highlighting common monitoring areas like system errors, plugin malfunctions, and pipeline code issues, along with key benefits such as preventing disruptions, reducing delays, and maintaining efficiency.](https://kodekloud.com/kk-media/image/upload/v1752870737/notes-assets/images/Certified-Jenkins-Engineer-Jenkins-Supervision/jenkins-supervision-infographic.jpg)
...
> **lightbulb** Rotate and archive Jenkins logs regularly to avoid disk space issues—especially on high-throughput servers.
...
![The image is about Jenkins supervision and monitoring, featuring a graph of load statistics and icons for logs, monitoring, and auditing. It includes a tooltip suggesting checking resource utilization.](https://kodekloud.com/kk-media/image/upload/v1752870739/notes-assets/images/Certified-Jenkins-Engineer-Jenkins-Supervision/jenkins-supervision-monitoring-graph.jpg)
...
![The image illustrates Jenkins supervision and monitoring using Grafana and Datadog, featuring dashboards for performance and health metrics. It includes sections for logs, monitoring, and auditing.](https://kodekloud.com/kk-media/image/upload/v1752870740/notes-assets/images/Certified-Jenkins-Engineer-Jenkins-Supervision/jenkins-supervision-monitoring-dashboards.jpg)
...
> **triangle-alert** Monitor plugin compatibility after Jenkins core upgrades—some plugins may require updates to continue reporting metrics.
...
![The image is a diagram illustrating Jenkins supervision and auditing, showing the use of the Audit Trail Plugin and Job Config History Plugin, with various loggers like File Logger and Syslog Logger.](https://kodekloud.com/kk-media/image/upload/v1752870741/notes-assets/images/Certified-Jenkins-Engineer-Jenkins-Supervision/jenkins-supervision-auditing-diagram.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/90da5b24-e8f2-455a-9756-9d69f4a7ce8e/lesson/c03fd18f-98a1-48d0-9ca5-ed671a25a8c6)
