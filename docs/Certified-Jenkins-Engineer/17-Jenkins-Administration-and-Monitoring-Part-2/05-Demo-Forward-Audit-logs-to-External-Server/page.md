...
> **lightbulb** Your Elastic Cloud trial includes full access to Observability features. Save the API key securely, as you’ll need it for agent enrollment.
...
> **triangle-alert** Ensure indentation and quotation marks are correct in `elastic-agent.yml`. A YAML syntax error will prevent the agent from starting.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/90da5b24-e8f2-455a-9756-9d69f4a7ce8e/lesson/d00342a9-0dd8-4001-b4c1-1a4633ee601f)
