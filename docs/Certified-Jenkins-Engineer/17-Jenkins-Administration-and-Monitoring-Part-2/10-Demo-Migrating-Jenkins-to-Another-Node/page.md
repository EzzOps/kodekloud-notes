...
> **triangle-alert** If the Jenkins or JDK versions differ, you risk plugin incompatibilities or startup failures.\
...
> **lightbulb** You should see `jenkins` owned by the `jenkins` user with proper read/write permissions.
...
> **lightbulb** On fresh installs, Jenkins displays a “Getting Started” page and prompts for an initial admin password. Retrieve it from:
