...
> **lightbulb** Using a timestamp in your backup filename (e.g., `$(date +"%Y%m%d%H%M")`) makes tracking and rotating archives much easier.
...
> **triangle-alert** Stopping the production Jenkins service may interrupt active builds. Perform this step during a maintenance window.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/77043650-89c2-4ad3-bbd1-e06eabe35581/lesson/6e3f884d-f3c9-49be-853d-504e2008212d)
