...
![The image shows the Jenkins plugin management interface, specifically the "Available plugins" section, with a search for "configuration as" displaying related plugins.](https://kodekloud.com/kk-media/image/upload/v1752870413/notes-assets/images/Certified-Jenkins-Engineer-Demo-Configure-and-Explore-JCasC/jenkins-plugin-management-available-plugins.jpg)
...
> **lightbulb** You can explore more sections like global security, authorization strategies, and plugin settings by scrolling through the full YAML.
...
> **triangle-alert** Always back up your YAML and test in a non-production instance before applying major changes.
...
![The image shows a Jenkins configuration page with options to apply a new configuration, reload, download, or view the existing configuration. It also includes a warning about the export not being directly usable for Jenkins YAML configuration.](https://kodekloud.com/kk-media/image/upload/v1752870415/notes-assets/images/Certified-Jenkins-Engineer-Demo-Configure-and-Explore-JCasC/jenkins-configuration-page-options.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/certified-jenkins-engineer/module/77043650-89c2-4ad3-bbd1-e06eabe35581/lesson/793e1439-dea7-411f-93ee-2c6f7513ab74)
