...
Source: https://notes.kodekloud.com/docs/Certified-Kubernetes-Administrator-CKA/Introduction/Certification/page
...
![A person stands beside a Google Trends graph showing the increasing interest in Kubernetes over time, labeled "Kubernetes Trend" with a certification logo.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869791/notes-assets/images/CKA-Certification-Course-Certified-Kubernetes-Administrator-Certification/frame_20.jpg)
...
![A man stands beside a chart showing year-over-year growth in job search interest for various tech skills, with Kubernetes leading at 173% growth.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869792/notes-assets/images/CKA-Certification-Course-Certified-Kubernetes-Administrator-Certification/frame_30.jpg)
...
![A person stands in front of logos for The Linux Foundation, Cloud Native Computing Foundation, and Certified Kubernetes Administrator, with a graphic of people below.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869793/notes-assets/images/CKA-Certification-Course-Certified-Kubernetes-Administrator-Certification/frame_50.jpg)
...
> **lightbulb** The CKA exam is performance-based and requires you to solve real-world problems in a three-hour time window. Unlike multiple-choice exams, you will perform hands-on tasks that mirror real Kubernetes operations. Notably, you will have access to the official Kubernetes documentation throughout the exam.
...
![The image promotes the Certified Kubernetes Administrator (CKA) program, featuring a person and a logo, with details about the program and registration options.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869794/notes-assets/images/CKA-Certification-Course-Certified-Kubernetes-Administrator-Certification/frame_90.jpg)
...
> **lightbulb** • Ensure your testing environment meets all the technical requirements as detailed in the candidate handbook.\
...
![A person stands in front of a Kubernetes documentation webpage, which includes navigation links and options for users, contributors, and browsing documents.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869795/notes-assets/images/CKA-Certification-Course-Certified-Kubernetes-Administrator-Certification/frame_170.jpg)

Let us begin.

- [Watch Video](https://learn.kodekloud.com/user/courses/cka-certification-course-certified-kubernetes-administrator/module/7d880b2d-bb2d-48a2-a1dc-9064f97596fe/lesson/54ff3d26-96ba-4a8c-a300-8e3c756b5231)
