...
> **lightbulb** Make sure that the properties under metadata (like name and labels) are
...
> **lightbulb** Using `kubectl describe` helps you gain detailed insights into the internal
