...
> **lightbulb** This article covers the process of monitoring deployment rollouts, updating container images, and performing rollbacks using Kubernetes commands.
...
> **lightbulb** Remember, using `kubectl set image` updates the running deployment but does not modify your deployment definition file. Ensure you update the file as well for future reference.
