...
Source: https://notes.kodekloud.com/docs/Certified-Kubernetes-Administrator-CKA/Security/2025-Updates-Custom-Controllers/page
...
> **lightbulb** While it is possible to write a controller in a language like Python, challenges such as managing expensive API calls, and building your own queuing and caching mechanisms might arise.
...
> **triangle-alert** Ensure your API calls are handled efficiently to avoid timeouts and performance issues in production environments.
