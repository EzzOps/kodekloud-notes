...
Source: https://notes.kodekloud.com/docs/Certified-Kubernetes-Administrator-CKA/Storage/Volumes/page
...
> **lightbulb** For example, to use an AWS Elastic Block Store (EBS) volume, replace the hostPath configuration with AWS EBS-specific parameters such as the volume ID and filesystem type. This allows your Kubernetes cluster to leverage AWS EBS for robust, scalable storage.
