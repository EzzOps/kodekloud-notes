...
Source: https://notes.kodekloud.com/docs/Certified-Kubernetes-Administrator-CKA/Networking/Prerequisite-Switching-Routing-Gateways-CNI-in-kubernetes/page

This article explores essential networking concepts for configuring Kubernetes environments, covering switching, routing, gateways, DNS, network namespaces, and Docker networking.
...
> **lightbulb** The "default" or "0.0.0.0" entry indicates that any destination not explicitly listed in the routing table will be directed through the specified gateway.
...
> **lightbulb** Modifying `/etc/sysctl.conf` ensures that IP forwarding remains enabled even after a system restart.
