...
> **lightbulb** Make sure your system has access to a working Kubernetes cluster and that
...
> **lightbulb** For the most current installation procedures, always refer to the official
  Helm documentation.
