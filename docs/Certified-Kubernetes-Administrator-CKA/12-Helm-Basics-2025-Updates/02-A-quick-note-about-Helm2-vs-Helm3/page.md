...
![The image is a timeline titled "Helm History," showing the release dates of Helm versions 1.0 in February 2016, 2.0 in November 2016, and 3.0 in November 2019.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869777/notes-assets/images/CKA-Certification-Course-Certified-Kubernetes-Administrator-A-quick-note-about-Helm2-vs-Helm3/helm-history-timeline-releases.jpg)
...
![The image is a diagram illustrating the architecture of Helm 2, showing the interaction between the Helm CLI and Tiller within a Kubernetes environment, with notes on Role-Based Access Control and Custom Resource Definitions.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869777/notes-assets/images/CKA-Certification-Course-Certified-Kubernetes-Administrator-A-quick-note-about-Helm2-vs-Helm3/helm-2-architecture-diagram-kubernetes.jpg)

> **triangle-alert** Using Tiller in Helm 2 means that any misconfiguration could lead to elevated security risks due to its extensive privileges.
...
![The image is a diagram illustrating Helm 3's architecture, showing the interaction between the Helm CLI, Kubernetes, and the use of role-based access control and custom resource definitions.](../../../../images/kodekloud.com/kk-media/image/upload/v1752869778/notes-assets/images/CKA-Certification-Course-Certified-Kubernetes-Administrator-A-quick-note-about-Helm2-vs-Helm3/helm-3-architecture-diagram.jpg)
