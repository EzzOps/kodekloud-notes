...
> **lightbulb** Both methods effectively update Kubernetes resources. The choice between JSON 6902 and strategic merge patches is based on personal preference, with many opting for the readability of strategic merge patches.
...
> **lightbulb** Remember that list indices in YAML start at zero. Always check the index to
...
> **triangle-alert** Ensure that you use the correct index when attempting to remove a container.
