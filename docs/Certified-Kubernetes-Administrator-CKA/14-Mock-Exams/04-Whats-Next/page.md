...
> **lightbulb** Always copy the exact command names from the exam instructions to avoid errors.
...
> **lightbulb** Always double-check that you have switched the context appropriately using `kubectl config use-context <cluster-name>` before running commands that interact with cluster-specific resources.
...
> **lightbulb** Always verify your solutions and ensure you are working on the correct cluster context to avoid misconfigurations.
