...
> **lightbulb** When installing Kubernetes, several core components are automatically deployed:
...
> **lightbulb** As you advance in your Kubernetes journey, you will explore additional kubectl commands and more complex cluster management tasks.
