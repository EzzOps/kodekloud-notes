...
> **lightbulb** First, apply taints on your nodes. This ensures that pods without the matching toleration are not scheduled on these nodes.

2. Next, implement node affinity rules on your pods

> **lightbulb** Next, implement node affinity rules on your pods. This guarantees that the pods are scheduled only on the nodes with the corresponding color labels.
