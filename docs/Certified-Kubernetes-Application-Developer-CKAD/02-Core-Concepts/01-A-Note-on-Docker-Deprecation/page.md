...
Source: https://notes.kodekloud.com/docs/Certified-Kubernetes-Application-Developer-CKAD/Core-Concepts/A-Note-on-Docker-Deprecation/page

This article clarifies Dockers deprecation in Kubernetes and explains the transition to using containerd as a standalone container runtime.
...
<Frame>
  ...
  marked as
  deprecated.](../../../../images/kodekloud.com/kk-media/image/upload/v1752871167/notes-assets/images/Certified-Kubernetes-Application-Developer-CKAD-A-note-on-Docker-Deprecation/frame_70.jpg)
</Frame>

<Callout icon="lightbulb">
  Kubernetes' deprecation of Docker as a runtime does not mean Docker is
  obsolete. It simply indicates that Kubernetes now uses containerd directly
  through CRI, bypassing Docker-specific integrations.
</Callout>
...
<Frame>
  ![The image features the Docker logo, highlighting components like CLI, API,
  and security, with a transition from "docker" to "nerdctl"
  command.](../../../../images/kodekloud.com/kk-media/image/upload/v1752871168/notes-assets/images/Certified-Kubernetes-Application-Developer-CKAD-A-note-on-Docker-Deprecation/frame_130.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/certified-kubernetes-application-developer-ckad/module/eae8cedf-d483-471f-8796-49f69baec6cf/lesson/73b29769-5515-44f5-b6e8-2377a406ff2e" />
</CardGroup>
