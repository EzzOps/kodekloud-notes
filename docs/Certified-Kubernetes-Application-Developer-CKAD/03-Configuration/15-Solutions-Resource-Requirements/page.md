...
> **lightbulb** The **OOMKilled** status indicates the pod was terminated because it ran out of memory. The pod has a memory limit set at **10Mi**, but its process needs **15 MB**.
