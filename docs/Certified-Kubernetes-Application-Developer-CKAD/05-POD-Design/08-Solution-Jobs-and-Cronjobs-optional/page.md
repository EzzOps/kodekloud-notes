...
Source: https://notes.kodekloud.com/docs/Certified-Kubernetes-Application-Developer-CKAD/POD-Design/Solution-Jobs-and-Cronjobs-optional/page
...
> **lightbulb** In this example, the Job ran a total of 4 attempts (1 succeeded and 3 failed) until a pod succeeded in generating a six.
...
> **triangle-alert** Ensure that the restart policy is specified as **Never** (with a capital “N”). Using "never" (all lowercase) will result in an error.
