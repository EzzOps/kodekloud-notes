...
> **triangle-alert** If you see an error like this and cannot quickly troubleshoot (due to a typo or minor mistake), mark the question for later review and move on. Don’t let one problem eat up valuable time.
...
> **lightbulb** Remember that practice and preparation are key to success. Rehearse these strategies in your mock exams and adjust them according to your personal strengths and weaknesses.
