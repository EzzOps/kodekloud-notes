...
> **lightbulb** Both inline definitions and separate patch files are valid options. Choose the approach that best suits your project structure and maintenance preferences.
...
> **lightbulb** The `name` field in the `kustomization.yaml` file strictly refers to the image name and is not related to the container name specified in the deployment manifest.
