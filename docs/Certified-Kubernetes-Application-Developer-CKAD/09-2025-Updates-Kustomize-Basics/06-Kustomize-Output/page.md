...
Source: https://notes.kodekloud.com/docs/Certified-Kubernetes-Application-Developer-CKAD/2025-Updates-Kustomize-Basics/Kustomize-Output/page

This article explains how to deploy and remove Kubernetes resources using Kustomize and kubectl commands.
...
> **lightbulb** The output from Kustomize build is solely for previewing your final configuration. To deploy these changes, you must apply them using `kubectl`.
