...
Source: https://notes.kodekloud.com/docs/Certified-Kubernetes-Application-Developer-CKAD/Helm-Fundamentals/Solution-Install-Helm/page
...
> **lightbulb** Ensure you follow only the method applicable to your package management setup.
...
> **lightbulb** Remember to use the "env" command in lowercase when checking the Helm client environment information.
...
> **lightbulb** Using the `--debug` flag will provide more detailed output, which is useful for diagnosing any issues during Helm operations.
