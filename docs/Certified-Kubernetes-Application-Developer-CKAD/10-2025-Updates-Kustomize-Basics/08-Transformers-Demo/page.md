...
Source: https://notes.kodekloud.com/docs/Certified-Kubernetes-Application-Developer-CKAD/2025-Updates-Kustomize-Basics/Transformers-Demo/page

Learn to use Kustomize transformations in Kubernetes configurations, including labels, namespaces, and image updates through a structured demo project.
...
> **lightbulb** Review the configuration output to verify that resources from both the API and database directories now include the `department: engineering` label.
...
> **lightbulb** Using both global name prefixes and folder-specific suffixes helps maintain a consistent naming convention across your deployments, making management and identification much easier.
...
> **triangle-alert** If you encounter an error indicating a type conversion issue, ensure that the image tag value is provided as a string using quotes.
