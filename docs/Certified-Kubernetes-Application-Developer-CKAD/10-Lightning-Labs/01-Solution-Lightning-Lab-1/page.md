...
> **triangle-alert** Ensure that the field name `persistentVolumeClaim` is spelled correctly and that you have saved the file appropriately before re-applying.
