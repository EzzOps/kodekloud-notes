...
Source: https://notes.kodekloud.com/docs/Certified-Kubernetes-Application-Developer-CKAD/Security/Solution-Cluster-Roles/page
...
> **lightbulb** Cluster roles are cluster-scoped and are not limited to any namespace.
...
> **lightbulb** Both cluster roles and cluster role bindings are applied across the entire cluster and are not namespace-specific.
...
> **triangle-alert** Exercise caution when modifying cluster roles as they affect permissions across the entire cluster.
