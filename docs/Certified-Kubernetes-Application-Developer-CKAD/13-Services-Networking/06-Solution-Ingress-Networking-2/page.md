...
> **lightbulb** After a short wait, the status should update to Running. This confirms that the Ingress Controller has been successfully deployed.
...
> **lightbulb** After saving these changes, the SSL redirect issue should be resolved, ensuring proper routing of traffic to both applications.
