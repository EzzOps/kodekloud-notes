...
Source: https://notes.kodekloud.com/docs/Certified-Kubernetes-Security-Specialist-CKS/Cluster-Setup-and-Hardening/Docker-Securing-the-Daemon/page
...
> **lightbulb** Regularly review and update your server security measures to keep pace with evolving threats.
...
> **triangle-alert** Do not rely solely on TLS encryption. Make sure to enable certificate-based authentication to verify the identity of clients connecting to your Docker daemon.
