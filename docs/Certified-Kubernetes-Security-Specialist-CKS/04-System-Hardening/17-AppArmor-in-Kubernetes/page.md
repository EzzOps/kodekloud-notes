...
> **lightbulb** Before proceeding, verify that all nodes have the AppArmor kernel module enabled and the required profile loaded.
...
> **lightbulb** Make sure the above profile is loaded on every worker node where your pod might run.
...
> **triangle-alert** If the file creation attempt fails as shown above, it confirms that the AppArmor profile is enforcing the security restrictions correctly.
