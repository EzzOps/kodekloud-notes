...
> **lightbulb** Only a portion of the base64-encoded certificate data is shown for brevity.
...
> **lightbulb** Using these commands helps ensure that you're aware of all the active admission controllers in your cluster.
