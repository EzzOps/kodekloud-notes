...
> **lightbulb** Ensure that you have adequate RBAC permissions before deploying Gatekeeper in your cluster.
...
> **lightbulb** Any object creation that violates the defined policies will trigger an error during the admission phase, preventing non-compliant objects from being admitted into the cluster.
