...
> **lightbulb** Each container in Kata Containers runs inside its own lightweight VM, ensuring
...
> **triangle-alert** Many cloud providers do not support nested virtualization. However, some
