...
Source: https://notes.kodekloud.com/docs/Certified-Kubernetes-Security-Specialist-CKS/Minimize-Microservice-Vulnerabilities/DNS-in-Multi-Tenant-Environments/page
...
> **lightbulb** Restricting DNS queries to the same namespace enhances tenant security and prevents unwanted cross-namespace communication.
...
> **triangle-alert** Be aware that misconfiguring DNS settings can interrupt service discovery within your cluster. Always validate changes in a test environment before applying them to production.
