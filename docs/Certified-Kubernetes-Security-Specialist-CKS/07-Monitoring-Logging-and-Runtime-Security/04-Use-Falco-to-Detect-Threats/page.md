...
Source: https://notes.kodekloud.com/docs/Certified-Kubernetes-Security-Specialist-CKS/Monitoring-Logging-and-Runtime-Security/Use-Falco-to-Detect-Threats/page
...
> **lightbulb** Ensure that Falco is installed and properly configured on your nodes before proceeding.
...
> **triangle-alert** Always ensure that your security rules are tested in a non-production environment before applying them to production systems.
