...
> **lightbulb** Custom rules or modifications should be added to `/etc/falco/falco_rules.local.yaml` to avoid being overwritten by package updates.
...
> **triangle-alert** Direct modifications to `/etc/falco/falco_rules.yaml` may be lost during package updates. Always add custom changes to `/etc/falco/falco_rules.local.yaml`.
