...
<Frame>
  ![The image illustrates a network setup with an Admin Jump Server and Internal Users accessing an application server (app01) via SSH, HTTP, and TCP protocols.](../../../../images/kodekloud.com/kk-media/image/upload/v1752871753/notes-assets/images/Certified-Kubernetes-Security-Specialist-CKS-UFW-Firewall-Basics/frame_40.jpg)
</Frame>
...
<Frame>
  ![The image shows a comparison between "iptables" and "ufw (Uncomplicated Firewall)" under the title "Install UFW."](../../../../images/kodekloud.com/kk-media/image/upload/v1752871754/notes-assets/images/Certified-Kubernetes-Security-Specialist-CKS-UFW-Firewall-Basics/frame_80.jpg)
</Frame>
