...
Source: https://notes.kodekloud.com/docs/Chaos-Engineering/Building-a-Basic-FIS-experiment/FIS-Permissions/page
...
> **triangle-alert** FIS experiments can induce downtime or resource failures. Apply the principle of least privilege when granting permissions to both roles.
...
> **lightbulb** You can scope the policy further by granting only the specific `fis:` actions your team requires.
