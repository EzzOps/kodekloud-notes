...
Source: https://notes.kodekloud.com/docs/Chaos-Engineering/Building-a-Basic-FIS-experiment/Experiment-1-Chaos-Engineering-on-ASG/page
...
> **lightbulb** We use [AWS Fault Injection Simulator](https://docs.aws.amazon.com/fis/latest/userguide/what-is-fis.html) to safely inject failures and test application resilience. Make sure your IAM role has the required permissions to execute FIS experiments.
...
> **triangle-alert** Always run chaos experiments in a staging or non-production environment first. Verify that your CloudWatch alarms and Auto Scaling health checks are correctly configured to avoid unintended downtime.
