...
> **lightbulb** Although the default policy already denies incoming connections, explicitly denying port 8080 clarifies its intended blocked status.
...
> **lightbulb** This demo uses **only** the AWS Management Console—no IaC templates or GitHub repositories required.
...
> **triangle-alert** Ensure your selected subnets have sufficient IP addresses to support up to 4 instances simultaneously.
