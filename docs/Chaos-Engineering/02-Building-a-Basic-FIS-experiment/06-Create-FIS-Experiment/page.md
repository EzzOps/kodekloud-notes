...
Source: https://notes.kodekloud.com/docs/Chaos-Engineering/Building-a-Basic-FIS-experiment/Create-FIS-Experiment/page

This guide explains how to define and launch an AWS FIS experiment using actions, targets, and stop conditions while applying guardrails.
...
> **lightbulb** Stop conditions are optional but **strongly recommended**. They prevent runaway experiments and ensure safety.
...
> **triangle-alert** Ensure your CloudWatch alarm ARN is correct. A misconfigured stop condition may not trigger, leaving experiments running longer than intended.
