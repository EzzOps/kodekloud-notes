...
> **triangle-alert** Starting a Chaos Engineering experiment will terminate live EC2 instances. Ensure this is performed in a non-production environment or during a maintenance window.
...
> **lightbulb** Chaos experiments require sufficient targets. If your Auto Scaling group has only one instance, 50% of one equals zero.
