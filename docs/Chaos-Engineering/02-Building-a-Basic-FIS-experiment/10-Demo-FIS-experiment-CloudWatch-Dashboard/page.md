...
> **lightbulb** * An AWS FIS experiment configured to terminate or impair EC2 instances
...
> **triangle-alert** If you terminate multiple instances at once or set a high desired capacity, the ASG may launch many replacements simultaneously. Monitor the **ASG Instance Checks** widget to avoid unexpected resource costs.
