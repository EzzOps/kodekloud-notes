...
> **lightbulb** This template does not declare any parameters—everything is preconfigured.
...
> **triangle-alert** If your Auto Scaling group has fewer than 2 instances, the preview will fail because you cannot select 50% of one instance.
