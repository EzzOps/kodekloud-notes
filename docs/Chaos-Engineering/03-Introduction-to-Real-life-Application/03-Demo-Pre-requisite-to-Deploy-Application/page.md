...
> **lightbulb** These steps mimic the Cloud9 IDE setup by granting the EC2 instance permissions via an IAM role and installing all required CLI tools, Docker, Kubernetes clients, and CDK.
...
> **triangle-alert** Opening SSH (port 22) to `0.0.0.0/0` is insecure. Restrict to your IP range where possible.
...
> **lightbulb** If EC2 Instance Connect isn’t available, use your SSH key pair and `ssh -i <key.pem> ec2-user@<public-ip>`.
