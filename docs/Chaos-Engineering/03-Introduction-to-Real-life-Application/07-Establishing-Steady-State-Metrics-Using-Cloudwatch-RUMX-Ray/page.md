...
> **lightbulb** Ensure RUM is configured on all critical user flows to gather representative web vitals.
...
> **triangle-alert** Trace sampling needs to be set appropriately. Over-sampling can increase costs, while under-sampling may hide critical issues.
