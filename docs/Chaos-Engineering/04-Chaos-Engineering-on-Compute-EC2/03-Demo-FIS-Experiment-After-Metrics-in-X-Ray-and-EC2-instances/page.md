...
> **lightbulb** Ensure your IAM role has the necessary FIS permissions and your EC2 instances are tagged for tracing with X-Ray.
...
> **triangle-alert** Always test fault injection in a staging environment before applying to production. Disk saturation can lead to data loss if not handled properly.
