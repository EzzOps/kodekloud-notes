...
Source: https://notes.kodekloud.com/docs/Chaos-Engineering/Chaos-Engineering-on-Serverless-Fargate/Demo-Fargate-IAM-role-creation/page

Learn to create an IAM role for chaos experiments on Amazon ECS Fargate using AWS Fault Injection Simulator.
...
<Frame>
  ![The image shows an AWS console interface where a user is selecting a use case for the Fault Injection Simulator (FIS) service, with options for different types of access like EC2, ECS, and EKS.](../../../../images/kodekloud.com/kk-media/image/upload/v1752871904/notes-assets/images/Chaos-Engineering-Demo-Fargate-IAM-role-creation/aws-console-fault-injection-simulator.jpg)
</Frame>
...
<Frame>
  ![The image shows an AWS Identity and Access Management (IAM) interface with a list of permission policies attached to a role. The policies include AmazonSSMFullAccess, AWSFaultInjectionSimulatorECSAccess, and CloudWatchLogsFullAccess.](../../../../images/kodekloud.com/kk-media/image/upload/v1752871907/notes-assets/images/Chaos-Engineering-Demo-Fargate-IAM-role-creation/aws-iam-interface-permission-policies.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/chaos-engineering/module/5fdff083-6ddb-4b6a-a584-9c877b0e9c7b/lesson/8a02f91f-ec15-4d25-83fa-28b83a8cd33b" />
</CardGroup>
