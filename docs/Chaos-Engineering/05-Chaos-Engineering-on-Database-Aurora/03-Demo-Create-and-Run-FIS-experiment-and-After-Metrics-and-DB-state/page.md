...
> **lightbulb** Ensure you have an IAM role with the managed policy `AWSFISFullAccess` and permissions to reboot RDS instances. Assign this role when you create the FIS experiment template.
...
> **triangle-alert** Rebooting the reader node confines the blast radius, but always validate your high-availability configuration before injecting faults in production.
