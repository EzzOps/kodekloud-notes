...
> **lightbulb** Baseline metrics enable you to compare system behavior before and after fault injection. Make sure you record the values for each metric over a consistent time window.
...
> **triangle-alert** If any metric is already at or near its limit (e.g., > 80% CPU or memory), address capacity issues before proceeding with fault injection.
