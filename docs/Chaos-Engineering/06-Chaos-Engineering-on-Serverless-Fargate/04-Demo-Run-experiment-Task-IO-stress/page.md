...
> **lightbulb** * An existing ECS Fargate service with tasks prefixed by `pay-for-adoption`
...
> **triangle-alert** Ensure your IAM role has permissions for both FIS actions and CloudWatch logging. Missing permissions can cause experiment failures.
