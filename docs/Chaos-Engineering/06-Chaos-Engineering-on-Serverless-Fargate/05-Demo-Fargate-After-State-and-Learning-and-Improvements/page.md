...
> **lightbulb** Generating concurrent adoption events helps ensure your application can handle spikes in user requests without degradation.
...
> **lightbulb** An Apdex score above 0.85 and zero frustrated sessions confirm a smooth user experience. For more details, see the [CloudWatch RUM User Guide](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-RUM.html).
...
> **triangle-alert** Keep an eye on sustained CPU and memory drops—they may indicate resource throttling or misconfiguration in your task definition.
