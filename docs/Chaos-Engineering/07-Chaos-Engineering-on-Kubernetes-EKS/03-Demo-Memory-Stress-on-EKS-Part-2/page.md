...
> **lightbulb** Ensure the path to `fis-trust-policy.json` is correct and your AWS CLI is configured with sufficient permissions.
...
> **triangle-alert** Be sure your AWS CLI profile has permission to call `eks:UpdateKubeconfig`. Incorrect context may lead to applying objects to the wrong cluster.
...
> **lightbulb** Establishing a steady-state baseline is crucial before running any chaos experiment. It helps you distinguish normal behavior from fault-induced anomalies.
