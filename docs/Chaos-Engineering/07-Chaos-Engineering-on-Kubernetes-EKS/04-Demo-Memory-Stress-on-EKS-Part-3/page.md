...
> **lightbulb** * An AWS account with administrative permissions
...
> **lightbulb** Setting `Percentage` to 50 limits memory consumption to half of available memory on targeted pods.
