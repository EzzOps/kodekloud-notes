...
> **lightbulb** Before running any FIS experiment, ensure your IAM role has the necessary permissions for AWS FIS, CloudWatch, and X-Ray. Review the [AWS FIS documentation](https://docs.aws.amazon.com/fis/latest/userguide/) for setup details.
...
> **lightbulb** Set your own RUM thresholds based on application SLAs. A small increase in “frustrating” sessions may be acceptable if overall availability remains high.
