...
> **lightbulb** These charts represent the steady state of the `PetSite` service under normal conditions.
...
> **lightbulb** Approximately 1% of virtual users experienced frustration, while the rest saw positive load times.
