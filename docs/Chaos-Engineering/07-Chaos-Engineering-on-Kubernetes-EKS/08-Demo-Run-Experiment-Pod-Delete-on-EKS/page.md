...
> **lightbulb** Make sure your IAM role trusts the `fis.amazonaws.com` service principal. For more details, see [AWS FIS IAM permissions](https://docs.aws.amazon.com/fis/latest/userguide/security_iam_id-based-policy-examples.html).
...
> **triangle-alert** Run FIS experiments only in non-production or controlled environments. Always validate on staging clusters before production.
