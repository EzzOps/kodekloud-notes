...
> **lightbulb** Only resources labeled `AZ impairment power: ready` are affected by the experiment, keeping the rest of your environment safe.
...
> **triangle-alert** Always run FIS experiments in a non-production or staging environment first. Improper scoping can lead to real service disruptions.
