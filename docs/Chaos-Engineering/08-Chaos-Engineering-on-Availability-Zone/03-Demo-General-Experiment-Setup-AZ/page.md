...
Source: https://notes.kodekloud.com/docs/Chaos-Engineering/Chaos-Engineering-on-Availability-Zone/Demo-General-Experiment-Setup-AZ/page

This tutorial prepares an AWS Fault Injection Simulator experiment to simulate an Availability Zone power outage.
...
> **lightbulb** These permissions let FIS safely describe and modify Auto Scaling groups, manage network ACLs tagged for FIS use, fail over RDS clusters, reboot instances, and interrupt power in ElastiCache clusters.
