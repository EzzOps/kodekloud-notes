...
> **lightbulb** Use the preview to confirm which resources will be targeted and to ensure you’re prepared for the potential impact before starting the experiment.
...
> **warning** Some templates include an ElastiCache pause step. If your environment does not use ElastiCache, FIS skips that action and continues. Verify the preview to confirm resource availability before execution.
