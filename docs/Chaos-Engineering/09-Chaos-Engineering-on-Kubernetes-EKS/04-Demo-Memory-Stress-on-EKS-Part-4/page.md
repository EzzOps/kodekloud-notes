...
Source: https://notes.kodekloud.com/docs/Chaos-Engineering/Chaos-Engineering-on-Kubernetes-EKS/Demo-Memory-Stress-on-EKS-Part-4/page

This article analyzes the effects of memory stress on a Kubernetes pod in Amazon EKS using AWS Fault Injection Simulator.
...
<Frame>
  ![The image shows an AWS CloudWatch X-Ray console displaying a trace map and metrics for an EC2 instance named "PetSite," including latency, requests, and fault rates over a selected time period.](../../../../images/kodekloud.com/kk-media/image/upload/v1752871876/notes-assets/images/Chaos-Engineering-Demo-Memory-Stress-on-EKS-Part-4/aws-cloudwatch-xray-ec2-trace-map.jpg)
</Frame>
