...
> **triangle-alert** Buckets with existing objects will block stack deletion. Ensure all objects are removed first.
...
> **lightbulb** Automated snapshots created by RDS are cleaned up when you delete the database instance.
