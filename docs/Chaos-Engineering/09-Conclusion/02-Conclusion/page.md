...
> **lightbulb** For detailed guidance on AWS Fault Injection Simulator, see the [AWS FIS User Guide](https://docs.aws.amazon.com/fis/latest/userguide/).
...
> **triangle-alert** Always perform chaos experiments in a **staging** or **non-production** environment first. Double-check IAM permissions, backups, and monitoring before injecting faults.
