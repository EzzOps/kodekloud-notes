...
> **lightbulb** Make sure your Auto Scaling group has a minimum capacity greater than zero. Otherwise, FIS won’t be able to replace the terminated instance.
...
> **triangle-alert** Avoid running this experiment during peak traffic unless you have a multi-AZ Aurora cluster and automated failover enabled.
...
> **lightbulb** Use labels or selectors to target a specific pod group. For example:\
