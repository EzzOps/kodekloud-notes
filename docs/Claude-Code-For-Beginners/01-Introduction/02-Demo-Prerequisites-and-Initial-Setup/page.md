...
> **lightbulb** Make sure Node.js 18+ is installed. On macOS use [Homebrew](https://brew.sh) (brew install node); on Linux use your distro package manager or the official installer; on Windows use the installer from [nodejs.org](https://nodejs.org).
...
> **warning** Important: Never run code you don't trust. Prompt injection and code-generation mistakes are real risks—review outputs and use version control for auditing changes.
