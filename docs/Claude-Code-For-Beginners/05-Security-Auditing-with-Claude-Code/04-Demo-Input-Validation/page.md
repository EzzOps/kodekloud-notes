...
> **warning** If you choose to run interactive commands (like `npm audit`) from the audit environment, ensure you understand any npm scripts or postinstall hooks. Running tools may modify lockfiles or node\_modules—use a safe environment or a CI job when possible.
...
> **lightbulb** Validate environment secrets and fail fast: ensure JWT\_SECRET is present and meets complexity requirements at app startup. Also add helmet and express-rate-limit for immediate mitigation.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/claude-code-for-beginners/module/eaf75a67-f28f-4217-a3f9-92d411403129/lesson/24a7a710-e16c-4b6d-beb9-ba2ee2a2bbb3)
...
> **lightbulb** Treat all external inputs as untrusted. Validate types, lengths, allowed values, and apply context-appropriate encoding before using data in queries, file operations, or rendered HTML.
