...
> **lightbulb** Object storage is optimized for durability and scale. Use block storage for fast random I/O and file storage when an application expects a filesystem interface.
...
> **warning** Cloud architecture also needs security controls and cost management. We’ll cover cloud security and cost control in a dedicated follow-up article.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/cloud-computing-fundamentals/module/f032d7b9-edae-4154-a304-efac660806f1/lesson/f992fb27-fe20-48cf-9643-f106e4af5272)
