...
> **lightbulb** Detect logic varies by buildpack and builder. For Python, modern buildpacks commonly detect `pyproject.toml` or `requirements.txt`; always consult the specific buildpack's documentation for exact detection rules.
