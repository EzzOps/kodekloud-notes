...
Source: https://notes.kodekloud.com/docs/Cloud-Native-Buildpacks/Buildpacks-Basics/Demo-Cloud-Native-Buildpack-Basics/page
...
> **lightbulb** The `node_modules` folder contains the application dependencies for Express and UUID, ensuring that your app runs correctly.
...
> **lightbulb** Although some code blocks (such as the Node.js application code) appear multiple times in the process, they are presented only once in full to avoid redundancy.
