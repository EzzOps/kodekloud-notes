...
> **lightbulb** The `pack inspect` command provides critical insight into your image’s structure. Verifying that your image is rebasable is an important prerequisite before proceeding.
