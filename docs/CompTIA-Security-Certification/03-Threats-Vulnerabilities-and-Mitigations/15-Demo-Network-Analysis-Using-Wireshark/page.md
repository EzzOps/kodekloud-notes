...
> **lightbulb** Use the capture filter "host 192.168.1.1" to ensure that only traffic from the specified IP is captured.
...
> **lightbulb** Always verify the accuracy of the capture file name and the paths provided in your lab instructions to avoid file-not-found errors.
