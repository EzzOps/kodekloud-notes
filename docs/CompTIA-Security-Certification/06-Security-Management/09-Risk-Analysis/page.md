...
Source: https://notes.kodekloud.com/docs/CompTIA-Security-Certification/Security-Management/Risk-Analysis/page

This article discusses risk analysis, its importance in risk management, and the two primary approaches  quantitative and qualitative analysis.
...
![The image is a quantitative risk analysis showing a risk cost of 1 million per year in loss and an upgrade cost of 500,000.](https://kodekloud.com/kk-media/image/upload/v1752872237/notes-assets/images/CompTIA-Security-Certification-Risk-Analysis/quantitative-risk-analysis-costs.jpg)
...
![The image shows a qualitative risk analysis gauge with a color gradient from red (high risk) to green (low risk), and a central label reading "RISK."](https://kodekloud.com/kk-media/image/upload/v1752872239/notes-assets/images/CompTIA-Security-Certification-Risk-Analysis/qualitative-risk-analysis-gauge.jpg)
...
![The image is about qualitative risk analysis, featuring icons of graphs and charts, and notes that it is more subjective and used when there is a lack of time or data for quantitative analysis.](https://kodekloud.com/kk-media/image/upload/v1752872240/notes-assets/images/CompTIA-Security-Certification-Risk-Analysis/qualitative-risk-analysis-graphs-charts.jpg)

> **lightbulb** Both quantitative and qualitative methods are invaluable in risk management. Quantitative analysis provides a clear financial perspective that supports cost-benefit decisions for risk mitigation, while qualitative analysis offers a quick, visual representation of risk severity, making it particularly useful when precise numerical data is limited.

- [Watch Video](https://learn.kodekloud.com/user/courses/comptia-security-certification/module/2ed228f2-896d-4847-a874-59c17394f560/lesson/9387b1e3-553d-438c-ba53-ee2e33c98e06)
