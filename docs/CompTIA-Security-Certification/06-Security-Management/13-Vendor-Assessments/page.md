...
Source: https://notes.kodekloud.com/docs/CompTIA-Security-Certification/Security-Management/Vendor-Assessments/page

This article discusses the importance of vendor assessments in security governance to mitigate risks from third-party vulnerabilities.
...
![The image illustrates a security governance concept, showing a flow from "Company Systems" to "Vendors" and "Bad Actors," with a shield icon protecting the company and a red cross indicating a block between vendors and bad actors.](https://kodekloud.com/kk-media/image/upload/v1752872289/notes-assets/images/CompTIA-Security-Certification-Vendor-Assessments/security-governance-flow-diagram.jpg)
...
> **lightbulb** Penetration testing not only highlights vulnerabilities but also helps prioritize risk mitigation efforts by demonstrating which areas require immediate attention.
...
![The image displays three icons labeled "Penetration Testing," "Vendors," and "Audit Clauses," each with a corresponding graphic.](https://kodekloud.com/kk-media/image/upload/v1752872290/notes-assets/images/CompTIA-Security-Certification-Vendor-Assessments/penetration-testing-vendors-audit-icons.jpg)

> **lightbulb** Regular audits—whether internal or third-party—are essential for maintaining an up-to-date understanding of your vendors’ security practices.
...
![The image is a diagram titled "Due Diligence" featuring "Supply Chain Analysis" at the center, with icons representing "Making," "Distributing," and "Delivering" below it.](https://kodekloud.com/kk-media/image/upload/v1752872291/notes-assets/images/CompTIA-Security-Certification-Vendor-Assessments/due-diligence-supply-chain-diagram.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/comptia-security-certification/module/2ed228f2-896d-4847-a874-59c17394f560/lesson/6b4783cc-c961-4be8-969e-c99a96623b0f)
