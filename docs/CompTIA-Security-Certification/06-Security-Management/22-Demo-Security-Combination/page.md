...
> **lightbulb** Make sure to verify that `q1.txt` is correctly created in the root after extracting the ZIP file.
...
> **lightbulb** Use the extracted message as the clue for locating the treasure.
...
> **triangle-alert** Always handle sensitive data with caution and ensure you have proper authorization before extracting or analyzing image metadata.
