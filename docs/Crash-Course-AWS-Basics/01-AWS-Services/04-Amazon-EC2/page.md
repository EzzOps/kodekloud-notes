...
> **lightbulb** Keep your private key file secure. After downloading, restrict permissions (for example: `chmod 400 ec2-demo.pem`) so SSH will accept the key.
...
> **warning** Allowing SSH from `0.0.0.0/0` exposes your instance to the entire Internet. Restrict SSH to your IP whenever possible.
