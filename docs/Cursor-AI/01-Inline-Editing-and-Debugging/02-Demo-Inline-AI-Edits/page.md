...
<Frame>
  ![The image shows a "Task Manager" web application interface where a user can create a new task by entering details like title, description, assignee, and status. The interface also includes options to filter tasks by status and assignee.](../../../../images/kodekloud.com/kk-media/image/upload/v1752872693/notes-assets/images/Cursor-AI-Demo-Debugging-with-AI/task-manager-web-app-interface.jpg)
</Frame>
