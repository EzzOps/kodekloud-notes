...
<Frame>
  ![The image shows a code editor with a Python file open on the left and a chat interface on the right, discussing the Jinja2 template system used in Flask applications.](../../../../images/kodekloud.com/kk-media/image/upload/v1752872696/notes-assets/images/Cursor-AI-Demo-Contextual-References/python-file-chat-jinja2-flask.jpg)
</Frame>
