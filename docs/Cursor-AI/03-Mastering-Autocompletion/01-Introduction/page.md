...
> **triangle-alert** Avoid overusing auto-generated code without review—always test and validate generated snippets.
...
> **lightbulb** Make sure you’re running VS Code version 1.60 or higher to ensure full compatibility with Cursor’s latest extensions.
...
> **triangle-alert** Certain corporate firewalls may block AI model API requests. Ensure your network allows outbound HTTPS traffic to `api.cursor.dev`.
