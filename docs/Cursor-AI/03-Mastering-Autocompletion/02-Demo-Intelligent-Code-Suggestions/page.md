...
> **lightbulb** Ensure `mockdata.csv` is in the same directory as `test.py` so the script can locate it.
...
> **lightbulb** Using **Command L** lets Cursor AI review your entire file (or project) for context-aware refactors.
