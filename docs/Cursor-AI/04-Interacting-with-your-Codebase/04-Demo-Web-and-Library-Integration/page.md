...
> **triangle-alert** Never commit sensitive values like `SECRET_KEY` or database credentials in your production code. Use environment variables or a secrets manager instead.
...
> **lightbulb** Performance tuning PRAGMAs can greatly reduce disk I/O and improve concurrency for SQLite-based applications.
