...
> **lightbulb** Always verify your `templates/` folder matches the filenames you pass to `render_template()`.
...
> **triangle-alert** Double-check your database schema (e.g., `schema.sql`) before running migrations or inserts.
...
> **lightbulb** Inline prompts work best for focused, localized changes. For broad design discussions, consider a separate chat to maintain context.
