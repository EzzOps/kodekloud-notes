...
> **lightbulb** The script writes output files `namevalues.csv` and `phone.txt` without printing to the console. Verify with:
...
> **lightbulb** Auto-select lets Cursor pick the best model based on your preferences and credits.
...
> **triangle-alert** Costs can add up quickly—monitor your credits and usage in Cursor Pro or via public API billing.
