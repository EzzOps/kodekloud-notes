...
> **warning** Always prefer specifying user\@host in your SSH entries (for example jeremy\@10.0.0.94). If you only specify an IP, your local username may be appended automatically and you may log in as a different user than intended.
...
> **lightbulb** If you plan to use multiple remote hosts frequently, save each host entry in your SSH config with descriptive comments and enable SSH key authentication to avoid repeated password prompts.
...
![Agenda: Choosing & Switching Models, Privacy & Security, Documentation, Profiles & Features, Remote Development, Agentic Automation](https://kodekloud.com/kk-media/image/upload/v1752872820/notes-assets/images/Cursor-AI-Introduction/agenda-six-items-models-privacy-documentation.jpg)
...
> **lightbulb** Before you begin, ensure that:
...
- [Watch Video](https://learn.kodekloud.com/user/courses/cursor-ai/module/fcc10c1c-5240-4626-9bfc-bf172a3a00c6/lesson/36bff4a5-c584-47f0-b880-ec1012c69a34)
