...
> **lightbulb** Your storage account name forms part of the service URL (`<name>.blob.core.windows.net`). If the chosen name is taken, append a unique suffix (e.g., your initials or date).
