...
> **lightbulb** NFS support requires a Premium storage account and VNet deployment.\
...
> **triangle-alert** Large-scale synchronization can incur data transfer charges and may impact network performance. Plan your cache settings and sync schedules to optimize costs and user experience.
