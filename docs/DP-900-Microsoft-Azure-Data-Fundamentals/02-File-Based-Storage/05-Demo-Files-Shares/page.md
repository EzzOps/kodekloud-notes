...
> **lightbulb** If you expect to exceed 5 TiB, you can enable large file shares (up to 100 TiB) either at the storage account level or per share after creation.
...
> **lightbulb** **Soft Delete** is enabled by default (14 days). Deleted files are recoverable within that period but still incur storage costs.

> **triangle-alert** Large file shares (100 TiB) do not support geo-redundancy. Plan accordingly if you need cross-region replication.
