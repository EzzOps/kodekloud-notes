...
> **lightbulb** Container names must be 3–63 characters, lowercase letters and numbers only, without special characters or spaces.
...
> **triangle-alert** Error code 403 indicates you need the **Storage Blob Data Contributor** role (or higher) to modify container contents. Assign this role at the storage account or container scope.
