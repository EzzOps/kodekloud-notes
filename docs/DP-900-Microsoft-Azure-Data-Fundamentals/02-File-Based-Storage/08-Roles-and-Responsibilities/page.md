...
> **lightbulb** Grant only the minimum permissions required—this enforces security and reduces the risk of accidental data exposure.
...
> **triangle-alert** Incorrect or overly broad RBAC assignments can lead to unintended data exposure. Always audit role assignments regularly.
