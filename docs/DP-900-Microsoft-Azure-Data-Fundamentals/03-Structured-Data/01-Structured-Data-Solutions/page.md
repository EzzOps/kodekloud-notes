...
> **lightbulb** Serverless databases automatically scale compute and storage based on demand, helping you optimize costs and performance.
...
> **triangle-alert** Features such as Service Broker and Database Mail aren’t supported in Azure SQL Database and some Managed Instances. If these are critical, consider SQL Server on a VM.
