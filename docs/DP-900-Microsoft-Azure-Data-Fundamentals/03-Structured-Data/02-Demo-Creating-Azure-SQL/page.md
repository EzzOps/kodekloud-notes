...
> **lightbulb** Server names must be lowercase and globally unique as they form part of your connection endpoint (e.g., `phvnewserver.database.windows.net`).
...
> **triangle-alert** Opening the firewall to all Azure services or 0.0.0.0/0 can expose your database. Limit rules to specific IP ranges whenever possible.
