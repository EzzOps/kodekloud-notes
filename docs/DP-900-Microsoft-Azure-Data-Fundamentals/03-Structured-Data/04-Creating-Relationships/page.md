...
Source: https://notes.kodekloud.com/docs/DP-900-Microsoft-Azure-Data-Fundamentals/Structured-Data/Creating-Relationships/page
...
> **lightbulb** Refer to [Database Normalization](https://en.wikipedia.org/wiki/Database_normalization) for best practices on organizing tables.
...
> **triangle-alert** Excessive joins on large tables without proper indexing can lead to slow queries. Always index foreign key columns and consider query optimization techniques like denormalization or materialized views when necessary.
