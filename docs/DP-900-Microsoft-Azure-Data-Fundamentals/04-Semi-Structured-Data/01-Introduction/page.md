...
> **triangle-alert** Azure Table Storage is a NoSQL (non-relational) database. It **does not** support SQL joins, rich secondary indexes, or transactions across multiple entities.
...
> **lightbulb** In Azure Table Storage, you use `PartitionKey` and `RowKey` to distribute and query your data efficiently.
