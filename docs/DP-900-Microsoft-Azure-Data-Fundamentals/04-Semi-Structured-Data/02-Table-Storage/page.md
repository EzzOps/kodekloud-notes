...
> **lightbulb** Azure Cosmos DB’s Table API offers global distribution and automatic indexing, but at a higher cost compared to native Azure Storage Table.
...
> **triangle-alert** Designing the wrong PartitionKey for your access patterns can lead to inefficient queries or throttling under load.
