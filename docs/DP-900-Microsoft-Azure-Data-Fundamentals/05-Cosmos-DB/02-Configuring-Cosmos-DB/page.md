...
> **lightbulb** You can select only one API per account. For JSON-like documents or MongoDB migrations, choose **MongoDB**.
...
> **lightbulb** Select a key with many unique values (e.g., `userId` or `orderId`) to spread traffic and storage evenly.
...
> **triangle-alert** Monitor RU consumption in Azure Monitor. Adjust your retry policy and increase RUs if you observe frequent HTTP 429 errors.
