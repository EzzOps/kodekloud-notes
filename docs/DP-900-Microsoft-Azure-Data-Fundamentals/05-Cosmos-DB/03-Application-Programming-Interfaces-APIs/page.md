...
> **lightbulb** The Core API automatically indexes all JSON properties by default, so there’s no need to manage schema migrations.
...
> **lightbulb** You can leverage MongoDB tools like `mongoexport` or `mongodump` to migrate data directly into Cosmos DB.
