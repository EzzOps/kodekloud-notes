...
> **lightbulb** Learn more about ETL best practices in the [Azure Data Factory documentation](https://docs.microsoft.com/azure/data-factory/concepts-pipelines-activities).
...
> **triangle-alert** Data transfer charges apply when moving data across Azure regions. To minimize egress fees, deploy your ETL pipelines and analytical storage within the **same region** as your source systems.
