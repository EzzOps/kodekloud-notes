...
> **lightbulb** Azure Synapse requires hierarchical namespace on your storage account. Letting the wizard create it ensures this setting is enabled automatically.
...
> **triangle-alert** Once the workspace is created, you cannot switch encryption between Microsoft-managed and customer-managed keys.
