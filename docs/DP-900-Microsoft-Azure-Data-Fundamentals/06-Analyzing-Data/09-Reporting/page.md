...
> **lightbulb** Power Query’s step-by-step transformation ensures reproducibility. When you refresh, only the final query runs against the source.
...
> **triangle-alert** DirectQuery can add query latency to visuals. Always test performance when using live connections.
...
> **lightbulb** In modeling view, drag to create relationships or adjust cardinality and cross-filter direction for accurate joins.
