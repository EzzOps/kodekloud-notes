...
> **lightbulb** In certain ccTLDs such as Mexico (MX) or India (IN), you may need to append a trailing dot during queries. Without the trailing dot, tools like dig might misinterpret the query—for example, confusing MX with mail exchange records.
