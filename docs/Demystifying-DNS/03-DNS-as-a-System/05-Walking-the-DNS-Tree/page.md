...
> **lightbulb** To verify glue records using DIG, you can execute the following command, which directly queries an authoritative nameserver with the +additional flag:
