...
> **lightbulb** If a client indicates support for 4096-byte UDP packets, the server will send larger UDP responses. TCP will only be used as a fallback when the response exceeds this limit.
...
> **triangle-alert** Using UDP payload sizes significantly higher than 4096 bytes may introduce security risks, including potential exposure to malicious attacks. Always adhere to recommended standards.
