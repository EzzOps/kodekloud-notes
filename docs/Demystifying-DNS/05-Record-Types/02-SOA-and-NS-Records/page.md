...
> **lightbulb** Remember to increment the Serial number each time you update the zone file.
...
> **triangle-alert** If you encounter an NXDOMAIN status, it may be due to the missing glue record for ns1.my.kodekloudlab.com. In the next article, we will discuss how to add this glue record, ensuring your local DNS server resolves the name server correctly.
