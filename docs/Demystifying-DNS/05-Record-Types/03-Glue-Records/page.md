...
Source: https://notes.kodekloud.com/docs/Demystifying-DNS/Record-Types/Glue-Records/page

This article explores glue records and their importance for DNS configuration and resolution.
...
> **lightbulb** In the example below, the nameserver is mapped to the loopback address (127.0.0.1). This setup works only when querying from node-01. In a production environment, replace it with a valid, routable IP address.
