...
> **triangle-alert** Domain hijacking is particularly dangerous because ICANN considers email an acceptable method for assessing the legitimacy of a domain transfer.
...
> **lightbulb** Legitimate domain transfers are a standard part of domain management. However, if you suspect that your domain has been transferred without authorization, you can file a dispute with [ICANN](https://www.icann.org/) to investigate the issue and potentially reverse the transfer.
