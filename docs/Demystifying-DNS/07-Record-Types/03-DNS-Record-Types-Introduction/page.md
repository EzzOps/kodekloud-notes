...
<Frame>
  ![The image illustrates DNS record types, showing a BIND9 server (DNS server) labeled as node01 and an Nginx server (web server) labeled as node02, with corresponding logos.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873250/notes-assets/images/Demystifying-DNS-DNS-Record-Types-Introduction/dns-record-types-bind9-nginx.jpg)
</Frame>
