...
> **lightbulb** Before proceeding, ensure that you have a proper backup of your critical data to avoid any loss during the troubleshooting process.
...
> **lightbulb** For application volumes, it is advisable to create an EBS snapshot to secure data before making changes.
