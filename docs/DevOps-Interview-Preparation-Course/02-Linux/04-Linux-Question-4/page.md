...
> **lightbulb** Ensure the Linux server has the proper permissions to interact with S3. This can be achieved using one of two methods:
...
> **lightbulb** Begin your Bash script with a shebang (`#!/bin/bash`) to specify the interpreter. This step ensures that the script runs in the appropriate shell environment.
