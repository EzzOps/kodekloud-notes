...
> **lightbulb** Although container logs persist across restarts, if a container is deleted, its logs are also removed. To avoid losing log data, it is recommended to use external persistent storage or integrate centralized logging solutions such as Splunk or CloudTrail.
