...
Source: https://notes.kodekloud.com/docs/DevOps-Interview-Preparation-Course/Docker/Docker-Question-4/page

This article clarifies the distinction between Docker images and Docker layers, essential concepts in DevOps interviews.
...
> **lightbulb** Understanding Docker layers can help you optimize your images by reducing size and improving security. Even though these layers operate behind the scenes, they are crucial for both image creation and container operation.
