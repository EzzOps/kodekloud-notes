...
Source: https://notes.kodekloud.com/docs/DevOps-Interview-Preparation-Course/Docker/Docker-Question-5/page

This article explores the differences between CMD and ENTRYPOINT instructions in Docker, clarifying their functionalities with practical examples.
...
> **lightbulb** While CMD offers runtime flexibility by allowing you to override its value, it should be used to define defaults rather than essential commands.
...
> **lightbulb** Using ENTRYPOINT with CMD allows you to maintain consistent behavior (via ENTRYPOINT) while offering adjustable defaults (via CMD), catering to both fixed operations and runtime customizations.
