...
> **lightbulb** When working with servers that have varying connection parameters, you must override the defaults by specifying the SSH port and username for each host directly within the inventory file.
