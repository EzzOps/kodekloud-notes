...
Source: https://notes.kodekloud.com/docs/DevOps-Interview-Preparation-Course/Jenkins-and-CICD/Jenkins-Question-1/page

This article explains using Docker containers to run Jenkins agents, isolating pipeline steps for consistent and clean test environments.
...
> **lightbulb** By leveraging Docker containers, you can spin up an isolated environment for each build or test stage on demand. After the tests are complete, the container is torn down, preserving the pristine state of your Jenkins agent.
