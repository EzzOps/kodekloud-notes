...
> **lightbulb** An instance fleet not only allows the use of multiple instance types but also supports integrating different purchasing options (spot, reserved, and on-demand) in one unified configuration.
