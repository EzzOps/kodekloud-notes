...
> **lightbulb** Use ENTRYPOINT for the always-run executable, CMD for default arguments, write both in exec/JSON form so signals are handled correctly, and use `docker exec` to debug a running container (do not replace CMD by running a new container).
...
- [Watch Video](https://learn.kodekloud.com/user/courses/devops-interview-prep/module/1d3d5877-dbf7-4105-8bc2-2c619ac62421/lesson/f8ea135f-474a-492c-b872-cec7a439c426)
