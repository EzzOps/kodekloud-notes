...
> **warning** Rewriting history and force-pushing affects every collaborator and all clones. Coordinate and require everyone to re-clone or perform a clean reset. Never force-push to shared branches without communication.
...
> **lightbulb** Short checklist when you discover leaked secrets:
...
- [Watch Video](https://learn.kodekloud.com/user/courses/devops-interview-prep/module/370000ef-b6bc-4986-8d29-0793ebb2c9e7/lesson/2b7b52a8-7642-4da9-a619-021b47120033)
...
> **lightbulb** Always run the query planner/executor to see what the database is actually doing before making changes.
...
> **warning** Do not use larger instances to hide slow queries. Upgrading hardware without addressing the root cause is expensive and temporary.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/devops-interview-prep/module/370000ef-b6bc-4986-8d29-0793ebb2c9e7/lesson/d9fd417e-1cee-4832-b412-a513ef2b44ca)
