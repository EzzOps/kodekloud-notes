...
> **lightbulb** Use a remote backend with locking (for example, S3 + DynamoDB or Terraform Cloud) when multiple engineers collaborate on the same infrastructure to avoid race conditions.

> **warning** Do not manually edit `terraform.tfstate`. Manual edits can corrupt the state and lead to resource drift or accidental destruction. Use Terraform commands (`taint`, `state` subcommands, etc.) to manage state safely.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/devops-interview-prep/module/b171f2a5-552f-44a7-a82e-e1770f1f9b53/lesson/7c496de6-bbda-4096-8d25-adb90e1b6a45)
...
> **lightbulb** A container is simply regular Linux processes with kernel-enforced isolation. From the process’s perspective it has its own filesystem, network interfaces, and process table—even though the kernel is shared with the host.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/devops-interview-prep/module/b171f2a5-552f-44a7-a82e-e1770f1f9b53/lesson/cb95dda1-c806-4b4d-9c2c-fa1e6176121d)
