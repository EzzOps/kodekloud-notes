...
> **lightbulb** Use single-flight/coalescing so concurrent cache misses for the same key result in a single database load.
...
> **warning** Be careful: caching introduces complexity — staleness, invalidation, race conditions, and potential for cache stampedes. Combine TTL, invalidation, single-flight, TTL jitter, and replication as appropriate to balance freshness, latency, and system resilience.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/devops-interview-prep/module/ef53ec43-96e9-4d1b-8a6e-e6eb97b0d0dc/lesson/bcc983fc-45fb-41f5-8a9f-4a73893294f0)
