...
> **lightbulb** Design labels carefully: include `service`, `environment`, `namespace`, `pod`, and `node` identifiers so queries can efficiently narrow the search space.
...
> **warning** If you need frequent full-text searches across all logs, evaluate the increased indexing cost with Elasticsearch. Loki is optimized for label-filtered queries and long-term, cost-efficient storage.

- [Watch Video](https://learn.kodekloud.com/user/courses/devops-interview-prep/module/ef53ec43-96e9-4d1b-8a6e-e6eb97b0d0dc/lesson/3405d1af-d021-498e-bf65-a45a11b261f1)
