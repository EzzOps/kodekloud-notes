...
<Frame>
  ![The image illustrates a multi-node deployment model with two servers, one running MariaDB and the other running Apache and PHP.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873404/notes-assets/images/DevOps-Pre-Requisite-Course-KodeKloud-E-Commerce-Application/frame_260.jpg)
</Frame>
...
<Frame>
  ![The image shows a list of popular programming languages, with JavaScript, Python, and Java highlighted, alongside a bar chart from a Stack Overflow survey.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873405/notes-assets/images/DevOps-Pre-Requisite-Course-Introduction/frame_130.jpg)
</Frame>
...
<Frame>
  ![The image categorizes programming languages into compiled (Java, C, C++) and interpreted (Python, Node.js, Ruby, Perl) types.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873406/notes-assets/images/DevOps-Pre-Requisite-Course-Introduction/frame_170.jpg)
</Frame>
