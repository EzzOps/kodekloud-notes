...
> **lightbulb** Please be aware that labs may take a few minutes to fully load. Patience is key!
...
> **triangle-alert** If your internet connection is lost, your lab session will expire. In this case, refresh the terminal or re-select the lab from the curriculum.
