...
> **lightbulb** When your Java application is built, it needs the Java Runtime Environment (JRE) to run. The JRE includes the necessary runtime components along with the Java command-line utility that serves as the application loader.
