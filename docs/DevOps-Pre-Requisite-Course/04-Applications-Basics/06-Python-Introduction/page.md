...
> **lightbulb** If Python is installed as `python` without an explicit version, you can check the version using `python -V` to determine whether it points to Python 2 or Python 3.
