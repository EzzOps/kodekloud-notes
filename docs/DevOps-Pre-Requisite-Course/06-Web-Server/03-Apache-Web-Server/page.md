...
> **lightbulb** Use the package manager to install, start, and check the Apache service with the commands shown below.
...
> **lightbulb** Mapping your domain in the `/etc/hosts` file can help simulate DNS resolution for local server development.
