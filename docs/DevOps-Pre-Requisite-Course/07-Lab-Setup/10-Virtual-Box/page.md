...
Source: https://notes.kodekloud.com/docs/DevOps-Pre-Requisite-Course/Lab-Setup/Virtual-Box/page

This article explains setting up a personal lab environment using VirtualBox for learning DevOps and cloud technologies through customizable virtual machines.
...
<Frame>
  ![The image is a slide titled "Labs," detailing topics like setting up labs, VirtualBox, deploying VMs, networking, and Vagrant basics.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873487/notes-assets/images/DevOps-Pre-Requisite-Course-Virtual-Box/frame_10.jpg)
</Frame>
...
<Frame>
  ![The image shows a laptop running two virtual machines with various software logos, including MySQL, Node.js, MongoDB, Java, Kubernetes, and CentOS, on a MacOS system.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873488/notes-assets/images/DevOps-Pre-Requisite-Course-Virtual-Box/frame_290.jpg)
</Frame>
...
<Frame>
  ![The image illustrates Type 1 virtualization software, featuring VMware ESXi and Microsoft Hyper-V, with a diagram showing VMs, a hypervisor, and a baremetal server.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873489/notes-assets/images/DevOps-Pre-Requisite-Course-Virtual-Box/frame_360.jpg)
</Frame>
...
<Frame>
  ![The image compares Type 1 and Type 2 virtualization software, featuring VMware ESXi and Microsoft Hyper-V for Type 1, and Oracle VirtualBox and VMware Workstation for Type 2.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873490/notes-assets/images/DevOps-Pre-Requisite-Course-Virtual-Box/frame_420.jpg)
</Frame>
...
<Frame>
  ![The image compares Oracle VirtualBox and VMware Workstation, highlighting features like being free, open-source, cross-platform, supporting snapshots, clones, multiple VMs, and networking.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873491/notes-assets/images/DevOps-Pre-Requisite-Course-Virtual-Box/frame_450.jpg)
</Frame>
...
<Frame>
  ![The image shows the Oracle VirtualBox interface, where a new virtual machine is being set up with the name "my-centos" and the Red Hat (64-bit) version.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873492/notes-assets/images/DevOps-Pre-Requisite-Course-Virtual-Box/frame_640.jpg)
</Frame>

<Frame>
  ![The image shows the Oracle VirtualBox interface, specifically the setup window for creating a new virtual machine with Red Hat Linux (64-bit) selected.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873494/notes-assets/images/DevOps-Pre-Requisite-Course-Virtual-Box/frame_650.jpg)
</Frame>
...
<Frame>
  ![The image shows the Oracle VM VirtualBox Manager interface with a context menu open, highlighting options to start a virtual machine named "my-centos."](../../../../images/kodekloud.com/kk-media/image/upload/v1752873495/notes-assets/images/DevOps-Pre-Requisite-Course-Virtual-Box/frame_790.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/devops-pre-requisite-course/module/9c8f26c1-90d7-488f-a675-1b77e777c173/lesson/3b787aa7-0f37-4077-aa0b-edc74d9d44c4" />
</CardGroup>
