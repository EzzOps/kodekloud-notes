...
> **lightbulb** The result of any JSONPath query is always returned as an array—even if it contains only a single element. For example, the query `$.vehicles.car` returns:
