...
Source: https://notes.kodekloud.com/docs/DevOps-Pre-Requisite-Course/Networking-Basics/DNS/page
...
You can also add multiple aliases for the same IP address. For instance, to associate system B with both "db" and "[www.google.com](http://www.google.com)", update the `/etc/hosts` file as follows:
...
<Frame>
  ![The image illustrates a DNS network diagram, showing connections between devices with "eth0" interfaces, IP addresses, and a DNS server within a 192.168.1.0 network.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873505/notes-assets/images/DevOps-Pre-Requisite-Course-DNS/frame_240.jpg)
</Frame>
...
<Frame>
  ![The image illustrates the DNS resolution process for "apps.google.com," showing the hierarchy from root DNS to the final IP address, 216.58.221.78.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873506/notes-assets/images/DevOps-Pre-Requisite-Course-DNS/frame_600.jpg)
</Frame>

Similarly, an organization might use a domain such as mycompany.com with subdomains like [www.mycompany.com](http://www.mycompany.com) for the public website, mail.mycompany.com for email, drive.mycompany.com for storage, payroll.mycompany.com for payroll services, and hr.mycompany.com for human resources. These DNS records are centrally managed by the internal DNS server.
...
<Frame>
  ![The image shows a table of DNS record types: A, AAAA, and CNAME, with corresponding web-server addresses and IPs.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873507/notes-assets/images/DevOps-Pre-Requisite-Course-DNS/frame_770.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/devops-pre-requisite-course/module/1790dd89-e589-4173-a51e-7be5efbd210a/lesson/ee144f98-d400-4906-aa03-c9acc4edcce8" />

  <Card title="Practice Lab" icon="installation" href="https://learn.kodekloud.com/user/courses/devops-pre-requisite-course/module/1790dd89-e589-4173-a51e-7be5efbd210a/lesson/8db7b84a-42ad-4b96-a6ac-211fc5c30a31" />
</CardGroup>
