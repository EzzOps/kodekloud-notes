...
> **lightbulb** If you need to change settings like the MySQL port or adjust other configurations, update this file as required. For this demo, default settings are maintained.
...
> **lightbulb** By following these steps, you have successfully deployed and configured the KodeKloud e-commerce application on a CentOS machine. Both the database and web server are now running and properly connected.
...
> **lightbulb** Be sure to adjust port settings or other configuration parameters in `/etc/my.cnf` as needed for your environment.
