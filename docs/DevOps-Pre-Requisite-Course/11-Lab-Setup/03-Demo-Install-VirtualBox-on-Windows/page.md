...
> **triangle-alert** If you don't see any 64-bit options in the drop-down, it may be because virtualization technology is disabled in your BIOS. Reboot your computer and access the BIOS settings to enable an option like "Virtualization Technology" under Advanced Settings.
