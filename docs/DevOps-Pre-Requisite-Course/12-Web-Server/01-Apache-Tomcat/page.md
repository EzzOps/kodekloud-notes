...
Source: https://notes.kodekloud.com/docs/DevOps-Pre-Requisite-Course/Web-Server/Apache-Tomcat/page

This article explores Apache Tomcat, detailing its installation, directory structure, and web application deployment on a CentOS machine.
...
<Frame>
  ![The image shows a browser displaying the Apache Tomcat 8.5.53 welcome page, indicating successful installation on localhost:8080.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873524/notes-assets/images/DevOps-Pre-Requisite-Course-Apache-Tomcat/frame_90.jpg)
</Frame>
...
[http://your-hostname:8080/app](http://your-hostname:8080/app)

For example, if your application displays a "Hello, World" message, its homepage will appear similar to the following:

<Frame>
  ![A browser displays a "Sample 'Hello, World' Application" webpage with links to a JSP page and a servlet, featuring a cat logo.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873525/notes-assets/images/DevOps-Pre-Requisite-Course-Apache-Tomcat/frame_310.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/devops-pre-requisite-course/module/b08dfb42-dea4-4432-862a-600e5e2649a6/lesson/2959e80a-c5a2-4a9b-8b39-695422114a97" />

  <Card title="Practice Lab" icon="installation" href="https://learn.kodekloud.com/user/courses/devops-pre-requisite-course/module/b08dfb42-dea4-4432-862a-600e5e2649a6/lesson/5c1cab66-71da-4594-9e30-a976306525a0" />
</CardGroup>
