...
<Frame>
  ![The image shows a task interface instructing to create an empty file named "empty\_file.txt" in the "/home/thor/" directory, with a "Tasks not completed" error.](https://kodekloud.com/kk-media/image/upload/v1752873499/notes-assets/images/DevOps-Pre-Requisite-Course-Labs-Introduction/frame_200.jpg)
</Frame>
