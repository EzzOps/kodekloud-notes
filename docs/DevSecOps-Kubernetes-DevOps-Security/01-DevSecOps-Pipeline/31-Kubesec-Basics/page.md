...
Source: https://notes.kodekloud.com/docs/DevSecOps-Kubernetes-DevOps-Security/DevSecOps-Pipeline/Kubesec-Basics/page

KubeSec is an open-source Kubernetes security scanner that analyzes manifests for vulnerabilities and provides a security score and recommendations.
...
<Frame>
  ![The image is a presentation slide about Kubesec, an open-source Kubernetes security scanner and analysis tool, detailing its features and availability. It includes a brief description of its functionality and formats in which it can be used.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873722/notes-assets/images/DevSecOps-Kubernetes-DevOps-Security-Kubesec-Basics/kubesec-kubernetes-security-scanner-presentation.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/devsecops-kubernetes-devops-security/module/877bd662-968c-40a5-bda6-a42b600ea957/lesson/975a1292-de3c-4b22-a4d5-09dfdd0bcb61" />
</CardGroup>
