...
Source: https://notes.kodekloud.com/docs/DevSecOps-Kubernetes-DevOps-Security/DevSecOps-Pipeline/OWASP-ZAP-Basics/page

This lesson explores using OWASP ZAP for dynamic application security testing of a Spring Boot REST API, covering scan types, Docker usage, and result interpretation.
...
<Frame>
  ![The image is an informational graphic about OWASP ZAP, an open-source web application security scanner, detailing its function as a "man-in-the-middle proxy" and describing different Docker images and scan types.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873725/notes-assets/images/DevSecOps-Kubernetes-DevOps-Security-OWASP-ZAP-Basics/owasp-zap-security-scanner-graphic.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/devsecops-kubernetes-devops-security/module/877bd662-968c-40a5-bda6-a42b600ea957/lesson/4dad6aa1-0cb4-43b7-a93f-89f3d5078db1" />
</CardGroup>
