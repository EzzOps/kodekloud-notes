...
Source: https://notes.kodekloud.com/docs/DevSecOps-Kubernetes-DevOps-Security/Introduction/Security-Aspects/page

This guide covers integrating security into the software development lifecycle to reduce risk and enhance delivery speed.
...
> **lightbulb** Early remediation reduces both cost and time to fix defects—build security gates into pull requests and CI pipelines.
...
> **lightbulb** Automate security checks in CI pipelines to enforce consistency and reduce manual overhead.
...
> **triangle-alert** DAST can be intrusive—run it in isolated environments to avoid service disruptions.
...
[^1]: Dynamic application security testing (DAST) - [https://en.wikipedia.org/wiki/Dynamic\_application\_security\_testing](https://en.wikipedia.org/wiki/Dynamic_application_security_testing)

[^2]: Common Vulnerabilities and Exposures (CVE) - [https://cve.mitre.org/](https://cve.mitre.org/)\
