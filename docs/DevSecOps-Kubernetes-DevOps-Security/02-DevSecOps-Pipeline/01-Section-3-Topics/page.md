...
> **lightbulb** Ensure you have a GitHub repository connected and a Jenkins server with the Kubernetes plugin installed.
...
> **triangle-alert** Make sure the Slack plugin is installed in Jenkins and you have configured your Incoming Webhook URL under **Manage Jenkins → Configure System → Slack**.
