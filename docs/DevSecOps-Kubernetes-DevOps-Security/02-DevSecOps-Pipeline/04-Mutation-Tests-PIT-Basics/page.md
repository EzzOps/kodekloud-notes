...
> **lightbulb** If you want to apply Talisman globally, see the [global\_install\_scripts](https://github.com/thoughtworks/talisman/tree/master/global_install_scripts) in the Talisman repo.
...
> **triangle-alert** Bypassing hooks (`--no-verify`) skips all pre-push checks. Use this only when you’re certain no sensitive data is included.
...
> **lightbulb** Mutation testing doesn’t replace unit testing—it complements it. Use mutation score alongside line coverage for a fuller picture of test quality.
...
> **triangle-alert** Mutation testing can significantly increase build time. For large codebases, run PIT in incremental mode or focus on key modules first.
