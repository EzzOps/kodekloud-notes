...
> **lightbulb** The environment variable `SONAR_ES_BOOTSTRAP_CHECKS_DISABLE=true` disables Elasticsearch bootstrap checks for development environments. Do **not** use this in production.
