...
> **lightbulb** Ensure you have administrative access in both Jenkins and SonarQube to configure plugins, credentials, and webhooks.
...
> **triangle-alert** If the quality gate fails, the pipeline will abort at the **Quality Gate** stage. Inspect and resolve all reported issues before retrying.
