...
> **lightbulb** Refer to the official [Trivy Documentation](https://aquasecurity.github.io/trivy/) for detailed information on supported targets and scanning modes.
...
> **lightbulb** Mounting a cache directory speeds up repeated scans by storing the vulnerability database locally.
...
> **triangle-alert** By default, Trivy exits with code `0` even if vulnerabilities are found. Use `--exit-code` to enforce build failures in CI/CD.
