...
Source: https://notes.kodekloud.com/docs/DevSecOps-Kubernetes-DevOps-Security/DevSecOps-Pipeline/OPA-Conftest-Basics/page

This guide explains using Open Policy Agent and Conftest to enforce Docker best practices through policy-as-code.
...
> **triangle-alert** Using the `latest` tag in production images can lead to unpredictable builds and security risks. Always pin to a specific, immutable version.
...
> **lightbulb** You can extend your Rego file to cover these additional rules or write new policies for other Dockerfile instructions.
