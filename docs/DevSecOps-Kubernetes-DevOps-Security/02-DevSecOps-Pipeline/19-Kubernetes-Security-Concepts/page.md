...
Source: https://notes.kodekloud.com/docs/DevSecOps-Kubernetes-DevOps-Security/DevSecOps-Pipeline/Kubernetes-Security-Concepts/page
...
> **lightbulb** Integrate these tools into your CI pipelines for continuous assessment. For example, add a GitHub Action step to run `trivy` on every push.
...
> **triangle-alert** Running containers as root (UID 0) may allow privilege escalation and lateral movement within your cluster. Always set `runAsNonRoot: true` unless absolutely necessary.
