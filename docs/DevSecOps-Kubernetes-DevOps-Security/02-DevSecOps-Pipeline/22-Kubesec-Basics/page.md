...
> **lightbulb** KubeSec supports multi-document YAML files. Separate resources with `---` in the same file and scan them together.
...
> **triangle-alert** If you expose the REST endpoint publicly, ensure you protect it behind authentication or a firewall to prevent misuse.
