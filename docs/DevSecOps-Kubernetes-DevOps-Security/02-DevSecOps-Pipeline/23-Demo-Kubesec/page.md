...
> **triangle-alert** Ensure the Jenkins service account has `get`, `create`, `update`, and `rollout` permissions on the target namespace.
...
> **lightbulb** Adjust the threshold (`5` points) to match your team’s security policy.
