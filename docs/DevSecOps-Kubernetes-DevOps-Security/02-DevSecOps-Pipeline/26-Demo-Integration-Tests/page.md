...
> **triangle-alert** Always applying the full manifest will restart pods and may cause brief downtime. Plan for rolling updates.
...
> **lightbulb** The `emptyDir` volume is ephemeral and only persists for the pod’s lifetime. Use a `PersistentVolume` if you need data durability.
