...
> **lightbulb** API scans skip UI-related tests (e.g., XSS) and focus on HTTP error codes or unusual content types.
...
> **triangle-alert** Ensure the API definition is reachable (no authentication required) when running scans. Firewall or incorrect URLs can cause false failures.
