...
> **lightbulb** Spring Security automatically adds many secure headers, including `X-Content-Type-Options: nosniff`.
...
> **triangle-alert** Raising the CVSS threshold should only be temporary. Revert once a fixed release is available.
