...
> **lightbulb** * `--light` mode skips non-OS packages for faster scans.
...
> **lightbulb** Below is a quick overview of the tools and their purposes:
...
> **triangle-alert** The pipeline will pause at the **Promote to PROD** stage until an approver selects **Proceed** or **Abort**. Aborting will stop the pipeline and notify the team via Slack.
