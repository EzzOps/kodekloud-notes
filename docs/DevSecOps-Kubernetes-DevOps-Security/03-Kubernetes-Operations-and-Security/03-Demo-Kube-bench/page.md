...
> **triangle-alert** Disabling mTLS will route all service-to-service traffic over plaintext HTTP, exposing your data in transit.
...
> **lightbulb** Permissive mode allows both mTLS and plaintext connections simultaneously—ideal for gradual rollout.
...
> **lightbulb** The PDF contains \~270 pages of guidelines, organized by test IDs per component. For instance, **4.2.1** in *Worker Node Security Configuration* verifies `--anonymous-auth=false`.
