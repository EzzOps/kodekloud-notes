...
> **lightbulb** Istio works transparently alongside any application stack (Spring Boot, Node.js, Vert.x, etc.) by injecting an Envoy sidecar proxy into each pod.
...
> **triangle-alert** In Istio 1.5+, Galley and Pilot components were merged into `istiod`. Be sure to check your Istio version and configuration model.
