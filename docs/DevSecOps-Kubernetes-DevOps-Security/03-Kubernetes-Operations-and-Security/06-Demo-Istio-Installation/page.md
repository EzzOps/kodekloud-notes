...
> **lightbulb** The **demo** profile is preconfigured with observability add-ons for testing and learning. It is **not** recommended for production environments.
...
> **triangle-alert** Enabling sidecar injection will add an Envoy proxy to every pod in the `default` namespace. Ensure your workloads are compatible.
