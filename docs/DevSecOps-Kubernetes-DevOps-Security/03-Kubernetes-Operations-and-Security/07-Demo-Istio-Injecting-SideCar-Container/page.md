...
> **lightbulb** We’ll use **Automatic Injection** for this demo, since it requires no modifications to your application manifests.
...
> **lightbulb** The `istio-system` namespace is generally labeled `istio-injection=disabled` to prevent sidecar injection into control plane components.
