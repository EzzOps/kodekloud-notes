...
> **lightbulb** Make sure your pods are annotated or labeled for automatic sidecar injection. See [Istio Automatic Injection](https://istio.io/latest/docs/setup/additional-setup/sidecar-injection/).
...
> **triangle-alert** Switching from **PERMISSIVE** to **STRICT** may break clients that don’t support mTLS. Roll out changes carefully and monitor with [Kiali](https://istio.io/latest/docs/ops/visualization/kiali/).
