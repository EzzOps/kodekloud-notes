...
> **lightbulb** Prometheus focuses strictly on metrics collection and alerting. It does not handle logs, distributed tracing, or advanced anomaly detection. Consider integrating with [Grafana Loki](https://grafana.com/oss/loki/) for logs and [Jaeger](https://www.jaegertracing.io/) for tracing.
