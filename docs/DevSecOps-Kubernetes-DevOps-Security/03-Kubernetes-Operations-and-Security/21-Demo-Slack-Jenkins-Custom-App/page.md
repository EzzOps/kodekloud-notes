...
> **lightbulb** Make sure the **Slack Notification Plugin** is installed in your Jenkins instance. It provides the `slackSend` step with support for attachments and Block Kit layouts.
...
> **triangle-alert** If you receive `{"ok":false,"error":"not_in_channel"}`, the bot hasn’t been invited to your channel yet.
