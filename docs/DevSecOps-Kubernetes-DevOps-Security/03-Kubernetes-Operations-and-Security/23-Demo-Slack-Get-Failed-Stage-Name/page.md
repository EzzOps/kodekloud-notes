...
> **lightbulb** The methods are annotated with `@NonCPS` to ensure they run outside the Pipeline CPS engine.
...
> **triangle-alert** Ensure you only approve trusted methods. Unrestricted script approval can introduce security risks.
