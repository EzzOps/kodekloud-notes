...
<Frame>
  ![The image shows the Jenkins Plugin Manager interface with a list of installed plugins, including Docker-related plugins. A search for "docker" is highlighted, and various plugins are listed with options to uninstall.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873564/notes-assets/images/DevSecOps-Kubernetes-DevOps-Security-Demo-Docker-Build-and-Push/jenkins-plugin-manager-docker-plugins.jpg)
</Frame>
...
<Frame>
  ![The image shows a Jenkins interface displaying the "Global credentials (unrestricted)" section, with a credential named "kubeconfig" listed as a secret file.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873565/notes-assets/images/DevSecOps-Kubernetes-DevOps-Security-Demo-Docker-Build-and-Push/jenkins-global-credentials-kubeconfig.jpg)
</Frame>

<Frame>
  ![The image shows a Jenkins interface where a user is adding global credentials, including a username, password, and ID. The browser tabs and taskbar are also visible.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873566/notes-assets/images/DevSecOps-Kubernetes-DevOps-Security-Demo-Docker-Build-and-Push/jenkins-global-credentials-interface.jpg)
</Frame>
