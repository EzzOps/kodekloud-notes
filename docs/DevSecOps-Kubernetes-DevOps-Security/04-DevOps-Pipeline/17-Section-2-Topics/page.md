...
<Frame>
  ![The image outlines a DevOps pipeline process, including setting up a VM, installing software, understanding use cases, and implementing a basic DevOps pipeline. It also covers DevSecOps and Kubernetes security topics.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873604/notes-assets/images/DevSecOps-Kubernetes-DevOps-Security-Section-2-Topics/devops-pipeline-vm-software-security.jpg)
</Frame>
...
kubectl apply -f https://raw.githubusercontent.[AWS_SECRET_ACCESS_KEY]kube-flannel.yml
```
