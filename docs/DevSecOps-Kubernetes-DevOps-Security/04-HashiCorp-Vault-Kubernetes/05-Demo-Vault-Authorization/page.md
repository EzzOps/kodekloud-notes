...
> **triangle-alert** Ensure your environment variable `KUBERNETES_PORT_443_TCP_ADDR` points to the correct API server IP or DNS name before running this command.
...
> **lightbulb** Vault policies are defined in HCL and loaded from local files. Capabilities include `create`, `read`, `update`, `delete`, among others.
