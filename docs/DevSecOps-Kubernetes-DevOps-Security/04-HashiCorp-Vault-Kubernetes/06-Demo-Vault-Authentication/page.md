...
> **lightbulb** You can use any non-root token with sufficient privileges instead of the root token. Follow [Vault best practices](https://www.vaultproject.io/docs/concepts/policies) for production environments.
