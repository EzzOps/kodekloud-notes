...
> **lightbulb** Refer to the [official Prometheus Alertmanager documentation](https://prometheus.io/docs/alerting/latest/alertmanager/) for complete configuration options and notification templates.
