...
> **lightbulb** DNS changes can take a few minutes to propagate. Use `nslookup DevSecOpsDemo.eastus.cloudapp.azure.com` to verify resolution.
...
> **triangle-alert** Always review scripts from external sources before executing them on production systems.
