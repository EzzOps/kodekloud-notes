...
> **lightbulb** If you don’t see your credits immediately, refresh the portal or wait a few seconds for the dashboard to update.
...
> **triangle-alert** Stopping (deallocating) a VM releases compute resources and stops billing for core hours, but you may still incur charges for allocated storage and public IP addresses.
...
> **lightbulb** Cost analysis data may take several hours (or up to 24 hours) to fully populate after you create or modify resources.
