...
> **lightbulb** Automating plugin installation with the Remote REST API ensures consistent environments, especially in Infrastructure as Code workflows.
...
> **lightbulb** If you changed the default port in your install script, adjust the URL accordingly.
...
> **lightbulb** Depending on your network and VM resources, this step may take several minutes.
