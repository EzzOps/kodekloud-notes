...
> **lightbulb** Your `pom.xml` sits at the root of your project. It controls everything from dependency versions to plugin executions.
...
> **triangle-alert** Ensure your `pom.xml` `<packaging>` element matches your intended artifact type (`jar`, `war`, etc.) to avoid build failures.
