...
> **triangle-alert** Make sure your Jenkins instance is accessible from the internet or via VPN so GitHub can reach the webhook endpoint.
...
> **lightbulb** Ensure the **GitHub Integration** and **Pipeline** plugins are installed in Jenkins to enable SCM polling and webhook triggers.
