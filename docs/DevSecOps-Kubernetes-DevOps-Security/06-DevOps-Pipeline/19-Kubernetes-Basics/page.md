...
Source: https://notes.kodekloud.com/docs/DevSecOps-Kubernetes-DevOps-Security/DevOps-Pipeline/Kubernetes-Basics/page

This article covers the basics of Kubernetes, focusing on core objects like Pods, ReplicaSets, and Deployments for managing containerized applications.
...
> **lightbulb** Pods are ephemeral. When a Pod dies, it won't be recreated unless managed by a higher-level controller (e.g., ReplicaSet).
...
> **triangle-alert** Always specify `selector.matchLabels` correctly in your Deployment to avoid orphaned ReplicaSets.
