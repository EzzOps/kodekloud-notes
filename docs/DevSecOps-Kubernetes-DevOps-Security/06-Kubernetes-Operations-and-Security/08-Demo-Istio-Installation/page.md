...
<Frame>
  ![The image showcases four tools: Jaeger, Grafana, Prometheus, and Kiali, each used for monitoring and visualizing microservices and infrastructure data. It includes brief descriptions and screenshots of their interfaces.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873751/notes-assets/images/DevSecOps-Kubernetes-DevOps-Security-Demo-Istio-Installation/jaeger-grafana-prometheus-kiali-tools.jpg)
</Frame>
...
<Frame>
  ![The image shows a Kiali dashboard interface displaying an overview of namespaces, including "default" and "istio-system," with details about applications and traffic. The browser tabs and taskbar are visible, indicating a Windows operating system.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873752/notes-assets/images/DevSecOps-Kubernetes-DevOps-Security-Demo-Istio-Installation/kiali-dashboard-namespaces-overview-windows.jpg)
</Frame>
