...
<Frame>
  ![The image shows a Kiali dashboard displaying a service mesh graph for a Kubernetes environment, illustrating the connections and response times between different services.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873753/notes-assets/images/DevSecOps-Kubernetes-DevOps-Security-Demo-Istio-mTLS/kiali-dashboard-service-mesh-graph.jpg)
</Frame>
...
<Frame>
  ![The image shows a Kiali dashboard displaying a service mesh graph for a Kubernetes environment, illustrating the connections and response times between different services.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873755/notes-assets/images/DevSecOps-Kubernetes-DevOps-Security-Demo-Istio-mTLS/kiali-dashboard-service-mesh-graph-2.jpg)
</Frame>
