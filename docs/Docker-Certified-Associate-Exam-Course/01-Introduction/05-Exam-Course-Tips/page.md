...
> **lightbulb** Research questions are open-book, multiple-choice exercises designed to help you learn how to locate answers in documentation and gain comfort with the exam style. They are learning tools — use lecture knowledge, the docs, and a lab environment to research answers.
...
> **warning** Important: The official exam is not open-book — do not expect to consult documentation during the test. Practice recall with timed mock exams to simulate conditions.
