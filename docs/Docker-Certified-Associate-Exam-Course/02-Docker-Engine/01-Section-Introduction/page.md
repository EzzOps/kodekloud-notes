...
> **triangle-alert** Live restore requires compatible Docker versions and proper permissions. Check the [Docker daemon.json reference][1] before enabling.
...
> **lightbulb** You should be comfortable with basic Docker concepts covered in the [Beginner’s Docker Course](https://example.com/beginners-course) before proceeding.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/docker-certified-associate-exam-course/module/871494af-49f8-42e9-95e9-cb0df80c2b21/lesson/45bbbbd4-1412-4eb9-94c6-138f327c742f)
