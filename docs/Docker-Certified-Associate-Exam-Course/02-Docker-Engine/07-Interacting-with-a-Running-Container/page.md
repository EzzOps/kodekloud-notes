...
Source: https://notes.kodekloud.com/docs/Docker-Certified-Associate-Exam-Course/Docker-Engine/Interacting-with-a-Running-Container/page

This article demonstrates managing running Docker containers, including exiting, detaching, executing commands, opening shells, and reattaching without interrupting processes.
...
> **lightbulb** The detach sequence `Ctrl-p` + `Ctrl-q` does not stop the container; it simply returns you to the host shell.
...
> **triangle-alert** Exiting the primary shell (PID 1) will stop the container. To avoid unintentionally shutting it down, detach (`Ctrl-p` `Ctrl-q`) instead of exiting.
