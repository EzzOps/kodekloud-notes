...
Source: https://notes.kodekloud.com/docs/Docker-Certified-Associate-Exam-Course/Docker-Engine/Demo-Docker-Container-Operations-Continued/page

This lesson covers advanced Docker flags and best practices for managing containers effectively.
...
> **lightbulb** Using `--rm` is ideal for one-off or CI tasks. Remember that you won’t be able to inspect logs or the filesystem after the container exits.
...
> **triangle-alert** Use `always` or `unless-stopped` for critical services. Excessive restart loops on failure can degrade performance—consider `on-failure` with a retry limit.
...
2020-05-04T08:38:43.747Z network connect cf10… (container=2daf…, name=bridge)
2020-05-04T08:38:43.976Z container start … (image=ubuntu, name=casethree)
2020-05-04T08:39:43.633Z network connect cf10… (container=74b0…, name=bridge)
2020-05-04T08:39:43.890Z container start … (image=ubuntu, name=casefour)
...
> **lightbulb** For production services, always use `-p` for predictable port assignments and easier firewall configuration.
