...
> **lightbulb** You can name and reuse stages to optimize builds and caching.
...
> **triangle-alert** Forgetting to exclude large directories (e.g., `.git` or `node_modules`) can dramatically increase build time and image size.
...
> **lightbulb** You can verify the full reference of an existing image with:
