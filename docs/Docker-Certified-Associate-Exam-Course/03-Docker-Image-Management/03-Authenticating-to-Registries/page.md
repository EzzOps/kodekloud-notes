...
> **triangle-alert** Pruning removes **all** unused volumes. Ensure you have backups of any critical data before proceeding.
...
> **lightbulb** The `"RW": true` field confirms the volume is mounted read-write inside the container.
...
> **lightbulb** By default, `docker pull ubuntu` retrieves the `latest` tag. To pull a specific version, append the tag (e.g., `ubuntu:20.04`).
...
> **triangle-alert** You must authenticate before pulling from or pushing to private registries.\
