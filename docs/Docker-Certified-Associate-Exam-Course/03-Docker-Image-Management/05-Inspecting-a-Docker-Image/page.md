...
> **triangle-alert** Always ensure you’re logged in to the correct registry. Pushing to the wrong registry can overwrite critical images.
...
> **lightbulb** Ensure you have Docker installed and running. Check your version with `docker version`.\
...
> **triangle-alert** Inspecting very large images may output extensive JSON. Use filtering (see next section) or redirect output to a file:
