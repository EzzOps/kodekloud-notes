...
Source: https://notes.kodekloud.com/docs/Docker-Certified-Associate-Exam-Course/Docker-Image-Management/Save-and-Load-Images/page

Learn to export and import Docker images and containers using tar archives in restricted environments without direct internet access.
...
> **lightbulb** Always verify you’re using the correct `<repository>:<tag>` when saving and loading images to avoid version mismatches.

> **triangle-alert** Ensure you have sufficient disk space on both source and target systems before exporting large images.
