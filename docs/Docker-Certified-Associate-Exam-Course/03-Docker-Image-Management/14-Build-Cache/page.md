...
> **triangle-alert** You cannot push or pull the `scratch` image—it's only referenced in `FROM scratch` directives.
...
> **triangle-alert** Stale package lists may cause installation of outdated or missing packages.
...
> **lightbulb** Always include `&& rm -rf /var/lib/apt/lists/*` if you want to reduce image size.
