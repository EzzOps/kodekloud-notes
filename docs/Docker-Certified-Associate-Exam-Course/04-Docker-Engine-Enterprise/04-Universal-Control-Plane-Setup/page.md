...
Source: https://notes.kodekloud.com/docs/Docker-Certified-Associate-Exam-Course/Docker-Engine-Enterprise/Universal-Control-Plane-Setup/page

This article covers the setup and installation of Dockers Universal Control Plane for managing Docker Swarm clusters.
...
On worker nodes, the UCP agent also spins up a dedicated *ucp-proxy* that mediates all Docker API calls, ensuring only authorized users and services can execute commands.
...
<Frame>
  ![The image is a diagram of a Docker Swarm setup, showing a manager node and worker nodes with components like "ucp-agent" and "ucp-proxy," and indicating compatibility with Linux and Windows.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873890/notes-assets/images/Docker-Certified-Associate-Exam-Course-Universal-Control-Plane-Setup/docker-swarm-setup-diagram.jpg)
</Frame>
...
<Frame>
  ![The image outlines steps for setting up UCP (Universal Control Plane) with Docker EE, including running a container, setting admin credentials, and adding managers and workers.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873890/notes-assets/images/Docker-Certified-Associate-Exam-Course-Universal-Control-Plane-Setup/ucp-setup-docker-ee-steps.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/docker-certified-associate-exam-course/module/a6a39359-7fb1-4fab-b0c2-6fc58a6ce617/lesson/9d977879-7bd7-4f6f-9000-a985b3d452be" />
</CardGroup>
