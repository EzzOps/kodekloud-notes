...
Source: https://notes.kodekloud.com/docs/Docker-Certified-Associate-Exam-Course/Docker-Engine-Enterprise/Demo-DTR-Setup/page

This guide covers the installation and configuration of Docker Trusted Registry on a Universal Control Plane cluster.
...
<Frame>
  ![The image shows a webpage from Docker documentation detailing the installation of Docker Trusted Registry (DTR) and Universal Control Panel (UCP), including a diagram illustrating the setup of manager and worker nodes.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873846/notes-assets/images/Docker-Certified-Associate-Exam-Course-Demo-DTR-Setup/docker-dtr-ucp-installation-diagram.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/docker-certified-associate-exam-course/module/a6a39359-7fb1-4fab-b0c2-6fc58a6ce617/lesson/3b83c4b7-d78b-4e11-b46a-9c52cf6080a3" />
</CardGroup>
