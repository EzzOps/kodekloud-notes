...
<Frame>
  ![The image shows a Docker Trusted Registry (DTR) interface with a message indicating there are no repositories and a prompt to create a new one.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873879/notes-assets/images/Docker-Certified-Associate-Exam-Course-Docker-Trusted-Registry-Setup/docker-trusted-registry-no-repositories.jpg)
</Frame>
...
<Frame>
  ![The image illustrates a Docker Swarm setup with a manager node and two worker nodes, showing components like ucp-agent, ucp-controller, and dtr-ol, along with a connection to S3 storage.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873880/notes-assets/images/Docker-Certified-Associate-Exam-Course-Docker-Trusted-Registry-Setup/docker-swarm-setup-manager-worker.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/docker-certified-associate-exam-course/module/a6a39359-7fb1-4fab-b0c2-6fc58a6ce617/lesson/be90b268-dc2c-4b30-bd07-9960d9a88689" />
</CardGroup>
