...
Source: https://notes.kodekloud.com/docs/Docker-Certified-Associate-Exam-Course/Docker-Engine-Enterprise/UCP-Setting-for-LDAP-integration/page

This article explains how to configure LDAP integration in Docker Universal Control Plane for user and group management.
...
1. Open your browser and go to your UCP console URL (e.g., [https://ucp.example.com](https://ucp.example.com)).
...
<Frame>
  ![The image shows the "Admin Settings" page of Docker Enterprise, specifically focusing on "Authentication & Authorization" settings, including options for LDAP configuration and test login.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873888/notes-assets/images/Docker-Certified-Associate-Exam-Course-UCP-Setting-for-LDAP-integration/docker-enterprise-admin-settings-authentication.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/docker-certified-associate-exam-course/module/a6a39359-7fb1-4fab-b0c2-6fc58a6ce617/lesson/539cdf2b-2d99-417f-bac4-0d444a0ab981" />
</CardGroup>
