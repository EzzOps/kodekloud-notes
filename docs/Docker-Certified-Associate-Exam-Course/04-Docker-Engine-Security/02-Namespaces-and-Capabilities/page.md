...
> **triangle-alert** Granting `--privileged` mode gives the container all host capabilities, which can compromise security. Use it only when absolutely necessary.

> **lightbulb** For a full list of Linux capabilities, see [Kernel Capabilities](http://man7.org/linux/man-pages/man7/capabilities.7.html).
