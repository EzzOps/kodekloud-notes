...
> **lightbulb** CPU shares only affect relative scheduling. A container with fewer shares can still use 100% of CPU if it’s the only active workload.
...
> **triangle-alert** Without proper CPU limits, a container can monopolize the host CPU, starving other containers or the Docker daemon and causing an unresponsive system.
