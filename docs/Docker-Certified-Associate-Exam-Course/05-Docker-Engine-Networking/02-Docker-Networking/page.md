...
<Frame>
  ![The image illustrates a user-defined network setup with Docker containers, showing IP addresses and connections between them.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873891/notes-assets/images/Docker-Certified-Associate-Exam-Course-Docker-Networking/docker-user-defined-network-setup.jpg)
</Frame>
