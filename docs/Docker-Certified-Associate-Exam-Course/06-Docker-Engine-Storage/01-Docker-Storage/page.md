...
> **lightbulb** Docker containers are ephemeral by design. Without proper use of volumes or external storage, any data written inside a container will be lost when the container stops or is removed.
...
> **triangle-alert** When using network-backed volumes, verify your plugin’s compatibility and performance constraints to prevent I/O bottlenecks in production.
