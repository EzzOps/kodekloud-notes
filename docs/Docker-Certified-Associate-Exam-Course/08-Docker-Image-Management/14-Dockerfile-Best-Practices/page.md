...
<Frame>
  ![The image is a slide titled "Slim/Minimal Images" with three best practice tips: create slim/minimal images, find an official minimal image, and only install necessary packages. There's also a globe icon and a "Best Practice" label.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873919/notes-assets/images/Docker-Certified-Associate-Exam-Course-Dockerfile-Best-Practices/slim-minimal-images-best-practices.jpg)
</Frame>
