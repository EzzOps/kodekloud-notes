...
> **lightbulb** By default, manager nodes can handle workloads in addition to management tasks. To dedicate a manager solely to orchestration, use `docker node update --availability drain <node>`.
