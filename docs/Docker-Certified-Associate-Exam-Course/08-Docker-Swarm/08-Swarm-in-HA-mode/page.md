...
> **lightbulb** The `--advertise-addr` flag sets the manager’s reachable IP for new nodes.
...
> **triangle-alert** Never simulate quorum loss in production. You will lose control over scheduling and service updates.
