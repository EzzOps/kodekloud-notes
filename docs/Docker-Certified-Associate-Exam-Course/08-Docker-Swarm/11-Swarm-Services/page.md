...
> **lightbulb** If you omit `--replicas`, Docker defaults to a single replica (`1`).
...
> **lightbulb** A *task* is the Swarm abstraction for running a container and maintaining its desired state.
