...
> **lightbulb** Ensure the `web:latest` image is available locally or on your registry before creating the service.
...
> **triangle-alert** Using `continue` can leave your cluster in a mixed-version state. Test thoroughly before choosing this option in production.
