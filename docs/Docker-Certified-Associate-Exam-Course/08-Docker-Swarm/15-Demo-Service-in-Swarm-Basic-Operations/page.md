...
> **lightbulb** Always confirm that at least one manager node is in **Leader** status before proceeding.
...
> **lightbulb** Swarm will detect that the replica count is below the desired state and launch a new task immediately.
...
> **triangle-alert** During rolling updates, verify your application’s health checks to avoid cascading failures.
