...
Source: https://notes.kodekloud.com/docs/Docker-Certified-Associate-Exam-Course/Docker-Swarm/Placement-in-Swarm/page

Managing service placement in Docker Swarm to optimize workload distribution across nodes with different resource profiles.
...
<Frame>
  ![The image illustrates a system architecture with three worker nodes labeled as CPU-optimized, memory-optimized, and general-purpose, alongside components for web servers, batch processing, and real-time analytics.](../../../../images/kodekloud.com/kk-media/image/upload/v1752873928/notes-assets/images/Docker-Certified-Associate-Exam-Course-Placement-in-Swarm/system-architecture-worker-nodes.jpg)
</Frame>
...
<Callout icon="triangle-alert">
  ...
  For more options, see the [Service Create reference][service_create].
</Callout>
...
* [Service Create reference][service_create]
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/docker-certified-associate-exam-course/module/16b8b1e1-1e1f-4e11-976f-8d5c1223c53d/lesson/2fd9461d-bd7c-42f2-a5b3-af8ef2c484ee" />
</CardGroup>
