...
> **lightbulb** Kubernetes supports multiple container runtimes. While Docker is the most common, you can also use CRI-O or containerd via the [Container Runtime Interface (CRI)](https://kubernetes.io/docs/concepts/architecture/cri/).
...
> **triangle-alert** Data in **etcd** is critical: back it up regularly. Loss of etcd data can render your cluster unusable.
