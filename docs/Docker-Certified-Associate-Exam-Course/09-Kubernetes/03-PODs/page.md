...
> **triangle-alert** Multi-container Pods are ideal for sidecars but shouldn’t replace scaling. Use them sparingly to avoid complexity.
...
> **lightbulb** The Pod is running inside the cluster but not exposed externally. Use a Service to make it accessible to clients.
