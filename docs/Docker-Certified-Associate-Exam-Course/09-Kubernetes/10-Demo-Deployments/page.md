...
> **lightbulb** Browse all available NGINX tags on Docker Hub to pick a stable version:\
...
> **triangle-alert** Using a non-existent image will trigger `ImagePullBackOff` errors and stall the rollout.\
