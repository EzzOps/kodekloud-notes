...
Source: https://notes.kodekloud.com/docs/Docker-Certified-Associate-Exam-Course/Kubernetes/ConfigMaps/page

ConfigMaps allow decoupling configuration artifacts from image content, enabling easy portability of containerized applications through key-value pair storage.
...
> **lightbulb** ConfigMaps are not designed for sensitive information. Use [Secrets](https://kubernetes.io/docs/concepts/configuration/secret/) for credentials and tokens.
...
> **lightbulb** Use descriptive names and labels for each ConfigMap (e.g., `app-config`, `mysql-config`, `redis-config`) so you can manage them easily across environments.
