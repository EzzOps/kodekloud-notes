...
> **triangle-alert** Hardcoding sensitive data like database passwords in your application is insecure. Always store secrets in a dedicated secret store rather than plain text files or code.
...
> **lightbulb** The `type: Opaque` is the default Secret type for arbitrary user-defined data.\
