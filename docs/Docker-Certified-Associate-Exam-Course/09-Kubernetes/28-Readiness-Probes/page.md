...
> **lightbulb** By default, Kubernetes marks the `Ready` condition as `True` once containers start, even if the application isn’t fully initialized.
...
> **lightbulb** Consider also configuring **liveness probes** to restart unhealthy containers.
...
> **triangle-alert** Ensure your readiness probe endpoint is lightweight and fast to avoid delaying traffic routing.
