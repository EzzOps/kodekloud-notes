...
> **lightbulb** You can also configure **Horizontal Pod Autoscaler** to automatically adjust replica counts based on CPU or custom metrics. See [Horizontal Pod Autoscaling](https://kubernetes.io/docs/tasks/run-application/horizontal-pod-autoscale/) for details.
...
> **triangle-alert** Without a liveness probe, Kubernetes **cannot** detect hung or unresponsive applications that have not exited.
