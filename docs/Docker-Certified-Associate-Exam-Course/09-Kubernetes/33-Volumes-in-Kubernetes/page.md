...
> **lightbulb** Docker volumes decouple container lifecycles from data lifecycles.\
...
> **triangle-alert** `hostPath` volumes are bound to a single node’s filesystem and do **not** provide data sharing or high availability. Avoid using them in multi-node clusters.
