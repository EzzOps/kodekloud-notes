...
> **triangle-alert** The `--link` flag is considered legacy. For production, prefer [user-defined networks](https://docs.docker.com/network/) or Docker Compose.
...
> **triangle-alert** User namespaces must be disabled or UCP deployment will fail.
...
> **lightbulb** - 3 UCP managers (high-availability quorum)
