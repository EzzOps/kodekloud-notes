...
Source: https://notes.kodekloud.com/docs/Docker-Certified-Associate-Exam-Course/Docker-Engine-Enterprise/Docker-Enterprise-Engine-Setup/page

Learn to install and configure Docker Enterprise Engine on CentOS 7 for secure container workloads.
...
> **lightbulb** If you don’t have a subscription, sign in to Docker Hub and click **Start One-Month Trial** to enable Docker EE repositories for your account.
...
> **triangle-alert** Make sure your subscription is active; otherwise the repository will return a 404 error.
