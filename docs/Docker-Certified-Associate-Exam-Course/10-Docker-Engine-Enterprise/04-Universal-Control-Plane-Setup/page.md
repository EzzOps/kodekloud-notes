...
> **lightbulb** UCP runs on [Docker Swarm](https://docs.docker.com/engine/swarm/) under the hood, extending it with enterprise security, monitoring, and governance features.
...
> **triangle-alert** Keep your `admin-password` secure and rotate it periodically. Avoid using weak or reused passwords.
