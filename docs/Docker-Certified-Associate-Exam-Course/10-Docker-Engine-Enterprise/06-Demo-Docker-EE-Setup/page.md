...
> **lightbulb** Ensure your corporate firewall allows access to `storebits.docker.com` and any other Docker EE endpoints.
...
> **triangle-alert** Editing repository files incorrectly can break package resolution. Always back up the `.repo` file before making changes.
