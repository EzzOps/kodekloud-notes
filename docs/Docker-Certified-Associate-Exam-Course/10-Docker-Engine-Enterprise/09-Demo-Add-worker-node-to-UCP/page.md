...
> **lightbulb** Ensure your Docker Enterprise Engine version matches the versions running on existing UCP managers to avoid compatibility issues.
...
> **triangle-alert** Keep your Swarm join token secret. Treat it like a password and do not expose it in public repositories.
