...
> **lightbulb** Ensure you are logged into the UCP console with an account that has the `admin` or `cluster_admin` role.
...
> **lightbulb** To remove the service, select it, choose **Actions** → **Delete**, and confirm the prompt.
