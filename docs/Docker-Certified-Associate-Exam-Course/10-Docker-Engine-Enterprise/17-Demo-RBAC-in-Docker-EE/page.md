...
> **lightbulb** You must be logged in as a UCP admin (e.g., `Yogesh Raheja`) to manage users.
...
> **lightbulb** Consider automating user and team management with the UCP CLI or API for large-scale environments.
