...
> **lightbulb** Make sure your browser can resolve the UCP hostname and that port 443 is accessible.
...
> **triangle-alert** If your LDAP server requires encryption, ensure you use an `ldaps://` URL or provide a CA certificate for TLS.
