...
> **lightbulb** Image scanning requires Docker Trusted Registry v2.6 or later. Verify your version under **System > Settings** before enabling this feature.
...
> **triangle-alert** Enabling **On Push** scanning can increase resource usage and may impact registry performance during peak push events.
