...
> **lightbulb** UCP does **not** back up Docker Swarm services, configs, or overlay networks. Use Docker Swarm tools for those workloads.
...
> **triangle-alert** Always verify that your passphrase and backup archive are accessible before starting a restore.
