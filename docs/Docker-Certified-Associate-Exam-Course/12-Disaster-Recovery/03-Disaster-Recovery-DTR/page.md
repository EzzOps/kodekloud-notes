...
> **triangle-alert** Local filesystem storage on individual replicas is **not** fault-tolerant. Always use an external object store for image data at scale.
...
> **lightbulb** For a full list of backup flags and how to obtain credentials, see the [DTR disaster recovery documentation](https://docs.docker.com/ee/dtr/admin/backup-and-restore/).
