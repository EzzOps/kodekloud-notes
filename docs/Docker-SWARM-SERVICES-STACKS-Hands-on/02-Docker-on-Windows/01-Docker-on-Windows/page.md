...
> **lightbulb** Ensure that your system meets the prerequisites: a 64-bit processor, Windows 7 or later, and that virtualization is enabled on your machine.
...
> **lightbulb** Using Hyper-V isolation, each container operates within its own optimized virtual machine, ensuring full kernel isolation and increased security between your containers.
