...
> **lightbulb** Docker containers by default attach to the bridge network. However, you can customize container connectivity by specifying different networks using the network command-line parameter.
...
> **lightbulb** Always consider using container names for service discovery to maintain stability during container restarts or scaling.
