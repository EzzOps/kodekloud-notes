...
Source: https://notes.kodekloud.com/docs/Docker-SWARM-SERVICES-STACKS-Hands-on/Docker-Swarm/Docker-Swarm-in-Depth/page
...
<Frame>
  ![The image illustrates a Docker Swarm setup with MySQL and web containers across multiple Docker hosts, alongside a person presenting.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874081/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Docker-Swarm-in-Depth/frame_60.jpg)
</Frame>
...
<Frame>
  ![The image shows a person explaining Docker Swarm setup with a diagram illustrating a Swarm Manager and three Worker nodes labeled as Docker Hosts.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874084/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Docker-Swarm-in-Depth/frame_90.jpg)
</Frame>
...
<Frame>
  ![The image shows a diagram of Docker Swarm architecture with manager and worker nodes, alongside a person explaining the concept.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874085/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Docker-Swarm-in-Depth/frame_200.jpg)
</Frame>
...
<Frame>
  ![A person is explaining the RAFT distributed consensus algorithm, with a diagram showing nodes and instructions on a digital background.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874086/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Docker-Swarm-in-Depth/frame_380.jpg)
</Frame>
...
The concept of fault tolerance is equally important. Fault tolerance is defined as the maximum number of manager node failures that the cluster can withstand while still functioning properly. Typically, this is computed as:
...
<Frame>
  ![The image illustrates a "Cluster Failure" in a Docker setup, showing web servers on Docker hosts with a person explaining the concept.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874089/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Docker-Swarm-in-Depth/frame_640.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/docker-swarm-services-stacks-hands-on/module/59d6dff1-0181-4a5e-9c05-6da9e38ae605/lesson/02bdc947-09ac-421a-bf63-365cdbf6119d" />
</CardGroup>
