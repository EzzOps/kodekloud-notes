...
> **lightbulb** Initially, you may notice that the worker and vote services are missing one instance. This is normal as the deployment process scales up based on resource availability.
