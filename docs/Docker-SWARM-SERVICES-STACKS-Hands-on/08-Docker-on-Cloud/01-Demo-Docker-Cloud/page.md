...
Source: https://notes.kodekloud.com/docs/Docker-SWARM-SERVICES-STACKS-Hands-on/Docker-on-Cloud/Demo-Docker-Cloud/page

This article provides a technical guide for deploying a Voting Application using Docker Cloud and AWS integration.
...
<Frame>
  ![The image shows a Docker Cloud interface with a terminated stack named "example-voting-app-stack" under the "Stacks" section.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874090/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Demo-Docker-Cloud/frame_80.jpg)
</Frame>
...
<Frame>
  ![The image shows a Docker Cloud interface displaying node clusters, with one terminated cluster named "example-voting-app3" in the us-east-1 region.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874091/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Demo-Docker-Cloud/frame_100.jpg)
</Frame>
...
<Frame>
  ![The image shows a Docker Cloud interface for setting up a node cluster, with options for provider, region, disk size, and number of nodes.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874092/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Demo-Docker-Cloud/frame_210.jpg)
</Frame>
...
<Frame>
  ![The image shows a Docker Cloud interface displaying the status of an "EXAMPLE-VOTING-APP" stack, with services and endpoints listed.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874093/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Demo-Docker-Cloud/frame_440.jpg)
</Frame>

<Frame>
  ![The image shows a voting result with "Cats" at 0% and "Dogs" at 100%, totaling 1 vote.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874094/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Demo-Docker-Cloud/frame_470.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/docker-swarm-services-stacks-hands-on/module/4cf8870d-54e8-4897-8fbe-e8ee9215e405/lesson/23ab942f-3dff-4fd1-83c8-0d21a229d5c4" />
</CardGroup>
