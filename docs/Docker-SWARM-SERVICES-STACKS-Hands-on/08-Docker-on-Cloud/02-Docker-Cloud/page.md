...
Source: https://notes.kodekloud.com/docs/Docker-SWARM-SERVICES-STACKS-Hands-on/Docker-on-Cloud/Docker-Cloud/page

This article explores advanced Docker concepts focusing on Docker Cloud for production cloud deployments and streamlining CI/CD processes.
...
<Frame>
  ![The image illustrates Docker Cloud's components, including building images, managing services, nodes, infrastructure, and configuring Docker and Swarm, with source and cloud providers listed.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874095/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Docker-Cloud/frame_140.jpg)
</Frame>

<Frame>
  ![The image illustrates a Docker Cloud build process, showing a flow from a GitHub code repository to a Docker Cloud build system, and finally to Docker Hub for release.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874096/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Docker-Cloud/frame_160.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/docker-swarm-services-stacks-hands-on/module/4cf8870d-54e8-4897-8fbe-e8ee9215e405/lesson/d7bded79-e599-4bf4-88c8-d3cfdc50c9f8" />
</CardGroup>
