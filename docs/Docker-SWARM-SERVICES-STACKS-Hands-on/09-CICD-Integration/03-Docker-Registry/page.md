...
> **lightbulb** Once your private registry is up and running (for example, on localhost at port 5000), be sure to update the image tags to reflect the new registry location.
