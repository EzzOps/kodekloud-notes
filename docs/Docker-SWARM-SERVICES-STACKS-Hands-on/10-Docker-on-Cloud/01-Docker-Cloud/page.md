...
> **lightbulb** With Docker Cloud, you can log into the Docker Cloud portal, create a stack using your configuration file, and have Docker Cloud automatically provision the necessary hosts on your chosen cloud provider. This process includes installing Docker and Docker Swarm, configuring networking, creating services, and running the containers as specified in your stack file.
