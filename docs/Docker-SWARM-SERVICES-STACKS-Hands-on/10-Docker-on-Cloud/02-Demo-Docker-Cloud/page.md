...
> **lightbulb** Be sure to wait until the node cluster deployment completes before moving on to deploy the application stack.
...
> **lightbulb** After pasting the final stack file into the Docker Cloud stack creation form, click **Create** to deploy. Docker Cloud will automatically detect and deploy the five identified services.
...
> **lightbulb** If you are interested in orchestration and cluster management, feel free to explore these beta features.
