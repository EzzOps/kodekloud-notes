...
Source: https://notes.kodekloud.com/docs/Docker-SWARM-SERVICES-STACKS-Hands-on/Kubernetes-Introduction/Kubernetes-Introduction/page
...
<Frame>
  ![The image compares Docker Swarm and Kubernetes cluster architectures, showing Swarm Manager and Workers versus Kubernetes Master and Nodes/Minions.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874116/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Kubernetes-Introduction/frame_160.jpg)
</Frame>
...
<Frame>
  ![The image illustrates a Kubernetes pod structure, showing two containers, shared storage, and an IP address within a "Kube Worker" node.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874118/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Kubernetes-Introduction/frame_320.jpg)
</Frame>
...
<Frame>
  ![The image illustrates Kubernetes pods, each containing two containers, storage, and an IP address, labeled under "Kube Worker."](../../../../images/kodekloud.com/kk-media/image/upload/v1752874119/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Kubernetes-Introduction/frame_370.jpg)
</Frame>

<Frame>
  ![The image compares Docker Swarm services with Kubernetes deployment, illustrating web server configurations on worker nodes and pods within respective clusters.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874120/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Kubernetes-Introduction/frame_400.jpg)
</Frame>

<Frame>
  ![The image illustrates a Kubernetes services architecture, showing Docker Swarm links, with pods for voting-app, result-app, redis, db, and worker, connected via services.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874122/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Kubernetes-Introduction/frame_450.jpg)
</Frame>
...
<Frame>
  ![The image illustrates an example voting app architecture using Kubernetes pods and services, including components like voting-app, result-app, Redis, database, and worker, with deployment steps.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874122/notes-assets/images/Docker-SWARM-SERVICES-STACKS-Hands-on-Kubernetes-Introduction/frame_760.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/docker-swarm-services-stacks-hands-on/module/9b8ffcd1-c5b0-45d0-968d-55a5146c3e39/lesson/60ad5136-ee70-4552-b089-50faeefd39e7" />
</CardGroup>
