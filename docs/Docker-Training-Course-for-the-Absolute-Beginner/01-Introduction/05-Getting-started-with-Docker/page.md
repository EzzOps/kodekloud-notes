...
> **lightbulb** If you choose Docker Desktop on Windows, modern setups typically use WSL2 (Windows Subsystem for Linux 2) to provide a lightweight integrated Linux kernel. Review the [Docker Desktop documentation](https://docs.docker.com/desktop/) and [Microsoft WSL docs](https://learn.microsoft.com/windows/wsl/) for prerequisites and recommended configuration.
