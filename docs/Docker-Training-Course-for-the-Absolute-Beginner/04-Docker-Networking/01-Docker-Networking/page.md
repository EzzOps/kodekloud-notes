...
> **lightbulb** If you require further isolation within a Docker host, you can create custom networks. This is especially useful if you need to separate groups of containers—such as two sets of web containers on different subnets (e.g., one on 172.x.x.x and another on 182.x.x.x).
