...
> **lightbulb** The response status will typically be yellow or green. A red status indicates critical issues that require immediate attention.
...
> **lightbulb** Before running any command, make sure to highlight the relevant section in the editor and then click on "Run" in Kibana.
...
> **lightbulb** Using PUT replaces the whole document, whereas using POST with \_update only modifies the designated fields.
