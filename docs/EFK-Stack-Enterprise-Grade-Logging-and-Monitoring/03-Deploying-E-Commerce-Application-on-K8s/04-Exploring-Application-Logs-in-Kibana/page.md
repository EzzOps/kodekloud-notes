...
Source: https://notes.kodekloud.com/docs/EFK-Stack-Enterprise-Grade-Logging-and-Monitoring/Deploying-E-Commerce-Application-on-K8s/Exploring-Application-Logs-in-Kibana/page

This article explains how to visualize and query application logs in Kibana after setting up Fluent Bit on a Kubernetes cluster.
...
<Frame>
  ![The image shows the "Index Management" section of an Elastic interface, displaying details of an index named "logstash-2024.06-29" with its health status, document count, and storage size.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874187/notes-assets/images/EFK-Stack-Enterprise-Grade-Logging-and-Monitoring-Exploring-Application-Logs-in-Kibana/index-management-logstash-2024-06-29.jpg)
</Frame>
...
<Frame>
  ![The image shows a "Create data view" interface in Kibana, where a user is setting up an index pattern and timestamp field for a data view named "app-event."](../../../../images/kodekloud.com/kk-media/image/upload/v1752874188/notes-assets/images/EFK-Stack-Enterprise-Grade-Logging-and-Monitoring-Exploring-Application-Logs-in-Kibana/create-data-view-kibana-app-event.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/efk-stack-enterprise-grade-logging-and-monitoring/module/b1b021b3-26c0-4701-aa90-d98fd3d8dc49/lesson/29313e64-fb7b-4381-ae5a-4f5c1becd711" />
</CardGroup>
