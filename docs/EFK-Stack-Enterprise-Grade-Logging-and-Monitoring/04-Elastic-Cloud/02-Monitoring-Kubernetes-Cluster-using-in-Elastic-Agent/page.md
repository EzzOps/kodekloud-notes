...
<Frame>
  ![The image shows a webpage from Elastic, displaying a list of integrations for various Amazon Web Services (AWS) and other categories. The left sidebar lists categories, while the main section shows specific AWS services with descriptions.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874193/notes-assets/images/EFK-Stack-Enterprise-Grade-Logging-and-Monitoring-Monitoring-Kubernetes-Cluster-using-in-Elastic-Agent/elastic-aws-integrations-webpage.jpg)
</Frame>
