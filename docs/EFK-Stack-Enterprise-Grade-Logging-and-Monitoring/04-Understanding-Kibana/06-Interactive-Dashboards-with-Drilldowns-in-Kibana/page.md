...
Source: https://notes.kodekloud.com/docs/EFK-Stack-Enterprise-Grade-Logging-and-Monitoring/Understanding-Kibana/Interactive-Dashboards-with-Drilldowns-in-Kibana/page

This article explores the drilldown feature in Kibana dashboards for deeper insights into application behavior and data exploration.
...
> **lightbulb** Suppose you want to investigate whether guest users experienced login failures. Perhaps there was an issue with the login process that prevented guest users from successfully creating accounts. By clicking directly on the segment of a graph that indicates "login failures," the drilldown filters the entire dashboard to display detailed information related to these incidents. For instance, if a graph shows two login failures on a particular day, this could suggest either user login errors or a system malfunction.
