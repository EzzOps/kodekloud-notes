...
Source: https://notes.kodekloud.com/docs/EFK-Stack-Enterprise-Grade-Logging-and-Monitoring/Elasticsearch-and-Kibana-Deployment-on-Kubernetes/Deployments-for-Kibana-instances/page
...
> **lightbulb** Ensure that the versions of Elasticsearch and Kibana are compatible. Always review the corresponding release notes from Elastic before selecting your Docker image.
...
> **lightbulb** By default, the Kibana Docker image searches for Elasticsearch within the same namespace. Ensure that Elasticsearch is deployed in the `efk` namespace to allow automatic connection.
...
> **lightbulb** Depending on your specific requirements, you might consider using a load balancer instead of NodePort for production environments.
