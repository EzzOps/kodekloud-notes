...
<Frame>
  ![The image shows the Fluent Bit logo with options for "Input," "Filter," "Plugins," and "Log Processing Pipeline" below it.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874214/notes-assets/images/EFK-Stack-Enterprise-Grade-Logging-and-Monitoring-Introduction-to-FluentBit/fluent-bit-logo-input-filter-plugins.jpg)
</Frame>
...
<Frame>
  ![The image features the Fluent Bit logo alongside two check-marked items: "Knowledge of the Tools" and "How to leverage?"](../../../../images/kodekloud.com/kk-media/image/upload/v1752874215/notes-assets/images/EFK-Stack-Enterprise-Grade-Logging-and-Monitoring-Introduction-to-FluentBit/fluent-bit-logo-knowledge-checks.jpg)
</Frame>
