...
> **lightbulb** If you are analyzing data for a shorter period (e.g., 20-30 minutes), the counts might be lower. In this lab, the analysis spans over 60 minutes, which explains the higher numbers.
