...
<Frame>
  ![The image illustrates an Elasticsearch index structure, showing two indices: "web\_app\_logs" and "login\_app\_logs," each containing multiple documents, with server icons above them.](https://kodekloud.com/kk-media/image/upload/v1752874250/notes-assets/images/EFK-Stack-Enterprise-Grade-Logging-and-Monitoring-Index-in-Elasticsearch/elasticsearch-index-structure-illustration.jpg)
</Frame>
