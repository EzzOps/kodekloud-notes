...
> **lightbulb** Event streaming platforms serve three core roles: durable storage of events (the log), message delivery to consumers, and stream processing (real-time transformation, enrichment, or aggregation).
