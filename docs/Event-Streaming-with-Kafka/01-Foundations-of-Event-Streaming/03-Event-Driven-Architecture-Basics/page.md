...
> **lightbulb** Kafka addresses many of these pitfalls by providing a durable event log that decouples producers and consumers, supports high throughput, enables replay, and offers built-in fault tolerance and scalability.
...
> **warning** Design choices (partitioning, retention, ordering guarantees) directly affect scalability and correctness. Test failure scenarios and recovery flows to ensure your pipeline meets SLAs.
