...
> **warning** When using IAM roles, follow the principle of least privilege. Only grant the permissions required for the workload and rotate credentials where applicable.
...
> **lightbulb** Hands-on labs are the best way to learn Kafka. Expect to experiment, make mistakes, and iterate—these labs are designed to simulate production-like scenarios so you can build confidence.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/event-streaming-with-kafka/module/37830f43-1d16-4aa1-899d-2c6914ee72b0/lesson/ed42b38c-b387-4ec9-a6c2-273b37af0065)
