...
<Callout icon="lightbulb">
  A Python virtual environment keeps demo packages isolated from system Python packages. Activate the virtual environment (`source kafka-demo-env/bin/activate`) in every terminal you use for this demo.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/event-streaming-with-kafka/module/25a81d98-c284-444b-b64d-6141e562d17d/lesson/0d89579f-2c52-479e-996a-a7f4bc04f18f" />

  <Card title="Practice Lab" icon="flask-conical" href="https://learn.kodekloud.com/user/courses/event-streaming-with-kafka/module/25a81d98-c284-444b-b64d-6141e562d17d/lesson/b31671b6-8301-4bd1-917f-a70a393b937f" />
</CardGroup>
