...
> **lightbulb** Note: Partition indices are zero-based (`0`, `1`, `2`, ...). When explaining partitions informally you may see them labeled `1`, `2`, `3`, but Kafka internally uses `0`-based indexing.
