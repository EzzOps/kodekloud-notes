...
> **lightbulb** [Confluent Cloud](https://www.confluent.io/confluent-cloud) is built by the original creators of [Apache Kafka](https://kafka.apache.org). That means you get a cloud-native, enterprise-grade Kafka that’s tested and optimized by the team that understands Kafka at its core.
