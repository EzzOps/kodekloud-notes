...
> **lightbulb** Confluent provides a free trial (typically a \$400 credit for 30 days) that you can use to create and test clusters, connectors, and other managed services. This is ideal for learning and development.
...
> **warning** Confluent may place a small authorization hold (often around \$1) to validate your payment method. This is typically an authorization only and not a permanent charge. You won’t be billed as long as you stay within the free-trial credit limits.
