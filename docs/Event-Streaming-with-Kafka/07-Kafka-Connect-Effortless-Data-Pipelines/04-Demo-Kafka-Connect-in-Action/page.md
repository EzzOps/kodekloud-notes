...
> **warning** For production or organizational environments, never open Kafka to the entire internet. Restrict inbound rules to specific IP ranges (for example, your office IP or VPN CIDR). Allowing `0.0.0.0/0` exposes your cluster to attacks.
