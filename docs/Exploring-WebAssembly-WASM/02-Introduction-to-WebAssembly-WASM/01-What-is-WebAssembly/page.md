...
> **lightbulb** WebAssembly modules interoperate seamlessly with JavaScript. You can call exported WASM functions from JS and vice versa.
...
> **triangle-alert** Ensure your browser supports WebAssembly threads if you plan to use shared memory and parallelism.
