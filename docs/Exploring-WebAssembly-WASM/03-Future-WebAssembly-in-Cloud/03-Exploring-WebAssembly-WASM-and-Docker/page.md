...
<Frame>
  ![The image is a diagram showing how WASM (WebAssembly) modules and runtime can be used across different platforms, including mobile (ARM), servers (Intel), and desktop (AMD).](../../../../images/kodekloud.com/kk-media/image/upload/v1752874811/notes-assets/images/Exploring-WebAssembly-WASM-Exploring-WebAssembly-WASM-and-Docker/wasm-modules-runtime-diagram.jpg)
</Frame>
...
<Frame>
  ![The image illustrates the size of a Docker image package, which is between 100-200 MB, with a graphic of a Docker whale and code.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874812/notes-assets/images/Exploring-WebAssembly-WASM-Exploring-WebAssembly-WASM-and-Docker/docker-image-size-whale-graphic.jpg)
</Frame>
...
<Frame>
  ![The image compares Docker and WASM, highlighting Docker's revolutionized deployment and high portability, and WASM's high security and efficiency.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874814/notes-assets/images/Exploring-WebAssembly-WASM-Exploring-WebAssembly-WASM-and-Docker/docker-vs-wasm-deployment-comparison.jpg)
</Frame>
...
<Frame>
  ![The image is a diagram showing the integration of Docker and WASM, with components like Docker Engine and containerd-wasm-shim, leading to multiple wasmedge instances.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874815/notes-assets/images/Exploring-WebAssembly-WASM-Exploring-WebAssembly-WASM-and-Docker/docker-wasm-integration-diagram.jpg)
</Frame>
...
<Frame>
  ![The image outlines benefits to developers, highlighting early stage development, availability in Docker Desktop, and enhanced implementation and management.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874816/notes-assets/images/Exploring-WebAssembly-WASM-Exploring-WebAssembly-WASM-and-Docker/developer-benefits-docker-desktop.jpg)
</Frame>
