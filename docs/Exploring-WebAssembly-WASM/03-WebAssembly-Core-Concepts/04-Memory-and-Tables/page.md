...
> **lightbulb** Out-of-bounds memory accesses in WebAssembly always trap, ensuring that modules cannot read or write arbitrary host memory.
...
> **triangle-alert** If you call an uninitialized or out-of-bounds table index, WebAssembly will trap immediately.
