...
> **lightbulb** Make sure your [Emscripten SDK installation](https://emscripten.org/docs/getting_started/downloads.html) is up to date and the `emcc` command is in your `PATH`.
...
> **lightbulb** Deep diving into the `.wasm` layout can help troubleshoot toolchain issues and squeeze out maximum performance.
