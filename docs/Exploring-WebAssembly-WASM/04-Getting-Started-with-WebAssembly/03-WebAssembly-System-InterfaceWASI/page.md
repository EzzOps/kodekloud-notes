...
> **lightbulb** Grant minimal capabilities (for example, read-only access to a data folder) to reduce attack surface.
...
> **triangle-alert** Always check return codes (`i32`) for robust error handling in production modules.
