...
> **lightbulb** After cloning, install and activate the latest SDK release, then configure your shell environment:
...
> **triangle-alert** Your server must serve `.wasm` files with `application/wasm`. Otherwise, streaming instantiation will fail.
...
> **lightbulb** By default, linear memory grows in 64 KB pages. You can configure initial and maximum sizes in your toolchain.
