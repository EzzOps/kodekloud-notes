...
> **lightbulb** You cannot load a WASM module via `file://`. Always serve your files over HTTP or HTTPS.
...
> **lightbulb** For other distributions, visit the [WABT GitHub releases](https://github.com/WebAssembly/wabt/releases) page.
