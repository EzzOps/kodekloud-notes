...
> **lightbulb** Low-level WASM debugging displays raw opcodes (`local.get`, `i32.mul`, etc.) and generic local names. To see your original C/C++ code directly, you need DWARF debug symbols.
