...
> **lightbulb** Use a multi-stage Dockerfile to minimize image size by separating build and runtime dependencies.
...
> **lightbulb** Different runtimes may prioritize AOT or JIT differently. Choose based on startup latency, memory footprint, and security requirements.
...
> **triangle-alert** When low startup time is critical, prefer AOT compilation. JIT may increase variability in performance and introduce additional dependencies.
