...
> **triangle-alert** Docker’s WASM integration is currently a beta feature available in a special technical-preview build of Docker Desktop. Refer to [Docker’s experimental WASM support][docker-wasm] when testing locally.
...
> **lightbulb** The `--platform=wasm/wasm32` flag instructs Docker to treat this as a WASM container.
