...
Source: https://notes.kodekloud.com/docs/Exploring-WebAssembly-WASM/WebAssembly-Core-Concepts/Instructions-and-Data-Types/page
...
<Frame>
  ![The image illustrates WebAssembly data types, showing temperature values (25°C and 25.5°C) alongside a code snippet with "i32" and "f64" data types.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874883/notes-assets/images/Exploring-WebAssembly-WASM-Instructions-and-Data-Types/webassembly-data-types-temperature-code.jpg)
</Frame>
...
<Frame>
  ![The image is a diagram showing WebAssembly data types, categorized into integers (i32, i64), floating-point numbers (f32, f64), and others (v128, funcref, externref).](../../../../images/kodekloud.com/kk-media/image/upload/v1752874885/notes-assets/images/Exploring-WebAssembly-WASM-Instructions-and-Data-Types/wasm-data-types-diagram.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/exploring-webassembly-wasm/module/50924ac0-6bb9-4e73-975d-55fc8d997574/lesson/da693135-cf92-4a49-a2da-8fe0b89ead2e" />
</CardGroup>
