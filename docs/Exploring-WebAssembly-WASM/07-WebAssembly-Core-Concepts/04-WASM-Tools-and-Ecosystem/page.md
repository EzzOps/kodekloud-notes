...
Source: https://notes.kodekloud.com/docs/Exploring-WebAssembly-WASM/WebAssembly-Core-Concepts/WASM-Tools-and-Ecosystem/page
...
<Frame>
  ![The image illustrates a concept where "Tools" plus "Ecosystem" equals "Enhance," "Support," and "Streamline," related to WebAssembly.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874893/notes-assets/images/Exploring-WebAssembly-WASM-WASM-Tools-and-Ecosystem/tools-ecosystem-enhance-support-streamline.jpg)
</Frame>
...
<Frame>
  ![The image shows the WASM Landscape by CNCF, featuring a categorized overview of various cloud-native technologies and tools, including languages, runtimes, and application frameworks.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874895/notes-assets/images/Exploring-WebAssembly-WASM-WASM-Tools-and-Ecosystem/wasm-landscape-cnc-technology-overview.jpg)
</Frame>

<Callout icon="lightbulb">
  Explore the CNCF WASM Landscape for the latest tools, libraries, and community projects: [https://github.com/cncf/wasm-landscape](https://github.com/cncf/wasm-landscape)
</Callout>
...
<Frame>
  ![The image illustrates programming languages and their relation to WebAssembly (WASM) garbage collection and compiling interpreters, featuring logos and icons for various technologies.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874895/notes-assets/images/Exploring-WebAssembly-WASM-WASM-Tools-and-Ecosystem/programming-languages-wasm-illustration.jpg)
</Frame>
...
<Frame>
  ![The image illustrates the process of converting code into WASM bytecode, which is then executed by various runtimes such as WasmEdge, WasmTime, and WAMR.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874896/notes-assets/images/Exploring-WebAssembly-WASM-WASM-Tools-and-Ecosystem/code-to-wasm-bytecode-process.jpg)
</Frame>
...
<Frame>
  ![The image illustrates the WASM Edge Runtime, which supports POSIX APIs, and shows its compatibility with Rust and JavaScript frameworks.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874897/notes-assets/images/Exploring-WebAssembly-WASM-WASM-Tools-and-Ecosystem/wasm-edge-runtime-posix-compatibility.jpg)
</Frame>
...
<Frame>
  ![The image illustrates a tailored framework featuring "Spin: WebAssembly Microservices" and "WasmCloud: Distributed App Development," with icons representing various functionalities connected to each.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874898/notes-assets/images/Exploring-WebAssembly-WASM-WASM-Tools-and-Ecosystem/spin-wasmcloud-framework-illustration.jpg)
</Frame>
...
<Frame>
  ![The image illustrates the concept of WASM cross-platform portability for edge and IoT environments, highlighting compatibility with Genode, SeL4 RTOS, and Flatcar Container Linux.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874899/notes-assets/images/Exploring-WebAssembly-WASM-WASM-Tools-and-Ecosystem/wasm-cross-platform-portability-edge-iot.jpg)
</Frame>
...
<Frame>
  ![The image illustrates "WASM as an Alternative Stack" for AI inference, featuring runtimes like Bytecode Alliance, WasmTime, and WasmEdge, alongside logos for OpenCV, PyTorch, and TensorFlow.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874901/notes-assets/images/Exploring-WebAssembly-WASM-WASM-Tools-and-Ecosystem/wasm-alternative-stack-ai-inference.jpg)
</Frame>
...
<Frame>
  ![The image illustrates the concept of embedded functions using WebAssembly (WASM) for user-defined code, with a focus on databases like LibSQL and OpenGauss.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874902/notes-assets/images/Exploring-WebAssembly-WASM-WASM-Tools-and-Ecosystem/embedded-functions-webassembly-databases.jpg)
</Frame>
...
<Frame>
  ![The image illustrates the "WASM Landscape" with a focus on tooling, featuring Cargo, LLVM, and Binaryen as tools.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874903/notes-assets/images/Exploring-WebAssembly-WASM-WASM-Tools-and-Ecosystem/wasm-landscape-tooling-cargo-llvm-binaryen.jpg)
</Frame>
...
<Frame>
  ![The image is a presentation slide titled "Application Deployment," featuring icons for Docker and Kubernetes as cloud-native tools and frameworks.](../../../../images/kodekloud.com/kk-media/image/upload/v1752874904/notes-assets/images/Exploring-WebAssembly-WASM-WASM-Tools-and-Ecosystem/application-deployment-docker-kubernetes.jpg)
</Frame>
...
<Frame>
  ![The image shows a diagram with a purple "WA" icon connected by an arrow to a green box labeled "Repositories," which includes "Docker Hub" and "Harbor."](../../../../images/kodekloud.com/kk-media/image/upload/v1752874905/notes-assets/images/Exploring-WebAssembly-WASM-WASM-Tools-and-Ecosystem/wa-icon-repositories-docker-hub-diagram.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/exploring-webassembly-wasm/module/50924ac0-6bb9-4e73-975d-55fc8d997574/lesson/21da5339-f4f1-4762-9665-a33250a3a91f" />
</CardGroup>
