...
Source: https://notes.kodekloud.com/docs/Fundamentals-of-DevOps/People/Teams-vs-Roles-crossing-teams/page

This article explores cross-functional teams in DevOps, emphasizing the integration of essential skills for efficient product delivery from concept to deployment.
...
> **lightbulb** Every team must have or have access to all the skills needed to take a product from the initial idea to production.
...
![A person is gesturing while sitting between plants, with the words "CODERS" and "OPERATIONS" on the left. A lamp and unicorn figure are on a table.](https://kodekloud.com/kk-media/image/upload/v1752874963/notes-assets/images/Fundamentals-of-DevOps-Teams-vs-Roles-crossing-teams/frame_40.jpg)

In practice, cross-functional teams usually consist of developers, operations personnel, testers, and product managers working collaboratively on the same software project. As the project scales, roles such as software architects and engineers are often introduced to support larger initiatives.
...
Since the publication of [Google's SRE (Site Reliability Engineering) Handbook](https://sre.google/), embedding operational talent directly within software teams has gained significant traction. This integration ensures that every necessary skill is either inherently present in the team or readily accessible, fostering an environment that promotes rapid and effective product delivery.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/fundamentals-of-devops/module/c39e68d9-637a-40c2-8a84-1bb10f490f3f/lesson/57adffcb-c0f8-4c32-951d-eee0695a63da)
