...
<Frame>
  ![The image shows a terminal window with a new file named "python-kafka-producer.py" open, displaying a blank screen with tilde symbols on the left.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875038/notes-assets/images/Fundamentals-of-MLOps-Demo-Stream-Data-using-Apache-Kafka/terminal-python-kafka-producer-file.jpg)
</Frame>
...
<Frame>
  ![The image shows a dark-themed terminal window with a text editor open, displaying a blank screen with a series of tilde (\~) symbols on the left. The status bar at the bottom indicates the editor is in "INSERT" mode.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875038/notes-assets/images/Fundamentals-of-MLOps-Demo-Stream-Data-using-Apache-Kafka/dark-terminal-text-editor-insert.jpg)
</Frame>
