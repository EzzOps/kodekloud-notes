...
> **lightbulb** If the installation process prompts any errors, ensure that your pip version is up-to-date and you are using a supported version of Python.
...
> **lightbulb** Click on the provided link or manually navigate to [http://127.0.0.1:5000](http://127.0.0.1:5000) in your browser to access the MLflow UI.
