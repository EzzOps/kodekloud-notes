...
Source: https://notes.kodekloud.com/docs/Fundamentals-of-MLOps/Data-Security-and-Governance/Need-of-Compliance-and-GDPR/page

This article discusses data compliance standards, focusing on GDPR and its importance in protecting individual rights and ensuring proper data handling by organizations.
...
![The image is an overview of GDPR, HIPAA, and PCI DSS, featuring a checklist for accepting terms and conditions and questions about data usage, deletion rights, information collection, and permissions.](https://kodekloud.com/kk-media/image/upload/v1752875084/notes-assets/images/Fundamentals-of-MLOps-Need-of-Compliance-and-GDPR/gdpr-hipaa-pci-dss-overview-checklist.jpg)
...
![The image illustrates the "Need for Compliance" with a focus on the "Rights of Data Subjects," highlighting four key rights: objection to processing, access to personal data, restriction and data portability, and rectification and erasure. It includes a visual of two people shaking hands in front of a compliance document and a gavel.](https://kodekloud.com/kk-media/image/upload/v1752875085/notes-assets/images/Fundamentals-of-MLOps-Need-of-Compliance-and-GDPR/need-for-compliance-data-rights.jpg)
...
![The image is about GDPR compliance, explaining that it is a data protection law in the EU regulating personal data processing and storage, enforced from May 25, 2018.](https://kodekloud.com/kk-media/image/upload/v1752875086/notes-assets/images/Fundamentals-of-MLOps-Need-of-Compliance-and-GDPR/gdpr-compliance-data-protection-law.jpg)
...
![The image outlines three key principles of GDPR compliance: Purpose Limitation, Integrity and Confidentiality, and Storage Limitation, each with a brief description.](https://kodekloud.com/kk-media/image/upload/v1752875086/notes-assets/images/Fundamentals-of-MLOps-Need-of-Compliance-and-GDPR/gdpr-compliance-principles-outline.jpg)

> **lightbulb** GDPR compliance is mandatory. Organizations handling sensitive personal data are required to appoint a Data Protection Officer (DPO) to ensure these regulations are upheld.
...
[Learn more about GDPR](https://gdpr.eu/what-is-gdpr/)\
[Explore HIPAA compliance](https://www.hhs.gov/hipaa/for-professionals/index.html)

- [Watch Video](https://learn.kodekloud.com/user/courses/fundamentals-of-mlops/module/eb24c415-d662-4cf4-86aa-b85da8c78a56/lesson/6495e0cb-e8c1-4319-99c2-f0729973d22c)
