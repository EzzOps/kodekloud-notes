...
<Frame>
  ![The image shows an MLflow interface displaying an experiment with three model runs: Random Forest Regressor, Decision Tree Regressor, and Linear Regression, each with details like creation time, duration, and source.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875167/notes-assets/images/Fundamentals-of-MLOps-Demo-Running-and-experiment-and-storing-the-result-on-MLflow/mlflow-experiment-model-runs.jpg)
</Frame>
...
<Frame>
  ![The image shows a contour plot from an MLflow experiment comparing three runs, with axes labeled for explained variance, mean absolute error (mae), and mean squared error (mse). Below the plot, there are details of the runs, including IDs, names, start and end times, and durations.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875169/notes-assets/images/Fundamentals-of-MLOps-Demo-Running-and-experiment-and-storing-the-result-on-MLflow/mlflow-experiment-contour-plot.jpg)
</Frame>
...
<Frame>
  ![The image shows an MLflow interface with no logged runs in the "Experiments" section, displaying a message that no runs have been logged yet.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875170/notes-assets/images/Fundamentals-of-MLOps-Demo-Setting-up-MLflow/mlflow-experiments-no-runs-logged.jpg)
</Frame>
...
<Frame>
  ![The image shows an MLflow interface with a "Registered Models" page, indicating no models are registered yet and offering an option to create a model.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875171/notes-assets/images/Fundamentals-of-MLOps-Demo-Setting-up-MLflow/mlflow-registered-models-empty.jpg)
</Frame>
