...
> **lightbulb** Make sure a DOCX file named `Sample.docx` (or another filename you pass to the script) is present in the same directory when you run the example below.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/fundamentals-of-rag/module/6c0f08eb-0b91-48b6-af70-e95dbf30af15/lesson/03d7891a-3b40-440f-9db5-5f2b04a70a5f)
