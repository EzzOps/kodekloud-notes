...
> **warning** Keyword stuffing — repeating a keyword excessively to inflate relevance — can cause TF-IDF-based systems to return spammy or low-quality results. Modern ranking functions like BM25 were designed to reduce that risk.
...
> **lightbulb** * Use `k1` to control how quickly additional term occurrences saturate; increase `k1` if repeated terms should count more.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/fundamentals-of-rag/module/316bc17d-74b4-4bc8-bac7-62286dc8eee8/lesson/b04656aa-f6c3-404b-b8b8-1edaca8bd6dc)
