...
> **warning** Avoid unstructured on-call assignments (e.g., “trial by fire”). Insufficiently prepared responders increase outage duration and risk operator error. Always pair training, shadowing, and clear playbooks with liveliness checks before assigning primary on-call duties.
...
> **lightbulb** Keep playbooks current and test them during drills. If a playbook step proves unclear in a real incident, update it immediately during the postmortem.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/fundamentals-of-sre/module/db75c0b7-05a9-41f7-b34d-762421f8b595/lesson/d4e148a9-9f5a-473e-978d-4a7457ad7d61)
