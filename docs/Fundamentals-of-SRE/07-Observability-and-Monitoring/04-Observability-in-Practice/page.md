...
<Callout icon="lightbulb">
  Provision Grafana via GF\_PATHS\_PROVISIONING so datasources and dashboards are available at startup. Keep these provisioning files in version control for reproducible dashboards and consistent environments.
</Callout>
...
<Callout icon="warning">
  Do not store plaintext credentials in provisioning files. Use environment variables or a secrets manager (for example, GF\_SECURITY\_ADMIN\_PASSWORD via Docker Compose) and restrict access to provisioning folders.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/fundamentals-of-sre/module/92f39ae4-b287-4850-93aa-3f0119393754/lesson/442c5b74-ef58-4257-ac5d-00af5cfd121f" />
</CardGroup>
