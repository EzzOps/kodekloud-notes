...
> **lightbulb** Normalize dynamic route segments (e.g., /products/) for metric labels to avoid high-cardinality label explosions.

> **warning** Avoid tagging metrics with high-cardinality values (user IDs, raw UUIDs). High-cardinality labels can cause large memory and storage usage in Prometheus.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/fundamentals-of-sre/module/92f39ae4-b287-4850-93aa-3f0119393754/lesson/afb59a4a-566c-4e8b-bfae-9065c0c2b7d8)
...
> **lightbulb** Prioritize p95 and p99 when SLAs, SLOs, or high-value user experiences are critical. Use averages for capacity planning and long-term trends, but let tail metrics drive user-facing reliability decisions.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/fundamentals-of-sre/module/92f39ae4-b287-4850-93aa-3f0119393754/lesson/3592e762-6ac2-4294-b54a-4e13937748e6)

  - [Practice Lab](https://learn.kodekloud.com/user/courses/fundamentals-of-sre/module/92f39ae4-b287-4850-93aa-3f0119393754/lesson/e3104654-4009-4303-b34b-212fa2da3115)
