...
> **lightbulb** Project ID is a user-assigned, globally unique string identifier (used in APIs and resource names). Project number is a system-assigned numeric identifier that is also unique and is used internally by GCP. Keep both handy when configuring services or opening support requests.
