...
> **lightbulb** If the API is already enabled due to previous usage, you may not see the enable prompt.
...
> **triangle-alert** If you are using a free trial subscription or selected region without billing requirements, this prompt may not appear.
