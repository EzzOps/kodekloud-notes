...
Source: https://notes.kodekloud.com/docs/GCP-Cloud-Digital-Leader-Certification/Building-APIs-in-GCP/How-APIs-can-modernize-legacy-systems/page

This lesson explores modernizing legacy systems using APIs to enhance integration and communication among independent applications within organizations.
...
<Frame>
  ![The image illustrates scalability issues with legacy systems in a pharmaceutical company, highlighting production, logistics, and sales across the USA and Sri Lanka. It includes icons of a hospital, a delivery truck, and a ship, along with a world map.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875197/notes-assets/images/GCP-Cloud-Digital-Leader-Certification-How-APIs-can-modernize-legacy-systems/scalability-issues-legacy-systems.jpg)
</Frame>
...
<Frame>
  ![The image illustrates scalability issues with legacy systems, showing different departments like Production, Logistics, and Sales, each represented by computer screens with code.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875198/notes-assets/images/GCP-Cloud-Digital-Leader-Certification-How-APIs-can-modernize-legacy-systems/scalability-issues-legacy-systems-2.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/gcp-cloud-digital-leader-certification/module/e5568170-9e5b-495b-9299-ee52fa013ca9/lesson/bce1ed8d-28c8-4d67-81fb-ead0682fa20d" />
</CardGroup>
