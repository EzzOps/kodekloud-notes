...
> **lightbulb** Keep in mind that when using an instance group, machines might be terminated and replaced frequently. It is therefore essential to automate the deployment process so that every new instance automatically includes the latest version of your application code.
