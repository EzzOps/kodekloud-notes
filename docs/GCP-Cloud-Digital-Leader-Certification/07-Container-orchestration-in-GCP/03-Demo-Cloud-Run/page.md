...
Source: https://notes.kodekloud.com/docs/GCP-Cloud-Digital-Leader-Certification/Container-orchestration-in-GCP/Demo-Cloud-Run/page

This article teaches how to deploy container images using Cloud Run on Google Cloud Platform, covering configuration, autoscaling, monitoring, and Kubernetes Engine options.
...
<Frame>
  ![The image shows the Google Cloud Platform console with a welcome screen for the "KodeKloud-GCP-Training" project. It includes options for creating a VM, running a query in BigQuery, and quick access to various project resources.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875208/notes-assets/images/GCP-Cloud-Digital-Leader-Certification-Demo-Cloud-Run/google-cloud-platform-kodekloud-training.jpg)
</Frame>
...
<Frame>
  ![The image shows a Google Cloud Platform interface for creating a Cloud Run service, with options for container image URL, service name, region, CPU allocation, autoscaling, and ingress settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875210/notes-assets/images/GCP-Cloud-Digital-Leader-Certification-Demo-Cloud-Run/google-cloud-run-service-creation.jpg)
</Frame>
...
<Frame>
  ![The image shows a Google Cloud Console interface for Cloud Run, displaying details of a service revision named "my-service-00001-geb," including configuration settings like CPU allocation, concurrency, and autoscaling.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875211/notes-assets/images/GCP-Cloud-Digital-Leader-Certification-Demo-Cloud-Run/google-cloud-console-cloud-run-service-details.jpg)
</Frame>
...
<Frame>
  ![The image shows a Google Cloud Platform interface for creating a Kubernetes cluster, offering options for "Autopilot" and "Standard" cluster modes. The user can configure or compare these options.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875213/notes-assets/images/GCP-Cloud-Digital-Leader-Certification-Demo-Cloud-Run/google-cloud-kubernetes-cluster-options.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/gcp-cloud-digital-leader-certification/module/d639dd79-213a-4d3c-928f-7e6392a95b3c/lesson/e46e9caf-1a1b-42b1-8bfa-4c5d08fe2987" />
</CardGroup>
