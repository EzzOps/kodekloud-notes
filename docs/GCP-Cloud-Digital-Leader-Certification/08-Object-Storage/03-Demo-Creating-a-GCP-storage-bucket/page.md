...
> **lightbulb** A helpful naming strategy is to start with your company prefix (e.g., "pharma") followed by a descriptor for its purpose (e.g., "store-data-information").
...
> **triangle-alert** Exposing a bucket to the public internet can be risky because unauthorized users might gain access to your stored data. GCP recommends enabling the option "Enforce public access prevention on this bucket" to keep your data secure.
