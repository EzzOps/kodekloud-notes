...
> **lightbulb** For further details on the orchestration services available in GCP, be sure to check out the [Google Kubernetes Engine (GKE)](https://cloud.google.com/kubernetes-engine) documentation.
