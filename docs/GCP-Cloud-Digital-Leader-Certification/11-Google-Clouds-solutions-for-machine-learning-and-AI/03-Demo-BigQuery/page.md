...
<Frame>
  ![The image shows a Google Cloud BigQuery interface with a dataset named "sample\_data" selected, displaying its details and options like "Create table" and "Share."](../../../../images/kodekloud.com/kk-media/image/upload/v1752875321/notes-assets/images/GCP-Cloud-Digital-Leader-Certification-Demo-BigQuery/google-cloud-bigquery-sample-data.jpg)
</Frame>
...
<Frame>
  ![The image shows a Google Cloud BigQuery interface where a user is in the process of creating a new table, with options for selecting the data source and configuring schema and partition settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875323/notes-assets/images/GCP-Cloud-Digital-Leader-Certification-Demo-BigQuery/google-cloud-bigquery-new-table.jpg)
</Frame>
...
<Frame>
  ![The image shows a Google Cloud BigQuery interface displaying the schema of a table named "user\_data" with fields like id, first\_name, last\_name, email, gender, and ip\_address.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875324/notes-assets/images/GCP-Cloud-Digital-Leader-Certification-Demo-BigQuery/google-cloud-bigquery-user-data-schema.jpg)
</Frame>
