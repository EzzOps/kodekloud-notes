...
> **lightbulb** You need to run this `gcloud container clusters get-credentials` command each time you start a new Cloud Shell session, as kubeconfig configurations aren’t persisted across sessions.
