...
> **lightbulb** Cloud Build integrates directly with Cloud Source Repositories, GitHub, and Bitbucket. You can trigger builds automatically on code pushes or pull requests.
...
> **triangle-alert** Ensure that the Cloud Build service account has the [`artifactregistry.writer`](https://cloud.google.com/artifact-registry/docs/access-control#roles) and GKE permissions before running pipelines.
