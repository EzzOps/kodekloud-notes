...
> **lightbulb** Make sure your `cloudbuild.yaml` is correctly indented. Even a single space error can cause build failures.

> **triangle-alert** Verify IAM roles for Cloud Build and Artifact Registry. Missing permissions will block image pushes.
