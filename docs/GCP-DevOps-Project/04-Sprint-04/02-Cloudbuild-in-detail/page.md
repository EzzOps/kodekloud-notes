...
> **lightbulb** Cloud Build automatically detects Dockerfiles, Maven, and Gradle builds. You can extend support by defining custom build steps.
...
> **lightbulb** Place your `cloudbuild.yaml` in the repository root. Cloud Build auto-detects triggers once you connect a source repository.
