...
> **lightbulb** To restrict the trigger to exactly **main** or **master**, use:
...
> **lightbulb** If your repository doesn’t include a `cloudbuild.yaml`, the trigger will fail at runtime.
