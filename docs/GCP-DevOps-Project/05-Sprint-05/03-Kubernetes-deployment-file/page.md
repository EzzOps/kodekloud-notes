...
> **lightbulb** Make sure you have committed or stashed any local changes before switching branches.
...
> **lightbulb** * [Kubernetes Deployments](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/)
...
> **triangle-alert** Always review your manifest for correct image tags and port configurations before applying to production clusters.
