...
> **lightbulb** Hotfixes via the GitHub UI can be useful for quick changes, but in production environments it's recommended to use pull requests and code reviews.
...
> **triangle-alert** Ensure your Cloud Build service account has the required [IAM roles](https://cloud.google.com/iam/docs/understanding-roles) for deploying to GKE.
