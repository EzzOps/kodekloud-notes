...
<Frame>
  ![The image shows a YAML file icon with an arrow pointing to a diagram of a person, symbolizing the extension of a gke.yaml file to include code for exposing an application via an endpoint.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875511/notes-assets/images/GCP-DevOps-Project-Sprint-06/gke-yaml-file-extension-diagram.jpg)
</Frame>
