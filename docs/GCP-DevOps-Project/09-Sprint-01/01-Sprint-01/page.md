...
> **lightbulb** * A [GitHub](https://github.com/) account with SSH keys configured
...
> **triangle-alert** Avoid committing sensitive information (credentials, tokens) to the repository. Use [GitHub Secrets](/docs/secure-credentials) for secure storage.
