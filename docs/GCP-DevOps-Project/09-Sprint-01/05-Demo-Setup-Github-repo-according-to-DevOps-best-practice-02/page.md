...
> **lightbulb** Enabling branch protection helps maintain code quality and prevents direct pushes to critical branches.
...
> **triangle-alert** Avoid committing directly to `main`. Always use a dedicated feature branch for your changes.
