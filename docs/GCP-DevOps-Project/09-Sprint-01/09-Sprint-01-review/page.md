...
> **triangle-alert** This built-in Flask server is for development only. For production deployments, use a WSGI server like [Gunicorn](https://gunicorn.org/) or [uWSGI](https://uwsgi-docs.readthedocs.io/).
...
> **lightbulb** A **Sprint Review** is conducted at the end of each sprint (weekly or bi-weekly) to demonstrate completed work, gather feedback, and update the backlog accordingly.
...
> **triangle-alert** If a blocker persists past the sprint boundary, raise it immediately in the backlog refinement meeting to avoid delays in future sprints.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/gcp-devops-project/module/a334971a-4fa2-4c61-8891-9c189e2aab64/lesson/1ee30e56-5f1b-4641-b80e-8eb9fdd92d96)
