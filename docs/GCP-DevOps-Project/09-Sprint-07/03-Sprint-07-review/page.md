...
<Frame>
  ![This image shows a GitHub repository page for a project named "gcp-devops-project" under the user "learnwithraghu." The repository contains files like Dockerfile, README.md, and app.py, and it mentions a Docker Flask application written in Python.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875522/notes-assets/images/GCP-DevOps-Project-Extending-development-environment-02/gcp-devops-project-github-repo-docker-flask.jpg)
</Frame>
...
<Frame>
  ![The image shows a Google Cloud Build interface displaying the details of a successful build process, including steps and logs related to deploying a project using Docker and GKE.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875523/notes-assets/images/GCP-DevOps-Project-Extending-development-environment-02/google-cloud-build-successful-deploy.jpg)
</Frame>
...
<Frame>
  ![The image shows the Google Cloud Console interface, specifically the Kubernetes Engine section, with a focus on Services & Ingress. A filter dropdown for selecting namespaces is open.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875524/notes-assets/images/GCP-DevOps-Project-Extending-development-environment-02/google-cloud-console-kubernetes-services-ingress.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/gcp-devops-project/module/c8ea3a0c-6c88-4c7d-8317-f50354bae0e6/lesson/7dc805aa-a32a-4340-b706-9448f2e85e70" />
</CardGroup>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/gcp-devops-project/module/c8ea3a0c-6c88-4c7d-8317-f50354bae0e6/lesson/9b4e0c9f-7331-4e9c-8bb6-fefdeb1c6123" />
</CardGroup>
