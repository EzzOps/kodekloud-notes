...
> **lightbulb** Before proceeding with cherry-picking, ensure that your target branch is up-to-date and that you understand how the changes from the commit will integrate with your current code base.
...
> **lightbulb** Cherry-picking only transfers the changes from the specified commit. Other commits and modifications from the source branch remain separate.
