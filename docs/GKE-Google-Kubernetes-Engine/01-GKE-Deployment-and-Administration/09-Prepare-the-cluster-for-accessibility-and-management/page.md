...
<Frame>
  ![The image is a diagram illustrating how to access a Kubernetes cluster using kubectl, showing components like Deployments, Services, Pods, and Others.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875573/notes-assets/images/GKE-Google-Kubernetes-Engine-Prepare-the-cluster-for-accessibility-and-management/kubernetes-cluster-access-kubectl-diagram.jpg)
</Frame>
