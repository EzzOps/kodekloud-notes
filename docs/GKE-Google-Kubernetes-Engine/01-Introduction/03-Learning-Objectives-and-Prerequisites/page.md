...
> **lightbulb** Hands-on practice is crucial. We recommend following along in a Google Cloud project with billing enabled and the Google Cloud SDK installed.
...
> **triangle-alert** Skipping these prerequisites may slow your progress when tackling advanced GKE features.
