...
> **lightbulb** In a vanilla Kubernetes setup, you must provision and manage your own worker nodes—Kubernetes does not handle node creation.
...
> **triangle-alert** In **Standard** mode, you’re responsible for node upgrades and autoscaling. Plan your maintenance windows and cluster autoscaler settings accordingly.
