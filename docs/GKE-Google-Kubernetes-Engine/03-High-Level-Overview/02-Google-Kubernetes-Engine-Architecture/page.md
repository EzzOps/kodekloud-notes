...
Source: https://notes.kodekloud.com/docs/GKE-Google-Kubernetes-Engine/High-Level-Overview/Google-Kubernetes-Engine-Architecture/page

Explores the key concepts and architecture of Google Kubernetes Engine and its differences from a standard Kubernetes cluster.
...
<Frame>
  ![The image illustrates a Kubernetes cluster architecture, showing the control plane components and worker nodes with kubelets, along with a connection to a cloud provider API.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875625/notes-assets/images/GKE-Google-Kubernetes-Engine-Google-Kubernetes-Engine-Architecture/kubernetes-cluster-architecture-diagram.jpg)
</Frame>
...
<Frame>
  ![The image illustrates the architecture of a Google Kubernetes Engine (GKE) cluster, showing components like the control plane, worker machines, and connected Google Cloud services. It includes elements such as the API server, scheduler, resource controller, and nodes with kubelet and kube proxy.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875627/notes-assets/images/GKE-Google-Kubernetes-Engine-Google-Kubernetes-Engine-Architecture/gke-cluster-architecture-control-plane-nodes.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/gke-google-kubernetes-engine/module/f43dc1c8-e09e-496b-bd15-160434440a1d/lesson/ff8f12d6-8481-4b68-9c8a-bc38375d3241" />
</CardGroup>
