...
> **lightbulb** Use `CronJob` for recurring batch tasks, e.g., nightly backups or ETL pipelines.
...
> **triangle-alert** A pod without a matching toleration won’t schedule on a tainted node. Double-check your keys and effects.
...
> **lightbulb** Provisioning the Cloud Shell VM can take a few seconds. You’ll see a spinner until the terminal is ready.
...
> **triangle-alert** Cloud Shell sessions time out after 120 minutes of inactivity. Be sure to save any important work or scripts to your persistent home directory (`~/`) before you leave.
