...
> **lightbulb** Assign a static external IP if you need consistent SSH access over time.
...
> **triangle-alert** Do not share your authorization code. Anyone with this code can access your Google Cloud resources.
