...
Source: https://notes.kodekloud.com/docs/GKE-Google-Kubernetes-Engine/GKE-Deployment-and-Administration/Demo-Install-kubectl-and-configure-cluster-access/page

Learn to install kubectl, set up GKE authentication, and configure access to your GKE cluster while deploying a sample Nginx application.
...
> **lightbulb** If you’re using **Google Cloud Shell**, `kubectl` comes pre-installed. You can skip directly to verifying its version.
...
> **lightbulb** Your context and cluster names are prefixed with your project and location. Use these exact identifiers with flags like `--cluster` or `--context`.
