...
> **lightbulb** If your workloads don’t tolerate `pod evictions`—for example, single-replica controllers—a scale-down can cause service interruption. Always use multiple replicas so pods can reschedule without downtime.
...
> **triangle-alert** Review your Compute Engine quota limits and scaling policies regularly to prevent quota exhaustion during high-traffic periods.
