...
> **lightbulb** You can override this with `--zone` or set a default region:
...
> **triangle-alert** Cluster creation can take several minutes. Monitor progress in the Cloud Console or via:
