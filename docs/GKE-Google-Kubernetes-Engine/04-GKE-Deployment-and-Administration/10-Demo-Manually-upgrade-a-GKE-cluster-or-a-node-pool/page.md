...
> **lightbulb** Ensure you’re authenticated:
...
> **triangle-alert** Control plane upgrades can cause brief API server interruptions. Plan a maintenance window if running production workloads.
