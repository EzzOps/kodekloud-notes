...
> **lightbulb** Leverage log-based metrics to create custom dashboards and alerts for application-specific events.
...
> **triangle-alert** High log and metric retention can increase costs. Use [log exclusions](/docs/logging/exclusions) and metric filters to manage your budget.
