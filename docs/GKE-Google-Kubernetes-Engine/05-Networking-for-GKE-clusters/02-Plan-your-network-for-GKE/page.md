...
> **triangle-alert** If you add high-priority firewall rules that block egress, you must explicitly allow:
...
> **lightbulb** Use the [flexible pod range feature](https://cloud.google.com/kubernetes-engine/docs/concepts/ip-allocation) to adjust the CIDR size per node pool.
