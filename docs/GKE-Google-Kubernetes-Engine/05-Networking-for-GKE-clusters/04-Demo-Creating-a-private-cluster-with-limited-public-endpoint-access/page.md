...
> **lightbulb** Cluster provisioning may take **10–15 minutes**.\
...
> **triangle-alert** Private-endpoint clusters only accept **reserved VPC networks** for API access.\
...
> **lightbulb** This cluster also takes **10–15 minutes** to provision.
