...
> **lightbulb** The readiness probe ensures that traffic is only routed to Pods that have successfully started.
...
> **lightbulb** Choose a CIDR range that doesn’t overlap with your existing networks. This subnet will host both Pods and Services via secondary IP ranges.
...
> **lightbulb** Cluster provisioning typically takes 10–15 minutes. Verify that two secondary IP ranges (for Pods and Services) appear under your subnet.
...
> **triangle-alert** An **EXTERNAL-IP** may take a few minutes to appear. Wait until it’s provisioned before testing.
