...
Source: https://notes.kodekloud.com/docs/GKE-Google-Kubernetes-Engine/Managing-Security-Aspects/Authentication-and-authorization-in-GKE/page

This guide explores access control methods in GKE, focusing on Google Cloud IAM, Kubernetes RBAC, and service accounts for securing clusters.
...
<Frame>
  ![The image is a comparison overview of Kubernetes RBAC and GCP IAM, detailing their features, scope, permissions, and principals. It highlights the differences in managing permissions for Kubernetes clusters and Google Cloud projects.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875642/notes-assets/images/GKE-Google-Kubernetes-Engine-Authentication-and-authorization-in-GKE/kubernetes-rbac-gcp-iam-comparison.jpg)
</Frame>
...
<Frame>
  ![The image provides an overview of Kubernetes RBAC and GCP IAM, with links to relevant documentation for each.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875642/notes-assets/images/GKE-Google-Kubernetes-Engine-Authentication-and-authorization-in-GKE/kubernetes-rbac-gcp-iam-overview.jpg)
</Frame>
...
<Frame>
  ![The image illustrates three types of service accounts: Kubernetes Service Accounts, GCP IAM Service Accounts, and GKE Service Agents, with their respective icons.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875644/notes-assets/images/GKE-Google-Kubernetes-Engine-Authentication-and-authorization-in-GKE/service-accounts-kubernetes-gcp-gke-icons.jpg)
</Frame>
...
<Frame>
  ![The image explains Kubernetes Service Accounts, highlighting their use in managing Kubernetes resources, in-cluster entities, API manipulation, and cluster scoping.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875645/notes-assets/images/GKE-Google-Kubernetes-Engine-Authentication-and-authorization-in-GKE/kubernetes-service-accounts-management-diagram.jpg)
</Frame>
...
<Frame>
  ![The image explains GCP IAM Service Accounts, highlighting their role in Google Cloud's IAM system, usage by applications on GCP, project scoping, and access control to GCP resources and services.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875646/notes-assets/images/GKE-Google-Kubernetes-Engine-Authentication-and-authorization-in-GKE/gcp-iam-service-accounts-explained.jpg)
</Frame>
...
<Frame>
  ![The image explains Kubernetes and GKE Service Accounts, highlighting that they are managed by Google, used for managing cluster resources, have a specific domain, and perform cluster management actions.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875648/notes-assets/images/GKE-Google-Kubernetes-Engine-Authentication-and-authorization-in-GKE/kubernetes-gke-service-accounts-explained.jpg)
</Frame>
...
<Frame>
  ![The image compares Kubernetes Service Accounts, scoped within a cluster, with GCP IAM Service Accounts, scoped within a project.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875649/notes-assets/images/GKE-Google-Kubernetes-Engine-Authentication-and-authorization-in-GKE/kubernetes-service-accounts-gcp-iam-comparison.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/gke-google-kubernetes-engine/module/225743c4-eb6e-4393-a51e-4ed7d41dbe51/lesson/7d225a92-6c51-4ce2-8818-096dcab2e35d" />
</CardGroup>
