...
> **lightbulb** Container Threat Detection is available through Security Command Center for real-time monitoring of container vulnerabilities.
...
> **triangle-alert** Running unsupported cluster versions exposes you to known vulnerabilities. Always upgrade to a supported GKE version.
