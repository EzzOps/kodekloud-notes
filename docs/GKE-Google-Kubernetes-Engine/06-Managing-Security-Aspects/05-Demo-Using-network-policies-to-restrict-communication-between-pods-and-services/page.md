...
Source: https://notes.kodekloud.com/docs/GKE-Google-Kubernetes-Engine/Managing-Security-Aspects/Demo-Using-network-policies-to-restrict-communication-between-pods-and-services/page

This tutorial explains how to use Kubernetes Network Policies to manage pod-to-service traffic in Google Kubernetes Engine.
...
> **lightbulb** Ensure you have the [Google Cloud SDK](https://cloud.google.com/sdk/docs) installed and authenticated before proceeding.
...
> **triangle-alert** This action **deletes** your entire GKE cluster and cannot be undone.
