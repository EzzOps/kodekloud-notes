...
> **lightbulb** For production workloads, regional clusters are strongly recommended over zonal clusters to maximize uptime and resilience.
...
> **triangle-alert** Cross-zone pod-to-pod traffic and control-plane communications may generate egress fees. Plan your network topology accordingly.
