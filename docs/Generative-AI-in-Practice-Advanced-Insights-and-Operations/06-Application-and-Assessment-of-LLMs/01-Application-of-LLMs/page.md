...
> **lightbulb** The sample response is in Spanish due to the agent configuration. To respond in English, simply update the system prompt accordingly.
...
> **lightbulb** While models trained primarily on datasets like Common Crawl can be highly effective, they may require additional fine-tuning to excel in specialized tasks such as RNA analysis.
