...
Source: https://notes.kodekloud.com/docs/Generative-AI-in-Practice-Advanced-Insights-and-Operations/Retrieval-Augmented-Generation-RAG/Introduction-to-RAG/page
...
<Frame>
  ![The image is a diagram comparing Standalone LLM and RAG, showing the flow from an external database to a standalone LLM, resulting in a dynamic and relevant answer.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875863/notes-assets/images/Generative-AI-in-Practice-Advanced-Insights-and-Operations-Introduction-to-RAG/standalone-llm-rag-comparison-diagram.jpg)
</Frame>
...
<Frame>
  ![The image highlights the importance of RAG in Generative AI across three sectors: Finance, Healthcare, and Customer Service. Each sector is represented with an icon and a number.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875864/notes-assets/images/Generative-AI-in-Practice-Advanced-Insights-and-Operations-Introduction-to-RAG/rag-generative-ai-sectors-icons.jpg)
</Frame>
...
<Frame>
  ![The image is a comparison between Fine-Tuning and RAG, highlighting that Fine-Tuning relies on static data at training time, while RAG handles dynamic data and real-time updates.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875865/notes-assets/images/Generative-AI-in-Practice-Advanced-Insights-and-Operations-Introduction-to-RAG/fine-tuning-vs-rag-comparison.jpg)
</Frame>
...
<Frame>
  ![The image is a diagram titled "RAG – Core Components," showing a central circle labeled "RAG" connected to three boxes: "Vector Search," "Retrieval," and "Generation."](../../../../images/kodekloud.com/kk-media/image/upload/v1752875866/notes-assets/images/Generative-AI-in-Practice-Advanced-Insights-and-Operations-Introduction-to-RAG/rag-core-components-diagram.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/generative-ai-in-practice-advanced-insights-and-operations/module/530aab3b-2236-4f0e-b1d6-089654d76036/lesson/e23d3972-3eb4-4bdd-a12f-68f522375706" />
</CardGroup>
