...
Source: https://notes.kodekloud.com/docs/Generative-AI-in-Practice-Advanced-Insights-and-Operations/Retrieval-Augmented-Generation-RAG/Vector-Search/page

This article explores vector search, its techniques, and applications in AI, emphasizing the importance of embeddings for retrieving semantically relevant information.
...
<Frame>
  ![The image shows a search bar with the query "World car" and a document preview highlighting the word "vehicle" multiple times.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875871/notes-assets/images/Generative-AI-in-Practice-Advanced-Insights-and-Operations-Vector-Search/world-car-search-document-preview.jpg)
</Frame>
...
<Frame>
  ![The image illustrates the concept of vector search, showing document text and user queries being converted into embeddings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875872/notes-assets/images/Generative-AI-in-Practice-Advanced-Insights-and-Operations-Vector-Search/vector-search-embeddings-diagram.jpg)
</Frame>
...
<Frame>
  ![The image illustrates a vector search example, showing word embeddings for words like "CAT," "DOG," "MAN," and "WOMAN," with dimensionality reduction from 7D to 2D and corresponding 2D visualizations.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875874/notes-assets/images/Generative-AI-in-Practice-Advanced-Insights-and-Operations-Vector-Search/vector-search-word-embeddings-2d.jpg)
</Frame>
...
<Frame>
  ![The image illustrates a vector search example, showing various items like animals and fruits represented as points in a 3D space with 300 dimensions. It demonstrates how different objects are positioned in relation to each other in a vector space.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875875/notes-assets/images/Generative-AI-in-Practice-Advanced-Insights-and-Operations-Vector-Search/vector-search-example-3d-space.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/generative-ai-in-practice-advanced-insights-and-operations/module/530aab3b-2236-4f0e-b1d6-089654d76036/lesson/002018fe-70ab-4e1a-b32c-ffd355534b01" />
</CardGroup>
