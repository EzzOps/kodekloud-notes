...
<Frame>
  ![The image shows a GitHub Actions workflow in progress, with a job sequence including "build\_job\_1," "test\_job\_2," and "deploy\_job\_3." The workflow is triggered by a push event and is currently executing "build\_job\_1."](../../../../images/kodekloud.com/kk-media/image/upload/v1752876140/notes-assets/images/GitHub-Actions-Certification-Execute-multiple-jobs-in-Sequence-using-needs/github-actions-workflow-build-job.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub Actions workflow interface with a failed job sequence, where "test\_job\_2" has failed, interrupting the process.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876142/notes-assets/images/GitHub-Actions-Certification-Execute-multiple-jobs-in-Sequence-using-needs/github-actions-failed-job-workflow.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/github-actions-certification/module/54711be0-66e6-461b-b935-f77d78a5e000/lesson/9cbb1473-9755-4ad5-ba14-ce9047f02368" />
</CardGroup>
