...
Source: https://notes.kodekloud.com/docs/GitHub-Actions-Certification/GitHub-Actions-Core-Concepts/Using-a-matrix-for-your-jobs/page

Learn to use GitHub Actions matrix strategy for running jobs across multiple environments without duplicating YAML.
...
<Frame>
  ![The image shows a GitHub Actions page displaying a list of workflow runs, including their status, branch, and execution time. The interface is dark-themed, with options for managing workflows on the left sidebar.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876168/notes-assets/images/GitHub-Actions-Certification-Using-a-matrix-for-your-jobs/github-actions-workflow-runs-status.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub Actions interface with a job titled "deploy-on-windows" that has successfully completed. It details the setup process, including the operating system and runner version used.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876169/notes-assets/images/GitHub-Actions-Certification-Using-a-matrix-for-your-jobs/github-actions-deploy-on-windows-success.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub Actions interface with a workflow run summary for a matrix job, displaying details of a successful deployment on Ubuntu.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876170/notes-assets/images/GitHub-Actions-Certification-Using-a-matrix-for-your-jobs/github-actions-matrix-job-deployment.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub Actions workflow interface with a matrix configuration, displaying the status of various deployment jobs for different environments like Ubuntu and Windows.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876171/notes-assets/images/GitHub-Actions-Certification-Using-a-matrix-for-your-jobs/github-actions-workflow-matrix-status.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/github-actions-certification/module/54711be0-66e6-461b-b935-f77d78a5e000/lesson/262b76e3-8f5b-455d-838f-d17f8676c140" />
</CardGroup>
