...
Source: https://notes.kodekloud.com/docs/GitHub-Actions-Certification/GitHub-Actions-Core-Concepts/Working-with-Variables-at-different-levels/page

Learn to refactor hard-coded values into environment variables in GitHub Actions workflows for better maintenance and readability.
...
<Callout icon="triangle-alert">
  Hard-coding credentials like `dockerUsername` and `s3curePaSsW0rd` is insecure and violates DRY.
  Always use variables and secrets instead.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/github-actions-certification/module/54711be0-66e6-461b-b935-f77d78a5e000/lesson/887fa064-69db-46c2-ba6f-5eea0f63707e" />
</CardGroup>
