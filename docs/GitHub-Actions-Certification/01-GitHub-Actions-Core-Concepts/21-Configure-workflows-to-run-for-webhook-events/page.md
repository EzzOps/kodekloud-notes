...
Source: https://notes.kodekloud.com/docs/GitHub-Actions-Certification/GitHub-Actions-Core-Concepts/Configure-workflows-to-run-for-webhook-events/page

This guide covers key GitHub Actions triggers to automate and chain CI/CD pipelines efficiently.
...
<Frame>
  ![The image is a table listing various trigger events, with some highlighted in green and red, related to GitHub actions or workflows.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876120/notes-assets/images/GitHub-Actions-Certification-Configure-workflows-to-run-for-webhook-events/github-actions-trigger-events-table.jpg)
</Frame>
...
* [repository\_dispatch API](https://docs.github.com/rest/dispatches#repository-dispatch)

<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/github-actions-certification/module/54711be0-66e6-461b-b935-f77d78a5e000/lesson/6cb36191-b294-4e05-8681-16ea2af9e44d" />

  <Card title="Practice Lab" icon="installation" href="https://learn.kodekloud.com/user/courses/github-actions-certification/module/54711be0-66e6-461b-b935-f77d78a5e000/lesson/80edf0ec-4e63-4407-866c-fa7f04e89e38" />
</CardGroup>
