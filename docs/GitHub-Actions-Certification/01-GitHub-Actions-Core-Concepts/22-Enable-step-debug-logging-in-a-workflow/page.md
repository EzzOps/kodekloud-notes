...
<Frame>
  ![The image shows a GitHub documentation page about enabling debug logging in GitHub Actions, with navigation links on the left and content explaining how to set up debug logging.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876131/notes-assets/images/GitHub-Actions-Certification-Enable-step-debug-logging-in-a-workflow/github-actions-debug-logging-docs.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub documentation page about enabling runner and step debug logging in GitHub Actions. It includes instructions and a navigation menu on the left.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876132/notes-assets/images/GitHub-Actions-Certification-Enable-step-debug-logging-in-a-workflow/github-actions-runner-debug-logging.jpg)
</Frame>
