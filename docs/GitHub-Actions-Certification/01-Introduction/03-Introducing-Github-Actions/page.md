...
> **lightbulb** You can combine multiple events in `on:` to run workflows on several triggers simultaneously.
...
> **triangle-alert** Self-hosted runners must be secured and updated regularly. You are responsible for OS patches, network access, and resource isolation.
