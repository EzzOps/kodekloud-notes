...
> **lightbulb** GitHub.dev provides the full VS Code keybindings and interface in your browser—no local install required.
...
> **triangle-alert** By default, the runner does **not** check out your repository. Without your code present, the `ls` and `cat` commands will fail.
