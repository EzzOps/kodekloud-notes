...
> **lightbulb** Save each workflow file in the `.github/workflows/` directory. You can have multiple workflow files, each triggered by different events (e.g., `pull_request`, `release`, or a schedule).
...
> **triangle-alert** If you need to share data between jobs, use [artifacts](https://docs.github.com/en/actions/using-workflows/storing-workflow-data-as-artifacts) or [caches](https://docs.github.com/en/actions/advanced-guides/caching-dependencies-to-speed-up-workflows).
