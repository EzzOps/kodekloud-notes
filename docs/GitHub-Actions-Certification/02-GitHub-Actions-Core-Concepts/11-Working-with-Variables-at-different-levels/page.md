...
> **triangle-alert** Hard-coding credentials like `dockerUsername` and `s3curePaSsW0rd` is insecure and violates DRY.
...
> **lightbulb** Sensitive values like `DOCKER_PASSWORD` are automatically masked in the logs.
