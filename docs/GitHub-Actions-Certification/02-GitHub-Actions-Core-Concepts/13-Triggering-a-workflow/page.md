...
> **lightbulb** Common trigger events include `push`, `pull_request`, `schedule`, `registry_package`, and `workflow_dispatch`. You can mix multiple events in a single workflow.
...
![The image shows a GitHub Docs page about GitHub Actions, specifically detailing events that trigger workflows, with a focus on the "registry\_package" event.](https://kodekloud.com/kk-media/image/upload/v1752876157/notes-assets/images/GitHub-Actions-Certification-Triggering-a-workflow/github-actions-workflows-registry-package.jpg)
...
> **lightbulb** Use [Crontab Guru](https://crontab.guru) to build and validate cron expressions.
...
![The image shows a GitHub documentation page about "workflow\_dispatch" in GitHub Actions, detailing how to manually trigger workflows and configure inputs.](https://kodekloud.com/kk-media/image/upload/v1752876161/notes-assets/images/GitHub-Actions-Certification-Triggering-a-workflow/github-actions-workflow-dispatch-docs.jpg)
