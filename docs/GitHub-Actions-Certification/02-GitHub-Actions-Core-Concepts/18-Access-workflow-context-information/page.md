...
> **lightbulb** Combine context lookups with [GitHub expressions](https://docs.github.com/en/actions/learn-github-actions/expressions) for powerful conditional statements.
...
> **triangle-alert** Never expose secrets in public or shared logs. Printing `toJson(secrets)` can reveal sensitive data if your repository or runner is not private.
