...
Source: https://notes.kodekloud.com/docs/GitHub-Actions-Certification/GitHub-Actions-Core-Concepts/Cancelling-and-Skipping-Workflows/page
...
> **lightbulb** Skipping workflows with commit messages is case-insensitive and works with or without brackets.
...
> **triangle-alert** Cancelling a workflow does not roll back any completed jobs or deployed artifacts. Ensure you manually revert changes if necessary.
