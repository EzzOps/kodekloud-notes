...
> **lightbulb** If you’re querying a public repository, you can omit the `Authorization` header.
...
> **triangle-alert** Avoid using `-k` in production—always validate SSL certificates to secure your data in transit.
