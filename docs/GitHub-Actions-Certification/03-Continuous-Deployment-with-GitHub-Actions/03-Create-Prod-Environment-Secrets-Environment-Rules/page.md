...
<Frame>
  ![The image shows a GitHub settings page for configuring deployment protection rules in a production environment, including options for required reviewers and a wait timer.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875880/notes-assets/images/GitHub-Actions-Certification-Create-Prod-Environment-Secrets-Environment-Rules/github-settings-deployment-protection-rules.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub settings page for configuring environment protection rules, deployment branches, environment secrets, and variables. It includes options to add secrets and variables, and to manage branch rules.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875881/notes-assets/images/GitHub-Actions-Certification-Create-Prod-Environment-Secrets-Environment-Rules/github-settings-environment-protection-rules.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub repository settings page focused on configuring environments, with sections for "production" and "development" that include protection rules, secrets, and variables.](../../../../images/kodekloud.com/kk-media/image/upload/v1752875882/notes-assets/images/GitHub-Actions-Certification-Create-Prod-Environment-Secrets-Environment-Rules/github-repo-settings-environments-config.jpg)
</Frame>
