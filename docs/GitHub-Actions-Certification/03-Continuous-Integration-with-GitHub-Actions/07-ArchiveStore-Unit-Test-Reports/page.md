...
> **lightbulb** The `path` field accepts glob patterns. To archive multiple XML reports, use something like `path: reports/**/*.xml`.
...
> **lightbulb** By default, artifacts are retained for 90 days. You can [configure retention](https://docs.github.com/actions/using-workflows/storing-workflow-data-as-artifacts#using-artifacts) or delete them when they’re no longer needed.
