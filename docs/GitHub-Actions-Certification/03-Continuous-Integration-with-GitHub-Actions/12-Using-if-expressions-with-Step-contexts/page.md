...
> **lightbulb** By default, when a step fails, all later steps (including uploads) are skipped.
...
> **lightbulb** You can use comparison operators (`==`, `!=`, `>`, `<`) and functions in [expressions](https://docs.github.com/actions/learn-github-actions/expressions) to control step execution.
