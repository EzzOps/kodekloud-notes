...
Source: https://notes.kodekloud.com/docs/GitHub-Actions-Certification/Continuous-Integration-with-GitHub-Actions/Workflow-Docker-Push/page

This tutorial enhances GitHub Actions to build, test, and publish a Docker image to Docker Hub using Docker Buildx.
...
> **lightbulb** Tagging images with the Git SHA ensures traceability. Use `${{ github.sha }}` for an immutable reference.
...
> **triangle-alert** Ensure your `DOCKERHUB_TOKEN` is stored as a [GitHub repository secret](https://docs.github.com/actions/security-guides/encrypted-secrets) to prevent credential leaks.
