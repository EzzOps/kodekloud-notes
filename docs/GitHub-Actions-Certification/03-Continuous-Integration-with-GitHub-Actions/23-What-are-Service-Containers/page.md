...
Source: https://notes.kodekloud.com/docs/GitHub-Actions-Certification/Continuous-Integration-with-GitHub-Actions/What-are-Service-Containers/page

Service containers in GitHub Actions enable Docker containers for on-demand services in CI/CD pipelines, facilitating integration and end-to-end testing without external infrastructure management.
...
> **lightbulb** This workflow is perfect for fast-running unit tests that do not depend on external databases or caches. If your tests require a service, see the next section.
...
> **triangle-alert** Be mindful of resource limits on GitHub-hosted runners. Running multiple heavyweight services can lead to slower startup times or timeouts.
