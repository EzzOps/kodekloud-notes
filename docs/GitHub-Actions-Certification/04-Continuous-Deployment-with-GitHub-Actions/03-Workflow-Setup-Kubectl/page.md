...
> **lightbulb** Using the official `azure/setup-kubectl` action ensures you get signed binaries and can pin a specific version for reproducible builds.
...
> **triangle-alert** You must provide a `kubeconfig` file via secrets or variables and configure it in your workflow. Without it, `kubectl` cannot authenticate to your cluster.
