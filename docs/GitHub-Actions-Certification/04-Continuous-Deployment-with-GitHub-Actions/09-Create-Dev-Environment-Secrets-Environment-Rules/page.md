...
> **lightbulb** You can extend protection with custom rules by exploring [third-party Actions](https://github.com/marketplace?type=actions) or writing your own.
...
> **triangle-alert** Environment secrets override repository secrets with the same name.

![The image shows a GitHub interface where a user is adding a secret in the environment settings. The user is entering a name and value for the secret, with suggestions like "DOCKER\_PASSWORD" and "MONGO\_PASSWORD" visible.](https://kodekloud.com/kk-media/image/upload/v1752875876/notes-assets/images/GitHub-Actions-Certification-Create-Dev-Environment-Secrets-Environment-Rules/github-add-secret-environment-settings.jpg)
