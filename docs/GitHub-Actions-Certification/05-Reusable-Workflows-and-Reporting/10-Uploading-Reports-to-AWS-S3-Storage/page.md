...
> **lightbulb** Store your AWS credentials securely under **Settings → Secrets and variables** in your GitHub repository.
...
> **lightbulb** Browse the [GitHub Marketplace](https://github.com/marketplace?type=actions) for actions to integrate with other cloud providers and CI/CD tools.
