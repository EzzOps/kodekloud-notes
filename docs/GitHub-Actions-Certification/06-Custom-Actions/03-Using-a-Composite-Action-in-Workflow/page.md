...
> **lightbulb** Reference the action directory (`npm-action`) without specifying `action.yml`; GitHub locates it automatically.
...
> **lightbulb** To inspect the Unit Testing job logs and progress, click the **Unit Testing** entry in the run detail.
...
> **lightbulb** To verify the Code Coverage job used the composite action, check the job details in the run summary.
