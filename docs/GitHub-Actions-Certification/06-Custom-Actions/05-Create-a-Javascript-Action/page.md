...
> **lightbulb** The `github-token` input is usually provided via `${{ secrets.GITHUB_TOKEN }}`.\
...
> **lightbulb** `ncc` produces `dist/index.js` with your action logic and all dependencies. This simplifies deployment.
