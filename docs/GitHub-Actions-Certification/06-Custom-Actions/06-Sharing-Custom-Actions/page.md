...
> **lightbulb** Publishing to the GitHub Marketplace requires two-factor authentication (2FA). If prompted, enable 2FA in your [GitHub account settings](https://docs.github.com/en/authentication/securing-your-account-with-two-factor-authentication-2fa/configuring-two-factor-authentication) and refresh the page.
...
> **lightbulb** Enhance your `README.md` with detailed usage examples and workflow snippets. Then, consumers can use your action like this:
