...
> **lightbulb** You can find a complete list of commands and parameters in the [Workflow Commands for GitHub Actions documentation][workflow-commands-docs].
...
> **triangle-alert** Be cautious when masking secrets. Once added, they cannot be retrieved in plain text within the runner.
