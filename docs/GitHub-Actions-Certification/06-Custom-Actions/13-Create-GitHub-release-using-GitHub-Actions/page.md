...
> **lightbulb** Use tag patterns to control when the workflow runs:
...
> **triangle-alert** The workflow needs `contents: write` permission to publish releases and upload assets.\
