...
<Frame>
  ![The image shows a GitHub documentation page about configuring a proxy server with self-hosted runners, including instructions on using environment variables.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876211/notes-assets/images/GitHub-Actions-Certification-Configure-self-hosted-runners-with-proxies/github-documentation-proxy-server-runners.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub Actions page for a repository named "enterprise-actions-demo" with a workflow titled "Exploring Github Enterprise Action Features/Policies." It displays a list of workflow runs with their statuses and details.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876213/notes-assets/images/GitHub-Actions-Certification-Configure-self-hosted-runners-with-proxies/github-actions-enterprise-demo-workflow.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub Actions job log with an error message indicating an external call failed due to invalid proxy credentials.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876214/notes-assets/images/GitHub-Actions-Certification-Configure-self-hosted-runners-with-proxies/github-actions-job-log-error-proxy.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub documentation page about configuring a proxy server using environment variables for self-hosted runners. It includes examples of proxy URLs and a sidebar with navigation links related to GitHub Actions.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876215/notes-assets/images/GitHub-Actions-Certification-Configure-self-hosted-runners-with-proxies/github-actions-proxy-server-configuration.jpg)
</Frame>
