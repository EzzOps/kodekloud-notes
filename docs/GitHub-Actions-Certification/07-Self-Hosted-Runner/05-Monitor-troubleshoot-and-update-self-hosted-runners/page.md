...
> **triangle-alert** Do **not** run this script as root unless you intentionally bypass the check.\
...
> **lightbulb** Ensure your self-hosted runner has all required tools and permissions for your workflows.
...
> **lightbulb** Generate a classic personal access token with the `workflow` scope under **Settings > Developer settings > Personal access tokens**.
...
> **triangle-alert** Disabling TLS verification reduces security. Use only for temporary troubleshooting:
...
> **lightbulb** If Docker is not found, container actions will fail:
