...
> **lightbulb** New users may be eligible for free credits on HCP. Check the [pricing page](https://cloud.hashicorp.com/pricing) for details.
...
> **triangle-alert** Always verify that only the minimum required permissions are granted when authorizing integrations. Avoid exposing secrets in plaintext logs.
...
> **lightbulb** Regularly rotate your secrets and remove any unused credentials to limit blast radius.
...
> **lightbulb** Short-lived tokens automatically expire, minimizing the risk of credential theft or misuse.
...
> **triangle-alert** Running unchecked user input in a shell step can expose secrets, corrupt workflows, or allow remote code execution.
