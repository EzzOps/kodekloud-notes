...
> **lightbulb** By default, GitHub uses your default branch (often `main`). You can switch branches or filter by event types before copying the badge snippet.
...
> **triangle-alert** If you’re updating only your README, consider adding `[skip ci]` to your commit message to avoid triggering CI workflows unnecessarily.
