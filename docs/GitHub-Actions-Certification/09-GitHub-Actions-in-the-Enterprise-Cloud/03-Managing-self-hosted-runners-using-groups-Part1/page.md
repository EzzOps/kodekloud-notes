...
> **triangle-alert** Public repository support for a runner group is only configurable at the **enterprise** level. You won’t be able to enable it within the organization settings.
