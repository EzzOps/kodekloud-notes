...
> **lightbulb** Enterprise-level policies take precedence over organization and repository settings. Once set, lower levels become read-only and inherit these policies.
...
> **triangle-alert** Disabling Actions at the repository level will prevent any workflows from running, including those critical for CI/CD.
