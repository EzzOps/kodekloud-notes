...
> **lightbulb** Pre-bundled actions are static snapshots captured at installation time. If you need newer versions or third-party actions, use one of the methods below.
...
> **lightbulb** After configuring GitHub Connect, approved public actions resolve automatically without additional steps.
...
> **triangle-alert** Always pin to a specific version when syncing with `actions-sync`. This prevents unintended updates and maintains workflow stability.
