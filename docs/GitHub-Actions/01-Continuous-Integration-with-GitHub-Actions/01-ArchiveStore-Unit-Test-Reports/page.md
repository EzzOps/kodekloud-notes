...
Source: https://notes.kodekloud.com/docs/GitHub-Actions/Continuous-Integration-with-GitHub-Actions/ArchiveStore-Unit-Test-Reports/page

Learn to archive Mocha unit test reports using GitHub Actions upload-artifact action for easy access and management of test results.
...
<Frame>
  ![The image shows a GitHub Actions page for a repository named "solar-system," displaying a list of workflow runs with their statuses and details.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876482/notes-assets/images/GitHub-Actions-ArchiveStore-Unit-Test-Reports/github-actions-solar-system-workflows.jpg)
</Frame>

Click into the run to explore individual steps, including the **Archive Test Result**:

<Frame>
  ![The image shows a GitHub Actions interface with a successful unit testing workflow, including steps like checking out the repository, setting up Node.js, and archiving test results.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876484/notes-assets/images/GitHub-Actions-ArchiveStore-Unit-Test-Reports/github-actions-unit-testing-workflow.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/github-actions/module/6136c7b5-8fe0-4a84-ae77-0274623512d5/lesson/150931a0-6a90-4955-ab62-b700873317b3" />
</CardGroup>
