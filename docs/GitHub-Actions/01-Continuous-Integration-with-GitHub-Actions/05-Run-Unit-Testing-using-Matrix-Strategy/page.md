...
Source: https://notes.kodekloud.com/docs/GitHub-Actions/Continuous-Integration-with-GitHub-Actions/Run-Unit-Testing-using-Matrix-Strategy/page
...
<Frame>
  ![The image shows a GitHub Actions workflow interface, displaying a "test on multiple os using matrix" job in progress, with unit testing being conducted on various operating systems.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876516/notes-assets/images/GitHub-Actions-Run-Unit-Testing-using-Matrix-Strategy/github-actions-matrix-job-testing.jpg)
</Frame>

<Frame>
  ![The image shows a GitHub Actions workflow interface with unit testing jobs for different operating systems, including Ubuntu and macOS. The highlighted job is "Unit Testing (20, ubuntu-latest)" which has succeeded.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876517/notes-assets/images/GitHub-Actions-Run-Unit-Testing-using-Matrix-Strategy/github-actions-workflow-unit-testing.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/github-actions/module/6136c7b5-8fe0-4a84-ae77-0274623512d5/lesson/ea28d45a-eecc-4f64-a139-5b8e6431ca0b" />
</CardGroup>
