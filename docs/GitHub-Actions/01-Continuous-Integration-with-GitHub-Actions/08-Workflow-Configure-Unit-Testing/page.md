...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/github-actions/module/6136c7b5-8fe0-4a84-ae77-0274623512d5/lesson/4a8b6d38-0341-43fb-acd5-fa2866f89217" />
</CardGroup>
...
<Frame>
  ![The image shows a GitHub repository page for a project named "solar-system," displaying the file structure and recent commits. The repository is public and has no stars or forks.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876533/notes-assets/images/GitHub-Actions-Workflow-Configure-Unit-Testing/github-repo-solar-system-structure.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub page for the "setup-node" action, detailing its functionality and usage for managing Node.js versions in GitHub Actions. It includes a code snippet for configuring the action.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876535/notes-assets/images/GitHub-Actions-Workflow-Configure-Unit-Testing/github-setup-node-action-usage.jpg)
</Frame>
...
<Frame>
  ![The image shows the settings page of a GitHub repository, specifically focusing on actions permissions and artifact log retention options. The "Disable actions" option is selected.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876536/notes-assets/images/GitHub-Actions-Workflow-Configure-Unit-Testing/github-repo-settings-actions-permissions.jpg)
</Frame>

Once enabled, the Actions tab will appear in your repository.

<Frame>
  ![The image shows a GitHub Actions setup page with options to configure workflows like Docker image, Node.js package publishing, and Jekyll using Docker.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876537/notes-assets/images/GitHub-Actions-Workflow-Configure-Unit-Testing/github-actions-workflows-setup-docker.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub Actions workflow interface with a failed unit testing job. It includes details of the setup process and logs related to the failure.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876538/notes-assets/images/GitHub-Actions-Workflow-Configure-Unit-Testing/github-actions-workflow-failed-job.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub repository settings page where a new secret named "MONGO\_PASSWORD" with the value "SuperPassword" is being added.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876538/notes-assets/images/GitHub-Actions-Workflow-Configure-Unit-Testing/github-repo-settings-add-mongo-password.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub settings page where a new action variable is being added, with the name "MONGO\_USERNAME" and the value "superuser."](../../../../images/kodekloud.com/kk-media/image/upload/v1752876539/notes-assets/images/GitHub-Actions-Workflow-Configure-Unit-Testing/github-settings-new-action-variable.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/github-actions/module/6136c7b5-8fe0-4a84-ae77-0274623512d5/lesson/c21be618-a76a-4930-97b0-7bcc5961e53c" />
</CardGroup>
