...
> **lightbulb** GitHub-hosted runners are preconfigured VMs managed by GitHub. You don’t need to worry about provisioning hardware, installing dependencies, or scaling resources.
...
> **lightbulb** Self-hosted runners require you to handle updates, scaling, and security.
