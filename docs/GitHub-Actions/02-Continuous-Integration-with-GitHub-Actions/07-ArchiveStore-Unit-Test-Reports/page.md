...
> **lightbulb** The `name` field under `with:` serves as the artifact identifier. The `path` field should point to your generated `test-results.xml`.
...
> **lightbulb** Artifacts are retained for **90 days** by default. You can download or delete them via the workflow summary under your repository’s **Actions** tab.
