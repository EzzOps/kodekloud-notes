...
> **triangle-alert** Storing secrets directly in your workflow can expose them in logs. Use [GitHub Secrets](https://docs.github.com/actions/security-guides/encrypted-secrets) instead.
