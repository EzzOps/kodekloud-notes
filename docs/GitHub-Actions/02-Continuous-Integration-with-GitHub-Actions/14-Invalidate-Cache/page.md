...
> **lightbulb** Use `continue-on-error` carefully—it can mask genuine failures if overused.
...
> **lightbulb** If multiple jobs use the same cache key, one job will succeed in saving while the others may report a save failure. This is expected behavior.
