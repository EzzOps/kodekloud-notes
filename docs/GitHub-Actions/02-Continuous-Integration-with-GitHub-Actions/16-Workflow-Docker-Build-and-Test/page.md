...
> **lightbulb** Store your Docker Hub credentials as [GitHub Secrets](/docs/github/creating-secrets-for-workflows) or repository variables to avoid exposing sensitive data in your workflow YAML.
