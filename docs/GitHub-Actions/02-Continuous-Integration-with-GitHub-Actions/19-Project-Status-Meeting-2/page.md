...
> **triangle-alert** Running tests and coverage jobs against a production database can lead to data corruption, unexpected downtime, and security risks. Always isolate your CI environment.
...
> **lightbulb** Service containers spin up alongside your job and provide an isolated database at `localhost`. No changes to production credentials are needed.
