...
Source: https://notes.kodekloud.com/docs/GitHub-Actions/Continuous-Integration-with-GitHub-Actions/What-are-Service-Containers/page

Service containers are Docker containers that host supporting services for GitHub Actions workflows, ensuring consistency across environments.
...
> **lightbulb** Always make sure the port you map on the runner (e.g., `12345`) is not in use by other services.
...
> **triangle-alert** Service containers share a user-defined bridge network. Do not rely on `localhost` inside the primary container; use the defined service hostname.
