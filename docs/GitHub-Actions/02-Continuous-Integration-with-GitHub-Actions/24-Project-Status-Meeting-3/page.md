...
> **lightbulb** Separating container responsibilities lets you scale each component independently, reduces resource contention, and improves fault isolation.
...
> **triangle-alert** Ensure `kubectl` is installed and pointed at a cluster. New to Kubernetes? Start with [Kubernetes Basics](https://kubernetes.io/docs/concepts/overview/what-is-kubernetes/).
