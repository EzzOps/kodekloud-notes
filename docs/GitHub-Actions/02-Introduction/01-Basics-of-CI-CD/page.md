...
Source: https://notes.kodekloud.com/docs/GitHub-Actions/Introduction/Basics-of-CI-CD/page
...
<Frame>
  ![The image illustrates a workflow for continuous integration, highlighting the process from feature branches to production, and lists challenges like delayed testing, inefficient deployment, and quality assurance issues without CI.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876695/notes-assets/images/GitHub-Actions-Basics-of-CI-CD/ci-workflow-feature-branches-production.jpg)
</Frame>
...
<Frame>
  ![The image illustrates a continuous integration workflow, showing steps from feature branch creation to production deployment, including unit testing, dependency scanning, and code scanning.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876696/notes-assets/images/GitHub-Actions-Basics-of-CI-CD/continuous-integration-workflow-diagram.jpg)
</Frame>
...
<Frame>
  ![The image illustrates a continuous deployment/delivery pipeline, showing the process from committing code to deploying it in production and staging environments, including steps like code review, continuous integration, and testing.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876697/notes-assets/images/GitHub-Actions-Basics-of-CI-CD/continuous-deployment-delivery-pipeline-diagram.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/github-actions/module/a038043a-b553-43c2-9748-2c91fa232a9b/lesson/536147b8-572e-46cb-8fe7-31a8d0d7b470" />
</CardGroup>
