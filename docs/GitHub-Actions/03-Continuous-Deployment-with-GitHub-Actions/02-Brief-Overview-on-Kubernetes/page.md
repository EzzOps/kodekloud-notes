...
> **lightbulb** To achieve high availability and self-healing, wrap pods in higher-level controllers such as ReplicaSets and Deployments.
...
> **triangle-alert** Provisioning a `LoadBalancer` service may incur additional cloud provider costs. Review your cloud network pricing before use.
