...
> **lightbulb** Ensure that `vars.NAMESPACE`, `vars.REPLICAS`, and your Docker Hub credentials are configured in your GitHub repository settings.
...
> **triangle-alert** Never commit real credentials into source control. Use GitHub Secrets and Kubernetes Secrets to manage sensitive data.
