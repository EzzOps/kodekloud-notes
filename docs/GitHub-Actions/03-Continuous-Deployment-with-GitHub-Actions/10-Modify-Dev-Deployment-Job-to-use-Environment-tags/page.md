...
> **lightbulb** Environment-level variables override repository-level variables. In our example, the repository variable `REPLICAS` is set to `2`, while in the **development** environment it’s set to `1`.
