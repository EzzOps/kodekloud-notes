...
> **lightbulb** The `if` expression runs at the job level. Jobs whose conditions evaluate to `false` are marked as **skipped**.
...
> **triangle-alert** Ensure you’ve configured environment protection rules in your repository settings to require manual approvals before Production deployments.
