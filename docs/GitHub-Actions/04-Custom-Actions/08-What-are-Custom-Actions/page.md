...
Source: https://notes.kodekloud.com/docs/GitHub-Actions/Custom-Actions/What-are-Custom-Actions/page

This article explains how to create and use custom GitHub Actions to enhance CI/CD pipelines with tailored scripts and containers.
...
<Frame>
  ![The image is a comparison chart of three types of custom actions: Composite Actions, Docker Actions, and JavaScript Actions, highlighting their features and differences.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876608/notes-assets/images/GitHub-Actions-What-are-Custom-Actions/custom-actions-comparison-chart.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/github-actions/module/cdb7c2b7-442d-440c-a4f1-d6679733ffd8/lesson/22b27d45-aa89-4e42-9331-044bdab63ccf" />
</CardGroup>
