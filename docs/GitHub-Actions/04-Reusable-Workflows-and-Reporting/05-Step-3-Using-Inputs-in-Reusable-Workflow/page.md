...
> **lightbulb** Reusable workflows require GitHub Actions `workflow_call`. See the [GitHub Actions Reusing Workflows](https://docs.github.com/actions/using-workflows/reusing-workflows) guide for details.
...
> **lightbulb** Repository variables are not encrypted. Use **Secrets** for sensitive values like passwords.
...
> **lightbulb** Keep input names consistent between caller and reusable workflows to minimize errors.
