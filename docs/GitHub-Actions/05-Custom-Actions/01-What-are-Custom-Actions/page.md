...
> **lightbulb** Use composite actions to encapsulate common setup tasks, such as linting or test orchestration, across multiple repositories.
...
> **triangle-alert** Docker container actions are supported **only** on Linux runners. Ensure your workflows target the correct OS.
