...
> **lightbulb** Keep your GitHub token and API keys secure. Never commit secrets directly to your repo.
...
> **triangle-alert** Add a `.gitignore` file to prevent tracking large files:
