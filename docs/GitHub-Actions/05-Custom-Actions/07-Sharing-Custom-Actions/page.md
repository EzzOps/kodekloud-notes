...
Source: https://notes.kodekloud.com/docs/GitHub-Actions/Custom-Actions/Sharing-Custom-Actions/page

This article explains how to publish a JavaScript action to the GitHub Marketplace, including prerequisites and steps for creating a release.
...
> **lightbulb** GitHub requires 2FA for all Marketplace publishers. If you haven’t set it up yet, follow the prompts under **Settings → Security → Two-factor authentication**.
...
> **triangle-alert** If you see “Action name must be unique” or “Branding information missing,” update your `action.yml` before you can publish.
