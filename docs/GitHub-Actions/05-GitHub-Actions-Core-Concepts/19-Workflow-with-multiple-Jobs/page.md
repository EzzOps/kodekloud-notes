...
<Frame>
  ![The image shows a GitHub Actions workflow summary with three jobs: "build\_job\_1" succeeded, while "test\_job\_2" and "deploy\_job\_3" failed, resulting in an overall failure status.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876687/notes-assets/images/GitHub-Actions-Workflow-with-multiple-Jobs/github-actions-workflow-summary-failure.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitHub Actions interface with a workflow run summary. It displays the status of multiple jobs, including "build\_job\_1" which succeeded, and "test\_job\_2" and "deploy\_job\_3" which failed.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876688/notes-assets/images/GitHub-Actions-Workflow-with-multiple-Jobs/github-actions-workflow-run-summary.jpg)
</Frame>
