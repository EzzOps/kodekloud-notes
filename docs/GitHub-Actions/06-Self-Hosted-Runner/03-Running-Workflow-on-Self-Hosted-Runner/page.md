...
> **lightbulb** Ensure your VM meets the [runner requirements](https://docs.github.com/en/actions/hosting-your-own-runners/adding-self-hosted-runners#self-hosted-runner-requirements): at least 2 CPU cores, 8 GB RAM, and Docker if you plan on containerized jobs.
...
> **triangle-alert** By default, running the runner as root is disabled for security. To override (at your own risk), export:
...
> **lightbulb** If you don’t see “Listening for Jobs,” verify your network connectivity and runner configuration.\
...
> **triangle-alert** Any typo or missing label (for example, using `production` instead of `prod`) will cause the job to remain pending until it times out.
