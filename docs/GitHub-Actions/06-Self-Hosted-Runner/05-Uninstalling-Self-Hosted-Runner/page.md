...
> **triangle-alert** Maintaining self-hosted runners requires you to manage updates, security patches, and uptime. Ensure you have monitoring and backup strategies in place.
...
> **lightbulb** If you have MFA enabled, GitHub will prompt you for your authentication code. Once verified, the runner is permanently removed from the repository.
...
> **triangle-alert** Ensure you copy the exact token from your repository’s runner settings. An invalid token will prevent the runner from unregistering.
