...
> **triangle-alert** Avoid embedding any sensitive data directly in your YAML. Always reference secrets using `${{ secrets.YOUR_SECRET_NAME }}`.
...
> **lightbulb** Before enabling OIDC, update your cloud trust policies to accept tokens from `token.actions.githubusercontent.com`.
...
> **triangle-alert** Never pass unescaped variables directly into `run:` blocks. Use parameterized inputs instead.
