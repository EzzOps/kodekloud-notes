...
> **triangle-alert** Exposed `AWS_SECRET_ACCESS_KEY` can be exploited to access AWS resources, incurring data breaches or infrastructure compromise.
...
> **lightbulb** For more guidance on securing workflows, see the [GitHub Actions security hardening guide](https://docs.github.com/actions/security-guides/security-hardening-for-github-actions).
