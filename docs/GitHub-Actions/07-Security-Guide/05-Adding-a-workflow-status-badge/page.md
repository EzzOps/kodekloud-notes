...
> **lightbulb** Badges are dynamic images that update automatically each time your workflow runs. You can filter by branch or event to display the status you care about.
...
> **triangle-alert** Too many badges can clutter your README. Group or reorder them logically to maintain readability.
