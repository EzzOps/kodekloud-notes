...
> **triangle-alert** Always review an action’s source code before integrating it. Ensure it handles your repository’s content and secrets safely—never exposes secrets to unintended hosts or logs sensitive data.
...
> **lightbulb** Tags strike a balance between stability and ease of upgrades. Use SHAs when you need fully reproducible builds.
