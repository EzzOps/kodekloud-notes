...
> **lightbulb** Installing `cowsay` is crucial. Without it, any `cowsay` commands will fail.
...
> **triangle-alert** Art files like `dragon.txt` exist only on the runner VM. Once the job ends, the VM is torn down and all generated files are lost.
