...
> **lightbulb** By default, GitHub Actions will cancel any workflow that runs longer than **360 minutes** (6 hours). Configuring `timeout-minutes` at a finer granularity helps you catch issues earlier.
