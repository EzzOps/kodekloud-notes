...
> **lightbulb** For full details on expressions, see the [GitHub Actions expressions documentation][expressions-docs].
...
> **lightbulb** Check the Actions tab in your repository to see which jobs succeeded or were skipped.
...
> **lightbulb** Pull request details display commit statuses, merge confirmation, and branch deletion options.
...
> **lightbulb** Monitor the Actions tab to confirm that the deploy job ran successfully.
