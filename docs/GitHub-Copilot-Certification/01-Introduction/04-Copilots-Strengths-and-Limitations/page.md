...
> **lightbulb** If you experience latency, try limiting the scope of the active file or using local indexing features in your IDE.
...
> **triangle-alert** Your code context is sent to remote servers; review organizational policies on data privacy and compliance before enabling Copilot in enterprise environments.
