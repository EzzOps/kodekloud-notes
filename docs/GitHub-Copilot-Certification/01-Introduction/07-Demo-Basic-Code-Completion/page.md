...
> **lightbulb** GitHub Copilot will trigger on typing patterns like `def` or `class`. Press `Tab` (or your configured shortcut) to accept the suggestion.
...
> **triangle-alert** Always review generated code for edge cases and security considerations—AI suggestions may not cover every scenario.
