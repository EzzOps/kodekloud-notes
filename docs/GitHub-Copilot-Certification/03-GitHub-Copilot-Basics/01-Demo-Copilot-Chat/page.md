...
Source: https://notes.kodekloud.com/docs/GitHub-Copilot-Certification/GitHub-Copilot-Basics/Demo-Copilot-Chat/page
...
3. Test your API endpoints:
   ...
   * **POST** [http://localhost:3000/users](http://localhost:3000/users) (JSON payload) → creates a user
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/github-copilot-certification/module/3d32a217-aca3-450a-882e-c9304c497387/lesson/15bdb476-3632-42fb-abda-ac6b71fd12a8" />
</CardGroup>
