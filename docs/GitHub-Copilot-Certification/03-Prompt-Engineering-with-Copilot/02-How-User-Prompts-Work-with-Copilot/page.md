...
> **lightbulb** Copilot does **not** upload your full codebase. It only sends the most relevant lines to preserve confidentiality and reduce latency.
...
> **triangle-alert** Never include **sensitive data** (API keys, passwords) in your prompts. Use environment variables or secret managers and follow your organization’s AI data-sharing policies.
