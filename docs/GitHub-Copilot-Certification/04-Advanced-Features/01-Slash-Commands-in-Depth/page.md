...
> **lightbulb** Visual Studio subscribers get **Copilot Free** automatically. Monthly limits reset on your billing date. To unlock unlimited completions, sign in with an existing GitHub Copilot subscription.
...
> **triangle-alert** If you use `/clear`, all previous chat history is lost. Make sure to save important context or prompts before resetting.
