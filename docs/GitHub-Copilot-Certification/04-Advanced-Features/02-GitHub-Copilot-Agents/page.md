...
> **lightbulb** Each agent has unique training data and access scopes—choose the right one for your task to get the best results.
...
> **triangle-alert** Agent Mode is experimental. Review all changes before committing to avoid unintended edits.
