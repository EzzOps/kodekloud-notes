...
> **lightbulb** Combine natural language with context references for precise guidance. For example:\
...
> **triangle-alert** In very large codebases, implicit context may include irrelevant files. Disable it in settings to prevent suggestion confusion.
...
> **lightbulb** Mention `@workspace` or `@terminal` in your query to route questions to the right Copilot agent.
