...
> **lightbulb** A [GitHub Copilot subscription](https://github.com/features/copilot) is required (free for eligible users).
...
> **triangle-alert** Always inspect AI-generated commands before executing in production environments.
