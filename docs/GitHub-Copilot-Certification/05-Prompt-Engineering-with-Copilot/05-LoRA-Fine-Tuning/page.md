...
Source: https://notes.kodekloud.com/docs/GitHub-Copilot-Certification/Prompt-Engineering-with-Copilot/LoRA-Fine-Tuning/page

LoRA fine-tuning customizes large language models efficiently by applying small patches instead of full retraining, reducing costs and speeding up the process.
...
<Frame>
  ![The image describes "LoRA – 'Smart Patches' for AI," highlighting three features: Low-Rank Adaptation, Highly Efficient, and Lightweight, each with a brief explanation and icon.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876950/notes-assets/images/GitHub-Copilot-Certification-LoRA-Fine-Tuning/lora-smart-patches-ai-features.jpg)
</Frame>
...
<Frame>
  ![The image explains how LoRA (Low-Rank Adaptation) works in three steps: freezing the original model, adding small trainable components, and training these components for faster computing.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876952/notes-assets/images/GitHub-Copilot-Certification-LoRA-Fine-Tuning/lora-low-rank-adaptation-explained.jpg)
</Frame>
...
<Frame>
  ![The image outlines three benefits of LoRA: less power usage, faster training, and improved performance on laptops.](../../../../images/kodekloud.com/kk-media/image/upload/v1752876953/notes-assets/images/GitHub-Copilot-Certification-LoRA-Fine-Tuning/lora-benefits-power-training-performance.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/github-copilot-certification/module/a78afa07-cb17-4076-996d-b7ecebb64ef3/lesson/57edad81-5871-49b0-a195-9f3cba9049ba" />
</CardGroup>
