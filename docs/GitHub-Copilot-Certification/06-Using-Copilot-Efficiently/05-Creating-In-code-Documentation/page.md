...
> **triangle-alert** Requests exceeding 1000 entries will return a **400 Bad Request**. Always validate `count` before calling the endpoint.
...
> **lightbulb** Keep inline comments concise—explain **why**, not **what**. The code itself should reveal the “what.”
...
> **triangle-alert** Review Copilot’s suggestions carefully—AI-generated docs may need tweaks to match your project conventions.
