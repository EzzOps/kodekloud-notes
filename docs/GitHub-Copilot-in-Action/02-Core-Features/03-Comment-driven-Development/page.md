...
> **lightbulb** Use comment-driven generation to create initial scaffolding quickly, but manually verify validation, edge cases, and algorithmic details afterwards.
