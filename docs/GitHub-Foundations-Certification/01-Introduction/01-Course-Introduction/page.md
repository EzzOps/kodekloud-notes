...
Source: https://notes.kodekloud.com/docs/GitHub-Foundations-Certification/Introduction/Course-Introduction/page
...
> **lightbulb** This course emphasizes active learning: each module pairs foundational concepts with hands-on labs so you can practice workflows, make mistakes safely, and learn by doing.
...
<Frame>
  <img alt="The image illustrates a Git workflow showing the interactions between a developer's local environment and a remote repository, including processes like cloning, fetching, pulling, pushing, and staging changes. Developers A and B are shown with their respective processes on laptops." />
</Frame>
