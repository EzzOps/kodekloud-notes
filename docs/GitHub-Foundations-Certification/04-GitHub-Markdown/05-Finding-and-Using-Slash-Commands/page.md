...
> **lightbulb** The `/task-list` shortcut is restricted to the issue description. Use standard Markdown task lists (`- [ ]` / `- [x]`) in other comment fields if needed.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/github-foundation-certification/module/42c15655-2217-4c66-8d0a-2472a3b15e43/lesson/c6708908-7f38-49b3-ad22-b98163d03113)
