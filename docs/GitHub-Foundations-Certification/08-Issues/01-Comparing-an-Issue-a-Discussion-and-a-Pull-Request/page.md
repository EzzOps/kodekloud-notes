...
> **lightbulb** Use Issues to define and track work, Discussions to collect context and community input, and Pull Requests to submit, review, and merge code. Linking these together (discussion → issue → pull request) creates a clear trace of decision-making and implementation.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/github-foundation-certification/module/3105bbb3-1ddf-433d-9b4f-15a905853817/lesson/40da7b8d-b07f-4b80-8343-bf728ee4efdb)
