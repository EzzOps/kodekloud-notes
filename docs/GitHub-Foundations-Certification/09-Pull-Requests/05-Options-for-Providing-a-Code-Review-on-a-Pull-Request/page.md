...
> **lightbulb** Best practice: use `#number` for references within the same repository and `owner/repo#number` for cross-repo links. For commits, prefer the 7-character SHA shown in the UI for readability; use the full SHA when you need an exact, unambiguous identifier.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/github-foundation-certification/module/d1fa4e43-2a65-4de9-8da8-dc9ea7cede8e/lesson/17aecaf3-3e8f-4bec-8097-d8c0eb4f9c93)

  - [Practice Lab](https://learn.kodekloud.com/user/courses/github-foundation-certification/module/d1fa4e43-2a65-4de9-8da8-dc9ea7cede8e/lesson/458ae912-79af-4d74-b3c3-1c303bb0de3e)
...
> **lightbulb** Best practices for constructive reviews:
...
> **warning** Requesting changes prevents the pull request from being merged until the issues are resolved and the reviewer either re-approves or the branch protection rules are satisfied.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/github-foundation-certification/module/d1fa4e43-2a65-4de9-8da8-dc9ea7cede8e/lesson/4d5bbfcd-6732-4377-8e88-5a05a7e1a52e)
