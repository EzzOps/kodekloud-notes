...
> **lightbulb** GitHub Actions can be triggered by a wide variety of repository events. Use `workflow_dispatch` for manual runs, `schedule` for periodic checks, and `repository_dispatch` to integrate external CI or automation systems.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/github-foundation-certification/module/e995be1d-2fac-4dc2-b467-fb8d1072632b/lesson/33a57224-21f0-46b6-942b-7f2af771c0a4)
