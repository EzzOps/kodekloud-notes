...
> **lightbulb** Define development environments with `devcontainer.json` and [Dockerfiles](https://docs.docker.com/engine/reference/builder/) so Codespaces can reproduce the same toolset and settings for every developer.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/github-foundation-certification/module/c4995815-313c-40eb-a9c1-aedee41abd7d/lesson/32e88d7b-0029-4cec-a98f-4be14fd8be5b)
