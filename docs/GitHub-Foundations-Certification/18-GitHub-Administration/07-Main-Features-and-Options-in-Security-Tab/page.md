...
> **lightbulb** Including a `SECURITY.md` file directs responsible disclosure and helps ensure sensitive issues are reported privately instead of in public issues.
...
> **warning** Push protection can block a developer's push if a credential is detected. Ensure your team knows how to respond (remove the secret, rotate credentials, and follow repository policies for force-pushes when required).
...
- [Watch Video](https://learn.kodekloud.com/user/courses/github-foundation-certification/module/e1fb240f-a163-45b7-ae70-61c1e162023f/lesson/68eed9df-bc5e-4a93-9cdf-44b5a729e211)
