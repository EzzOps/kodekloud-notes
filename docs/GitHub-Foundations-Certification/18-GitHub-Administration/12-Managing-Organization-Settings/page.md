...
> **lightbulb** Best practice: Start by documenting desired defaults (e.g., who may create repos, required branch protections, and approved GitHub Actions). Apply controls progressively—test changes on a pilot team before rolling them out org-wide.
...
> **warning** Warning: Enforcing SSO or strict authentication controls can block access for users who are not correctly configured. Communicate changes in advance and have an emergency administrative plan to restore access if necessary.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/github-foundation-certification/module/e1fb240f-a163-45b7-ae70-61c1e162023f/lesson/7dfb8356-85d1-4a4c-b671-c15fe462a3ed)
