...
> **lightbulb** Use the `.github` directory to keep repository metadata centralized. If you store templates in `docs` or the repository root, make sure contributors know where to find them.
...
> **warning** Do not include sensitive data or credentials in PR templates. Templates are visible to all repository contributors and may be copied into PR histories.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/github-foundation-certification/module/1231fb21-5b25-4a68-8d38-373808b0ba92/lesson/1df80f62-8cdf-4b35-99a5-5e652b357c0c)
