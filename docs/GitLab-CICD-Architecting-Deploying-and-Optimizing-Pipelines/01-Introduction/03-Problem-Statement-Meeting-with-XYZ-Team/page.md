...
- [Watch Video](https://learn.kodekloud.com/user/courses/gitlab-ci-cd-architecting-deploying-and-optimizing-pipelines/module/75db752f-09a3-4df6-a1ac-3a1fa506eb65/lesson/4ab5154c-f48c-40bf-89b1-1c4e1b65a32b)
...
![The image lists traditional CI/CD tools and challenges, featuring icons for Java, Maven, Python, Azure, AWS CLI, Trivy, and Kubesec.](https://kodekloud.com/kk-media/image/upload/v1752877313/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Problem-Statement-Meeting-with-XYZ-Team/ci-cd-tools-challenges-icons.jpg)

> **lightbulb** Managing your own CI/CD infrastructure means spending more time on setup and maintenance rather than on writing pipelines.
...
![The image outlines challenges of traditional CI/CD tools, highlighting the need for simple setup without extensive installations and focusing on pipeline development without infrastructure concerns. It includes a central icon labeled "Alice."](https://kodekloud.com/kk-media/image/upload/v1752877314/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Problem-Statement-Meeting-with-XYZ-Team/ci-cd-challenges-simple-setup.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/gitlab-ci-cd-architecting-deploying-and-optimizing-pipelines/module/75db752f-09a3-4df6-a1ac-3a1fa506eb65/lesson/85bc6a69-1c17-46e3-9e5e-2206f9ada981)
