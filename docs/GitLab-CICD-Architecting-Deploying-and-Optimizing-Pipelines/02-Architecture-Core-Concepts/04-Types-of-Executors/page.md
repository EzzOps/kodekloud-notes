...
![The image is a slide titled "Runner Executors" with a logo labeled "Executor" and a description explaining that executors define the job's environment to ensure consistent, isolated runs.](https://kodekloud.com/kk-media/image/upload/v1752877031/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Types-of-Executors/runner-executors-job-environment-slide.jpg)

> **lightbulb** Selecting the appropriate executor is essential for performance, security, and maintainability. Consider factors like isolation level, resource overhead, and integration with your existing infrastructure.
...
![The image is a slide showing different runner executors with "Kubernetes" highlighted, alongside its cons such as complex setup, potential infrastructure dependency, and increased learning curve.](https://kodekloud.com/kk-media/image/upload/v1752877034/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Types-of-Executors/kubernetes-runner-executors-cons-slide.jpg)
...
![The image lists different runner executors, highlighting "Virtual Machine" with its cons: high resource usage, slower startup times, and complex management.](https://kodekloud.com/kk-media/image/upload/v1752877035/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Types-of-Executors/runner-executors-virtual-machine-cons.jpg)
...
> **triangle-alert** Be sure to rotate and securely store your SSH keys. Unsecured credentials can lead to unauthorized access.

![The image lists different runner executors, highlighting SSH with its cons: security concerns, network dependency, and limited control and visibility.](https://kodekloud.com/kk-media/image/upload/v1752877035/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Types-of-Executors/runner-executors-ssh-cons-list.jpg)
...
![The image lists different runner executors such as Shell, Docker, Kubernetes, and others, alongside logos for Parallels and Docker. It also mentions cons like overhead, complexity, and increased resource usage.](https://kodekloud.com/kk-media/image/upload/v1752877037/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Types-of-Executors/runner-executors-shell-docker-kubernetes.jpg)
...
![The image is a comparison table for selecting executors, showing features and capabilities across different executors like SSH, Shell, VirtualBox, Parallels, Docker, Kubernetes, and Custom. It includes criteria such as clean build environments, reuse of previous clones, and debugging difficulty.](https://kodekloud.com/kk-media/image/upload/v1752877038/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Types-of-Executors/executor-comparison-table-features.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/gitlab-ci-cd-architecting-deploying-and-optimizing-pipelines/module/fbf7cb8d-dcca-444e-a547-7bdb8b725634/lesson/1c376b5b-7128-4b5c-ac47-3df21107fc05)
