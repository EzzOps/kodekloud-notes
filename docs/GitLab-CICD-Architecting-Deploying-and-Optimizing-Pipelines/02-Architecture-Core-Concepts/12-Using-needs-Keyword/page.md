...
> **triangle-alert** When jobs share the same stage, GitLab CI/CD executes them in parallel. This may cause `docker_push` to run before `docker_build`, or allow failures in `docker_testing` without halting `docker_push`.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/gitlab-ci-cd-architecting-deploying-and-optimizing-pipelines/module/fbf7cb8d-dcca-444e-a547-7bdb8b725634/lesson/da301f46-6c42-4c5d-aa4f-26aa8f9472ac)

  - [Practice Lab](https://learn.kodekloud.com/user/courses/gitlab-ci-cd-architecting-deploying-and-optimizing-pipelines/module/fbf7cb8d-dcca-444e-a547-7bdb8b725634/lesson/1b39cf47-9ccb-448c-9d50-bb27fe48be4b)
