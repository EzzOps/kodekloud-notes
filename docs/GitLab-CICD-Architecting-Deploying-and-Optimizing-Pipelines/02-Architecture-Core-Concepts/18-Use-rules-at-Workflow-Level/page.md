...
> **triangle-alert** The first matching rule wins. If no rule matches, the pipeline won’t be created—no jobs will run.
...
> **lightbulb** Customize your `rules` with `when: manual`, `allow_failure`, or file filters to match your team’s workflow.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/gitlab-ci-cd-architecting-deploying-and-optimizing-pipelines/module/fbf7cb8d-dcca-444e-a547-7bdb8b725634/lesson/b8f75a88-d4e2-45c3-9c77-7105ad3986e2)
