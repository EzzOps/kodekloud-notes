...
> **lightbulb** Both directives are recognized by GitLab. Choose the one you prefer—case-insensitive.
...
![The image shows a GitLab documentation page about skipping and deleting pipelines, with navigation options on the left and related topics on the right.](https://kodekloud.com/kk-media/image/upload/v1752877029/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Skipping-Pipeline-Trigger/gitlab-skipping-deleting-pipelines-doc.jpg)

Once pushed, GitLab marks the pipeline as **Skipped** immediately—no jobs are queued or executed.

![The image shows a GitLab CI/CD pipeline dashboard with a list of pipeline statuses, including "Skipped," "Passed," and "Failed." It displays details such as pipeline IDs, branches, and timestamps.](https://kodekloud.com/kk-media/image/upload/v1752877030/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Skipping-Pipeline-Trigger/gitlab-ci-cd-pipeline-dashboard.jpg)
...
> **triangle-alert** Do **not** use skip directives for commits that modify build scripts, tests, or production code. Skipping critical changes can lead to undetected failures.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/gitlab-ci-cd-architecting-deploying-and-optimizing-pipelines/module/fbf7cb8d-dcca-444e-a547-7bdb8b725634/lesson/fc1a216b-77e6-4956-916c-ff4e91ff8827)

  - [Practice Lab](https://learn.kodekloud.com/user/courses/gitlab-ci-cd-architecting-deploying-and-optimizing-pipelines/module/fbf7cb8d-dcca-444e-a547-7bdb8b725634/lesson/d50943d7-3e62-4858-8668-c85132790710)
