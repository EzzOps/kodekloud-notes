...
<Frame>
  ![The image shows a GitLab interface with a pop-up window for connecting a Kubernetes cluster, where a user is entering a name for a new agent.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877178/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Configure-Gitlab-Agent/gitlab-kubernetes-agent-setup.jpg)
</Frame>
