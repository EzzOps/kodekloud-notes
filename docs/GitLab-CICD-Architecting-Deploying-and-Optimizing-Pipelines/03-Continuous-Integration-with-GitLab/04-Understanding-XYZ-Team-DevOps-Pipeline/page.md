...
> **triangle-alert** Tests will fail without `MONGO_URI`, `MONGO_USERNAME`, and `MONGO_PASSWORD`. Set these before running `npm test`.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/gitlab-ci-cd-architecting-deploying-and-optimizing-pipelines/module/3a1c2306-8091-4dfe-b40f-e2ca53918553/lesson/f6de778b-f061-4043-92ad-dc97d2eee6c7)
