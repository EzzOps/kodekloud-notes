...
<Frame>
  ![The image shows a GitLab documentation page about the container registry, detailing how to use and view the integrated container registry for GitLab projects. The sidebar includes navigation options related to package and container management.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877283/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Publish-Image-to-Gitlab-Container-Registry/gitlab-container-registry-documentation.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitLab documentation page about predefined CI/CD variables, specifically focusing on registry-related variables like CI\_REGISTRY, CI\_REGISTRY\_IMAGE, and CI\_REGISTRY\_PASSWORD. The sidebar lists various documentation sections.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877285/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Publish-Image-to-Gitlab-Container-Registry/gitlab-ci-cd-variables-documentation.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitLab interface for a project named "Solar System" with the Container Registry section open, indicating no container images are stored for the project. The sidebar includes options like Manage, Plan, Code, and Deploy.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877286/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Publish-Image-to-Gitlab-Container-Registry/gitlab-solar-system-container-registry.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitLab CI/CD pipeline interface for a project named "Solar System NodeJS Pipeline," displaying various stages and jobs such as code coverage, unit testing, docker build, and docker push.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877287/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Publish-Image-to-Gitlab-Container-Registry/gitlab-ci-cd-solar-system-pipeline.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitLab container registry interface for a project named "Solar System," displaying details of an image called "ss-image," including its size, tag, and digests.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877288/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Publish-Image-to-Gitlab-Container-Registry/gitlab-container-registry-solar-system.jpg)
</Frame>
