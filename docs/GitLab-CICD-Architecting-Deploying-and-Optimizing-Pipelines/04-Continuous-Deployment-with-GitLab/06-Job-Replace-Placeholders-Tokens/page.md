...
> **triangle-alert** Never commit secrets (e.g., database credentials) directly in your YAML files. Always use masked or protected CI/CD variables.
...
> **lightbulb** You can learn more about the Ingress resource in the [Kubernetes Ingress documentation](https://kubernetes.io/docs/concepts/services-networking/ingress/).
