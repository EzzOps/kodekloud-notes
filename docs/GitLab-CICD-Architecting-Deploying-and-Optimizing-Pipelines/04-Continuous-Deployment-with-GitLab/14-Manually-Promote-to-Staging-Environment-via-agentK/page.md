...
> **lightbulb** * A configured GitLab Kubernetes Agent with `ci_access` enabled in `config.yaml`
...
> **lightbulb** Ensure you have added `stage-deploy` to the top-level `stages` list and set `NAMESPACE: staging`.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/gitlab-ci-cd-architecting-deploying-and-optimizing-pipelines/module/df17ec22-8cda-4af7-af44-10f9f061d4a8/lesson/1e328feb-4d88-44fa-b11a-b95bb858ce59)

  - [Practice Lab](https://learn.kodekloud.com/user/courses/gitlab-ci-cd-architecting-deploying-and-optimizing-pipelines/module/df17ec22-8cda-4af7-af44-10f9f061d4a8/lesson/4be4590b-8f41-4681-902a-533a96a92ba4)
