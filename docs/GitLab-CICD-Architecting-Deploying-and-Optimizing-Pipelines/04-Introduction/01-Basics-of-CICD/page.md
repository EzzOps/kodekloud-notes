...
<Frame>
  ![The image is a diagram explaining the CI/CD process, showing the flow from feature branch creation to deployment and production, including steps like commit, pull request, review, and approval.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877294/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Basics-of-CICD/ci-cd-process-diagram-flow.jpg)
</Frame>
...
<Frame>
  ![The image illustrates a workflow for continuous integration, highlighting the process from feature branches to production, and emphasizes the challenges of delayed testing, inefficient deployment, and quality assurance without CI.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877295/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Basics-of-CICD/ci-workflow-feature-branches-production.jpg)
</Frame>
...
<Frame>
  ![The image illustrates a continuous integration workflow, showing steps from feature branching and committing to production, including unit testing, dependency scanning, building artifacts, and code scanning.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877296/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Basics-of-CICD/continuous-integration-workflow-diagram.jpg)
</Frame>
