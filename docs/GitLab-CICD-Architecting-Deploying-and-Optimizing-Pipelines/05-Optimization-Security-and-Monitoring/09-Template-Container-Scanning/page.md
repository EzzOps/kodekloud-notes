...
> **lightbulb** By default, the `container_scanning` job runs in the `test` stage. Override `CS_DEFAULT_BRANCH_IMAGE` to scan a different image tag.
...
> **triangle-alert** Allowlisting will mark these CVEs as approved and they will not fail your pipeline. Use with caution!
