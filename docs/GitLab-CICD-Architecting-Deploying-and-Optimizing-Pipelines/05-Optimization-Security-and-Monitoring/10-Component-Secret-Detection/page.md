...
<Frame>
  ![The image shows a GitLab documentation page about "Full history Secret Detection," explaining how to enable it and customize rulesets. The sidebar lists related topics.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877363/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Component-Secret-Detection/gitlab-full-history-secret-detection.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitLab documentation page about customizing secret detection rules, with highlighted text and a sidebar menu.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877364/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Component-Secret-Detection/gitlab-customizing-secret-detection.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitLab Pipeline Editor interface with YAML code for configuring CI/CD pipelines. The code includes sections for preparing environments and unit testing, with a dropdown menu suggesting code options.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877365/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Component-Secret-Detection/gitlab-pipeline-editor-yaml-code.jpg)
</Frame>
...
<Frame>
  ![The image shows a GitLab interface displaying a list of artifacts from different jobs, including unit testing and secret detection, with details like file size and creation time.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877366/notes-assets/images/GitLab-CICD-Architecting-Deploying-and-Optimizing-Pipelines-Component-Secret-Detection/gitlab-artifacts-list-jobs.jpg)
</Frame>
