...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/gitops-with-argocd/module/ef6b6fef-0bd5-4fab-b437-b6d613fa74b4/lesson/7c262d2f-3939-45be-9dd5-c616e91bafea" />
</CardGroup>


# Monitoring through Prometheus Grafana

Source: https://notes.kodekloud.com/docs/GitOps-with-ArgoCD/ArgoCD-AdvancedAdmin/Monitoring-through-Prometheus-Grafana/page

Learn to visualize ArgoCD metrics using Prometheus and Grafana, including setup, configuration, and monitoring of various ArgoCD components.
...
<Frame>
  ![The image shows a Prometheus monitoring dashboard with a list of service targets, some of which are marked as unhealthy in red. The interface includes options to filter and expand the list of targets.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877495/notes-assets/images/GitOps-with-ArgoCD-Monitoring-through-Prometheus-Grafana/prometheus-monitoring-dashboard-targets.jpg)
</Frame>

Filtering the target list for ArgoCD-related endpoints should display the newly added targets:

<Frame>
  ![The image shows a Prometheus web interface displaying a list of monitoring targets, with some services marked as "up" in blue and others in red, indicating issues.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877497/notes-assets/images/GitOps-with-ArgoCD-Monitoring-through-Prometheus-Grafana/prometheus-monitoring-targets-interface.jpg)
</Frame>
...
<Frame>
  ![The image shows a Prometheus dashboard displaying query results for argocd\_app\_info, listing various application metrics and statuses in a tabular format.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877498/notes-assets/images/GitOps-with-ArgoCD-Monitoring-through-Prometheus-Grafana/prometheus-dashboard-argocd-metrics.jpg)
</Frame>
...
<Frame>
  ![The image shows a webpage from Argo CD documentation, detailing application controller metrics for Kubernetes, including metric names, types, and descriptions.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877499/notes-assets/images/GitOps-with-ArgoCD-Monitoring-through-Prometheus-Grafana/argo-cd-application-controller-metrics-2.jpg)
</Frame>
...
<Frame>
  ![The image shows a webpage from Grafana Labs featuring the ArgoCD dashboard, with options to sign up for Grafana Cloud, download the dashboard JSON, and view dependencies.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877500/notes-assets/images/GitOps-with-ArgoCD-Monitoring-through-Prometheus-Grafana/grafana-argocd-dashboard-webpage.jpg)
</Frame>

<Frame>
  ![The image shows a Grafana dashboard displaying metrics for ArgoCD, including uptime, clusters, applications, and sync status. Various graphs and statistics are presented, such as health status and sync activity.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877500/notes-assets/images/GitOps-with-ArgoCD-Monitoring-through-Prometheus-Grafana/grafana-argocd-dashboard-metrics.jpg)
</Frame>

<Frame>
  ![The image shows a Grafana dashboard with multiple time-series graphs displaying metrics such as requests and Redis stats. The graphs are mostly flat, indicating minimal activity, with one graph showing a spike in "AccountService Requests."](../../../../images/kodekloud.com/kk-media/image/upload/v1752877502/notes-assets/images/GitOps-with-ArgoCD-Monitoring-through-Prometheus-Grafana/grafana-dashboard-time-series-graphs.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/gitops-with-argocd/module/ef6b6fef-0bd5-4fab-b437-b6d613fa74b4/lesson/a65a1c4b-f30f-4806-b83c-72e7837ffe88" />
</CardGroup>
