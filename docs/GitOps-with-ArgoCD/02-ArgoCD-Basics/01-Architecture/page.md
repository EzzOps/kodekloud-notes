...
<Frame>
  ![The image illustrates the ArgoCD architecture, showing the workflow from GitHub to various Kubernetes clusters (prod, dev, staging) with interactions through UI, CLI, and gRPC/REST, and notifications sent to platforms like Teams, Gmail, and Slack.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877505/notes-assets/images/GitOps-with-ArgoCD-Architecture/argocd-architecture-github-kubernetes-workflow.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/gitops-with-argocd/module/546d7ffa-8e6e-4197-9dff-443bb15dcdf6/lesson/163ec829-9de7-4ef4-b555-62a3660e419c" />
</CardGroup>
