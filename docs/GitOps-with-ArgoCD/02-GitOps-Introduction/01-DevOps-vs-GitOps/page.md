...
Source: https://notes.kodekloud.com/docs/GitOps-with-ArgoCD/GitOps-Introduction/DevOps-vs-GitOps/page
...
> **lightbulb** In DevOps, the deployment is initiated by pushing changes directly into the cluster.
...
> **lightbulb** In a GitOps pipeline, the deployment operator pulls changes from the repository and applies them to the cluster, contrasting with the push-based approach in traditional DevOps workflows.
