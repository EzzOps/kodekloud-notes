...
Source: https://notes.kodekloud.com/docs/GitOps-with-ArgoCD/ArgoCD-Basics/Architecture/page
...
> **lightbulb** ArgoCD continuously monitors deployed applications by comparing the current running state with the desired state stored in your Git repository. When changes are committed to the repository, ArgoCD automatically pulls and applies these updates, ensuring your environments remain consistent.
...
> **lightbulb** Make sure to configure Prometheus and Grafana to take full advantage of ArgoCD's monitoring capabilities, allowing you to gain critical insights into application performance and synchronization events.
