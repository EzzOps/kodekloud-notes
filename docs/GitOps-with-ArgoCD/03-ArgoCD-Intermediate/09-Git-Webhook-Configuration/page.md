...
Source: https://notes.kodekloud.com/docs/GitOps-with-ArgoCD/ArgoCD-Intermediate/Git-Webhook-Configuration/page

This article explains how to configure a Git webhook for ArgoCD to trigger notifications on push events.
...
<Frame>
  ![The image shows a user interface of Argo CD, displaying options for creating or managing applications, with settings for sync options and source repository URLs.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877559/notes-assets/images/GitOps-with-ArgoCD-Git-Webhook-Configuration/argo-cd-user-interface-settings.jpg)
</Frame>
...
<Frame>
  ![The image shows a dashboard interface for managing applications, displaying the status of a "git-webhook-app" with components like "nginx" and a pod, all marked as healthy and synced.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877560/notes-assets/images/GitOps-with-ArgoCD-Git-Webhook-Configuration/git-webhook-app-dashboard-interface.jpg)
</Frame>
...
<Frame>
  ![The image shows a dashboard interface of a web application, displaying the health and sync status of a "git-webhook-app" with a visual representation of its deployment components. The application is marked as "Healthy" and "Synced," with details about the deployment and pods.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877562/notes-assets/images/GitOps-with-ArgoCD-Git-Webhook-Configuration/git-webhook-app-dashboard-status.jpg)
</Frame>
...
<Frame>
  ![The image shows a web interface for adding a webhook in a Gitea repository, with fields for target URL, HTTP method, content type, and event triggers.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877563/notes-assets/images/GitOps-with-ArgoCD-Git-Webhook-Configuration/gitea-webhook-interface-setup.jpg)
</Frame>
...
<Frame>
  ![The image shows a dashboard interface of Argo CD with three application tiles, each displaying details like project name, status, repository, and options to sync, refresh, or delete. The sidebar includes filters for sync status, health status, labels, projects, and clusters.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877565/notes-assets/images/GitOps-with-ArgoCD-Git-Webhook-Configuration/argo-cd-dashboard-interface-tiles.jpg)
</Frame>

Finally, update the webhook configuration to use HTTP and test the delivery again.

<Frame>
  ![The image shows a webhook configuration interface with options for setting the target URL, HTTP method, and trigger events. It also displays recent delivery details, including a successful POST request.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877566/notes-assets/images/GitOps-with-ArgoCD-Git-Webhook-Configuration/webhook-configuration-interface.jpg)
</Frame>
...
<Frame>
  ![The image shows a dashboard interface for managing applications, displaying the sync status and health of a "git-webhook-app" with a visual representation of its components and their statuses. The current sync status is "OutOfSync," while the last sync result is "Sync OK."](../../../../images/kodekloud.com/kk-media/image/upload/v1752877567/notes-assets/images/GitOps-with-ArgoCD-Git-Webhook-Configuration/git-webhook-app-dashboard-status-2.jpg)
</Frame>
...
<Frame>
  ![The image shows a dashboard interface for managing applications, displaying the sync status and health of a "git-webhook-app" with a visual representation of its deployment and pods.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877569/notes-assets/images/GitOps-with-ArgoCD-Git-Webhook-Configuration/git-webhook-app-dashboard-interface-2.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/gitops-with-argocd/module/7d158b65-58ef-432d-9d26-61e245751bfe/lesson/c2edb032-e0c1-4018-b07c-bef7203f0601" />

  <Card title="Practice Lab" icon="installation" href="https://learn.kodekloud.com/user/courses/gitops-with-argocd/module/7d158b65-58ef-432d-9d26-61e245751bfe/lesson/e0dc6b36-a3c5-4d68-b8d4-65ec6acd3282" />
</CardGroup>
