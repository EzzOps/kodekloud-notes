...
<Frame>
  ![The image illustrates a reconciliation loop using webhooks, showing a process flow from code commit to deployment in a Kubernetes environment, with configuration settings for managing webhooks.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877574/notes-assets/images/GitOps-with-ArgoCD-Reconciliation-loop/reconciliation-loop-webhooks-kubernetes.jpg)
</Frame>
...
<Frame>
  ![The image illustrates different sync strategies in Argo CD, showing how changes in Git repositories affect Kubernetes clusters, with features like manual/automatic sync, auto-pruning, and self-healing.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877575/notes-assets/images/GitOps-with-ArgoCD-Types-of-Sync-Strategies/argo-cd-sync-strategies-diagram.jpg)
</Frame>
