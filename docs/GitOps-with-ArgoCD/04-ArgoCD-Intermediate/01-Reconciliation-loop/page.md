...
> **lightbulb** For immediate synchronization after each commit, configure a webhook on your Git provider that targets `[ARGOCD_SERVER_URL]/api/webhook`. This setup bypasses the default polling mechanism.
