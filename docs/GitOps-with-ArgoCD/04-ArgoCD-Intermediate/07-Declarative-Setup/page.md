...
Source: https://notes.kodekloud.com/docs/GitOps-with-ArgoCD/ArgoCD-Intermediate/Declarative-Setup/page

This guide demonstrates setting up Kubernetes resources declaratively using a Mono application example with ArgoCD and Git for infrastructure management.
...
> **lightbulb** Defining your infrastructure as code in Git offers clear traceability, version control, and simplifies management of changes across different environments.
...
> **lightbulb** By managing both your application definition and its corresponding resources in source control, you can easily track changes and maintain a consistent state across your environments.
