...
Source: https://notes.kodekloud.com/docs/GitOps-with-ArgoCD/ArgoCD-Intermediate/Multi-cluster-application-deployment/page
...
> **triangle-alert** This command creates a service account on the external cluster with full cluster-level administrator access. Ensure you understand the security implications before proceeding.
