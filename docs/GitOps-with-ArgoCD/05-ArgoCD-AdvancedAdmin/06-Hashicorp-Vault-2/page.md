...
Source: https://notes.kodekloud.com/docs/GitOps-with-ArgoCD/ArgoCD-AdvancedAdmin/Hashicorp-Vault-2/page
...
> **lightbulb** Ensure that the URL provided for the plugin binary is correct and that the binary version is compatible with your ArgoCD installation.
...
> **lightbulb** Always ensure that Vault credentials and configurations are secured appropriately. It is recommended to use Kubernetes Secrets to store sensitive Vault information.
