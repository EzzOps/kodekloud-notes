...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/gitops-with-fluxcd/module/44949c1c-edf6-4432-81ce-78d709c30af5/lesson/15517464-f585-461c-9fee-7edfdff5d428" />
</CardGroup>


# FluxCD Features

Source: https://notes.kodekloud.com/docs/GitOps-with-FluxCD/Flux-Overview/FluxCD-Features/page

This article explores the key features of FluxCD, a GitOps operator for automating Kubernetes deployments and managing cluster states.
...
| --------- | ----------------------------------------- | ---------------------------------------------- |
| Kustomize | Overlay-based patches and customization   | [https://kustomize.io/](https://kustomize.io/) |
| Helm      | Package reusable charts                   | [https://helm.sh/](https://helm.sh/)           |
| Jsonnet   | Data templating and configuration as code | [https://jsonnet.org/](https://jsonnet.org/)   |
| YAML      | Simple, declarative manifests             | [https://yaml.org/](https://yaml.org/)         |
...
<Frame>
  ![The image lists features of FluxCD, including automated deployment, support for multiple config tools, integration with Git providers, and automated configuration drift detection.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877615/notes-assets/images/GitOps-with-FluxCD-FluxCD-Features/fluxcd-features-automated-deployment-integration.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/gitops-with-fluxcd/module/44949c1c-edf6-4432-81ce-78d709c30af5/lesson/d0519312-b724-451c-9241-31c5bb4e10db" />
</CardGroup>
