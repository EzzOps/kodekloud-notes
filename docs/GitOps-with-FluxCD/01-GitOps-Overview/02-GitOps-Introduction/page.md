...
> **lightbulb** GitOps is compatible with any declarative tooling—whether you use plain YAML manifests, [Helm charts](https://helm.sh/), or [Kustomize](https://kustomize.io/).
...
> **triangle-alert** Secure your Git repository with branch protection, signed commits, and role-based access control. Exposed or misconfigured repos can compromise your cluster.
