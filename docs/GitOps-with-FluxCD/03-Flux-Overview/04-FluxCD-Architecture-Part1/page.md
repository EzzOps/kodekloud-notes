...
> **triangle-alert** Store your GitHub token safely. Never commit it to a public repo or share it in plaintext.
...
> **lightbulb** FluxCD follows the GitOps pattern:
...
> **triangle-alert** Ensure your cluster’s RBAC policies allow Flux to read Secrets and apply CRDs. Misconfigured permissions can prevent controllers from reconciling.
