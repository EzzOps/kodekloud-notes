...
Source: https://notes.kodekloud.com/docs/GitOps-with-FluxCD/Flux-Overview/FluxCD-Architecture-Part2/page
...
> **lightbulb** Ensure you provide credentials for private Git, OCI or S3 repositories via Kubernetes Secrets.
...
> **triangle-alert** The Image Automation Controller requires write access to your Git repository. Ensure branch protections and commit permissions are configured securely.
