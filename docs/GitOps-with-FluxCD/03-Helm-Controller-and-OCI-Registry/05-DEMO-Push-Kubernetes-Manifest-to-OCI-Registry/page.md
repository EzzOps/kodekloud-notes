...
<Frame>
  ![The image shows a GitHub settings page for editing a personal access token, with various scopes selected for repository and package management permissions.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877631/notes-assets/images/GitOps-with-FluxCD-DEMO-Push-Kubernetes-Manifest-to-OCI-Registry/github-settings-personal-access-token-scopes.jpg)
</Frame>

Once the correct scopes are selected, click **Update Token** and save the token value securely.

<Frame>
  ![The image shows a GitHub settings page for managing personal access tokens, specifically the "Tokens (classic)" section, with options to generate or revoke tokens.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877632/notes-assets/images/GitOps-with-FluxCD-DEMO-Push-Kubernetes-Manifest-to-OCI-Registry/github-settings-personal-access-tokens.jpg)
</Frame>
