...
> **lightbulb** Because the `kustomization.yaml` is present, the Kustomize controller will skip the normal build phase and apply resources directly.
...
> **lightbulb** Flux will poll the Git repository every 10 seconds and store an artifact for the specified branch.
