...
> **lightbulb** Flux requires a Kubernetes [imagePullSecret](/docs/guides/oci-acr/) to authenticate when pulling OCI artifacts. We’ll cover secret creation in a later module.
