...
Source: https://notes.kodekloud.com/docs/GitOps-with-FluxCD/Source-and-Kustomize-Controller/Source-Controller-S3-Bucket/page

Learn to use Flux CD’s Source Controller to fetch Kubernetes manifests from an S3-compatible bucket like MinIO.
...
> **lightbulb** Ensure your credentials are scoped to the least-privileged user on your S3 endpoint.
...
> **triangle-alert** Using `--insecure` disables TLS verification. Only use this flag in trusted environments or testing scenarios.
...
* [Flux Bucket Source][Bucket Source]
* [Flux Kustomization][Kustomization]
* [Kubernetes Secrets][Kubernetes Secrets]
* [MinIO Documentation][MinIO]
