...
> **lightbulb** Adjust `--interval` and `--timeout` to suit your release cadence and network conditions.
...
> **lightbulb** Starting with version 7.6.0, Block Buster introduces multiple levels. Complete Level One to unlock Level Two!
...
> **triangle-alert** If you see warnings about your kubeconfig file being group- or world-readable, consider tightening permissions:
...
> **lightbulb** Your token should have the `read:packages` and `write:packages` scopes to push and pull images.
