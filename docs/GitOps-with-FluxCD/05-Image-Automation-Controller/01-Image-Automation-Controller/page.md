...
> **lightbulb** These examples use Flux CLI v0.34+. Adjust flags if you’re on an earlier release.
...
> **triangle-alert** Ensure your registry credentials are correctly configured so Flux can access private repositories.
