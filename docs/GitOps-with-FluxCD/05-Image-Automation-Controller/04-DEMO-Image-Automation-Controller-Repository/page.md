...
> **lightbulb** Make sure your Git repository includes the `flux-system` namespace and the Flux controllers are installed before applying this manifest.
...
> **triangle-alert** Be sure to update **all** source files (e.g., `level2.php`) to keep version consistency.
