...
Source: https://notes.kodekloud.com/docs/GitOps-with-FluxCD/Image-Automation-Controller/DEMO-Image-Automation-Controller-Policy/page

This article explains how to use the ImagePolicy CRD in Flux to automatically select the latest image tag based on semantic versioning.
...
> **lightbulb** Semantic version ranges follow [npm semver syntax](https://github.com/npm/node-semver#ranges); here `7.8.x` matches `7.8.0`, `7.8.1`, etc.
...
> **triangle-alert** An `ImagePolicy` alone does **not** update running workloads. To automate commits of updated tags back into Git, you’ll need the **ImageUpdateAutomation** controller, which we’ll cover next.
