...
> **lightbulb** Only the Secret’s values are encrypted. The keys (`password`) stay in cleartext for mapping.
...
> **lightbulb** Seeing `command not found` means Cosign isn’t installed. Continue to the installation methods below.
