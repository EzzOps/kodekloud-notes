...
> **lightbulb** You will use the PGP fingerprint with the `sops` CLI to encrypt your secret.
...
> **lightbulb** Always ensure your working directory is clean before switching branches.
