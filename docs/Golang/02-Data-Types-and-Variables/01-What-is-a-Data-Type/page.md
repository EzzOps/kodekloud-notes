...
> **lightbulb** Data types group related values together and explicitly define which operations can be performed. For example, you can carry out mathematical operations on numbers but have different operations available for strings, like converting to uppercase or finding the length.
