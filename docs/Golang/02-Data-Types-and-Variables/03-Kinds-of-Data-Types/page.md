...
> **lightbulb** When choosing an integer type in your Go programs, consider the required range of values and memory footprint.
...
> **lightbulb** When working with booleans in Go, always use `true` or `false` explicitly rather than numeric equivalents.
