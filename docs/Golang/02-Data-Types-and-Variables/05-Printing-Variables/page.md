...
> **lightbulb** Remember that the `fmt.Print` function does not append a newline by default. When printing multiple items consecutively, they will appear without any line breaks.
