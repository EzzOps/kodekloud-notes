...
Source: https://notes.kodekloud.com/docs/Golang/Data-Types-and-Variables/Converting-between-types/page
...
<Frame>
  ![The image explains type casting, the process of converting one data type to another, noting that value integrity isn't guaranteed.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877711/notes-assets/images/Golang-Converting-between-types/frame_30.jpg)
</Frame>
...
<Frame>
  ![The image describes the strconv package functions: Itoa() converts integers to strings, and Atoi() converts strings to integers, returning an integer and an error.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877712/notes-assets/images/Golang-Converting-between-types/frame_200.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/golang/module/eeafa284-50db-4de2-a58a-759d3926fced/lesson/e862e62c-80b5-4d9d-9f7d-686aa1ca611c" />

  <Card title="Practice Lab" icon="installation" href="https://learn.kodekloud.com/user/courses/golang/module/eeafa284-50db-4de2-a58a-759d3926fced/lesson/da3019bd-092d-4cc8-854a-cb30980acd84" />
</CardGroup>
