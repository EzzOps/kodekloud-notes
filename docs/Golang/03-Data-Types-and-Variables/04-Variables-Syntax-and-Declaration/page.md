...
> **lightbulb** Variables in Go can also be declared without an initial value. In such cases, Go automatically assigns a zero value based on the type. For example, an uninitialized `int` variable gets a value of `0`.
