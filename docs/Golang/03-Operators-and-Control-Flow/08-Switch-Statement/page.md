...
Source: https://notes.kodekloud.com/docs/Golang/Operators-and-Control-Flow/Switch-Statement/page

This article explores the switch statement in Go, detailing its syntax, usage, and features like fallthrough for handling multiple conditions.
...
> **lightbulb** Switch statements provide a clean and efficient way to handle multiple conditions, especially when comparing a single variable to several possible values.
...
> **triangle-alert** Use the fallthrough keyword carefully as it can lead to unintended execution of additional case blocks. It bypasses typical case matching rules, so ensure it aligns with your program logic.
