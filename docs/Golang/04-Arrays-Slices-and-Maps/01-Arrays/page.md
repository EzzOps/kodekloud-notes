...
> **triangle-alert** Never commit `sops.private.asc` to Git. Only `sops.pub.asc` should be versioned.
...
> **lightbulb** An empty string is the zero value for a string in Go.
