...
Source: https://notes.kodekloud.com/docs/Golang/Operators-and-Control-Flow/Operators/page
...
> **lightbulb** Operators are symbols used to represent specific mathematical and logical computations. In the expression "A + B", the plus sign (+) is the operator, while A and B are the operands.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/golang/module/036484d6-1e16-46e2-908d-77e545bde2bf/lesson/b8121607-79ab-4815-86d3-3dc859a30160)
