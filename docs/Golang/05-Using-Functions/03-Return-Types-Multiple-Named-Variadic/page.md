...
> **lightbulb** When you name the return parameters, you can use an empty `return` statement to return the current values of those parameters. This approach can make your code clearer and easier to maintain.
