...
> **lightbulb** In this example, the memory address (e.g., 0x0301) is illustrative. Actual memory addresses will vary when you run the program.
...
> **lightbulb** Notice the distinction between the asterisk used in the Dereference Operator and the asterisk seen in the type output (\*int). They serve different purposes in the code and the output.
