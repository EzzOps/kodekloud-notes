...
> **lightbulb** In the factorial function, the base case is defined when n equals 0, because 0! is defined as 1.
...
> **lightbulb** Each recursive call reduces the problem size until the simplest case (n = 0) is reached, after which the results are combined to form the final output.
