...
> **lightbulb** The output confirms that uninitialized pointers in Go have the `nil` value.
...
> **lightbulb** Pointers store the memory address of another variable, allowing you to manipulate data directly.
