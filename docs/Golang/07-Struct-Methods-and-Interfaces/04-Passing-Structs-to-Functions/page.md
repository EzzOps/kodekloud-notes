...
Source: https://notes.kodekloud.com/docs/Golang/Struct-Methods-and-Interfaces/Passing-Structs-to-Functions/page
...
> **lightbulb** Passing by value means that modifications made inside the function do not alter the original struct. This is useful when you want to ensure the integrity of the initial data.
...
> **lightbulb** Passing by reference using pointers allows the function to alter the original data. This approach is ideal when you need to update the struct directly.
