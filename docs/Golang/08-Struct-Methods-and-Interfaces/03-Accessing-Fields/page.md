...
Source: https://notes.kodekloud.com/docs/Golang/Struct-Methods-and-Interfaces/Accessing-Fields/page
...
> **lightbulb** Remember that Go structs cannot be partially assigned. Each field must be explicitly set or initialized.
...
> **triangle-alert** Always ensure that you only access fields that are defined in your struct. Attempting to work with undefined fields will lead to compile-time errors.
