...
<Callout icon="warning">
  Avoid returning raw stack traces or long technical dumps to users. Return a short user-facing error\_message and, if needed, a brief technical hint (exception type). Store full traces in logs/tracing for debugging.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/google-adk/module/672589ad-758d-4e70-8408-bd4bd4409388/lesson/0ac61c4a-988d-4d4e-ae5a-e66272191e60" />
</CardGroup>
