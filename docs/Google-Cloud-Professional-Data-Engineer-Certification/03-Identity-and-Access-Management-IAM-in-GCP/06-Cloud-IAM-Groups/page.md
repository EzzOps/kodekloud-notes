...
> **lightbulb** Prefer using groups for membership management rather than maintaining many individual IAM bindings. Bind the group identity (for example a Google Group email) to IAM roles at the correct resource scope.

> **warning** Follow the principle of least privilege: avoid assigning overly broad roles to large groups. When necessary, create smaller, task-specific groups with narrowly scoped roles.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/google-cloud-professional-data-engineer-certification/module/9b9dd8e9-0075-430e-92db-757c9a6b738a/lesson/775a8ca0-5c0e-4123-982d-86429c6f58ae)
