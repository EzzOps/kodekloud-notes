...
<Callout icon="lightbulb">
  TrueTime is a central piece of Spanner's design. If you want a deeper dive, see the [Cloud Spanner documentation](https://cloud.google.com/spanner/docs) for implementation details and design notes.
</Callout>
...
<Callout icon="warning">
  Commit-wait ensures correctness but adds a small, bounded latency equal to TrueTime's uncertainty. For low-latency workloads, design your data and transaction patterns accordingly (e.g., minimize cross-region contention).
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/google-cloud-professional-data-engineer-certification/module/8113b673-3c60-4b57-ae81-fd9533eba836/lesson/0fdb422b-200f-42f4-b25e-cd112e9c1941" />
</CardGroup>
