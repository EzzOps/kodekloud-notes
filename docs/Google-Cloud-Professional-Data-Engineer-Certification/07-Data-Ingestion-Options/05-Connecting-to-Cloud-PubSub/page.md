...
> **lightbulb** Use least-privilege IAM roles. For publishing and subscribing, grant the `roles/pubsub.publisher` or `roles/pubsub.subscriber` role respectively to the service account.
