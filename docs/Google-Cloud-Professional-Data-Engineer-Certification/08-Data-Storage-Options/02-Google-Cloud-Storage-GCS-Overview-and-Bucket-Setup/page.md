...
1. Bucket name (global and immutable)
   ...
   * Rules to follow:
   ...
   > **lightbulb** Use a predictable naming convention (for example, `project-environment-region-purpose`) so it’s easier to manage and discover buckets across teams.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/google-cloud-professional-data-engineer-certification/module/9b9963c1-ef6f-4c29-94d2-1427ab43c94c/lesson/8b285410-f6a8-40eb-b767-e35b6cbb896e)
