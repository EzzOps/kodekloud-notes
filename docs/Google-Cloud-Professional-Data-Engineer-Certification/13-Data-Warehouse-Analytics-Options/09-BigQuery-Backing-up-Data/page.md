...
> **lightbulb** Time Travel retains snapshots only for the table's configured retention window (default 7 days). Once that window expires, historical snapshots are no longer available for recovery.
...
> **warning** If your recovery window requires more than 90 days of historical data, you must implement an external archival or backup strategy (for example, scheduled exports to Cloud Storage). Time Travel retention cannot exceed 90 days.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/google-cloud-professional-data-engineer-certification/module/5918fa46-3bfb-4bd1-a53b-41f2a2a77532/lesson/4eae0eab-b35f-487e-ba4a-0d32a23ca217)
