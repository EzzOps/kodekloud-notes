...
> **lightbulb** Exam tip: If the question requires analytics across clouds without moving data (due to compliance, egress costs, or latency), BigQuery Omni is the best choice.
...
> **lightbulb** Remember these short hooks for the exam: Omni = query across clouds without moving data; BigLake = unified governance + open formats + multi-engine access; STS/BQ DTS = move or ingest data into GCP.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/google-cloud-professional-data-engineer-certification/module/c354d782-20e6-4961-a282-071b52a4013d/lesson/8c90505a-49b8-4a60-9591-e488713f1e6b)
