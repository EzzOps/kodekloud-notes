...
> **lightbulb** Use the project name for human-readability; use the project ID for resource paths, scripts, and most automations; and be aware that Google services often reference the project number for billing and internal links.

> **warning** Project IDs and project numbers are immutable. Choose project IDs carefully — once created they cannot be changed.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/google-cloud-professional-data-engineer-certification/module/54d4f17c-56da-41a4-b998-2a2c63f0ee3f/lesson/798ca7db-ca9b-4040-a765-4b31708121ef)
