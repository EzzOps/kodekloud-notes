...
<Callout icon="lightbulb">
  Cloud Data Fusion is the visual, code-free tool for building and running data integration pipelines. Cloud Composer is an orchestration service (based on [Apache Airflow](https://airflow.apache.org/)) for scheduling and managing workflows, and is not a visual ETL studio.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/google-cloud-professional-data-engineer-certification/module/36c7f00a-93ef-43ff-8baa-7d73914196ca/lesson/ff779828-374f-486d-bf62-e546caf662d1" />
</CardGroup>
