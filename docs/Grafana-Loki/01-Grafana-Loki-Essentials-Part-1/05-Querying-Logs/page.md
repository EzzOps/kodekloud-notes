...
Source: https://notes.kodekloud.com/docs/Grafana-Loki/Grafana-Loki-Essentials-Part-1/Querying-Logs/page

This guide verifies Loki server log reception and demonstrates querying logs using Grafana.
...
<Frame>
  ![The image shows a Grafana Loki interface with a query being set up to filter logs from a specific file path. A graph and log output area are visible below the query builder.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877764/notes-assets/images/Grafana-Loki-Querying-Logs/grafana-loki-query-setup-logs.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/grafana-loki/module/99ea0065-ea43-4058-9fef-46fbe62292ee/lesson/6b042439-5cfc-4a11-9992-8ffb1db15004" />
</CardGroup>
