...
> **lightbulb** If you're running Loki locally for testing, you can use several commands based on your operating system.
...
> **lightbulb** These examples illustrate how you can leverage Loki’s powerful LogQL to filter logs using labels and search within log messages. Grafana's intuitive query builder further simplifies the process, enabling you to quickly locate the logs relevant to your operations and troubleshooting needs.
