...
Source: https://notes.kodekloud.com/docs/Grafana-Loki/Grafana-Loki-Essentials-Part-2/Connecting-to-Grafana/page

This article explains how to connect to a Grafana instance and verify the operation of Loki and Grafana using port forwarding.
...
<Frame>
  ![The image shows a Grafana dashboard interface with options for tutorials, adding data sources, and creating dashboards. It also includes a blog section with recent updates.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877767/notes-assets/images/Grafana-Loki-Connecting-to-Grafana/grafana-dashboard-interface-tutorials.jpg)
</Frame>

<Frame>
  ![The image shows a web interface for managing data sources, specifically displaying a connection to "Loki" with options to add a new data source, build a dashboard, or explore. The interface is dark-themed and includes a search bar and sorting options.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877768/notes-assets/images/Grafana-Loki-Connecting-to-Grafana/web-interface-managing-data-sources-loki.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/grafana-loki/module/bcacc3b5-9868-4ee5-9a59-a2b73b2c500f/lesson/87c455c9-ee8f-4114-be87-19e15b682e51" />
</CardGroup>
