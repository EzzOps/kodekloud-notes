...
Source: https://notes.kodekloud.com/docs/Grafana-Loki/Grafana-Loki-Essentials-Part-2/Loki-in-Kubernetes/page

This tutorial explores collecting logs from Kubernetes applications using Loki, Promtail, and Grafana for effective log management within the cluster.
...
> **lightbulb** Deploying Promtail via daemon sets ensures comprehensive log collection on every node, regardless of when the node was added.
...
> **lightbulb** Using Helm streamlines the deployment process and ensures consistency across your cluster, making it a highly efficient approach to managing your logging infrastructure.
