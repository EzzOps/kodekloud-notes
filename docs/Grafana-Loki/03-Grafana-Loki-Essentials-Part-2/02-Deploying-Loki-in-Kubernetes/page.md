...
Source: https://notes.kodekloud.com/docs/Grafana-Loki/Grafana-Loki-Essentials-Part-2/Deploying-Loki-in-Kubernetes/page
...
> **lightbulb** Ensure that your Helm version is up-to-date to prevent compatibility issues with newer charts.
...
> **lightbulb** You can adjust the Grafana image tag if you require a specific version for your environment.
...
> **lightbulb** For multi-node clusters, Promtail will automatically run on every node, ensuring comprehensive log collection.
