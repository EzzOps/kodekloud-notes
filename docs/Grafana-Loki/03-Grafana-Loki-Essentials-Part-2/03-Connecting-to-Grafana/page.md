...
> **lightbulb** Using port forwarding is an excellent way to test and interact with in-cluster applications like Grafana without exposing them to the public internet.
...
> **triangle-alert** Port forwarding is ideal for testing; however, it is not recommended for production environments. Always secure your clusters appropriately when exposing services.
