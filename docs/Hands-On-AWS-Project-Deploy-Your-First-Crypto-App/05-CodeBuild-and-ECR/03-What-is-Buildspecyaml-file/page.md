...
> **lightbulb** Ensure your AWS CLI is configured with credentials that have the required ECR permissions. Typical actions needed when pushing images include: `ecr:GetAuthorizationToken`, `ecr:BatchCheckLayerAvailability`, `ecr:InitiateLayerUpload`, `ecr:UploadLayerPart`, `ecr:CompleteLayerUpload`, and `ecr:PutImage`. Also verify your CLI region matches the repository's region.
...
> **warning** For production images, enable "Scan on push" to automatically scan images for vulnerabilities. Also follow the principle of least privilege for credentials used by CI systems; prefer short-lived credentials or IAM roles where possible.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/building-scalable-microservices-on-aws-deploy-a-crypto-app/module/37195f61-a068-4f6c-9ccc-0bd66b358449/lesson/b78585c0-4b2d-45b6-b908-226eedb78a09)
...
> **lightbulb** Recommendation: Use the `buildspec.yml` filename (lowercase `.yml`) for consistency; `.yaml` is functionally equivalent.
...
> **warning** Important: Without Privileged mode enabled or the appropriate service-role IAM permissions, Docker commands and pushing to ECR will fail. Verify both the build environment settings and the IAM policy before running the build.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/building-scalable-microservices-on-aws-deploy-a-crypto-app/module/37195f61-a068-4f6c-9ccc-0bd66b358449/lesson/2dd2b175-8bcd-4e14-9601-0a57f2ab8442)
