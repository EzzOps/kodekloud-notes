...
> **lightbulb** * The buildspec filename must be exactly `buildspec.yml` (not `.yaml` and check case sensitivity).
...
> **lightbulb** * Confirm `buildspec.yml` is present in the repository root and named exactly `buildspec.yml`.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/building-scalable-microservices-on-aws-deploy-a-crypto-app/module/37195f61-a068-4f6c-9ccc-0bd66b358449/lesson/b7751643-4ef7-4341-962a-f58929bd7dfd)
