...
- [Watch Video](https://learn.kodekloud.com/user/courses/building-scalable-microservices-on-aws-deploy-a-crypto-app/module/f2cfee46-980a-49cb-b81a-dd46bfce3824/lesson/9eacc776-f8d1-40e5-9269-a9fef1a9b4d3)
...
> **warning** Do not commit credentials, tokens, or long-lived secrets into your repository. Use IAM roles (for CodeBuild and EC2) or secrets managers to provide secure access to ECR and other resources.

> **lightbulb** Summary of completed tasks: ECR setup, CodeBuild project creation and integration with CodeCommit, `buildspec.yml`-driven Docker builds, pushing images to ECR, and validating images from both EC2 and local development environments.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/building-scalable-microservices-on-aws-deploy-a-crypto-app/module/37195f61-a068-4f6c-9ccc-0bd66b358449/lesson/a87b294a-1760-4e00-9f94-708455617b60)
