...
> **lightbulb** A service ensures the desired number of task instances are running and performs controlled, automated deployments when you switch to a new task definition revision. Remember: the task definition is the immutable blueprint; a task is the running copy of that blueprint.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/building-scalable-microservices-on-aws-deploy-a-crypto-app/module/a5f47c01-ffdc-4186-8d6b-2b5189000482/lesson/cf04207e-3e39-4503-996a-bd4c1ef27f82)
