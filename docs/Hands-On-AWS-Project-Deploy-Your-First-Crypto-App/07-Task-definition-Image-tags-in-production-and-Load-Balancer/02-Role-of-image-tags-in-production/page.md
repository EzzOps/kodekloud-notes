...
- [Watch Video](https://learn.kodekloud.com/user/courses/building-scalable-microservices-on-aws-deploy-a-crypto-app/module/87867a08-358d-4890-933e-f6b072182388/lesson/1f09d93c-d5e9-44da-84e4-e44ac74f5925)
...
> **lightbulb** Best practice: Tag each build with both a human-friendly tag (for example, `latest` or a semantic version) and an immutable identifier (for example, the short commit hash). Push both tags to your registry so you get the convenience of `latest` plus the traceability and safety of an immutable tag.

> **warning** Do not rely solely on `latest` in production. `latest` is mutable and can make rollbacks or incident investigations difficult because it does not uniquely identify a build artifact.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/building-scalable-microservices-on-aws-deploy-a-crypto-app/module/87867a08-358d-4890-933e-f6b072182388/lesson/50c99233-5785-47d2-a2d7-7bef11c8c576)
