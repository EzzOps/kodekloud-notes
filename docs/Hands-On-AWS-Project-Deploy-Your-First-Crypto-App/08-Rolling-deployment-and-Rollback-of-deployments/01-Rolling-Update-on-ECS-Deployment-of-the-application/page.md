...
> **lightbulb** Control ECS rolling-update behavior with `minimumHealthyPercent` and `maximumPercent`, and tune ALB target group deregistration delay to manage concurrency and connection draining during updates.

> **warning** ECS rolling updates do not automatically roll back to a previous task definition. Monitor deployments and prepare a rollback plan (manual re-deploy or automated CI/CD pipeline) in case the new revision fails health checks.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/building-scalable-microservices-on-aws-deploy-a-crypto-app/module/acc69333-5a37-4353-a880-a86823fb1e93/lesson/fc6bc2a6-7a02-4cc1-8280-9d105a18c62b)
