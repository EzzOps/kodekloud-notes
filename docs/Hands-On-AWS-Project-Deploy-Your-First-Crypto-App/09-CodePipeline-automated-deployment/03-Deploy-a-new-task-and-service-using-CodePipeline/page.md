...
> **lightbulb** CodePipeline automatically detects changes in the configured source repository and triggers a pipeline execution for each new commit on the tracked branch.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/building-scalable-microservices-on-aws-deploy-a-crypto-app/module/d608c5f9-ae0c-4023-864f-b30b3099cd6f/lesson/bc66f992-acb5-42e8-b3fe-8a2ca6ab02b1)
...
> **warning** When selecting the provider, pick **Amazon ECS** (rolling deployments). Choosing ECR Blue/Green will switch CodePipeline to a different deployment model that requires a different setup.
