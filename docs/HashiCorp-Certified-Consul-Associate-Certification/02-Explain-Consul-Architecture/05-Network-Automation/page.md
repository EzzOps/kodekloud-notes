...
> **lightbulb** Consul integrates natively with Envoy for L7 control, and you can extend to F5, NGINX, or HAProxy using built-in connectors.
...
> **triangle-alert** Ensure both versions pass health checks before shifting traffic. A misconfigured subset with `Weight > 0` and failing health checks will not receive traffic.
