...
> **lightbulb** This Raft implementation was later extended to power HashiCorp Vault’s integrated storage starting in Vault 1.4.
...
> **triangle-alert** If your cluster falls below quorum, no new entries can be committed, and the cluster becomes unavailable for writes.
