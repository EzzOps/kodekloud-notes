...
> **lightbulb** Always run Consul on an odd number of **voting** server nodes (3, 5, 7, or 9). This ensures proper quorum and automatic leader election.
...
> **triangle-alert** Clusters larger than **nine** voting nodes often suffer from increased replication traffic, which can degrade performance. Only scale beyond nine nodes for very specific requirements.
