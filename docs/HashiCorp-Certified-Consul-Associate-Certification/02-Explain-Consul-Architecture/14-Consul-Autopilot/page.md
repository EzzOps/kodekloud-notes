...
> **triangle-alert** Autopilot is exclusive to the enterprise release of Consul. It is not available in the open-source distribution.
...
> **lightbulb** Keep dead server cleanup enabled to prevent stale entries in your cluster membership list.
