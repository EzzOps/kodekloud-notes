...
> **lightbulb** If you have a Consul Enterprise license, be sure to select the enterprise package instead of the open-source edition.
...
> **triangle-alert** Mixing CLI flags and configuration files can lead to unexpected overrides. Prefer HCL files for production setups.
