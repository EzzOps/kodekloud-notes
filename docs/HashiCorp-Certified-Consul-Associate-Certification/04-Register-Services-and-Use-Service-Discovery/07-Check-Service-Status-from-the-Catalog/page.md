...
> **lightbulb** Ensure your firewall allows traffic to port `8600/udp` for DNS forwarding.
...
> **triangle-alert** The Consul UI is unauthenticated by default. Consider enabling ACLs or reverse-proxy authentication in production.
