...
> **lightbulb** Set `"OnlyPassing": true` in your query definition to ensure only healthy service instances are returned.
...
> **triangle-alert** Always replace the query ID in your API URL when inspecting or updating prepared queries.
