...
Source: https://notes.kodekloud.com/docs/HashiCorp-Certified-Consul-Associate-Certification/Register-Services-and-Use-Service-Discovery/Objective-3-Section-Recap/page

This article covers service registration and discovery tasks using Consul, including registration methods, health checks, querying services, and prepared queries for failover.
...
> **lightbulb** A well-structured registration makes automated tooling and monitoring far easier to implement.
...
> **triangle-alert** After adding or modifying a file in the config directory, always run `consul reload` to apply changes without downtime.
