...
> **lightbulb** Base64 encoding is not encryption. Data at rest in Consul is unencrypted by default; the API simply returns values encoded in Base64.
...
> **triangle-alert** Once ACLs are enabled, all API, CLI, and UI requests require a valid token. Plan your migration and token distribution carefully.
...
> **lightbulb** Consul KV Store is designed strictly for key/value operations, not as a full database or file system.
...
> **triangle-alert** Consul KV Store data is *not* encrypted by default. For secrets and sensitive information, use [HashiCorp Vault](https://www.vaultproject.io).
