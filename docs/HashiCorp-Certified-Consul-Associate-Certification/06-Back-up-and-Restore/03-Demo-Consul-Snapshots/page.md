...
> **lightbulb** Ensure you have sufficient disk space in your working directory before creating large snapshots.
...
> **lightbulb** * The **Version** field refers to the snapshot format, not the Consul binary version.
...
> **triangle-alert** Do **not** restore a snapshot into an active cluster without first stopping agents—this can lead to data corruption.
