...
> **triangle-alert** The Snapshot Agent requires Consul Enterprise. If you’re on OSS Consul, implement external scripting for snapshots.
...
> **lightbulb** Configure `snapshot.interval` (e.g., `24h`) and `snapshot.retain` (e.g., `48`) to control scheduling and purge behavior.
