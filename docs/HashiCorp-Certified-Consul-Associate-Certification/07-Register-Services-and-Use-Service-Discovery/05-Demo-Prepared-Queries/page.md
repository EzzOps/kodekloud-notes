...
<Frame>
  ![The image shows a web interface for managing services, specifically displaying two web servers under "front-end-eCommerce," with all service checks passing.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877893/notes-assets/images/HashiCorp-Certified-Consul-Associate-Certification-Demo-Prepared-Queries/web-interface-managing-services-ecommerce.jpg)
</Frame>
