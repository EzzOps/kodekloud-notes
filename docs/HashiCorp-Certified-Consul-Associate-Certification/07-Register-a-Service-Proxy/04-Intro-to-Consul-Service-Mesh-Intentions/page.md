...
> **lightbulb** Services are registered immediately but not yet running—health checks will show “critical” until the application and proxy start.
...
> **triangle-alert** If you switch to `Deny All`, all existing service calls will be blocked until you configure Allow Intentions.
...
> **lightbulb** To use Layer 7 Intentions, integrate [Envoy](https://www.envoyproxy.io) or another HTTP-aware proxy with Consul.
