...
> **lightbulb** Consul’s integrated CA simplifies setup by removing manual renewal tasks. It’s ideal for most small-to-medium deployments.
...
> **triangle-alert** If any certificate chain does not match the configured root CA bundle, Consul agents will refuse to connect, causing service disruptions.
...
> **triangle-alert** If you skip Gossip encryption, all Serf traffic (including cluster health checks) is sent in clear text.
