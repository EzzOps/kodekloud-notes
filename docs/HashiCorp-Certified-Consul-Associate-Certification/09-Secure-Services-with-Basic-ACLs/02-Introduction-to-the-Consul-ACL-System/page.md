...
> **lightbulb** Service identities automatically grant mTLS and discovery permissions for your Connect services. No additional rules are required.
...
> **lightbulb** If you set `default_policy` to `allow` during setup, switch it to `deny` as soon as your policies are in place to avoid accidental exposure.
...
> **triangle-alert** The bootstrap token is your “root” credential. Treat it like a database superuser password—store it in a secure vault and rotate it if exposed.
