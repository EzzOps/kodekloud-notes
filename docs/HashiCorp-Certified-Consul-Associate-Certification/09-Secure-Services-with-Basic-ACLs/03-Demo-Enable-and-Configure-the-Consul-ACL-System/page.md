...
> **lightbulb** Consul ACLs are disabled out of the box. Enabling them enforces access control for API requests, service registrations, and key/value operations.
...
> **lightbulb** If a node isn’t listed as `alive`, check logs with `journalctl -u consul` and verify network connectivity.
...
> **triangle-alert** Store the **SecretID** securely. Losing it may lock you out of ACL management. Consider rotating tokens after bootstrapping.
