...
> **lightbulb** Make sure ACLs are enabled in your `consul.hcl` configuration under `acl { enabled = true }`.
...
> **triangle-alert** Always include your bootstrap token when creating or managing ACL policies.\
