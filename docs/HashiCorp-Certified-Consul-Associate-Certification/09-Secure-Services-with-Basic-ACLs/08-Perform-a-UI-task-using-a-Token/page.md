...
> **triangle-alert** Ensure you have the correct ACL token (Secret ID) before continuing. Without it, all management actions in the UI will be blocked.
...
> **lightbulb** For complete ACL configuration and best practices, see the [Consul ACL documentation](https://www.consul.io/docs/security/acl).
