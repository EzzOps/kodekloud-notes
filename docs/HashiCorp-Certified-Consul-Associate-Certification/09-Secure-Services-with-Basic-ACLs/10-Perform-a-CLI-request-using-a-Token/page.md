...
Source: https://notes.kodekloud.com/docs/HashiCorp-Certified-Consul-Associate-Certification/Secure-Services-with-Basic-ACLs/Perform-a-CLI-request-using-a-Token/page

This guide covers four primary ways to supply your ACL token when using HashiCorp Consul CLI.
...
> **lightbulb** Storing tokens as environment variables is convenient, but ensure your shell history is secured to prevent accidental leakage.
...
> **lightbulb** The `--token-file` flag instructs Consul to read the token from the specified path, mirroring the behavior of `CONSUL_HTTP_TOKEN_FILE`.
