...
> **lightbulb** Before proceeding, ensure Consul is running and you have access to the `consul` binary. For more details, see the [Consul documentation](https://www.consul.io/docs).
...
> **triangle-alert** Keep your token file secure. Avoid committing it to version control or sharing it publicly.
