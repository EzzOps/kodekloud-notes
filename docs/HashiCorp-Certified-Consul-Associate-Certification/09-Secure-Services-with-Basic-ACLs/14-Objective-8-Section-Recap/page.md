...
> **lightbulb** If you’re running Consul in a cluster, ensure all agents join with `-enable-agent` and share the same ACL configuration.
...
> **triangle-alert** Always revoke tokens as soon as they’re no longer needed to minimize security risks.
