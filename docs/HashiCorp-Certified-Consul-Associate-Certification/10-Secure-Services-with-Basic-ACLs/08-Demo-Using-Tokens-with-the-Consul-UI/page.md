...
<Frame>
  ![The image shows a web interface for managing access controls, specifically displaying a list of tokens with details such as their scope and description. The interface includes tabs for Tokens, Roles, and Policies.](../../../../images/kodekloud.com/kk-media/image/upload/v1752877954/notes-assets/images/HashiCorp-Certified-Consul-Associate-Certification-Demo-Using-Tokens-with-the-Consul-UI/access-control-web-interface-tokens.jpg)
</Frame>
