...
> **lightbulb** To generate or rotate a gossip encryption key, run:
...
> **triangle-alert** Restarting the Consul agent will momentarily interrupt cluster membership. Perform these steps during a maintenance window.
