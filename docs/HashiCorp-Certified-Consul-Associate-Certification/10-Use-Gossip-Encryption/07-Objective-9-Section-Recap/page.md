...
> **lightbulb** Gossip encryption protects only the internal communication between Consul agents. It does *not* encrypt ACL tokens, HTTP API traffic, or storage backends.
...
> **triangle-alert** Rotating or removing encryption keys without following a proper rollout plan can interrupt agent communication. Always validate connectivity after each step.
