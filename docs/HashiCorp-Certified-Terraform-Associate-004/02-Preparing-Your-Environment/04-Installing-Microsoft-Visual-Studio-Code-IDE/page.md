...
> **lightbulb** Choose the installer that matches both your OS and CPU architecture (Intel vs Apple Silicon on macOS) to avoid runtime issues or performance penalties.
...
> **lightbulb** If an extension or language feature doesn’t behave as expected, try reloading the window (Cmd/Ctrl+Shift+P → "Developer: Reload Window") or reinstalling the extension. For Terraform-specific issues, ensure your Terraform binary is installed and on your PATH.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/hashicorp-certified-terraform-associate-004/module/df5b5815-c1ea-45f5-ba18-7a5c53ded28a/lesson/ab4bdedc-45a8-429f-b607-45bb4cdd9522)
