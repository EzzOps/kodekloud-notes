...
> **lightbulb** Because you describe the desired final state rather than the steps to get there, Terraform can compute an efficient change plan, manage dependencies automatically, and provide a predictable `plan`/`apply` workflow.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/hashicorp-certified-terraform-associate-004/module/be082b2a-db28-4bed-84e4-233393a3aafa/lesson/a4e5f0e2-a9a1-4bf8-a592-0157c396577b)
...
> **lightbulb** Terraform automates provisioning but does not replace domain knowledge. Be familiar with the platform you’re targeting (networking, compute, identities) before automating it with Terraform.
...
> **warning** Protect Terraform state and secrets: state files can contain sensitive information. Use secure remote backends (e.g., `s3` with encryption or HashiCorp Cloud) and enable state locking to prevent concurrent modifications.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/hashicorp-certified-terraform-associate-004/module/be082b2a-db28-4bed-84e4-233393a3aafa/lesson/ad20a8c8-1323-495c-8835-c52288feda6a)
