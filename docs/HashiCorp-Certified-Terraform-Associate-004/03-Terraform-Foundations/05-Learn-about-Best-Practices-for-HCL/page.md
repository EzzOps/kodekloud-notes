...
> **warning** Never commit plaintext secrets to version control. Use a secrets manager or CI secret storage and reference values via environment variables or secure provider integrations.
...
> **lightbulb** Use editor extensions to catch syntax errors and style issues as you type, and run `terraform fmt` and linters in CI to ensure consistent formatting and policy checks across the team.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/hashicorp-certified-terraform-associate-004/module/be082b2a-db28-4bed-84e4-233393a3aafa/lesson/5a007a70-10c3-4314-833c-9b96b5f2ccdc)
