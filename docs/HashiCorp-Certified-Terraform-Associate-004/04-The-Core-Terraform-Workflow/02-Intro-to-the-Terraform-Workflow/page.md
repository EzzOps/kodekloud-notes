...
> **lightbulb** Modules have isolated scopes. You must explicitly pass values between modules; variables are not shared implicitly.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/hashicorp-certified-terraform-associate-004/module/7a9b9328-bd7d-4cb0-99f2-2ac166f272a7/lesson/629e1af0-5117-4c95-a064-281840d4f417)
...
> **lightbulb** Always run `terraform init` when you start working in a new Terraform project or after adding new provider/module references. Without initialization, `terraform plan` and `terraform apply` will fail.
