...
> **lightbulb** Tip: Treat the CLI as your single source of truth for executing infrastructure changes. Combine careful use of `terraform plan` with remote state locking to avoid race conditions in team environments.
...
> **warning** Warning: Avoid editing the Terraform state file directly. Use `terraform state` subcommands or remote state features (backends) to prevent corruption and ensure team safety.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/hashicorp-certified-terraform-associate-004/module/35cbc795-57ed-4af7-88c8-c9323af9294d/lesson/d404ab90-44cf-430f-9230-694be44070fb)
