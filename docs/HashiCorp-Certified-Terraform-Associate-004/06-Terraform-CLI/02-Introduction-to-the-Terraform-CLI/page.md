...
> **warning** Be careful with `-auto-approve` or `--auto-approve` flags on `apply` and `destroy`. They bypass interactive confirmation and can cause destructive changes if used accidentally.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/hashicorp-certified-terraform-associate-004/module/35cbc795-57ed-4af7-88c8-c9323af9294d/lesson/0e35f910-b353-4b57-b16f-1afa236e6024)
