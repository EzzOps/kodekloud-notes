...
> **lightbulb** The `.terraform` directory and provider plugin binaries are local artifacts for this working directory. They are safe to ignore in version control (add them to `.gitignore`).
