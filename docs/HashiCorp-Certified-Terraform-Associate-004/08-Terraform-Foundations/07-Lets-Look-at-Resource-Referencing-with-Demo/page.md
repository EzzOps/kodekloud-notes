...
<Callout icon="lightbulb">
  Use `terraform fmt` or a Terraform-aware editor (for example, the [VS Code Terraform extension](https://marketplace.visualstudio.com/items?itemName=HashiCorp.terraform)) to keep formatting consistent automatically.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/hashicorp-certified-terraform-associate-004/module/be082b2a-db28-4bed-84e4-233393a3aafa/lesson/4e01a1e6-aa12-4247-b73f-5c65c7652b8f" />
</CardGroup>
