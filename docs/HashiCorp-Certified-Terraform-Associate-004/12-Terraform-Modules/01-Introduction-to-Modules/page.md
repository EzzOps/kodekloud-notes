...
> **warning** Ensure your AWS credentials are available before running Terraform commands. You can export `AWS_ACCESS_KEY_ID`, `AWS_SECRET_ACCESS_KEY`, and optionally `AWS_SESSION_TOKEN`, or use the AWS CLI credential store.
...
> **lightbulb** Run [`terraform init`](https://developer.hashicorp.com/terraform/cli/commands/init) after adding or changing module sources so Terraform can download required modules and providers.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/hashicorp-certified-terraform-associate-004/module/7a9b9328-bd7d-4cb0-99f2-2ac166f272a7/lesson/c3fa64d8-e20e-43f3-8b1f-a7e52ed25978)
...
> **lightbulb** The root module is the directory where you run Terraform commands. Child modules live in other directories, remote registries, or version control and are referenced via `module` blocks.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/hashicorp-certified-terraform-associate-004/module/7a9b9328-bd7d-4cb0-99f2-2ac166f272a7/lesson/d7e308d3-d224-426f-a4a8-019b2f68b4b5)
