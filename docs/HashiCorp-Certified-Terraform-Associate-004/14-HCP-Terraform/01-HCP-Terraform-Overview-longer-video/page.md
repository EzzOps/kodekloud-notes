...
> **lightbulb** This lesson is presented for educational purposes (Terraform Associate exam preparation) and is not intended as marketing material.
...
> **lightbulb** Tip: If you plan a gradual migration, start by using HCP only for managed state (local execution), then enable remote execution once your team is ready. Always run `terraform login` to store HCP credentials for CLI access.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/hashicorp-certified-terraform-associate-004/module/110bee15-3e45-411c-a55c-e8dfff73d23a/lesson/738a4a65-2650-4f59-af4b-feee09f34caf)
