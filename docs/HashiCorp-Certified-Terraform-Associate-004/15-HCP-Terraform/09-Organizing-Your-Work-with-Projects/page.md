...
* A default project is created for every organization.
  * HCP Terraform creates a default project on organization creation. You may rename it, but you cannot delete it.
  > **lightbulb** The default project guarantees every workspace has a project. Rename it to match your naming conventions, but note it cannot be removed.
...
* Deleting projects:
  * A project must be empty before it can be deleted. Move or delete workspaces in a project prior to removing the project to avoid accidental orphaning of workspaces.
  > **warning** Only empty projects can be deleted. Always reassign or remove workspaces before attempting to delete a project.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/hashicorp-certified-terraform-associate-004/module/110bee15-3e45-411c-a55c-e8dfff73d23a/lesson/e0f6d06f-38be-498e-bb0f-e168bc4d4fe6)
