...
<Callout icon="warning">
  You cannot mix the `cloud` block and a `backend` block in the same configuration. They are mutually exclusive — choose one or the other.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/hashicorp-certified-terraform-associate-004/module/110bee15-3e45-411c-a55c-e8dfff73d23a/lesson/449f4b46-c4b5-49b3-8eb8-2f09b39eee16" />
</CardGroup>
