...
> **lightbulb** Vault Enterprise modules are sold separately. Contact your HashiCorp representative for licensing and feature add-ons.
...
> **triangle-alert** Vault on HCP is currently available only on AWS. Azure and GCP support are planned for future releases.
