...
Source: https://notes.kodekloud.com/docs/HashiCorp-Certified-Vault-Associate-Certification/Learning-the-Vault-Architecture/Unsealing-with-Auto-Unseal/page

Auto unseal simplifies Vault operations by using an external KMS or HSM for master key management, enhancing reliability and availability.
...
| --------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| AWS KMS               | seal "awskms"        | [https://www.vaultproject.io/docs/secrets/aws#auto-unseal-using-aws-kms](https://www.vaultproject.io/docs/secrets/aws#auto-unseal-using-aws-kms)             |
| Azure Key Vault       | seal "azurekeyvault" | [https://www.vaultproject.io/docs/secrets/azure#auto-unseal-using-azure-kv](https://www.vaultproject.io/docs/secrets/azure#auto-unseal-using-azure-kv)       |
| Google Cloud KMS      | seal "gcpckms"       | [https://www.vaultproject.io/docs/secrets/gcp#auto-unseal-using-gcp-kms](https://www.vaultproject.io/docs/secrets/gcp#auto-unseal-using-gcp-kms)             |
| AliCloud KMS          | seal "alicloudkms"   | [https://www.vaultproject.io/docs/secrets/alicloud#auto-unseal](https://www.vaultproject.io/docs/secrets/alicloud#auto-unseal)                               |
| On-prem HSM (PKCS#11) | seal "pkcs11"        | [https://www.vaultproject.io/docs/secrets/pkcs11#auto-unseal-using-pkcs11-hsm](https://www.vaultproject.io/docs/secrets/pkcs11#auto-unseal-using-pkcs11-hsm) |
