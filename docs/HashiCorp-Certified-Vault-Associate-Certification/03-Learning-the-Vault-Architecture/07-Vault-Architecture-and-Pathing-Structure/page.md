...
Source: https://notes.kodekloud.com/docs/HashiCorp-Certified-Vault-Associate-Certification/Learning-the-Vault-Architecture/Vault-Architecture-and-Pathing-Structure/page

This lesson examines HashiCorp Vault’s architecture, data security, and path-based routing for effective design, operation, and troubleshooting.
...
* **Storage Backend**\
  A durable, encrypted storage layer. Vault supports [Consul](https://www.consul.io/), DynamoDB, AWS S3, and more. In development mode, an in-memory backend is used. Vault always writes *encrypted* data to the backend.
