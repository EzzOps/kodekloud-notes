...
Source: https://notes.kodekloud.com/docs/HashiCorp-Certified-Vault-Associate-Certification/Assess-Vault-Tokens/Periodic-Tokens/page

Periodic tokens in Vault are renewable credentials ideal for long-running services, allowing indefinite renewal before TTL expiration without leaving orphaned credentials.
...
For more on Vault ACL policies, see [Vault Policy Documentation][vault-policy-docs].
...
* [Vault Policy Documentation][vault-policy-docs]
