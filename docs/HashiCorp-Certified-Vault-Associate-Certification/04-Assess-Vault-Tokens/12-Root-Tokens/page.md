...
> **lightbulb** You can use an existing root token to create a new token with a finite TTL if desired.
...
> **triangle-alert** Root tokens grant unlimited access. Always revoke them immediately after use to avoid security risks:
