...
Source: https://notes.kodekloud.com/docs/HashiCorp-Certified-Vault-Associate-Certification/Compare-Authentication-Methods/Demo-Okta-Auth-Method/page

This tutorial explains how to configure HashiCorp Vault to authenticate users through Okta, including creating tokens and mapping users to policies.
...
Assign an Okta user (for example, **[bryan@krausen.io](mailto:bryan@krausen.io)**) to a Vault policy (e.g., `bryan`):
