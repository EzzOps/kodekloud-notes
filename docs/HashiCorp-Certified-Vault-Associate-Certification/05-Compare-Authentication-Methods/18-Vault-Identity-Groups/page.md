...
> **lightbulb** You can nest groups indefinitely. Policies from parent groups cascade to all nested subgroups and members.
...
> **triangle-alert** Ensure that policy names are unique across namespaces to avoid unintended access overlaps when using internal groups with Vault Enterprise namespaces.
