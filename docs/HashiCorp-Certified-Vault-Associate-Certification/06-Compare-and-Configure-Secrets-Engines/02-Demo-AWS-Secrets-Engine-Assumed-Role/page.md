...
Source: https://notes.kodekloud.com/docs/HashiCorp-Certified-Vault-Associate-Certification/Compare-and-Configure-Secrets-Engines/Demo-AWS-Secrets-Engine-Assumed-Role/page

This guide explains configuring HashiCorp Vault’s AWS Secrets Engine for obtaining temporary cross-account AWS credentials using the assumed_role credential type.
