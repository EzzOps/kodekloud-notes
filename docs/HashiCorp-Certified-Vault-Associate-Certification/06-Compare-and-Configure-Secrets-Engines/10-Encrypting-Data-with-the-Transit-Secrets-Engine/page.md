...
> **triangle-alert** Decentralized encryption makes it hard to enforce policies, rotate keys, and audit usage.
...
> **lightbulb** Vault’s Transit engine does *not* store ciphertext—it simply encrypts or decrypts and returns the result.
