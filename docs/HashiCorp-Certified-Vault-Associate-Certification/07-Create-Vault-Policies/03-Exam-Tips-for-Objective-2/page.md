...
Source: https://notes.kodekloud.com/docs/HashiCorp-Certified-Vault-Associate-Certification/Create-Vault-Policies/Exam-Tips-for-Objective-2/page
...
* To explore default permissions:
  1. Start a [Dev server][vault-dev] (`vault server -dev`).
...
* [Vault Dev Server][vault-dev]
* [Vault API Reference][vault-api]
* [HashiCorp Vault Documentation][vault-docs]

[vault-policies]: https://www.vaultproject.io/docs/concepts/policies

[vault-dev]: https://www.vaultproject.io/docs/commands/server#dev-server
