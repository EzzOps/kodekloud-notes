...
> **triangle-alert** Userpass does not enforce password complexity, expiration, or rotation by default. For production workloads, consider integrating Vault with [external identity providers][vault-oidc] or LDAP.
