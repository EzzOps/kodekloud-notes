...
Source: https://notes.kodekloud.com/docs/HashiCorp-Certified-Vault-Operations-Professional-2022/Configure-Vault-Agent/Vault-Agent-Templating/page

This guide configures Vault Agent Templating for legacy applications to access Vault secrets through local files without altering application code.
...
Vault Agent Templating leverages the [Consul Template][ct-github] engine. Despite its name, Consul Template can fetch and renew secrets directly from Vault.
...
* [Consul Template GitHub][ct-github]
