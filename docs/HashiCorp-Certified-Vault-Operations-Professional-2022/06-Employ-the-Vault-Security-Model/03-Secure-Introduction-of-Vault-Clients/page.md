...
Source: https://notes.kodekloud.com/docs/HashiCorp-Certified-Vault-Operations-Professional-2022/Employ-the-Vault-Security-Model/Secure-Introduction-of-Vault-Clients/page

This guide explores methods to securely introduce Vault clients, ensuring applications obtain secrets without exposing initial credentials.
...
* [Azure Managed Identities][azure-msi]
* [GCP Metadata Server][gcp-metadata]
* [Kubernetes ServiceAccount Tokens][k8s-serviceaccount]
* [Jenkins][jenkins]
...
[azure-msi]: https://learn.microsoft.com/azure/active-directory/managed-identities-azure-resources/overview

[gcp-metadata]: https://cloud.google.com/compute/docs/metadata/overview

[k8s-serviceaccount]: https://kubernetes.io/docs/reference/access-authn-authz/service-accounts-admin/
