...
> **lightbulb** Cost Estimation is available in the Team & Governance tier of Terraform Cloud. If you’re not on this tier yet, [start a free trial](https://app.terraform.io/signup/account) to enable cost forecasting features.
