...
Source: https://notes.kodekloud.com/docs/HashiCorp-Terraform-Cloud/Introduction/Course-Introduction/page
...
| ------------------ | --------------------------------------------- | ------------------------------------------------------------------ |
| Terraform Cloud    | Remote state, runs, VCS integration           | [https://app.terraform.io/signup](https://app.terraform.io/signup) |
