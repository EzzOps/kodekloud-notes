...
Source: https://notes.kodekloud.com/docs/HashiCorp-Terraform-Cloud/Terraform-Cloud-Private-Module-Registry/Private-Module-Registry/page

Terraform Cloud’s private registry centralizes approved modules and providers, enforces policies, and simplifies version management for consistent and secure infrastructure building.
...
> **lightbulb** Terraform Cloud integrates with these version control systems:
  ...
  | Provider        | Link                                                                                         | Type               |
  | --------------- | -------------------------------------------------------------------------------------------- | ------------------ |
  | GitHub          | [https://github.com](https://github.com)                                                     | SaaS & Self-Hosted |
