...
Source: https://notes.kodekloud.com/docs/Helm-for-Beginners/Introduction-to-Helm/Customizing-chart-parameters/page
...
When deploying WordPress, the application configuration is defined via YAML files. For example, the Deployment template below sets several environment variables, such as WORDPRESS\_BLOG\_NAME, which derives its value from the values.yaml file.
...
> **lightbulb** The default values in the values.yaml file are intended to work “out-of-the-box.” Overriding them allows you to optimize the deployment for your specific needs.
...
> **lightbulb** Always be sure to test your changes in a development environment before deploying to production.
