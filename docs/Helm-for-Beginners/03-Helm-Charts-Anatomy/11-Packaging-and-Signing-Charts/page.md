...
> **lightbulb** Before uploading your chart to a repository, it is strongly recommended that you sign it. Signing helps users verify the integrity and authenticity of the package.
...
> **triangle-alert** When uploading your chart to an online repository, **always include both** the `.tgz` archive and the corresponding `.tgz.prov` provenance file.
