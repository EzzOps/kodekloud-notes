...
![The image shows a chat interface in a coding environment where a mathematical expression is being solved step-by-step, resulting in the final answer of 175.](https://kodekloud.com/kk-media/image/upload/v1752879168/notes-assets/images/Introduction-to-OpenAI-Getting-Started-With-OpenAI-Platform/chat-interface-coding-math-solution-175.jpg)
...
> **lightbulb** The Playground is ideal for rapid prototyping. Once satisfied, copy code snippets directly into your application.
...
![The image shows a webpage from OpenAI's documentation, detailing an overview of various AI models, their descriptions, and capabilities. The left sidebar includes navigation options like "Overview," "Quickstart," and "Models."](https://kodekloud.com/kk-media/image/upload/v1752879169/notes-assets/images/Introduction-to-OpenAI-Getting-Started-With-OpenAI-Platform/openai-documentation-ai-models-overview.jpg)
...
> **lightbulb** Be sure to set your `OPENAI_API_KEY` in environment variables before running these snippets.
...
![The image shows a webpage detailing deprecations and updates for various GPT models and APIs, including shutdown dates and recommended replacements. It includes a sidebar with navigation options related to best practices and resources.](https://kodekloud.com/kk-media/image/upload/v1752879171/notes-assets/images/Introduction-to-OpenAI-Getting-Started-With-OpenAI-Platform/gpt-models-deprecations-updates-webpage.jpg)

> **triangle-alert** Deprecated endpoints and models will stop functioning after their scheduled sunset dates. Always update to the recommended replacements to prevent downtime.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/introduction-to-openai/module/192b48b6-ae6c-4126-8784-a84f0d284a41/lesson/1ade8416-e558-49ae-a7a7-d88d2df040d4)
