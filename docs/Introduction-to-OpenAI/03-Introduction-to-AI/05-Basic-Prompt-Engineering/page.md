...
> **triangle-alert** Never commit your API key directly to source control. Use environment variables or a secrets manager in production.
...
> **lightbulb** `top_p` must be between 0 and 1 (exclusive). Values closer to 0 yield more focused results.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/introduction-to-openai/module/b34266e4-9475-4747-82ff-ee6646f5ca14/lesson/c4b1b680-4258-44c5-9298-be6a9d91a843)

  - [Practice Lab](https://learn.kodekloud.com/user/courses/introduction-to-openai/module/b34266e4-9475-4747-82ff-ee6646f5ca14/lesson/8238ca63-e986-470f-b463-86640b99c0a6)
