...
![The image illustrates types of tokenization, focusing on word-level tokenization where each word in the sentence "The cat wore a hat." is treated as a single token.](https://kodekloud.com/kk-media/image/upload/v1752879128/notes-assets/images/Introduction-to-OpenAI-Tokenization-and-Its-Impact-on-AI-Models/word-level-tokenization-types-illustration.jpg)
...
![The image explains sub-word-level tokenization, highlighting three steps: splitting words into smaller parts, using Byte Pair Encoding (BPE), and merging frequent character pairs or sub-words.](https://kodekloud.com/kk-media/image/upload/v1752879130/notes-assets/images/Introduction-to-OpenAI-Tokenization-and-Its-Impact-on-AI-Models/sub-word-tokenization-bpe-steps.jpg)

For example, “unhappiness” may become: `un` + `happiness`, and “don’t waste food” could split into: `don` + `'t`, `waste`, `food`.

![The image illustrates types of tokenization, focusing on sub-word level, where the word "unhappiness" is split into "un" and "happiness."](https://kodekloud.com/kk-media/image/upload/v1752879131/notes-assets/images/Introduction-to-OpenAI-Tokenization-and-Its-Impact-on-AI-Models/tokenization-subword-level-unhappiness.jpg)
...
![The image is a comparison chart of the advantages and disadvantages of sub-word-level tokenization. Advantages include handling rare words and reducing vocabulary size, while disadvantages include increased complexity and computational power requirements.](https://kodekloud.com/kk-media/image/upload/v1752879132/notes-assets/images/Introduction-to-OpenAI-Tokenization-and-Its-Impact-on-AI-Models/subword-tokenization-advantages-disadvantages-chart.jpg)

> **lightbulb** Subword tokenization (BPE, WordPiece) is the most common approach in state-of-the-art language models to mitigate OOV issues and control vocabulary size.
...
![The image explains types of tokenization, focusing on character-level tokenization where each character in the word "cat" is treated as a separate token.](https://kodekloud.com/kk-media/image/upload/v1752879133/notes-assets/images/Introduction-to-OpenAI-Tokenization-and-Its-Impact-on-AI-Models/tokenization-character-level-explanation.jpg)

![The image illustrates character-level tokenization of the input text "It is raining." by breaking it down into individual characters.](https://kodekloud.com/kk-media/image/upload/v1752879134/notes-assets/images/Introduction-to-OpenAI-Tokenization-and-Its-Impact-on-AI-Models/character-level-tokenization-input-text.jpg)
...
![The image outlines the role of tokenization in AI models, highlighting its impact on vocabulary, efficiency, computational requirements, and model performance.](https://kodekloud.com/kk-media/image/upload/v1752879138/notes-assets/images/Introduction-to-OpenAI-Tokenization-and-Its-Impact-on-AI-Models/tokenization-role-ai-models-impact.jpg)
...
> **triangle-alert** Inadequate tokenization may amplify bias or degrade performance in specialized or multilingual scenarios. Always evaluate your tokenizer on representative data.

![The image outlines challenges and considerations in tokenization, highlighting issues like tokenization bias, language-specific challenges, and impacts on multilingual models. It mentions specific languages such as Mandarin, Japanese, and Arabic, and the need for additional design considerations.](https://kodekloud.com/kk-media/image/upload/v1752879140/notes-assets/images/Introduction-to-OpenAI-Tokenization-and-Its-Impact-on-AI-Models/tokenization-challenges-bias-multilingual-models.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/introduction-to-openai/module/b34266e4-9475-4747-82ff-ee6646f5ca14/lesson/ebf99aee-afa8-41cd-844c-2a8403158de9)
