...
> **lightbulb** MDP assumptions include the Markov property: the next state depends only on the current state and action.
...
> **triangle-alert** Poorly designed reward functions can lead to unintended or unsafe behaviors. Always validate and test reward shaping thoroughly.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/introduction-to-openai/module/b34266e4-9475-4747-82ff-ee6646f5ca14/lesson/60bb409b-81c5-4ef8-a3b6-439407d53e3c)
