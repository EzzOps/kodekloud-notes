...
- [Watch Video](https://learn.kodekloud.com/user/courses/introduction-to-openai/module/b6b7bec7-ed21-47d5-afbb-663df59f5e97/lesson/428405c7-d156-47ee-9f54-a8ff04ce8542)
...
> **lightbulb** Adjust `temperature` (creativity) and `max_tokens` (length) to fine-tune your results. Lower `temperature` yields deterministic output, while higher values increase randomness.
...
> **triangle-alert** Never expose your API key in public repositories or client-side code. Use environment variables or a secrets manager.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/introduction-to-openai/module/b6b7bec7-ed21-47d5-afbb-663df59f5e97/lesson/04f1a674-6fc4-47a3-a431-2ccfe3bf41ef)
