...
<Frame>
  ![The image illustrates an embedding model that converts images, documents, and audio into vectors, which are then visualized in a 3D space.](../../../../images/kodekloud.com/kk-media/image/upload/v1752879208/notes-assets/images/Introduction-to-OpenAI-Embeddings/embedding-model-3d-vector-visualization.jpg)
</Frame>
...
<Frame>
  ![The image explains embeddings as vectors (lists) of floating-point numbers, with the distance between two vectors indicating their relatedness.](../../../../images/kodekloud.com/kk-media/image/upload/v1752879209/notes-assets/images/Introduction-to-OpenAI-Embeddings/embeddings-vectors-floating-point-numbers.jpg)
</Frame>
...
<Frame>
  ![The image illustrates how embeddings work, showing words grouped by sentiment: positive (e.g., "pretty," "elegant"), negative (e.g., "dirty," "ugly"), and neutral (e.g., "neutral," "impartial").](../../../../images/kodekloud.com/kk-media/image/upload/v1752879210/notes-assets/images/Introduction-to-OpenAI-Embeddings/embeddings-sentiment-words-illustration.jpg)
</Frame>
...
<Frame>
  ![The image lists three uses: text search, clustering, and recommendations, on a dark background.](../../../../images/kodekloud.com/kk-media/image/upload/v1752879212/notes-assets/images/Introduction-to-OpenAI-Embeddings/text-search-clustering-recommendations-dark.jpg)
</Frame>
