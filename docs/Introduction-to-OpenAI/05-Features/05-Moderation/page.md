...
> **lightbulb** Make sure you’re using the `openai` Python package version that supports `.parse()` (e.g., v0.27+).\
...
> **triangle-alert** Never commit your API keys to public repositories. Use environment variables or a secure vault.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/introduction-to-openai/module/42afe984-cd3e-4b3c-b1e0-8e9093f57a63/lesson/69e43059-3653-4c78-8216-84ef4ceefe3c)
...
![The image is a slide titled "Importance of Moderation," highlighting four key points: user safety, ethical considerations, compliance with regulations, and brand reputation. Each point includes a brief explanation of its significance.](https://kodekloud.com/kk-media/image/upload/v1752879011/notes-assets/images/Introduction-to-OpenAI-Moderation/importance-of-moderation-key-points.jpg)
...
![The image is a flowchart illustrating the process of moderating user-generated content, identifying categories like hate speech, profanity, NSFW, and low quality. It shows steps involving an image classifier and integration with other platforms.](https://kodekloud.com/kk-media/image/upload/v1752879012/notes-assets/images/Introduction-to-OpenAI-Moderation/user-content-moderation-flowchart.jpg)
...
![The image explains how a moderation model works using machine learning to detect harmful or inappropriate content and flag or filter responses based on predefined categories.](https://kodekloud.com/kk-media/image/upload/v1752879014/notes-assets/images/Introduction-to-OpenAI-Moderation/moderation-model-machine-learning-content-filtering.jpg)

> **lightbulb** You can adjust the model’s `threshold` and combine multiple category scores to fine-tune what content is flagged. This flexibility ensures the moderation pipeline aligns with your brand guidelines and compliance requirements.
...
![The image lists four use cases: customer support chatbots, social media applications, educational tools, and healthcare applications, each with a brief description of their purpose.](https://kodekloud.com/kk-media/image/upload/v1752879015/notes-assets/images/Introduction-to-OpenAI-Moderation/use-cases-chatbots-social-media-education-healthcare.jpg)
...
> **triangle-alert** Review your threshold settings carefully. Overly strict filters may block legitimate content, while lenient settings could let harmful material slip through.

***

## Best Practices

![The image outlines three best practices: human review with automated moderation, adjusting sensitivity based on context, and monitoring and updating policies.](https://kodekloud.com/kk-media/image/upload/v1752879016/notes-assets/images/Introduction-to-OpenAI-Moderation/best-practices-human-review-moderation.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/introduction-to-openai/module/42afe984-cd3e-4b3c-b1e0-8e9093f57a63/lesson/60ce1069-ade6-4ac2-8ade-3b0735b1e857)
