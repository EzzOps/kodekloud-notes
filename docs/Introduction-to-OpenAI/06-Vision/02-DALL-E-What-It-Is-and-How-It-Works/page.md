...
- [Watch Video](https://learn.kodekloud.com/user/courses/introduction-to-openai/module/b6b7bec7-ed21-47d5-afbb-663df59f5e97/lesson/12a9fcf0-2ab9-461b-bf9a-67fc1c132eb4)
...
> **triangle-alert** Keep your API key (`openai.api_key`) secure. Do not commit it to public repositories.
...
> **lightbulb** Vague prompts often result in generic or unexpected visuals. Include colors, styles, and context to get the best output.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/introduction-to-openai/module/d76ba88f-ebc6-4d12-8aa5-9359bc23be72/lesson/e920eba1-6176-4751-964e-384957e866ae)
