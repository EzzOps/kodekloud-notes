...
> **lightbulb** You can also pin a specific version for reproducibility:
...
> **triangle-alert** Never hard-code your API key in source files. Use environment variables or a secrets manager.
