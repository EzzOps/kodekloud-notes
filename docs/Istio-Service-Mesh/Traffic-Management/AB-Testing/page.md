...
Source: https://notes.kodekloud.com/docs/Istio-Service-Mesh/Traffic-Management/AB-Testing/page

This article explains how to use Istio Virtual Services for A/B testing by controlling traffic distribution between different service versions.
