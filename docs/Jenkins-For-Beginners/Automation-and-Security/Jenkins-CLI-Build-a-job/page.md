...
Source: https://notes.kodekloud.com/docs/Jenkins-For-Beginners/Automation-and-Security/Jenkins-CLI-Build-a-job/page
...
!!! note "Explore CLI Commands"
To explore available CLI commands, you can run the following command, which displays an overview of all commands and options:
...
!!! note "Authentication Tip"
Always ensure you are using secure credentials. For improved security, consider using API tokens instead of plain-text passwords.
