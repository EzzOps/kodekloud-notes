...
Source: https://notes.kodekloud.com/docs/Jenkins-Pipelines/AWS-Lambda-and-Advanced-Deployment-Techniques/AWS-Lambda-Basics/page

AWS Lambda is a serverless compute service that allows you to run code without managing servers or infrastructure.
