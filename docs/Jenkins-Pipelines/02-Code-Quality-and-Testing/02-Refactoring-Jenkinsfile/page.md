...
Source: https://notes.kodekloud.com/docs/Jenkins-Pipelines/Code-Quality-and-Testing/Refactoring-Jenkinsfile/page

This article discusses refactoring a Jenkinsfile to enhance credential management and streamline the pipeline structure.
...
When using the Bitbucket credentials via the BITBUCKET\_COMMON\_CREDS variable, you receive a string in the format `username:password`. If you require them separately, they are automatically exposed as the variables BITBUCKET\_COMMON\_CREDS\_USR and BITBUCKET\_COMMON\_CREDS\_PSW.
