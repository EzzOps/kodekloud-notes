...
> **lightbulb** Ensure that the SonarScanner CLI is installed on your virtual machine or available in your Jenkins tools.
...
> **lightbulb** In a future demonstration, we will explore how to retrieve the quality gate status from SonarQube to ensure that the Jenkins pipeline can fail the build if the quality gate conditions are not met.
