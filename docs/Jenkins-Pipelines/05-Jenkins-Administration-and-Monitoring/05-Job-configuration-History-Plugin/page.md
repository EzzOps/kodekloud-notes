...
Source: https://notes.kodekloud.com/docs/Jenkins-Pipelines/Jenkins-Administration-and-Monitoring/Job-configuration-History-Plugin/page
...
Each job has its own subdirectory within the "jobs" folder. For instance, to inspect "Dasher\_testJob":
