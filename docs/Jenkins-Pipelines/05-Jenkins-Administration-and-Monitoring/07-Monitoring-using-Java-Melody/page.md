...
> **lightbulb** For single-node setups, while the available monitoring information might be limited compared to multi-node environments, the essential details for system health and performance are still readily accessible.
