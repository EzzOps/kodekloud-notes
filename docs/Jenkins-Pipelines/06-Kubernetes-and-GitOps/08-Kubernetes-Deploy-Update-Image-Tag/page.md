...
Source: https://notes.kodekloud.com/docs/Jenkins-Pipelines/Kubernetes-and-GitOps/Kubernetes-Deploy-Update-Image-Tag/page
...
Before committing the changes, Jenkins must be configured with the appropriate credentials. A Gitea (or GitHub) token is stored in Jenkins and referenced as the environment variable GITEA\_TOKEN. An example environment section in the Jenkinsfile is as follows:
