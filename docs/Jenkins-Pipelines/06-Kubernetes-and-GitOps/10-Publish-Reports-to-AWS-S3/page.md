...
> **lightbulb** When using environment variables inside Groovy maps (such as during the S3 upload), ensure that you use double quotes to enable proper variable interpolation.
...
> **lightbulb** Experiment with these settings via the Jenkins Snippet Generator to ensure your S3 uploads meet your requirements.
