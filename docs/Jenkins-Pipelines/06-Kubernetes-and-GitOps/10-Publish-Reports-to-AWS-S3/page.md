...
Source: https://notes.kodekloud.com/docs/Jenkins-Pipelines/Kubernetes-and-GitOps/Publish-Reports-to-AWS-S3/page

This guide explains how to upload CI/CD pipeline reports to an Amazon S3 bucket using a Jenkins pipeline.
...
<Frame>
  ![The image shows a Jenkins workspace interface displaying a list of files and directories with their names, sizes, and modification dates.](../../../../images/kodekloud.com/kk-media/image/upload/v1752879744/notes-assets/images/Jenkins-Pipelines-Publish-Reports-to-AWS-S3/jenkins-workspace-file-list.jpg)
</Frame>
...
<Frame>
  ![The image shows an AWS S3 console with a list of general purpose buckets. One bucket named "solar-system-jenkins-reports-bucket" is displayed, located in the US East (Ohio) region.](../../../../images/kodekloud.com/kk-media/image/upload/v1752879745/notes-assets/images/Jenkins-Pipelines-Publish-Reports-to-AWS-S3/aws-s3-console-general-purpose-buckets.jpg)
</Frame>

<Frame>
  ![The image shows an Amazon S3 console with an empty bucket named "solar-system-jenkins-reports-bucket." There are no objects stored in the bucket, and options for actions like upload and create folder are visible.](../../../../images/kodekloud.com/kk-media/image/upload/v1752879746/notes-assets/images/Jenkins-Pipelines-Publish-Reports-to-AWS-S3/amazon-s3-empty-bucket-console.jpg)
</Frame>
...
<Frame>
  ![The image shows a Jenkins dashboard displaying a list of stored credentials, including IDs and names for various systems and services.](../../../../images/kodekloud.com/kk-media/image/upload/v1752879747/notes-assets/images/Jenkins-Pipelines-Publish-Reports-to-AWS-S3/jenkins-dashboard-credentials-list.jpg)
</Frame>
...
<Frame>
  ![The image shows an AWS Identity and Access Management (IAM) console screen, displaying the permissions policies for a user named "jenkins-user," with policies like "AmazonEC2FullAccess" and "AmazonS3FullAccess" listed.](../../../../images/kodekloud.com/kk-media/image/upload/v1752879748/notes-assets/images/Jenkins-Pipelines-Publish-Reports-to-AWS-S3/aws-iam-console-jenkins-user-policies.jpg)
</Frame>
...
<Frame>
  ![The image shows a webpage for the Jenkins "Pipeline: AWS Steps" plugin, detailing its features, version information, and links for further resources.](../../../../images/kodekloud.com/kk-media/image/upload/v1752879749/notes-assets/images/Jenkins-Pipelines-Publish-Reports-to-AWS-S3/jenkins-pipeline-aws-steps-plugin.jpg)
</Frame>

<Frame>
  ![The image shows a Jenkins interface with the "Snippet Generator" tool open, allowing users to configure and generate pipeline scripts.](../../../../images/kodekloud.com/kk-media/image/upload/v1752879750/notes-assets/images/Jenkins-Pipelines-Publish-Reports-to-AWS-S3/jenkins-snippet-generator-pipeline-scripts.jpg)
</Frame>
...
<Frame>
  ![The image shows a ZAP Scanning Report detailing security alerts for various sites, with a summary of alerts categorized by risk level, including low and informational risks.](../../../../images/kodekloud.com/kk-media/image/upload/v1752879752/notes-assets/images/Jenkins-Pipelines-Publish-Reports-to-AWS-S3/zap-scanning-report-security-alerts.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/jenkins-pipelines/module/fb6b2c83-178c-4962-b4e6-ca5528721170/lesson/5b381dd1-ff85-46c0-baf3-5eed389f7619" />
</CardGroup>
