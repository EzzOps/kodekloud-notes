...
Source: https://notes.kodekloud.com/docs/Jenkins-Pipelines/Kubernetes-and-GitOps/Manifest-Repository-and-Configure-ArgoCD/page
...
Generate a secret YAML without creating it immediately in the cluster. This command creates a file named "mongo-creds\_k8s-secret.yaml" containing the secret’s definition:
