...
![The image illustrates a process flow involving an application, a Lambda function, and a pipeline, with steps labeled "Deploy" and "Configure."](https://kodekloud.com/kk-media/image/upload/v1752879977/notes-assets/images/Jenkins-Project-Building-CICD-Pipeline-for-Scalable-Web-Applications-Section-Introduction/application-lambda-pipeline-flow.jpg)
...
> **lightbulb** Understanding the Serverless Application Model is crucial as it simplifies many aspects of deploying Lambda functions by automating several manual steps.
...
![The image outlines a project covering three topics: Lambda Overview, Serverless Application Model, and Deploying to Lambda.](https://kodekloud.com/kk-media/image/upload/v1752879978/notes-assets/images/Jenkins-Project-Building-CICD-Pipeline-for-Scalable-Web-Applications-Section-Introduction/lambda-overview-serverless-deployment.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/jenkins-project-building-ci-cd-pipeline-for-scalable-web-applications/module/ddd997d7-0eea-4fa7-8265-5feeb01301e8/lesson/0c88f902-1de4-4eab-a7a4-19f1ab2adeee)
