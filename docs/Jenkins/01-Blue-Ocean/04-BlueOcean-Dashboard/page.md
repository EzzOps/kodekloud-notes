...
Source: https://notes.kodekloud.com/docs/Jenkins/Blue-Ocean/BlueOcean-Dashboard/page

This article provides a detailed overview of the BlueOcean dashboard interface for managing and troubleshooting Jenkins pipelines.
