...
Source: https://notes.kodekloud.com/docs/Jenkins/Build-Agents/Using-an-Ubuntu-Server-as-a-Build-Agent/page

This guide explains how to configure an Ubuntu server as a Jenkins build agent, including user creation, credential setup, node configuration, and connection verification.
