...
> **lightbulb** In production environments, it is advisable to deploy build agents on secure and resilient infrastructure, such as data centers or dedicated server racks, as opposed to personal machines.
...
> **triangle-alert** Avoid running builds on your main Jenkins server to maintain stability and safeguard your system from potential security threats.
