...
> **lightbulb** Copy the displayed SSH key and paste it into the SSH keys section of your Jenkins configuration. Once saved, your public SSH key will be linked to your user account (for example, user "Mike"), granting you terminal access via the CLI.
...
> **lightbulb** In the next lesson, we will delve deeper into additional features and commands available within Jenkins to enhance your automation and continuous integration workflows.
