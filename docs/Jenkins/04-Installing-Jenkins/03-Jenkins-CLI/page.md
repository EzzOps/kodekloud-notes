...
Source: https://notes.kodekloud.com/docs/Jenkins/Installing-Jenkins/Jenkins-CLI/page

This guide explains how to configure authentication and use the Jenkins CLI via cURL.
...
<Frame>
  ![The image shows a Jenkins documentation page about SSH authentication, detailing user permissions and SSH key configuration, with a form for entering a full name and description.](../../../../images/kodekloud.com/kk-media/image/upload/v1752880062/notes-assets/images/Jenkins-Jenkins-CLI/frame_30.jpg)
</Frame>
...
<Frame>
  ![The image shows a Jenkins user settings page with fields for password, SSH public keys, and search settings, along with "Save" and "Apply" buttons.](../../../../images/kodekloud.com/kk-media/image/upload/v1752880063/notes-assets/images/Jenkins-Jenkins-CLI/frame_100.jpg)
</Frame>
