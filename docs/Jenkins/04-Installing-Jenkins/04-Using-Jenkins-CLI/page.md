...
Source: https://notes.kodekloud.com/docs/Jenkins/Installing-Jenkins/Using-Jenkins-CLI/page

Learn to manage your Jenkins instance using the CLI, covering installation, authentication, job listing, and job building.
