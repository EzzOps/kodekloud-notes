...
> **lightbulb** To explore all the endpoints, simply navigate to the Swagger UI after starting the application.
...
> **lightbulb** Feel free to explore the repository further, download the source code, and experiment with the application locally.
