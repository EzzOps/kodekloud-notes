...
Source: https://notes.kodekloud.com/docs/Jenkins/Pipelines/Build-a-CI-Pipeline/page

This tutorial covers setting up a continuous integration pipeline using Jenkins to run tests on a Go application.
...
<Frame>
  ![The image shows a Jenkins Plugin Manager interface listing plugins, some marked for adoption, with options to uninstall them.](../../../../images/kodekloud.com/kk-media/image/upload/v1752880081/notes-assets/images/Jenkins-Build-a-CI-Pipeline/frame_40.jpg)
</Frame>
...
<Frame>
  ![The image shows a Jenkins interface for creating a new item, offering options like Freestyle project, Pipeline, and Multi-configuration project.](../../../../images/kodekloud.com/kk-media/image/upload/v1752880082/notes-assets/images/Jenkins-Build-a-CI-Pipeline/frame_190.jpg)
</Frame>
...
<Frame>
  ![The image shows a Jenkins dashboard for a pipeline named "go3," displaying stage view times for "Tool Install" and "Test" stages.](../../../../images/kodekloud.com/kk-media/image/upload/v1752880083/notes-assets/images/Jenkins-Build-a-CI-Pipeline/frame_220.jpg)
</Frame>
