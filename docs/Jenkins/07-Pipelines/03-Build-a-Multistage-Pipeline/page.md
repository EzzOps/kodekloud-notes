...
Source: https://notes.kodekloud.com/docs/Jenkins/Pipelines/Build-a-Multistage-Pipeline/page

This tutorial demonstrates how to extend a pipeline configuration by adding a new stage named "UAT" to create a multistage pipeline.
