...
> **triangle-alert** The "Build Pipeline" plugin is vulnerable to stored XSS attacks. It is recommended to consider alternative solutions, such as SSH Pipeline Steps, to secure your build and agent processes.
