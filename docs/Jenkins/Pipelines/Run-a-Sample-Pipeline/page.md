...
Source: https://notes.kodekloud.com/docs/Jenkins/Pipelines/Run-a-Sample-Pipeline/page

This article demonstrates how to set up a sample Jenkins pipeline before building a full Go application pipeline.
...
// **NOTE:** This 'M3' Maven tool must be configured in Jenkins' global configuration.
        //
</Callout>
        mvnHome = tool 'M3'
    }
