...
> **lightbulb** Always consult the [official Kubernetes container runtimes guide](https://kubernetes.io/docs/setup/production-environment/container-runtimes/) for platform-specific instructions.
...
> **triangle-alert** Failing to specify `runAsUser` can expose your host to privilege escalation if a container is compromised.
