...
Source: https://notes.kodekloud.com/docs/Kubernetes-and-Cloud-Native-Security-Associate-KCSA/Platform-Security/Service-Mesh/page

A service mesh is an infrastructure layer managing service-to-service communication in microservices, enhancing resilience, security, and observability without altering application code.
