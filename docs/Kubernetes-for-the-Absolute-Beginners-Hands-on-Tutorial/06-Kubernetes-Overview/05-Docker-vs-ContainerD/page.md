...
> **lightbulb** CTR is primarily designed for debugging purposes. For production environments, consider using alternatives that offer a richer feature set.
...
> **lightbulb** Crictl is an essential tool for troubleshooting and debugging container runtimes and complements the kubelet’s functionality in Kubernetes.
