...
Source: https://notes.kodekloud.com/docs/Kubernetes-for-the-Absolute-Beginners-Hands-on-Tutorial/Microservices-Architecture/Deploying-voting-app-on-Kubernetes/page

This guide covers deploying a voting application on Kubernetes, detailing
...
* KodeKloud/example-voting-app\_vote:v1
* KodeKloud/example-voting-app\_worker:v1
* KodeKloud/example-voting-app\_result:v1
