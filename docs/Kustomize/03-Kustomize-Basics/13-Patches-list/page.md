...
Source: https://notes.kodekloud.com/docs/Kustomize/Kustomize-Basics/Patches-list/page

This article explains how to use Kustomize to modify lists in Kubernetes resources using JSON 6902 and Strategic Merge Patches.
