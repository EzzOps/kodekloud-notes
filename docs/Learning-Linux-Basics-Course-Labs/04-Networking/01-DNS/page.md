...
Source: https://notes.kodekloud.com/docs/Learning-Linux-Basics-Course-Labs/Networking/DNS/page

This article explores the Domain Name System (DNS), its components, and troubleshooting techniques for hostname resolution in networking.
...
When pinging external sites like [www.facebook.com](http://www.facebook.com), you'll notice the inclusion of top-level domains (TLDs), such as .com. Public DNS relies on fully qualified domain names (FQDNs) structured hierarchically.
...
* External website: [www.mycompany.com](http://www.mycompany.com)
