...
Source: https://notes.kodekloud.com/docs/Learning-Linux-Basics-Course-Labs/Storage-in-Linux/DAS-NAS-and-SAN/page

This article provides an overview of DAS, NAS, and SAN external storage technologies essential for enterprise-grade environments.
...
<Frame>
  ![The image illustrates a Network Attached Storage (NAS) setup, showing an NFS server connected to hosts via a network, highlighting features like shared file-based storage.](../../../../images/kodekloud.com/kk-media/image/upload/v1752881144/notes-assets/images/Learning-Linux-Basics-Course-Labs-DAS-NAS-and-SAN/frame_160.jpg)
</Frame>
...
<Frame>
  ![The image illustrates a Storage Area Network (SAN) setup, showing SAN devices connected to hosts A and B via Fibre Channel switches.](../../../../images/kodekloud.com/kk-media/image/upload/v1752881145/notes-assets/images/Learning-Linux-Basics-Course-Labs-DAS-NAS-and-SAN/frame_240.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/learning-linux-basics-course-labs/module/e0021af2-9983-4bde-97a2-29255d3ea1da/lesson/34a1aac0-c5b9-4952-a675-ec552f5858d8" />
</CardGroup>
