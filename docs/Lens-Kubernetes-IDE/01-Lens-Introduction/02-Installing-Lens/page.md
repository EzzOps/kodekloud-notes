...
Source: https://notes.kodekloud.com/docs/Lens-Kubernetes-IDE/Lens-Introduction/Installing-Lens/page

This article provides a step-by-step guide to installing and setting up Lens, a Kubernetes IDE for cluster management.
...
| ---------------- | -------------- | ------------------------------------------ |
| macOS            | `.dmg`         | [https://k8slens.dev](https://k8slens.dev) |
| Windows          | `.exe`         | [https://k8slens.dev](https://k8slens.dev) |
| Linux            | `.AppImage`    | [https://k8slens.dev](https://k8slens.dev) |
