...
> **lightbulb** Verify your Lens version via **Help › About Lens** in the desktop app.
...
> **triangle-alert** By default, shared clusters are **read-only**. To grant write permissions or restrict namespaces, configure teams and role bindings.
