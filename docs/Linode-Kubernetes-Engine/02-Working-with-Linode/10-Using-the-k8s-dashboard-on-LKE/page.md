...
> **lightbulb** Tokens are scoped by RBAC rules. Ensure your service account has the correct role bindings to view the resources you need.
...
> **triangle-alert** If you leave the dashboard exposed without proper authentication, anyone with the URL and token can view or modify your cluster. Always secure access.
