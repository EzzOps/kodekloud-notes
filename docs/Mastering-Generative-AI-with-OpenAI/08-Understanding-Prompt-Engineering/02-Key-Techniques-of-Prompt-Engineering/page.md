...
> **lightbulb** Choose zero-shot for quick tasks, one-shot when you need consistent formatting with minimal context, and few-shot for complex patterns or strict constraints.
...
> **lightbulb** Zero-shot is fast to set up but may require more precise wording for specialized or nuanced tasks.
...
> **triangle-alert** Including many examples can increase token usage and latency. Keep your prompt concise to stay within model limits.
