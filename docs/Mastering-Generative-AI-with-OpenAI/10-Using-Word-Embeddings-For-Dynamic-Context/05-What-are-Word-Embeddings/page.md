...
<Frame>
  ![The image explains word embeddings, showing how text (phrases, sentences, words) is converted into vectors (arrays) with similar words/sentences having similar vectors.](../../../../images/kodekloud.com/kk-media/image/upload/v1752881582/notes-assets/images/Mastering-Generative-AI-with-OpenAI-What-are-Word-Embeddings/word-embeddings-text-to-vectors.jpg)
</Frame>
...
<Frame>
  ![The image explains word embeddings with three vectors, each containing related words: Vector 1 (Black, Inky, Dark), Vector 2 (Orange, Tangerine, Ginger), and Vector 3 (Powerful, Strong, Brawny).](../../../../images/kodekloud.com/kk-media/image/upload/v1752881584/notes-assets/images/Mastering-Generative-AI-with-OpenAI-What-are-Word-Embeddings/word-embeddings-three-vectors-explained.jpg)
</Frame>
...
<Frame>
  ![The image illustrates the process of converting text into embeddings using a word embeddings model, showing how different sentences are transformed into numerical vectors.](../../../../images/kodekloud.com/kk-media/image/upload/v1752881585/notes-assets/images/Mastering-Generative-AI-with-OpenAI-What-are-Word-Embeddings/text-to-embeddings-word-model-diagram.jpg)
</Frame>
...
<Frame>
  ![The image illustrates the concept of cosine similarity using vectors representing different sentences, showing their angular relationships.](../../../../images/kodekloud.com/kk-media/image/upload/v1752881586/notes-assets/images/Mastering-Generative-AI-with-OpenAI-What-are-Word-Embeddings/cosine-similarity-vectors-angular-relationships.jpg)
</Frame>
