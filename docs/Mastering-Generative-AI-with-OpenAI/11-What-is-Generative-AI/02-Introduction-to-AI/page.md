...
Source: https://notes.kodekloud.com/docs/Mastering-Generative-AI-with-OpenAI/What-is-Generative-AI/Introduction-to-AI/page

This article introduces Artificial Intelligence, its subsets Machine Learning and Deep Learning, and compares traditional programming with machine learning techniques.
...
| --------------------- | -------------- | ----------------------------------------------------- |
| Supervised Learning   | Labeled data   | Predict labels for new inputs                         |
