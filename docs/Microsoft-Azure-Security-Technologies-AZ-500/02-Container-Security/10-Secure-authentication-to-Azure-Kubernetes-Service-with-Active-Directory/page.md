...
Source: https://notes.kodekloud.com/docs/Microsoft-Azure-Security-Technologies-AZ-500/Container-Security/Secure-authentication-to-Azure-Kubernetes-Service-with-Active-Directory/page

This guide explores secure authentication and network security for Azure Kubernetes Service using Azure Active Directory integration.
...
* **Resource Group:** Create a new group (e.g., *app AKS-01*).
* **Cluster Name:** Example: *app AKS cluster*.
