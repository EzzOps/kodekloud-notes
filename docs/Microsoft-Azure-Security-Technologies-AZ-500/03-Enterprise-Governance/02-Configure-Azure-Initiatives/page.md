...
> **lightbulb** Grouping policies into an initiative simplifies policy management and enforcement while ensuring consistency across your resources.
...
> **triangle-alert** Ensure that the proper role assignments are in place, as some policies (e.g., inherited tag policies) require the system to have sufficient permissions (like Tags Contributor) to automatically apply tag updates.
