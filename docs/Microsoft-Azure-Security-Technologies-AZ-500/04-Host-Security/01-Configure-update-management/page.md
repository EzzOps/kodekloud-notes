...
Source: https://notes.kodekloud.com/docs/Microsoft-Azure-Security-Technologies-AZ-500/Host-Security/Configure-update-management/page

This article explains how to configure Azure Update Management for keeping Windows and Linux servers updated and secure.
...
<Frame>
  ![The image is a flowchart illustrating the process of configuring update management, including steps like reviewing updates, checking maintenance windows, and applying updates using various repositories and services.](../../../../images/kodekloud.com/kk-media/image/upload/v1752881845/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Configure-update-management/update-management-flowchart-configuration.jpg)
</Frame>
...
<Frame>
  ![The image shows the Microsoft Azure portal displaying the update status for a virtual machine named "linux-ra-vm," indicating a total of six updates, with three being security and critical updates.](../../../../images/kodekloud.com/kk-media/image/upload/v1752881847/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Configure-update-management/azure-portal-linux-ra-vm-updates.jpg)
</Frame>
...
<Frame>
  ![The image shows the Microsoft Azure portal interface for managing updates on a virtual machine named "vm-from-image." It displays details about recommended updates, with a total of five updates, all classified as "Other."](../../../../images/kodekloud.com/kk-media/image/upload/v1752881848/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Configure-update-management/azure-portal-vm-updates-interface.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/microsoft-azure-security-technologies-az-500/module/d8d70777-3d80-4e41-803e-0929352de5e7/lesson/e07b41b7-83d5-4920-9903-977e7b381359" />
</CardGroup>
