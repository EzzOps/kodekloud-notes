...
Source: https://notes.kodekloud.com/docs/Microsoft-Azure-Security-Technologies-AZ-500/Hybrid-Identity/Deploy-Federation-with-Azure-AD/page

This article details the federation authentication method in Azure AD Connect, establishing trust between on-premises AD FS and Azure AD for seamless integration.
...
2. **User Sign-In Process:**
   * The user enters their email address (e.g., [user@kodekloud.com](mailto:user@kodekloud.com)) on the Azure AD sign-in page.
