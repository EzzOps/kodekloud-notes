...
Source: https://notes.kodekloud.com/docs/Microsoft-Azure-Security-Technologies-AZ-500/Secure-Azure-solution-with-Azure-Active-Directory/Create-and-manage-Azure-AD-users/page

This guide explores managing users and groups in Azure Active Directory, focusing on user accounts, creation, deletion, and types of accounts available.
...
<Frame>
  ![The image shows a user account management interface from Azure Active Directory, listing user details and options for managing accounts. It also includes a sidebar with navigation options and a section explaining user account functionalities.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882199/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Create-and-manage-Azure-AD-users/azure-active-directory-user-management.jpg)
</Frame>
...
<Frame>
  ![The image is a diagram explaining three types of user accounts: Cloud Identities, Guest Accounts, and Directory-Synchronized Users, with brief descriptions for each.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882200/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Create-and-manage-Azure-AD-users/user-accounts-diagram-cloud-guest-directory.jpg)
</Frame>
...
1. **Create a New User (Cloud Identity)**
   * Directly create a new user in Azure AD. For example, if your domain is cloudlabs.onmicrosoft.com, a new user might be created as [alice@kodekloudlabs.onmicrosoft.com](mailto:alice@kodekloudlabs.onmicrosoft.com).
...
<Frame>
  ![The image shows a Microsoft Azure interface for managing user accounts, with options to create or invite users and track sign-in and audit logs.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882202/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Create-and-manage-Azure-AD-users/azure-user-management-interface.jpg)
</Frame>
...
When creating a cloud user, the system automatically appends your tenant’s domain to the username. For instance, creating an account for Mark Chris might result in a user principal name like [mark.chris@yourtenantdomain.com](mailto:mark.chris@yourtenantdomain.com).

<Frame>
  ![The image shows a Microsoft Azure interface for creating a new user, with fields for user principal name, mail nickname, display name, and password settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882203/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Create-and-manage-Azure-AD-users/azure-create-new-user-interface.jpg)
</Frame>
...
<Frame>
  ![The image shows a Microsoft Azure interface for creating a new user, with fields for entering details like department, employee ID, and contact information.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882204/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Create-and-manage-Azure-AD-users/azure-create-user-interface.jpg)
</Frame>
...
<Frame>
  ![The image shows a Microsoft Azure portal interface displaying a list of users with options to create or invite new users. A notification indicates a user named Mark Chris was successfully created.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882205/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Create-and-manage-Azure-AD-users/azure-portal-user-management-notification.jpg)
</Frame>
...
<Frame>
  ![The image shows a Microsoft Azure user profile page for a user named Mark Chris, displaying details such as user principal name, object ID, and account status.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882206/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Create-and-manage-Azure-AD-users/azure-user-profile-mark-chris.jpg)
</Frame>
...
<Frame>
  ![The image shows a Microsoft Azure portal interface where a user named Aida Perkins is being deleted, with a notification confirming the successful deletion.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882207/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Create-and-manage-Azure-AD-users/azure-portal-delete-user-notification.jpg)
</Frame>
...
<Frame>
  ![The image shows a Microsoft Azure portal interface displaying a list of users with options to add filters and manage user accounts. The sidebar includes navigation options like audit logs and user settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882208/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Create-and-manage-Azure-AD-users/azure-portal-user-management-interface.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/microsoft-azure-security-technologies-az-500/module/c0f70ae1-790f-4a5d-8e09-29450b5ee610/lesson/6137e17a-614a-4b5d-aca0-44a5c030f2b1" />
</CardGroup>
