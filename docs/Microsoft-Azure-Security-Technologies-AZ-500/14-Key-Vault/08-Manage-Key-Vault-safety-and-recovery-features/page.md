...
Source: https://notes.kodekloud.com/docs/Microsoft-Azure-Security-Technologies-AZ-500/Key-Vault/Manage-Key-Vault-safety-and-recovery-features/page

This article explores Azure Key Vaults safety and recovery features, focusing on soft delete and backup options for secure data management.
...
<Frame>
  ![The image illustrates the difference between managing a key vault with and without soft-delete protection, showing that without it, the key vault is permanently deleted, while with it, the vault can be recovered from a soft-deleted state.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882011/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Manage-Key-Vault-safety-and-recovery-features/key-vault-soft-delete-comparison.jpg)
</Frame>
...
<Frame>
  ![The image shows a Microsoft Azure portal interface displaying the properties of a key vault named "akvappsec," including details like location, subscription ID, and soft-delete settings.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882012/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Manage-Key-Vault-safety-and-recovery-features/azure-portal-key-vault-properties.jpg)
</Frame>
...
<Frame>
  ![The image shows a Microsoft Azure Key Vault interface displaying a secret named "sql-db-connstring" with its current version enabled. There are options to create a new version, refresh, delete, or download a backup.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882014/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Manage-Key-Vault-safety-and-recovery-features/azure-key-vault-sql-connstring.jpg)
</Frame>

For certificates, the Azure portal provides a similar interface:

<Frame>
  ![The image shows a Microsoft Azure portal interface displaying a certificate management page with details such as version, thumbprint, status, activation date, and expiration date. The "Download Backup" option is highlighted.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882015/notes-assets/images/Microsoft-Azure-Security-Technologies-AZ-500-Manage-Key-Vault-safety-and-recovery-features/azure-portal-certificate-management.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/microsoft-azure-security-technologies-az-500/module/e6ef26f3-b79d-482a-8f38-130223404051/lesson/acbe0298-e8d3-4649-b3e1-f8aa07b3756f" />
</CardGroup>
