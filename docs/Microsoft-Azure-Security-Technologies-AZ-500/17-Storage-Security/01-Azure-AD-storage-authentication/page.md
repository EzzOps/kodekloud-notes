...
Source: https://notes.kodekloud.com/docs/Microsoft-Azure-Security-Technologies-AZ-500/Storage-Security/Azure-AD-storage-authentication/page

Azure AD Storage Authentication offers a secure method for accessing Azure Storage, addressing limitations of shared access signatures through identity-based authentication and authorization.
...
1. Configure a request in Postman to the Azure AD token endpoint. Use these parameters:
   ...
   * client\_id: (your copied client ID)
   * client\_secret: (your generated client secret)
   * grant\_type: client\_credentials
   * resource: [https://storage.azure.com](https://storage.azure.com)
