...
> **lightbulb** On-premises Active Directory Domain Services is not supported for Azure Blob access.
...
> **lightbulb** For RESTful access to Azure Files, only Shared Key and SAS are supported. Azure AD and on-premises Active Directory Domain Services authentication methods are not available in this scenario.
...
> **lightbulb** On-premises Active Directory Domain Services and anonymous access are not supported for Azure Queues.
