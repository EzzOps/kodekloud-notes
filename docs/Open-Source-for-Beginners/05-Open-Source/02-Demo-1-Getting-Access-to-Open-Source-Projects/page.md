...
> **lightbulb** If you’re new to Docker or Compose, no worries—this demo focuses on accessing the project’s codebase rather than using it.
...
![The image shows an octopus holding blue cubes next to a document icon labeled "YAML," with a plus sign between them.](https://kodekloud.com/kk-media/image/upload/v1752882532/notes-assets/images/Open-Source-for-Beginners-Demo-1-Getting-Access-to-Open-Source-Projects/octopus-blue-cubes-yaml-icon.jpg)

Head to the [Docker Open Source page][docker-oss] and scroll down until you see **Docker Compose**.

![The image is a screenshot of the Docker website's "Open Source" page, highlighting Docker's collaboration with the open source ecosystem and its projects. It includes navigation links and a "Get Started" button.](https://kodekloud.com/kk-media/image/upload/v1752882533/notes-assets/images/Open-Source-for-Beginners-Demo-1-Getting-Access-to-Open-Source-Projects/docker-open-source-page-screenshot.jpg)
...
![The image shows a GitHub repository page for "docker/compose," displaying the file structure, recent commits, and repository statistics like stars and forks.](https://kodekloud.com/kk-media/image/upload/v1752882534/notes-assets/images/Open-Source-for-Beginners-Demo-1-Getting-Access-to-Open-Source-Projects/github-repo-docker-compose-structure.jpg)
...
![The image shows a GitHub repository page for "Docker Compose v2," featuring a cartoon octopus with Docker containers and information about the repository, including contributors and language usage statistics.](https://kodekloud.com/kk-media/image/upload/v1752882536/notes-assets/images/Open-Source-for-Beginners-Demo-1-Getting-Access-to-Open-Source-Projects/github-repo-docker-compose-octopus.jpg)

> **triangle-alert** Always check the LICENSE file before using or modifying open source code to ensure compliance with its terms.
...
![The image shows a GitHub repository page for "docker/compose," displaying the file structure, clone options, and repository details like stars and forks.](https://kodekloud.com/kk-media/image/upload/v1752882537/notes-assets/images/Open-Source-for-Beginners-Demo-1-Getting-Access-to-Open-Source-Projects/github-repo-docker-compose-structure-2.jpg)
...
- [Watch Video](https://learn.kodekloud.com/user/courses/open-source-for-beginners/module/649f4ff1-452a-46e6-9822-6cb8808ccc6f/lesson/1cfa4b39-1b99-4969-96d3-53f94f7edcea)

  - [Practice Lab](https://learn.kodekloud.com/user/courses/open-source-for-beginners/module/649f4ff1-452a-46e6-9822-6cb8808ccc6f/lesson/be446a0c-784c-4546-bd18-f6e32afa525e)
