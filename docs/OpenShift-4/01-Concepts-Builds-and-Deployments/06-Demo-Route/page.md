...
<Frame>
  ![The image shows a Red Hat OpenShift Container Platform interface displaying a list of deployments with their names, status, labels, and pod selectors.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882587/notes-assets/images/OpenShift-4-Demo-Route/red-hat-openshift-deployments-interface.jpg)
</Frame>
...
<Frame>
  ![The image shows a Red Hat OpenShift Container Platform interface where a user is configuring a route for a project. The form includes fields for the route name, hostname, path, and service selection.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882590/notes-assets/images/OpenShift-4-Demo-Route/openshift-route-configuration-interface.jpg)
</Frame>
...
<Frame>
  ![The image shows a Red Hat OpenShift Container Platform interface displaying route details for a project named "frontend-app," which is marked as accepted. The interface includes navigation options for workloads, networking, and other features.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882591/notes-assets/images/OpenShift-4-Demo-Route/openshift-frontend-app-route-details.jpg)
</Frame>
