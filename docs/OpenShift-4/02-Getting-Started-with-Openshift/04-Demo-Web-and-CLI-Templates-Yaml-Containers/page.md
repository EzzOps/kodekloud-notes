...
> **triangle-alert** Even though the trial version appears free, you are still liable for paying for the cluster configuration and any related cloud services. Trials used for learning purposes should be deleted promptly to avoid unexpected charges.
