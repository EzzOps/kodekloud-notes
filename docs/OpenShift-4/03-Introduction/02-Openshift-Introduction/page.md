...
Source: https://notes.kodekloud.com/docs/OpenShift-4/Introduction/Openshift-Introduction/page

This article provides an overview of OpenShift, Red Hats open-source container application platform for developing and hosting enterprise-grade applications.
