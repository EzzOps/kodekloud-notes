...
Source: https://notes.kodekloud.com/docs/OpenShift-4/Networks-Services-Routes-and-Scaling/Demo-Scaling/page

This article provides a hands-on tutorial for deploying and scaling applications in OpenShift, focusing on a simple web application example.
...
<Frame>
  ![The image shows a GitLab project page for "simple-webapp-color," displaying options for repository management, CI/CD setup, and project details. An alert at the top indicates the need to add an SSH key for code operations.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882673/notes-assets/images/OpenShift-4-Demo-Scaling/gitlab-simple-webapp-color-project.jpg)
</Frame>
...
<Frame>
  ![The image shows an OpenShift Origin web console where a Python application named "webapp-color" is being created in "Web Application 2." The interface displays a progress bar with steps labeled Information, Configuration, and Results.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882674/notes-assets/images/OpenShift-4-Demo-Scaling/openshift-web-console-python-app-creation.jpg)
</Frame>
...
<Frame>
  ![The image shows a web browser displaying a red background with the text "Hello from webapp-color-1-pl829!" in white. The browser tab is labeled "Hello from Flask."](../../../../images/kodekloud.com/kk-media/image/upload/v1752882674/notes-assets/images/OpenShift-4-Demo-Scaling/webapp-color-1-hello-flask.jpg)
</Frame>
...
<Frame>
  ![The image shows a webpage from the OpenShift documentation, specifically detailing route-specific annotations with a table listing variables, descriptions, and default environment variables.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882677/notes-assets/images/OpenShift-4-Demo-Scaling/openshift-route-annotations-table.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/openshift-4/module/ec611802-285c-4fb9-b13e-26eb84f4ec7d/lesson/b3d4170a-4ff7-4a1d-af42-60ec5e991754" />
</CardGroup>
