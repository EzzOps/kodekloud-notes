...
> **triangle-alert** Directly connecting to pods using their IP addresses is generally discouraged. The recommended approach is to use services because they provide a stable endpoint. Detailed discussions on services will be covered in upcoming sections.
