...
Source: https://notes.kodekloud.com/docs/OpenShift-4/Openshift-Concepts-Projects-and-Users/Demo-Projects-and-Users/page

This article covers managing projects and users in OpenShift using the CLI and web console.
...
::: warning Web Console Login
Logging in to the web console using a system admin user is not permitted because system users do not have access through the UI.
:::
