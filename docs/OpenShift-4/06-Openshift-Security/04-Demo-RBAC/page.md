...
Source: https://notes.kodekloud.com/docs/OpenShift-4/Openshift-Security/Demo-RBAC/page

This article explores setting up roles and role bindings in a cluster, including creating namespaced roles and binding them to service accounts.
