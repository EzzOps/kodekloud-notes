...
Source: https://notes.kodekloud.com/docs/OpenShift-4/Openshift-Security/Demo-User-Management/page
...
This confirms that the "allow\_all" identity is now successfully mapped to "miketest".
