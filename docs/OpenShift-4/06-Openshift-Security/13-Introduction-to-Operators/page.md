...
Source: https://notes.kodekloud.com/docs/OpenShift-4/Openshift-Security/Introduction-to-Operators/page

This article explains how Kubernetes operators extend the API for resource management and application deployment.
