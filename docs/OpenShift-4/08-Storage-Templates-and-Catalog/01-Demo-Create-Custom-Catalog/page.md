...
Source: https://notes.kodekloud.com/docs/OpenShift-4/Storage-Templates-and-Catalog/Demo-Create-Custom-Catalog/page

This guide explains how to create a custom template for a voting application on an OpenShift cluster.
