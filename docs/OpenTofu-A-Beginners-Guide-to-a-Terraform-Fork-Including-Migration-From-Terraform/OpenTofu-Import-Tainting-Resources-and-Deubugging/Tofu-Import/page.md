...
Source: https://notes.kodekloud.com/docs/OpenTofu-A-Beginners-Guide-to-a-Terraform-Fork-Including-Migration-From-Terraform/OpenTofu-Import-Tainting-Resources-and-Deubugging/Tofu-Import/page

This lesson explains how to use the OpenTofu import command to manage existing resources like AWS EC2 instances.
