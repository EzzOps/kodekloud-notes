...
Source: https://notes.kodekloud.com/docs/OpenTofu-A-Beginners-Guide-to-a-Terraform-Fork-Including-Migration-From-Terraform/Working-with-OpenTofu/LifeCycle-Rules/page

This article explains OpenTofu's lifecycle rules for managing resource creation, updates, and destruction to prevent downtime and accidental changes.
...
* [create\_before\_destroy](#1-create_before_destroy)
* [prevent\_destroy](#2-prevent_destroy)
* [ignore\_changes](#3-ignore_changes)
