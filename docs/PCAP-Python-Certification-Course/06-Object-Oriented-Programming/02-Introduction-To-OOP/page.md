...
<Frame>
  ![The image compares procedural and object-oriented programming. It explains that procedural programming distinguishes data and code, while object-oriented programming encloses them together in classes.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882922/notes-assets/images/PCAP-Python-Certification-Course-Introduction-To-OOP/procedural-vs-object-oriented-programming.jpg)
</Frame>
...
<Frame>
  ![The image is a flowchart categorizing vehicles into land, water, air, and space vehicles, with further subdivisions for land vehicles into wheeled, tracked, and hovercrafts.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882922/notes-assets/images/PCAP-Python-Certification-Course-Introduction-To-OOP/vehicle-categorization-flowchart.jpg)
</Frame>
