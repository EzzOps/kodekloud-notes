...
Source: https://notes.kodekloud.com/docs/PCAP-Python-Certification-Course/String-and-List-Methods/Introduction-to-Character-and-String-Standards/page

This article explains character and string standards in Python, focusing on ASCII, code points, code pages, Unicode, and UTF-8 encoding.
...
<Frame>
  ![The image shows the phrase "Hello world" with each letter and space represented by its corresponding ASCII code below.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882925/notes-assets/images/PCAP-Python-Certification-Course-Introduction-to-Character-and-String-Standards/hello-world-ascii-codes.jpg)
</Frame>
...
<Frame>
  ![The image defines "Unicode" as an information technology standard that assigns unique characters to more than a million code points.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882925/notes-assets/images/PCAP-Python-Certification-Course-Introduction-to-Character-and-String-Standards/unicode-information-technology-standard.jpg)
</Frame>
...
<Frame>
  ![The image defines UTF-8 as a text encoding system that represents Unicode by using one to four one-byte code units for over a million code points.](../../../../images/kodekloud.com/kk-media/image/upload/v1752882926/notes-assets/images/PCAP-Python-Certification-Course-Introduction-to-Character-and-String-Standards/utf-8-text-encoding-unicode.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/pcap-python-certification-course/module/2c9c597a-cb2d-43ca-ba29-2dc1b630cae6/lesson/8f749351-3b18-4b2f-b01f-2d3385ae0678" />
</CardGroup>
