...
Source: https://notes.kodekloud.com/docs/Prep-Course-Linux-Foundation-Certified-System-Administrator-LFCS-Certification/Essential-Commands/List-Set-and-Change-Standard-File-Permissions/page
...
In the example above, the file "family\_dog.jpg" is owned by the user "aaron" and associated with the group "family". Only the file owner or the superuser (root) can change its permissions.
...
For example, to change the ownership of "family\_dog.jpg" to "jane", use:
