...
Source: https://notes.kodekloud.com/docs/Prep-Course-Linux-Foundation-Certified-System-Administrator-LFCS-Certification/Essential-Commands/Back-Up-Files-to-a-Remote-System-Optional/page

This guide explains how to back up files on Linux using rsync and dd for efficient file synchronization and disk imaging.
...
• "Aaron" is the username on the remote system.\
