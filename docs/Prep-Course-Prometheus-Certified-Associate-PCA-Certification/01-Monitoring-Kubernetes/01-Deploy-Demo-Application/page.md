...
> **lightbulb** Ensure your application listens on the same port you expose in the container and in the Kubernetes Service (below). This example uses port 3000 and exposes metrics at `/swagger-stats/metrics`.
