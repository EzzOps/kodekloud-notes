...
> **lightbulb** Regular expressions are powerful but can impact performance if overused. Test and keep regex patterns as simple and specific as possible. For a regex reference, see [Regular-Expressions.info](https://www.regular-expressions.info/).
...
> **warning** Make sure label values and regex patterns are quoted correctly. Unquoted or malformed regexes can cause query errors. When in doubt, test queries in the Prometheus UI or Grafana Explore.
