...
> **lightbulb** Prometheus stores recent data on local disk by default. Tune retention by time (`--storage.tsdb.retention.time`) or by size (`--storage.tsdb.retention.size`) depending on whether you want to limit based on age or storage consumption.
...
> **warning** If retention flags are not configured according to your ingestion rate, Prometheus may delete data unexpectedly or exhaust disk space. Always plan capacity and monitor disk usage.
...
> **lightbulb** For exams or conceptual understanding, you only need to know that tools like Thanos and Grafana Mimir exist to provide long-term, cost-effective storage for Prometheus metrics. Deep internals of those systems are not required for basic certification-level knowledge.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/prometheus-certified-associate-pca/module/def44ace-3439-4128-88c2-b701bf182baf/lesson/64b211c3-08a0-4911-bc97-d78f747b4c06)
