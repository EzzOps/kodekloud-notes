...
> **lightbulb** Prometheus is built for metrics: it scrapes and stores time series, evaluates alerting rules, and powers dashboards. Use dedicated logging and tracing systems to capture the other observability signals and correlate them with Prometheus metrics.
