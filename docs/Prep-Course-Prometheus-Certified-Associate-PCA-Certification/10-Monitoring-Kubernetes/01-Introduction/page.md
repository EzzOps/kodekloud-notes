...
> **lightbulb** Using the kube-prometheus-stack chart plus the Prometheus Operator provides a Kubernetes-native, declarative approach to deploy and manage Prometheus, Alertmanager, and related resources with far less manual YAML and maintenance overhead.
