...
> **warning** Using a `ClusterIP` service means the application is not exposed externally by default. If you need external access, consider `NodePort`, `LoadBalancer`, or an Ingress depending on your environment.
