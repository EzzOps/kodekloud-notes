...
> **lightbulb** This lesson uses Alertmanager v0.24.0 as an example. Replace the version in the commands if you need a newer/older release. For releases see the Alertmanager GitHub releases: [https://github.com/prometheus/alertmanager/releases](https://github.com/prometheus/alertmanager/releases)
