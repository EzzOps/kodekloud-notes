...
<Frame>
  ![The image shows a webpage from the FastAPI documentation, specifically focusing on SQL (Relational) Databases and how to use them with SQLAlchemy. It includes a list of supported databases and a table of contents on the right.](../../../../images/kodekloud.com/kk-media/image/upload/v1752883391/notes-assets/images/Python-API-Development-with-FastAPI-Sqlalchemy-Setup/fastapi-sqlalchemy-database-docs.jpg)
</Frame>

Begin by visiting the SQL page.

<Frame>
  ![The image shows the SQLAlchemy 1.4 documentation webpage, featuring sections on getting started, tutorials, and reference documentation for SQLAlchemy ORM and Core.](../../../../images/kodekloud.com/kk-media/image/upload/v1752883392/notes-assets/images/Python-API-Development-with-FastAPI-Sqlalchemy-Setup/sqlalchemy-1-4-documentation-webpage.jpg)
</Frame>
...
<Frame>
  ![The image shows a webpage from the SQLAlchemy documentation, featuring navigation menus and information about the Python SQL toolkit.](../../../../images/kodekloud.com/kk-media/image/upload/v1752883393/notes-assets/images/Python-API-Development-with-FastAPI-Sqlalchemy-Setup/sqlalchemy-documentation-webpage.jpg)
</Frame>
