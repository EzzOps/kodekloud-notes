...
Source: https://notes.kodekloud.com/docs/Python-API-Development-with-FastAPI/FastAPI-Basics/Post-Requests/page
...
2. Update the URL to "[http://127.0.0.1:8000/createposts](http://127.0.0.1:8000/createposts)".
