...
> **lightbulb** On macOS, the Python executable is not named python.exe. If you need to override the default, locate the appropriate Python installation on your system.
