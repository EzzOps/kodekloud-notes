...
Source: https://notes.kodekloud.com/docs/Python-API-Development-with-FastAPI/Python-Setup/Windows-Venv/page

Learn to set up a virtual environment on Windows using Visual Studio Code to isolate project dependencies from the global Python installation.
