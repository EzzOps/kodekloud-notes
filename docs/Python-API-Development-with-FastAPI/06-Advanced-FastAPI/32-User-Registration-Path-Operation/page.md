...
Source: https://notes.kodekloud.com/docs/Python-API-Development-with-FastAPI/Advanced-FastAPI/User-Registration-Path-Operation/page
...
After correcting the email—for example, using "[newuser@gmail.com](mailto:newuser@gmail.com)"—the endpoint successfully creates and returns the user.
