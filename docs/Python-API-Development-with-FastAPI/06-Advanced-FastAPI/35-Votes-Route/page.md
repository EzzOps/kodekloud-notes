...
Source: https://notes.kodekloud.com/docs/Python-API-Development-with-FastAPI/Advanced-FastAPI/Votes-Route/page
...
4. Ensure the Authorization header is set to "Bearer \<your\_token>".
