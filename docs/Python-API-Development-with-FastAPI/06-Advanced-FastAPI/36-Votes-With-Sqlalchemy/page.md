...
Source: https://notes.kodekloud.com/docs/Python-API-Development-with-FastAPI/Advanced-FastAPI/Votes-With-Sqlalchemy/page

This article explains how to create a votes table model using SQLAlchemy, including foreign keys and composite primary keys for user and post IDs.
...
* The votes table includes both the user\_id and post\_id columns.
...
This query will display vote records. For instance, if there is a vote with user\_id 21 and post\_id 10, it will appear in the results. Attempting to insert a record with an invalid user or post reference will produce an error, confirming that the foreign key constraints and cascade delete behavior are enforced correctly.
