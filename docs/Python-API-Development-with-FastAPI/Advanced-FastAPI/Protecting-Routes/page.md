...
Source: https://notes.kodekloud.com/docs/Python-API-Development-with-FastAPI/Advanced-FastAPI/Protecting-Routes/page
...
| GET /posts/    | Requires a valid token to fetch a specific post.                                  |
