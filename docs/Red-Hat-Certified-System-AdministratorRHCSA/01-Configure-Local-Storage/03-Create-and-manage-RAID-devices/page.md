...
> **triangle-alert** RAID 0 does not provide any redundancy. If any single disk fails, all data in the array is lost.
...
> **lightbulb** For additional guidance on managing and expanding your RAID configurations, refer to the [mdadm manual](https://manpages.debian.org/testing/mdadm/mdadm.8.en.html) and Linux system documentation.
