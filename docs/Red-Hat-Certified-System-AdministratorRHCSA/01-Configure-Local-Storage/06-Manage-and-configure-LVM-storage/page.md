...
Source: https://notes.kodekloud.com/docs/Red-Hat-Certified-System-AdministratorRHCSA/Configure-Local-Storage/Manage-and-configure-LVM-storage/page

This article provides a comprehensive guide on managing and configuring LVM storage in Linux, covering key concepts, commands, and operations.
...
To utilize the available storage, create a Volume Group (VG) that aggregates the physical volumes into one virtual disk. For example, combining `/dev/sdc` and `/dev/sdd` creates a VG of 10 gigabytes. Create the volume group named "my\_volume" with:
...
Create a logical volume named "partition1" with a size of 2GB in "my\_volume":
