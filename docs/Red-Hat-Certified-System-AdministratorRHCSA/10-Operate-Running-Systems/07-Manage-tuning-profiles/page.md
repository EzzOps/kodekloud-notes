...
Source: https://notes.kodekloud.com/docs/Red-Hat-Certified-System-AdministratorRHCSA/Operate-Running-Systems/Manage-tuning-profiles/page

Learn to manage tuning profiles with TuneD for optimizing system performance and settings based on various workloads.
...
!!! note "Installing TuneD"
If TuneD is not installed, use the following commands to install, enable, and verify its status:
...
!!! warning "Caution"
When merging profiles, ensure that settings do not conflict. For example, avoid merging performance-optimized disk settings with power-saving parameters.
