...
Source: https://notes.kodekloud.com/docs/Red-Hat-Certified-System-AdministratorRHCSA/Understand-and-Use-Essential-Tools/Create-and-manage-hard-links/page

This article explains how to create and manage hard links in Linux, highlighting their differences from soft links and their practical applications.
...
  /home/aaron/pictures/family\_dog.jpg
...
When you access the file (for example, by reading family\_dog.jpg), Linux refers to inode 52946177 to retrieve the data. The "Links" count indicates how many file names point to that inode.
...
For example, to create a hard link for family\_dog.jpg in Jane’s directory, run:
