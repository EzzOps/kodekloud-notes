...
* Disable direct root SSH access (set `PermitRootLogin no` in /etc/ssh/sshd\_config).
...
* [Kubernetes Basics](https://kubernetes.io/docs/concepts/overview/what-is-kubernetes/) (for context on multiuser environments)
* [PAM (Pluggable Authentication Modules)](https://www.linux-pam.org/)
* [Sudoers manual (man 5 sudoers)](https://man7.org/linux/man-pages/man5/sudoers.5.html)
...
Source: https://notes.kodekloud.com/docs/Red-Hat-Certified-System-AdministratorRHCSA/Understand-and-Use-Essential-Tools/Pagers-and-vi-demo/page

Learn to use pagers and the Vim text editor for efficient text file navigation and editing.
