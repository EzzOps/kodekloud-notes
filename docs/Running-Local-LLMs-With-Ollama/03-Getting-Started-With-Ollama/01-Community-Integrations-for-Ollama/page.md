...
> **lightbulb** * Docker installed on your machine
...
> **triangle-alert** Running models locally with Ollama ensures that sensitive data never leaves your network. Combine this with community UIs for a secure and user-friendly experience.
