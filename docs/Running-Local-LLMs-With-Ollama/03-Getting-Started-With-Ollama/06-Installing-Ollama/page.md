...
Source: https://notes.kodekloud.com/docs/Running-Local-LLMs-With-Ollama/Getting-Started-With-Ollama/Installing-Ollama/page

This guide explains how to download, install, and verify Ollama for running large language models on your local machine.
...
Visit the [Ollama website][1] and choose your operating system. Below is a quick reference for each platform:
