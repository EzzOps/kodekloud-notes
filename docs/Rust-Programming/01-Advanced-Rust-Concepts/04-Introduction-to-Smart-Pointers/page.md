...
> **lightbulb** Smart pointers come into play when more flexible memory management is needed beyond the standard ownership and borrowing rules.
...
> **lightbulb** Each smart pointer type addresses different programming needs. Choosing the right one depends on whether you require heap allocation, shared ownership, or interior mutability.
