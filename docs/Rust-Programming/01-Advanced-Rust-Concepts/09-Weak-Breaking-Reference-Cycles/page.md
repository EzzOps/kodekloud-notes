...
> **lightbulb** In scenarios where two entities hold strong references to each other, careful design is needed to allow proper memory deallocation. This is especially common in parent-child relationships and cyclic graph structures.
...
> **lightbulb** Using weak pointers is especially beneficial in scenarios such as parent-child relationships or cyclic data structures where a strong back-reference could inadvertently keep an object alive. This ensures that your application remains memory efficient.
