...
Source: https://notes.kodekloud.com/docs/Rust-Programming/Rust-Basics/Writing-and-Running-Your-First-Rust-program/page

Learn to write, compile, and run your first Rust program, including creating a file, writing code, and executing it from the terminal.
