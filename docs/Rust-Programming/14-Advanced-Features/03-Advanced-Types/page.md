...
Source: https://notes.kodekloud.com/docs/Rust-Programming/Advanced-Features/Advanced-Types/page

This lesson covers advanced features of Rusts type system, including new types, type aliases, the never type, and dynamically sized types.
