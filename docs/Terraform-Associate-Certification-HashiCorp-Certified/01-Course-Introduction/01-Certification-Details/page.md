...
Source: https://notes.kodekloud.com/docs/Terraform-Associate-Certification-HashiCorp-Certified/Course-Introduction/Certification-Details/page
...
Let's review the essential details for the HashiCorp Certified Terraform Associate exam. This exam is designed to test your Terraform knowledge with a mix of multiple choice, multiple answer, and true/false questions.
...
Before you begin the exam, ensure that your system and environment meet these technical requirements:

1. Virtual machines are not permitted.
2. The PSI Secure Browser must be installed to start the exam.
3. Additional or external monitors are not allowed.
4. Headphones are not permitted during the exam.
5. Your webcam, speakers, and microphone must remain active for the entire exam.
