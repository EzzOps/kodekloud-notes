...
Source: https://notes.kodekloud.com/docs/Terraform-Associate-Certification-HashiCorp-Certified/Use-the-Terraform-CLI/Basic-Terraform-Commands/page

This article covers commonly used Terraform commands for validating configurations, managing resources, and synchronizing infrastructure state.
...
Use the `terraform state list` command to display all resources recorded in the state file. The output lists resource addresses in the format *resource\_type.resource\_name*. For example:
