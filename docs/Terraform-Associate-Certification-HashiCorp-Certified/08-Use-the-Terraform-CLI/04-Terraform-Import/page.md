...
Source: https://notes.kodekloud.com/docs/Terraform-Associate-Certification-HashiCorp-Certified/Use-the-Terraform-CLI/Terraform-Import/page
...
For an EC2 instance, the resource address is "aws\_instance.webserver-2" and the unique resource attribute is the instance ID. Run the command as shown below:
