...
Source: https://notes.kodekloud.com/docs/Terraform-Associate-Certification-HashiCorp-Certified/Terraform-Provider-Basics/Version-Constraints/page

This article explores how Terraform manages provider versions and version constraints to ensure stable infrastructure deployments.
...
2. Add a new `terraform` block to your configuration with a required\_providers block that includes version constraints.
