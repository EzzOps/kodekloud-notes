...
> **lightbulb** Terraform's interpolation syntax allows you to reference another resource's attribute using the format: resource\_type.resource\_name.attribute. This ensures that when one resource's output changes, the dependent resource will update accordingly.
