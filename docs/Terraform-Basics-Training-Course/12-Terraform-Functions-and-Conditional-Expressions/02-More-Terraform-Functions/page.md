...
Source: https://notes.kodekloud.com/docs/Terraform-Basics-Training-Course/Terraform-Functions-and-Conditional-Expressions/More-Terraform-Functions/page

This lesson explores additional Terraform functions for processing and transforming values, including numeric, string, collection, and map functions.
