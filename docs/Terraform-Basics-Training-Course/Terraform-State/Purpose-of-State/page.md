...
Source: https://notes.kodekloud.com/docs/Terraform-Basics-Training-Course/Terraform-State/Purpose-of-State/page

This article explores the role of the state file in Terraform and how it maps resource configurations to real-world infrastructure.
