...
Source: https://notes.kodekloud.com/docs/Terragrunt-for-Beginners/Building-our-first-AWS-Demo-with-Terragrunt/Demo-of-Lab-6/page

This article provides a walkthrough for using Terragrunt to provision a multi-account, multi-region AWS infrastructure.
...
| ---------- | --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Terraform  | v1.8.3+         | [https://www.terraform.io/downloads.html](https://www.terraform.io/downloads.html)                                                                             |
| Terragrunt | v0.58.8+        | [https://terragrunt.gruntwork.io/docs/getting-started/install/](https://terragrunt.gruntwork.io/docs/getting-started/install/)                                 |
| AWS CLI    | v2.x            | [https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) |
