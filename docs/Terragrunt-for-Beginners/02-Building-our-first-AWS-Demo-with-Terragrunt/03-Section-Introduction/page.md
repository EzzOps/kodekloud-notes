...
<Frame>
  ![The image outlines four key steps for building an AWS demo with Terragrunt: setting up AWS, initializing Terraform configuration, sourcing modules, and parameterizing variables.](../../../../images/kodekloud.com/kk-media/image/upload/v1752884252/notes-assets/images/Terragrunt-for-Beginners-Section-Introduction/aws-demo-terragrunt-steps-outline.jpg)
</Frame>
...
<Frame>
  ![The image outlines key steps for building an AWS demo with Terragrunt, focusing on versioning and updates, testing and validation, and documentation and best practices.](../../../../images/kodekloud.com/kk-media/image/upload/v1752884254/notes-assets/images/Terragrunt-for-Beginners-Section-Introduction/aws-demo-terragrunt-steps-overview.jpg)
</Frame>
