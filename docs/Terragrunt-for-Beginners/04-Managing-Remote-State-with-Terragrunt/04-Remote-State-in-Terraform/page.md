...
> **lightbulb** Terragrunt automatically generates the Terraform backend configuration for you. This ensures consistent remote state settings across all environments.
...
> **triangle-alert** Your state file may contain sensitive data (passwords, IDs, etc.). Always enable encryption and restrict access to authorized team members only.
