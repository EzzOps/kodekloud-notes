...
Source: https://notes.kodekloud.com/docs/Terragrunt-for-Beginners/Terragrunt-Attributes/skip-Attribute/page

This article explores the `skip` attribute in Terragrunt, a boolean flag for controlling module execution of Terraform commands.
