...
Source: https://notes.kodekloud.com/docs/Terragrunt-for-Beginners/Terragrunt-Commands/terragrunt-hclfmt/page

Terragrunt HCL Format enforces consistent style for HCL files, helping teams maintain clean code and minimize version-control noise.
