...
Source: https://notes.kodekloud.com/docs/Updated-AZ-104-Microsoft-Azure-Administrator/Administer-Azure-Storage/Creating-Azure-File-Share/page

This article explains how to create and connect to an Azure File Share for cloud file storage.
