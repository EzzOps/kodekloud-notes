...
Source: https://notes.kodekloud.com/docs/Updated-AZ-104-Microsoft-Azure-Administrator/Administer-Governance-and-Compliance/Managing-subscriptions/page

This article explains Azure Subscriptions, their types, management, and how they help organize and monitor cloud resources effectively.
...
<Frame>
  ![The image is an infographic about Azure Subscriptions, highlighting features such as billing boundaries, resource mapping, environmental boundaries, unique IDs, multiple subscriptions, identity sign-up, subscription types, and access management.](../../../../images/kodekloud.com/kk-media/image/upload/v1752884552/notes-assets/images/Updated-AZ-104-Microsoft-Azure-Administrator-Managing-subscriptions/azure-subscriptions-infographic-features.jpg)
</Frame>
...
<Frame>
  ![The image lists different subscription offer types: Enterprise Agreements, Pay-as-You-Go, Cloud Solution Provider, Free Trial, Azure for Students, and Visual Studio, each with an icon.](../../../../images/kodekloud.com/kk-media/image/upload/v1752884553/notes-assets/images/Updated-AZ-104-Microsoft-Azure-Administrator-Managing-subscriptions/subscription-offer-types-list.jpg)
</Frame>
...
<Frame>
  ![The image shows a Microsoft Azure portal dashboard displaying subscription details for "MSDN Firbish RTN," including subscription ID, billing period, and cost management options. It also features charts for spending forecasts, resource costs, and Azure Defender coverage.](../../../../images/kodekloud.com/kk-media/image/upload/v1752884555/notes-assets/images/Updated-AZ-104-Microsoft-Azure-Administrator-Managing-subscriptions/azure-portal-dashboard-msdn-firbish.jpg)
</Frame>
...
<Frame>
  ![The image shows a Microsoft Azure portal page where users can select offers for their subscriptions, with options like "Microsoft Partner Network" and "Azure in Open." There are buttons to check eligibility and select offers.](../../../../images/kodekloud.com/kk-media/image/upload/v1752884558/notes-assets/images/Updated-AZ-104-Microsoft-Azure-Administrator-Managing-subscriptions/azure-portal-offer-selection.jpg)
</Frame>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/az-104-microsoft-azure-administrator/module/df99187b-f512-443a-a64b-93af9d73c5bc/lesson/50db585f-47cb-472b-bd18-a16c06b20b39" />
</CardGroup>
