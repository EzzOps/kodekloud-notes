...
> **lightbulb** When selecting a SKU, consider your workload’s requirements for performance, security, and availability. The Standard SKU is better suited for production environments with stringent SLA needs.
...
> **lightbulb** For detailed instructions on configuring your load balancing rules, refer to the official [Azure Load Balancer documentation](https://docs.microsoft.com/en-us/azure/load-balancer/load-balancer-standard-overview).
