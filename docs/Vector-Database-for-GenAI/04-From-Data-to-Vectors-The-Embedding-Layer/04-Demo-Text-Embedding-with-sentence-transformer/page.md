...
> **lightbulb** Loading the CLIP model may take some time the first time because the pretrained weights are downloaded. Expect a minute or two depending on your connection and environment.
...
> **warning** The script below deletes any existing LanceDB at the configured `DB_PATH`. Back up data if you need to preserve a previous index.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/vector-database-for-genai/module/47c71900-9efe-47e3-ac4c-502d14eafd06/lesson/07f3b28d-96de-440d-b8df-e31168048037)

  - [Practice Lab](https://learn.kodekloud.com/user/courses/vector-database-for-genai/module/47c71900-9efe-47e3-ac4c-502d14eafd06/lesson/4cdce043-f06d-48a4-b9f4-3eb6c0f79bfc)
...
> **lightbulb** If you see warnings about unauthenticated Hugging Face Hub requests, set a `HF_TOKEN` environment variable to increase rate limits and speed up downloads.
