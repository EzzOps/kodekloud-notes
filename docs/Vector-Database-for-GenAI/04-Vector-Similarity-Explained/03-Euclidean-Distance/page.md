...
> **lightbulb** Euclidean distance is the straight-line distance between two points: smaller distance means more similar, larger distance means less similar.
...
> **warning** Be cautious using Euclidean distance for high-dimensional embeddings: the curse of dimensionality can make distances less meaningful. Consider cosine similarity or other normalized measures for many text-embedding tasks.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/vector-database-for-genai/module/8e06787b-1ff8-4f2f-82f3-64f588e6637b/lesson/a08ffc6a-28a9-442f-9dae-d751f40e8bd9)
