...
> **lightbulb** If you're following along in a fresh notebook, run each code block sequentially so variables (like `fruit_vectors` and `mango_query`) are available for plotting and metric computation.
