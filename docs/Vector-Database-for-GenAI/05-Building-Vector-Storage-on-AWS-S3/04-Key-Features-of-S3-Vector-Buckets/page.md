...
> **lightbulb** Security notes: S3 Vector Buckets separate vector permissions from standard S3 and enable public access block by default. Use IAM, SCPs, and `SSE-KMS` when customer-managed keys are required for compliance.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/vector-database-for-genai/module/afa51fbf-32d5-4459-a9de-0a764b24682b/lesson/c593c978-cfbb-4777-91f1-988d076c8e2a)
