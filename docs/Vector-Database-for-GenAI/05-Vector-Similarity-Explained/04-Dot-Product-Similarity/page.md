...
> **lightbulb** Remember: a large positive dot product means a strong, aligned match. A large negative dot product means a strong but opposite signal.
...
> **warning** When using dot product as a scoring function, be aware that magnitudes influence scores. Score normalization or alternative metrics (e.g., cosine) may be preferable if you want to ignore magnitude and focus on pure directional similarity.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/vector-database-for-genai/module/8e06787b-1ff8-4f2f-82f3-64f588e6637b/lesson/2d9eded2-99f0-4c16-95b0-429c5d320b8a)
