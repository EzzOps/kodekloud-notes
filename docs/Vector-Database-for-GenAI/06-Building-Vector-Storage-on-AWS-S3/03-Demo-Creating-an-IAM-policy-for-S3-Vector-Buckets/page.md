...
> **warning** If you receive `AccessDenied` or `Unauthorized` errors, verify the IAM policy attached to your user/role includes the required s3vectors actions and the resource ARNs are in scope for your region and account.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/vector-database-for-genai/module/afa51fbf-32d5-4459-a9de-0a764b24682b/lesson/94f5393a-3890-4d8c-be70-da046f8489e1)
...
> **lightbulb** If you have multiple vector buckets or separate environments (dev/stage/prod), create separate policies per environment and scope ARNs accordingly. This makes auditing and rotation easier.
...
> **warning** Never commit access keys to source control. Store them securely (for example, in a secrets manager or environment variables) and rotate them regularly.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/vector-database-for-genai/module/afa51fbf-32d5-4459-a9de-0a764b24682b/lesson/9191e7a7-9555-44f1-899e-9a15c16efe0e)
