...
> **lightbulb** A common production pattern is to use both: store raw source files (PDFs, knowledge base articles, images) in a standard S3 bucket, and store document or chunk embeddings in an S3 Vector Bucket. Use vector search to find relevant chunks and then fetch the original content from standard S3.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/vector-database-for-genai/module/afa51fbf-32d5-4459-a9de-0a764b24682b/lesson/3a6f5583-1a3e-430b-84c7-a74edd73da16)
