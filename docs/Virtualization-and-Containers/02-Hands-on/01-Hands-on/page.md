...
<Callout icon="warning">
  Unpatched or unsupported VMs (older OS builds) can be vulnerable to attacks. Treat any VM with internet access as potentially unsafe—do not store real credentials or sensitive data inside them.
</Callout>
