...
<Callout icon="lightbulb">
  Lab instances are ephemeral: the owner account (email, first name, last name, password) you create is temporary and tied to that lab session only. Feel free to reuse different credentials for different lab runs.
</Callout>
...
<Callout icon="warning">
  When you see the “unverified app” message, it is expected for test apps created in your own Google Cloud project. Only proceed if you created the project and trust the app; otherwise, do not grant access.
</Callout>
...
<CardGroup>
  <Card title="Watch Video" icon="video" href="https://learn.kodekloud.com/user/courses/n8n-zero-to-hero/module/6045516d-9973-433b-8ce3-99f78a1b3c15/lesson/218465a7-9ea9-4d38-baa7-757ab8d2bb07" />

  <Card title="Practice Lab" icon="flask-conical" href="https://learn.kodekloud.com/user/courses/n8n-zero-to-hero/module/6045516d-9973-433b-8ce3-99f78a1b3c15/lesson/82bb662f-822a-435f-8ea9-fb3ce84b806d" />
</CardGroup>
