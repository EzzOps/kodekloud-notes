...
> **warning** Design workflows with error handling and retries when calling external APIs. Use conditional nodes (`If`) and the `Continue On Fail` option to avoid full workflow failures on intermittent errors.
...
> **lightbulb** When writing expressions or other snippets that contain braces or template syntax, wrap them in inline code or fenced code blocks so the MDX renderer does not attempt to evaluate them.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/n8n-zero-to-hero/module/bb9d0021-2331-4d70-8853-4e4eb64070f3/lesson/28a3f8ee-80f5-486f-b0c0-b827417f6678)
