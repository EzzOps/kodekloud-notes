...
> **lightbulb** If you see a "Google hasn't verified this app" warning when signing in, that is expected for unverified apps. For development and testing you can proceed. To remove the warning for production, submit the app for verification through Google Cloud.
...
> **warning** Ensure the redirect URI you add to Google Cloud exactly matches the OAuth Redirect URL shown in n8n (including protocol, domain, and path). A mismatch will cause Google sign-in to fail.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/n8n-zero-to-hero/module/6045516d-9973-433b-8ce3-99f78a1b3c15/lesson/b4e9cd1a-eb37-40bb-a525-4123655e1f7c)
