...
> **warning** Make sure you are an admin to install the app into the Slack workspace. Treat the Bot User OAuth Token as a secret — do not share it publicly.
...
> **note** The Slack Request URL must be publicly reachable over HTTPS. If your n8n instance is running locally or behind a firewall, use a secure tunnel (for example, `ngrok` at [https://ngrok.com](https://ngrok.com)) or expose n8n with a valid TLS endpoint. Ensure n8n is running and reachable while completing the verification step.
...
- [Watch Video](https://learn.kodekloud.com/user/courses/n8n-zero-to-hero/module/6045516d-9973-433b-8ce3-99f78a1b3c15/lesson/3344ec6a-9398-48d6-b9a3-3b3e0009ef38)
