...
> **lightbulb** The Error Trigger only captures failures from production executions. Manual runs won’t fire the error workflow — toggle the original workflow to production to test real error forwarding.
...
> **warning** Avoid logging sensitive PII or secrets in plain text to shared sheets or public channels. Mask or redact sensitive fields before persisting or notifying.

- [Watch Video](https://learn.kodekloud.com/user/courses/n8n-zero-to-hero/module/ec8c9063-8504-4153-b9d6-b95d35c600c9/lesson/22c4a7c3-4c82-4e39-978c-2ec0449a791d)
